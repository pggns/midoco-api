...
class GetOrgunitEmailSigListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem) {
            ...
            if (!$getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\OrgunitEmailSigDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetOrgunitEmailSigListResponse
     */
