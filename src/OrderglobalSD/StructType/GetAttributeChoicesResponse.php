...
class GetAttributeChoicesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO[]
     */
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintsFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $getAttributeChoicesResponseMidocoAttributeChoiceValueItem) {
            ...
            if (!$getAttributeChoicesResponseMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAttributeChoiceValue property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetAttributeChoicesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO $item
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetAttributeChoicesResponse
     */
    public function addToMidocoAttributeChoiceValue(\Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAttributeChoiceValue property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AttributeChoiceValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
