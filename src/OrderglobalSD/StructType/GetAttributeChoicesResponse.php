...
class GetAttributeChoicesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $getAttributeChoicesResponseMidocoAttributeChoiceValueItem) {
            ...
            if (!$getAttributeChoicesResponseMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\AttributeChoiceValueDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAttributeChoicesResponse
     */
