...
class GetDbiDefinitionRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoDbiCcInfo $midocoDbiCcInfo = null, ?bool $emailIfNew = true, ?string $publisherId = null, ?string $dbiItemType = null, ?int $customerId = null, ?string $companyAccount = null)
    {
        $this
