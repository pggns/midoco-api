...
class GetSftpCredentialListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO[]
     */
    ...
    public static function validateMidocoSftpCredentialForArrayConstraintFromSetMidocoSftpCredential(?array $values = []): string
    {
        ...
        foreach ($values as $getSftpCredentialListResponseMidocoSftpCredentialItem) {
            ...
            if (!$getSftpCredentialListResponseMidocoSftpCredentialItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO[] $midocoSftpCredential
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetSftpCredentialListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetSftpCredentialListResponse
     */
    public function addToMidocoSftpCredential(\Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\SftpCredentialDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
