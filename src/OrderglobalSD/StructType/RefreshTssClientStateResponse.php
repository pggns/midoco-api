...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\RefreshTssClientStateResponse
     */
