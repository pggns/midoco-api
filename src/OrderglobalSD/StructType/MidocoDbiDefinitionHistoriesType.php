...
class MidocoDbiDefinitionHistoriesType extends AbstractStructBase
{
     ...
     */
    public function __construct(\Pggns\MidocoApi\Api\OrderglobalSD\StructType\DbiUpdateDTO $midocoDbiUpdate, ?array $midocoDbiDefinitionHistory = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\DbiUpdateDTO $midocoDbiUpdate
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoDbiDefinitionHistoriesType
     */
    ...
    public static function validateMidocoDbiDefinitionHistoryForArrayConstraintsFromSetMidocoDbiDefinitionHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDbiDefinitionHistoriesTypeMidocoDbiDefinitionHistoryItem) {
            ...
            if (!$midocoDbiDefinitionHistoriesTypeMidocoDbiDefinitionHistoryItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoDbiDefinitionHistory) {
