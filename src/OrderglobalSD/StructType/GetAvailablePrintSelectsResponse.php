...
class GetAvailablePrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailablePrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAvailablePrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAvailablePrintSelectsResponse
     */
