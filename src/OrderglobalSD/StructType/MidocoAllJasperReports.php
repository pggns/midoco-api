...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAllJasperReports
     */
