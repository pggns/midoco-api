...
class CreateCcProxySingleUseTokenRequest extends AbstractStructBase
{
    ...
    /**
     * The emailData
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO|null
     */
    protected ?\Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO $emailData = null;
    /**
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO $emailData
     */
    public function __construct(?string $token = null, ?string $tokenValue = null, ?string $sensitiveId = null, ?int $lifespanInSeconds = null, ?int $userId = null, ?string $orgUnit = null, ?\Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO $emailData = null)
    {
        $this
            ->setToken($token)
     ...
     * Set token value
     * @param string $token
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\CreateCcProxySingleUseTokenRequest
     */
    ...
    /**
     * Get emailData value
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO|null
     */
    public function getEmailData(): ?\Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO
    {
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\CreateCcProxySingleUseTokenRequest
     */
    public function setEmailData(?\Pggns\MidocoApi\OrderglobalSD\StructType\CcProxyEmailDataDTO $emailData = null): self
    {
