...
class SaveAccessibleComponentsByRoleRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $saveAccessibleComponentsByRoleRequestMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$saveAccessibleComponentsByRoleRequestMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAccessibleComponentByRoleType) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAccessibleComponentByRoleType[] $midocoAccessibleComponentByRole
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\SaveAccessibleComponentsByRoleRequest
     */
