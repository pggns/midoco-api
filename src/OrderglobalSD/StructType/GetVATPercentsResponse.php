...
class GetVATPercentsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDefinitionForArrayConstraintsFromSetMidocoVatDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getVATPercentsResponseMidocoVatDefinitionItem) {
            ...
            if (!$getVATPercentsResponseMidocoVatDefinitionItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoVatDefinition) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoVatDefinition[] $midocoVatDefinition
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetVATPercentsResponse
     */
