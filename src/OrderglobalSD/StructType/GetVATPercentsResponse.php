...
class GetVATPercentsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDefinitionForArrayConstraintFromSetMidocoVatDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getVATPercentsResponseMidocoVatDefinitionItem) {
            ...
            if (!$getVATPercentsResponseMidocoVatDefinitionItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoVatDefinition) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoVatDefinition[] $midocoVatDefinition
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetVATPercentsResponse
     */
