...
class MidocoJasperReportListExt extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoParameter
     * @var \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter[] $midocoParameter
     ...
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter[]
     */
    ...
    public static function validateMidocoParameterForArrayConstraintsFromSetMidocoParameter(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperReportListExtMidocoParameterItem) {
            ...
            if (!$midocoJasperReportListExtMidocoParameterItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoParameter property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter[] $midocoParameter
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoJasperReportListExt
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter $item
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoJasperReportListExt
     */
    public function addToMidocoParameter(\Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter) {
            throw new InvalidArgumentException(sprintf('The MidocoParameter property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoParameter, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoJasperReportForArrayConstraintsFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperReportListExtMidocoJasperReportItem) {
            // validation for constraint: itemType
            if (!$midocoJasperReportListExtMidocoJasperReportItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoJasperReport) {
