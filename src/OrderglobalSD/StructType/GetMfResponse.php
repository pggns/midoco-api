...
class GetMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfResponseMidocoMfItem) {
            ...
            if (!$getMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetMfResponse
     */
