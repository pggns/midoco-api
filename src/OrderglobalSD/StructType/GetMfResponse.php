...
class GetMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfResponseMidocoMfItem) {
            ...
            if (!$getMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetMfResponse
     */
