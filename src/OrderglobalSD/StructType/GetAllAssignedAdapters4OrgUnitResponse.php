...
class GetAllAssignedAdapters4OrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem) {
            ...
            if (!$getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
