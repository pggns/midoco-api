...
class RoleAppDTO extends AbstractStructBase
{
    ...
    /**
     * Constructor method for RoleAppDTO
     * @uses RoleAppDTO::setAppId()
     * @uses RoleAppDTO::setPosition()
     * @uses RoleAppDTO::setRoleId()
     * @param string $appId
     * @param int $position
     * @param int $roleId
     */
    public function __construct(?string $appId = null, ?int $position = null, ?int $roleId = null)
    {
        $this
            ->setAppId($appId)
     ...
     * Set appId value
     * @param string $appId
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\RoleAppDTO
     */
