...
class GetAccessibleComponentsByRoleResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAccessibleComponentByRoleType) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAccessibleComponentByRoleType[] $midocoAccessibleComponentByRole
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAccessibleComponentsByRoleResponse
     */
