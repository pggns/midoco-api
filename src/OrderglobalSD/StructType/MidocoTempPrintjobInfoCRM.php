...
class MidocoTempPrintjobInfoCRM extends AbstractStructBase
{
    ...
    /**
     * Constructor method for MidocoTempPrintjobInfoCRM
     * @uses MidocoTempPrintjobInfoCRM::setComment()
     * @uses MidocoTempPrintjobInfoCRM::setCreatingUser()
     * @uses MidocoTempPrintjobInfoCRM::setId()
     * @uses MidocoTempPrintjobInfoCRM::setIsPreview()
     * @uses MidocoTempPrintjobInfoCRM::setIsPrinted()
     * @uses MidocoTempPrintjobInfoCRM::setNumCopies()
     * @uses MidocoTempPrintjobInfoCRM::setPrintTimestamp()
     * @uses MidocoTempPrintjobInfoCRM::setPrintjobId()
     * @uses MidocoTempPrintjobInfoCRM::setTimeCreated()
     * @uses MidocoTempPrintjobInfoCRM::setTypeId()
     * @uses MidocoTempPrintjobInfoCRM::setStatus()
     ...
     * Set comment value
     * @param string $comment
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\MidocoTempPrintjobInfoCRM
     */
