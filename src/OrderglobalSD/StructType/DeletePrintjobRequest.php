...
/**
 * This class stands for DeletePrintjobRequest StructType
 * @subpackage Structs
 */
class DeletePrintjobRequest extends AbstractStructBase
{
    /**
     * The printjob_id
     * @var int|null
    ...
    /**
     * Constructor method for DeletePrintjobRequest
     * @uses DeletePrintjobRequest::setPrintjob_id()
     ...
     * @param int $printjob_id
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\DeletePrintjobRequest
     */
