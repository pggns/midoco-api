...
class GetAssignedPrintTypeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     */
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign[]
     */
    ...
    public static function validateMidocoPrintTypeAssignForArrayConstraintFromSetMidocoPrintTypeAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintTypeResponseMidocoPrintTypeAssignItem) {
            ...
            if (!$getAssignedPrintTypeResponseMidocoPrintTypeAssignItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAssignedPrintTypeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAssignedPrintTypeResponse
     */
    public function addToMidocoPrintTypeAssign(\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintTypeAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
