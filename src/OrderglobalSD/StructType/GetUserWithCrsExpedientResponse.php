...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetUserWithCrsExpedientResponse
     */
