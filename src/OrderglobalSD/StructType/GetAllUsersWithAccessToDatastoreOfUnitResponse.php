...
class GetAllUsersWithAccessToDatastoreOfUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem) {
            ...
            if (!$getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetAllUsersWithAccessToDatastoreOfUnitResponse
     */
