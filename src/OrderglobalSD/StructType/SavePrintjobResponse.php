...
class SavePrintjobResponse extends AbstractStructBase
{
    ...
    /**
     * Constructor method for SavePrintjobResponse
     * @uses SavePrintjobResponse::setPrintjob_id()
     ...
     * @param int $printjob_id
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\SavePrintjobResponse
     */
