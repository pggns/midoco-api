...
class GetAutoMailInfoResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO[] $midocoAutoMailInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO[]
     */
    ...
    public static function validateMidocoAutoMailInfoForArrayConstraintsFromSetMidocoAutoMailInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getAutoMailInfoResponseMidocoAutoMailInfoItem) {
            ...
            if (!$getAutoMailInfoResponseMidocoAutoMailInfoItem instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAutoMailInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO[] $midocoAutoMailInfo
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetAutoMailInfoResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO $item
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\GetAutoMailInfoResponse
     */
    public function addToMidocoAutoMailInfo(\Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAutoMailInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderglobalSD\StructType\AutoMailDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
