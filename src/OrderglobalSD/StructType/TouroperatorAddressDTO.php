...
class TouroperatorAddressDTO extends AbstractStructBase
{
    ...
    /**
     * Constructor method for TouroperatorAddressDTO
     * @uses TouroperatorAddressDTO::setAdditionalInfo()
     * @uses TouroperatorAddressDTO::setAddressId()
     * @uses TouroperatorAddressDTO::setCity()
     * @uses TouroperatorAddressDTO::setCountryCode()
     * @uses TouroperatorAddressDTO::setEmail()
     * @uses TouroperatorAddressDTO::setPhone()
     * @uses TouroperatorAddressDTO::setPostalCode()
     * @uses TouroperatorAddressDTO::setStreet()
     * @uses TouroperatorAddressDTO::setStreetNo()
     * @uses TouroperatorAddressDTO::setTouroperatorId()
     * @uses TouroperatorAddressDTO::setValidFrom()
     * @uses TouroperatorAddressDTO::setValidTo()
     ...
     */
    public function __construct(?string $additionalInfo = null, ?int $addressId = null, ?string $city = null, ?string $countryCode = null, ?string $email = null, ?string $phone = null, ?string $postalCode = null, ?string $street = null, ?string $streetNo = null, ?int $touroperatorId = null, ?string $validFrom = null, ?string $validTo = null)
    {
        $this
     ...
     * @param string $additionalInfo
     * @return \Pggns\MidocoApi\Api\OrderglobalSD\StructType\TouroperatorAddressDTO
     */
