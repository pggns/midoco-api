...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\AvailableAdaptersResponse
     */
