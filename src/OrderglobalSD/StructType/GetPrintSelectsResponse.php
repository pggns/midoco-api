...
class GetPrintSelectsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect[] $midocoPrintSelect
     */
    ...
    public static function validateMidocoPrintSelectForArrayConstraintsFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetPrintSelectsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetPrintSelectsResponse
     */
    public function addToMidocoPrintSelect(\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoPrintSelect, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
