...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Workflow\StructType\RefreshTssClientStateRequest
     */
