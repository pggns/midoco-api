...
class MidocoJasperReportParamForExec extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Workflow\StructType\MidocoJasperReportParam $midocoJasperReportParam = null, ?\Pggns\MidocoApi\Api\Workflow\StructType\JasperParameterDTO $midocoJasperParameter = null)
    {
        $this
