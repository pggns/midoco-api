...
class GetMidocoAttributeDefinitionRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO $midocoSystemAttributeDefinition = null, ?string $orgunit = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO $midocoSystemAttributeDefinition
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetMidocoAttributeDefinitionRequest
     */
