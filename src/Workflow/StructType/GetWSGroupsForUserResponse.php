...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Workflow\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Workflow\StructType\GetWSGroupsForUserResponse
     */
