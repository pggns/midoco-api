...
class GetDocumentNatureRetentionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType[] $midocoDocumentNatureRetention
     */
     ...
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType[]
     */
    ...
    public static function validateMidocoDocumentNatureRetentionForArrayConstraintsFromSetMidocoDocumentNatureRetention(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNatureRetentionsResponseMidocoDocumentNatureRetentionItem) {
            ...
            if (!$getDocumentNatureRetentionsResponseMidocoDocumentNatureRetentionItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNatureRetention property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType[] $midocoDocumentNatureRetention
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetDocumentNatureRetentionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType $item
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetDocumentNatureRetentionsResponse
     */
    public function addToMidocoDocumentNatureRetention(\Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNatureRetention property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\MidocoDocumentNatureRetentionType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
