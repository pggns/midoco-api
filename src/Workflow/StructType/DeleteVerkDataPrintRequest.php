...
class DeleteVerkDataPrintRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoVerkDataPrintForArrayConstraintsFromSetMidocoVerkDataPrint(?array $values = []): string
    {
        ...
        foreach ($values as $deleteVerkDataPrintRequestMidocoVerkDataPrintItem) {
            ...
            if (!$deleteVerkDataPrintRequestMidocoVerkDataPrintItem instanceof \Pggns\MidocoApi\Workflow\StructType\VerkDataPrintDTO) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\VerkDataPrintDTO[] $midocoVerkDataPrint
     * @return \Pggns\MidocoApi\Workflow\StructType\DeleteVerkDataPrintRequest
     */
