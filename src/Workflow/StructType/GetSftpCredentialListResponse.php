...
class GetSftpCredentialListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO[]
     */
    ...
    public static function validateMidocoSftpCredentialForArrayConstraintsFromSetMidocoSftpCredential(?array $values = []): string
    {
        ...
        foreach ($values as $getSftpCredentialListResponseMidocoSftpCredentialItem) {
            ...
            if (!$getSftpCredentialListResponseMidocoSftpCredentialItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO[] $midocoSftpCredential
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetSftpCredentialListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO $item
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetSftpCredentialListResponse
     */
    public function addToMidocoSftpCredential(\Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\SftpCredentialDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
