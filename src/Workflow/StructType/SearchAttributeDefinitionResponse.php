...
class SearchAttributeDefinitionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeDefinitionForArrayConstraintsFromSetMidocoAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $searchAttributeDefinitionResponseMidocoAttributeDefinitionItem) {
            ...
            if (!$searchAttributeDefinitionResponseMidocoAttributeDefinitionItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionType) {
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionType[] $midocoAttributeDefinition
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\SearchAttributeDefinitionResponse
     */
