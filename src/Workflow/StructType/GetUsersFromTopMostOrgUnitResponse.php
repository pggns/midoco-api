...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Workflow\StructType\GetUsersFromTopMostOrgUnitResponse
     */
