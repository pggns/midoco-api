...
class ListTssClientResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $listTssClientResponseMidocoTssClientItem) {
            ...
            if (!$listTssClientResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Workflow\StructType\ListTssClientResponse
     */
