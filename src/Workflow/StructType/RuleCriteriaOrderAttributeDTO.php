...
/**
 * This class stands for RuleCriteriaOrderAttributeDTO StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RuleCriteriaOrderAttributeDTO extends AbstractStructBase
{
    /**
     * The attributeId
     * @var int|null
    ...
    /**
     * Constructor method for RuleCriteriaOrderAttributeDTO
     * @uses RuleCriteriaOrderAttributeDTO::setAttributeId()
     * @uses RuleCriteriaOrderAttributeDTO::setAttributeName()
     * @uses RuleCriteriaOrderAttributeDTO::setAttributeValue()
     * @uses RuleCriteriaOrderAttributeDTO::setCriteriaId()
