...
class GetMfLocalRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Workflow\StructType\MidocoMfLocal $midocoMfLocal = null, ?string $unitName = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoMfLocal $midocoMfLocal
     * @return \Pggns\MidocoApi\Workflow\StructType\GetMfLocalRequest
     */
