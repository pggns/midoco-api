...
class GetMidocoAttributeDefinitionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO[]
     */
    ...
    public static function validateMidocoSystemAttributeDefinitionForArrayConstraintsFromSetMidocoSystemAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoAttributeDefinitionResponseMidocoSystemAttributeDefinitionItem) {
            ...
            if (!$getMidocoAttributeDefinitionResponseMidocoSystemAttributeDefinitionItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSystemAttributeDefinition property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO[] $midocoSystemAttributeDefinition
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetMidocoAttributeDefinitionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO $item
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetMidocoAttributeDefinitionResponse
     */
    public function addToMidocoSystemAttributeDefinition(\Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSystemAttributeDefinition property can only contain items of type \Pggns\MidocoApi\Api\Workflow\StructType\AttributeDefinitionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
