...
/**
 * This class stands for ListRuleCriteriaCrmRequest StructType
 * @subpackage Structs
 */
class ListRuleCriteriaCrmRequest extends AbstractStructBase
{
    /**
     * The unitName
    ...
    /**
     * Constructor method for ListRuleCriteriaCrmRequest
     * @uses ListRuleCriteriaCrmRequest::setUnitName()
     * @uses ListRuleCriteriaCrmRequest::setDefinitionId()
     ...
     * Set unitName value
     * @param string $unitName
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\ListRuleCriteriaCrmRequest
     */
