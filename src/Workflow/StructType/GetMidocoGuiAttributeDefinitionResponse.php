...
class GetMidocoGuiAttributeDefinitionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO[]
     */
    ...
    public static function validateMidocoGuiAttributeDefinitionForArrayConstraintsFromSetMidocoGuiAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoGuiAttributeDefinitionResponseMidocoGuiAttributeDefinitionItem) {
            ...
            if (!$getMidocoGuiAttributeDefinitionResponseMidocoGuiAttributeDefinitionItem instanceof \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoGuiAttributeDefinition property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO[] $midocoGuiAttributeDefinition
     * @return \Pggns\MidocoApi\Workflow\StructType\GetMidocoGuiAttributeDefinitionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO $item
     * @return \Pggns\MidocoApi\Workflow\StructType\GetMidocoGuiAttributeDefinitionResponse
     */
    public function addToMidocoGuiAttributeDefinition(\Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoGuiAttributeDefinition property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\GuiAttributeDefinitionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
