...
class SaveMidocoAttributeChoiceValueRequest extends AbstractStructBase
{
     ...
     * @param bool $isNew
     */
    public function __construct(?\Pggns\MidocoApi\Api\Workflow\StructType\AttributeChoiceValueDTO $midocoSystemAttributeChoiceValue = null, ?bool $isNew = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\AttributeChoiceValueDTO $midocoSystemAttributeChoiceValue
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\SaveMidocoAttributeChoiceValueRequest
     */
