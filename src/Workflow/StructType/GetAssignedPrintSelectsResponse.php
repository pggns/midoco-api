...
class GetAssignedPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAssignedPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Workflow\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Workflow\StructType\GetAssignedPrintSelectsResponse
     */
