...
class GetAssignedSystemRulesToOrgunitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset[]
     */
     ...
     * @return \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset[]
     */
    ...
    public static function validateMidocoUnitRulesetForArrayConstraintsFromSetMidocoUnitRuleset(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedSystemRulesToOrgunitResponseMidocoUnitRulesetItem) {
            ...
            if (!$getAssignedSystemRulesToOrgunitResponseMidocoUnitRulesetItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUnitRuleset property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset[] $midocoUnitRuleset
     * @return \Pggns\MidocoApi\Workflow\StructType\GetAssignedSystemRulesToOrgunitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset $item
     * @return \Pggns\MidocoApi\Workflow\StructType\GetAssignedSystemRulesToOrgunitResponse
     */
    public function addToMidocoUnitRuleset(\Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset) {
            throw new InvalidArgumentException(sprintf('The MidocoUnitRuleset property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\MidocoUnitRuleset, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
