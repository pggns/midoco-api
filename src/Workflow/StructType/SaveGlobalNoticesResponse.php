...
class SaveGlobalNoticesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoGlobalNoticeForArrayConstraintsFromSetMidocoGlobalNotice(?array $values = []): string
    {
        ...
        foreach ($values as $saveGlobalNoticesResponseMidocoGlobalNoticeItem) {
            ...
            if (!$saveGlobalNoticesResponseMidocoGlobalNoticeItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\MidocoGlobalNotice) {
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoGlobalNotice[] $midocoGlobalNotice
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\SaveGlobalNoticesResponse
     */
