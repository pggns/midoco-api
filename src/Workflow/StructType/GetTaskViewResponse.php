...
class GetTaskViewResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTaskViewForArrayConstraintsFromSetMidocoTaskView(?array $values = []): string
    {
        ...
        foreach ($values as $getTaskViewResponseMidocoTaskViewItem) {
            ...
            if (!$getTaskViewResponseMidocoTaskViewItem instanceof \Pggns\MidocoApi\Api\Workflow\StructType\MidocoTaskView) {
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoTaskView[] $midocoTaskView
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetTaskViewResponse
     */
