...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Workflow\StructType\GetUserWithCrsExpedientResponse
     */
