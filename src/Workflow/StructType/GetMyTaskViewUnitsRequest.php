...
/**
 * This class stands for GetMyTaskViewUnitsRequest StructType
 * @subpackage Structs
 */
class GetMyTaskViewUnitsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetMyTaskViewUnitsRequest
     * @uses GetMyTaskViewUnitsRequest::setMidocoTaskViewUser()
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoTaskViewUser $midocoTaskViewUser
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetMyTaskViewUnitsRequest
     */
