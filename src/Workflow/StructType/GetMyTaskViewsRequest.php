...
/**
 * This class stands for GetMyTaskViewsRequest StructType
 * @subpackage Structs
 */
class GetMyTaskViewsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetMyTaskViewsRequest
     * @uses GetMyTaskViewsRequest::setMidocoTaskViewUser()
     ...
     * @param \Pggns\MidocoApi\Api\Workflow\StructType\MidocoTaskViewUser $midocoTaskViewUser
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\GetMyTaskViewsRequest
     */
