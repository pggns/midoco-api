...
class ListPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $listPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$listPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Workflow\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Workflow\StructType\ListPrintSelectsResponse
     */
