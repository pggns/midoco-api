...
/**
 * This class stands for ListRuleCriteriaCrmAttributeRequest StructType
 * @subpackage Structs
 */
class ListRuleCriteriaCrmAttributeRequest extends AbstractStructBase
{
    /**
     * The unitName
    ...
    /**
     * Constructor method for ListRuleCriteriaCrmAttributeRequest
     * @uses ListRuleCriteriaCrmAttributeRequest::setUnitName()
     * @uses ListRuleCriteriaCrmAttributeRequest::setCriteriaId()
     ...
     * Set unitName value
     * @param string $unitName
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\ListRuleCriteriaCrmAttributeRequest
     */
