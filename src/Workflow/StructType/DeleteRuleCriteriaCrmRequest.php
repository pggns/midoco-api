...
/**
 * This class stands for DeleteRuleCriteriaCrmRequest StructType
 * @subpackage Structs
 */
class DeleteRuleCriteriaCrmRequest extends AbstractStructBase
{
    /**
     * The unitName
    ...
    /**
     * Constructor method for DeleteRuleCriteriaCrmRequest
     * @uses DeleteRuleCriteriaCrmRequest::setUnitName()
     * @uses DeleteRuleCriteriaCrmRequest::setCriteriaId()
     ...
     * Set unitName value
     * @param string $unitName
     * @return \Pggns\MidocoApi\Api\Workflow\StructType\DeleteRuleCriteriaCrmRequest
     */
