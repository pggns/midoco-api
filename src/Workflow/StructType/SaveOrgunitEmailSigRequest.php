...
class SaveOrgunitEmailSigRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintsFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $saveOrgunitEmailSigRequestMidocoOrgunitEmailSigItem) {
            ...
            if (!$saveOrgunitEmailSigRequestMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\Workflow\StructType\OrgunitEmailSigDTO) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\Workflow\StructType\SaveOrgunitEmailSigRequest
     */
