...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Workflow\StructType\GetUserWithCrsExpedientRequest
     */
