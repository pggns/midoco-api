...
/**
 * This class stands for DeleteMisReportParamRequest StructType
 * @subpackage Structs
 */
class DeleteMisReportParamRequest extends AbstractStructBase
{
    /**
     * The reportId
    ...
    /**
     * Constructor method for DeleteMisReportParamRequest
     * @uses DeleteMisReportParamRequest::setReportId()
     * @uses DeleteMisReportParamRequest::setParameterId()
     * @param int $reportId
     ...
     * Set reportId value
     * @param int $reportId
     * @return \Pggns\MidocoApi\Api\Mis\StructType\DeleteMisReportParamRequest
     */
