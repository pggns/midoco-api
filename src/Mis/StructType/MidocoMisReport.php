...
class MidocoMisReport extends MisReportDTO
{
     ...
     * - minOccurs: 0
     * - ref: MidocoMisCube
     * @var \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube|null
     */
    protected ?\Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube $MidocoMisCube = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube $midocoMisCube
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MisDimensionDTO[] $midocoMisDimension
     */
    public function __construct(?array $midocoMisReportParam = null, ?\Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube $midocoMisCube = null, ?array $midocoMisDimension = null)
    {
        $this
    ...
    public static function validateMidocoMisReportParamForArrayConstraintsFromSetMidocoMisReportParam(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMisReportMidocoMisReportParamItem) {
            ...
            if (!$midocoMisReportMidocoMisReportParamItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReportParam) {
     ...
     * @return \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube|null
     */
    public function getMidocoMisCube(): ?\Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube
    {
     ...
     * @return \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReport
     */
    public function setMidocoMisCube(?\Pggns\MidocoApi\Api\Mis\StructType\MidocoMisCube $midocoMisCube = null): self
    {
    ...
    public static function validateMidocoMisDimensionForArrayConstraintsFromSetMidocoMisDimension(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMisReportMidocoMisDimensionItem) {
            // validation for constraint: itemType
            if (!$midocoMisReportMidocoMisDimensionItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MisDimensionDTO) {
