...
class GetOrgunitDatastoresResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem) {
            ...
            if (!$getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Mis\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Mis\StructType\GetOrgunitDatastoresResponse
     */
