...
/**
 * This class stands for GetReportWithSameParamRequest StructType
 * @subpackage Structs
 */
class GetReportWithSameParamRequest extends AbstractStructBase
{
    /**
     * The reportId
     * @var int|null
    ...
    /**
     * Constructor method for GetReportWithSameParamRequest
     * @uses GetReportWithSameParamRequest::setReportId()
     * @param int $reportId
     */
     ...
     * Set reportId value
     * @param int $reportId
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetReportWithSameParamRequest
     */
