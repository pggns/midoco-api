...
class GetAttributeDefinitions4UserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeDefinitionForArrayConstraintsFromSetMidocoAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getAttributeDefinitions4UserResponseMidocoAttributeDefinitionItem) {
            ...
            if (!$getAttributeDefinitions4UserResponseMidocoAttributeDefinitionItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\AttributeDefinitionType) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\AttributeDefinitionType[] $midocoAttributeDefinition
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAttributeDefinitions4UserResponse
     */
