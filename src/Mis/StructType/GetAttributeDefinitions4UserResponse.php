...
class GetAttributeDefinitions4UserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeDefinitionForArrayConstraintFromSetMidocoAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getAttributeDefinitions4UserResponseMidocoAttributeDefinitionItem) {
            ...
            if (!$getAttributeDefinitions4UserResponseMidocoAttributeDefinitionItem instanceof \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionType) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionType[] $midocoAttributeDefinition
     * @return \Pggns\MidocoApi\Mis\StructType\GetAttributeDefinitions4UserResponse
     */
