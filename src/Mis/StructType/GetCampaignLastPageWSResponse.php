...
class GetCampaignLastPageWSResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMisCampaignResultWSForArrayConstraintsFromSetMidocoMisCampaignResultWS(?array $values = []): string
    {
        ...
        foreach ($values as $getCampaignLastPageWSResponseMidocoMisCampaignResultWSItem) {
            ...
            if (!$getCampaignLastPageWSResponseMidocoMisCampaignResultWSItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MisCampaignResultWSType) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MisCampaignResultWSType[] $midocoMisCampaignResultWS
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetCampaignLastPageWSResponse
     */
    ...
    public static function validateMidocoMisCustomerResultForArrayConstraintsFromSetMidocoMisCustomerResult(?array $values = []): string
    {
        ...
        foreach ($values as $getCampaignLastPageWSResponseMidocoMisCustomerResultItem) {
            // validation for constraint: itemType
            if (!$getCampaignLastPageWSResponseMidocoMisCustomerResultItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MisCustomerResultDTO) {
