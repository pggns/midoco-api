...
class SearchMidocoAttributeLocalizationResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO[]
     */
    ...
    public static function validateMidocoSystemAttributeLocalizationForArrayConstraintFromSetMidocoSystemAttributeLocalization(?array $values = []): string
    {
        ...
        foreach ($values as $searchMidocoAttributeLocalizationResponseMidocoSystemAttributeLocalizationItem) {
            ...
            if (!$searchMidocoAttributeLocalizationResponseMidocoSystemAttributeLocalizationItem instanceof \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSystemAttributeLocalization property can only contain items of type \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO[] $midocoSystemAttributeLocalization
     * @return \Pggns\MidocoApi\Mis\StructType\SearchMidocoAttributeLocalizationResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO $item
     * @return \Pggns\MidocoApi\Mis\StructType\SearchMidocoAttributeLocalizationResponse
     */
    public function addToMidocoSystemAttributeLocalization(\Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSystemAttributeLocalization property can only contain items of type \Pggns\MidocoApi\Mis\StructType\AttributeDefinitionLocalDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
