...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Mis\StructType\RefreshTssClientStateRequest
     */
