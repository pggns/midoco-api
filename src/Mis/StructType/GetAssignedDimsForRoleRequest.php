...
/**
 * This class stands for GetAssignedDimsForRoleRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetAssignedDimsForRoleRequest extends AbstractStructBase
{
    /**
     * The orgUnit
     * @var string|null
    ...
    /**
     * Constructor method for GetAssignedDimsForRoleRequest
     * @uses GetAssignedDimsForRoleRequest::setOrgUnit()
     * @uses GetAssignedDimsForRoleRequest::setRoleId()
