...
class GetMidocoOrgUnitGuiAttributeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute[] $midocoOrgunitGuiAttribute
     */
     ...
     * @return \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute[]
     */
    ...
    public static function validateMidocoOrgunitGuiAttributeForArrayConstraintFromSetMidocoOrgunitGuiAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoOrgUnitGuiAttributeResponseMidocoOrgunitGuiAttributeItem) {
            ...
            if (!$getMidocoOrgUnitGuiAttributeResponseMidocoOrgunitGuiAttributeItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitGuiAttribute property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute[] $midocoOrgunitGuiAttribute
     * @return \Pggns\MidocoApi\Mis\StructType\GetMidocoOrgUnitGuiAttributeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute $item
     * @return \Pggns\MidocoApi\Mis\StructType\GetMidocoOrgUnitGuiAttributeResponse
     */
    public function addToMidocoOrgunitGuiAttribute(\Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitGuiAttribute property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoOrgunitGuiAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
