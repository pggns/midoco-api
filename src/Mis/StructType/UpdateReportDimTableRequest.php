...
/**
 * This class stands for UpdateReportDimTableRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdateReportDimTableRequest extends AbstractStructBase
{
    /**
     * The reportId
     * @var int|null
    ...
    /**
     * Constructor method for UpdateReportDimTableRequest
     * @uses UpdateReportDimTableRequest::setReportId()
     * @param int $reportId
     */
