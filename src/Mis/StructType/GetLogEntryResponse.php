...
class GetLogEntryResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoLogEntryForArrayConstraintsFromSetMidocoLogEntry(?array $values = []): string
    {
        ...
        foreach ($values as $getLogEntryResponseMidocoLogEntryItem) {
            ...
            if (!$getLogEntryResponseMidocoLogEntryItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\LogentryDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\LogentryDTO[] $midocoLogEntry
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetLogEntryResponse
     */
