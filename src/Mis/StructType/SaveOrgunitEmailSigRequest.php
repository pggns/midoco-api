...
class SaveOrgunitEmailSigRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $saveOrgunitEmailSigRequestMidocoOrgunitEmailSigItem) {
            ...
            if (!$saveOrgunitEmailSigRequestMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\Mis\StructType\OrgunitEmailSigDTO) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\Mis\StructType\SaveOrgunitEmailSigRequest
     */
