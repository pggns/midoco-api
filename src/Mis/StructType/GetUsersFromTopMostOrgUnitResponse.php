...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Mis\StructType\GetUsersFromTopMostOrgUnitResponse
     */
