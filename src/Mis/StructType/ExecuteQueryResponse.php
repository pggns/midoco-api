...
class ExecuteQueryResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMisCampaignResultForArrayConstraintFromSetMidocoMisCampaignResult(?array $values = []): string
    {
        ...
        foreach ($values as $executeQueryResponseMidocoMisCampaignResultItem) {
            ...
            if (!$executeQueryResponseMidocoMisCampaignResultItem instanceof \Pggns\MidocoApi\Mis\StructType\MisCampaignResultDTO) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MisCampaignResultDTO[] $midocoMisCampaignResult
     * @return \Pggns\MidocoApi\Mis\StructType\ExecuteQueryResponse
     */
    ...
    public static function validateMidocoMisCustomerResultForArrayConstraintFromSetMidocoMisCustomerResult(?array $values = []): string
    {
        ...
        foreach ($values as $executeQueryResponseMidocoMisCustomerResultItem) {
            // validation for constraint: itemType
            if (!$executeQueryResponseMidocoMisCustomerResultItem instanceof \Pggns\MidocoApi\Mis\StructType\MisCustomerResultDTO) {
