 ...
 * - documentation: executeQuery --- executes a query on the MIS db
 * @subpackage Structs
 */
class ExecuteQueryResponse extends AbstractStructBase
{
     ...
     * @uses ExecuteQueryResponse::setMidocoMisCampaignResult()
     * @uses ExecuteQueryResponse::setMidocoMisCustomerResult()
     * @uses ExecuteQueryResponse::setMidocoMisCampaign()
    ...
    public static function validateMidocoMisCampaignResultForArrayConstraintsFromSetMidocoMisCampaignResult(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $executeQueryResponseMidocoMisCampaignResultItem) {
            // validation for constraint: itemType
            if (!$executeQueryResponseMidocoMisCampaignResultItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MisCampaignResultDTO) {
                $invalidValues[] = is_object($executeQueryResponseMidocoMisCampaignResultItem) ? get_class($executeQueryResponseMidocoMisCampaignResultItem) : sprintf('%s(%s)', gettype($executeQueryResponseMidocoMisCampaignResultItem), var_export($executeQueryResponseMidocoMisCampaignResultItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MisCampaignResultDTO[] $midocoMisCampaignResult
     * @return \Pggns\MidocoApi\Api\Mis\StructType\ExecuteQueryResponse
     */
    ...
    public static function validateMidocoMisCustomerResultForArrayConstraintsFromSetMidocoMisCustomerResult(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $executeQueryResponseMidocoMisCustomerResultItem) {
            // validation for constraint: itemType
            if (!$executeQueryResponseMidocoMisCustomerResultItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MisCustomerResultDTO) {
                $invalidValues[] = is_object($executeQueryResponseMidocoMisCustomerResultItem) ? get_class($executeQueryResponseMidocoMisCustomerResultItem) : sprintf('%s(%s)', gettype($executeQueryResponseMidocoMisCustomerResultItem), var_export($executeQueryResponseMidocoMisCustomerResultItem, true));
            }
        }
        if (!empty($invalidValues)) {
