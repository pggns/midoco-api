...
/**
 * This class stands for SavedCreationDateDimDTO StructType
 * @subpackage Structs
 */
class SavedCreationDateDimDTO extends AbstractStructBase
{
    /**
     * The creationDateId
     * @var int|null
    ...
    /**
     * Constructor method for SavedCreationDateDimDTO
     * @uses SavedCreationDateDimDTO::setCreationDateId()
     * @uses SavedCreationDateDimDTO::setDatabaseDate()
     * @uses SavedCreationDateDimDTO::setDayNoInMonth()
     * @uses SavedCreationDateDimDTO::setDayOfWeek()
     * @uses SavedCreationDateDimDTO::setMonth()
     * @uses SavedCreationDateDimDTO::setQuarter()
     * @uses SavedCreationDateDimDTO::setWeekNoInYear()
     * @uses SavedCreationDateDimDTO::setWeekend()
     * @uses SavedCreationDateDimDTO::setYear()
     ...
     * @param int $year
     */
    public function __construct(?int $creationDateId = null, ?string $databaseDate = null, ?int $dayNoInMonth = null, ?string $dayOfWeek = null, ?int $month = null, ?int $quarter = null, ?int $weekNoInYear = null, ?bool $weekend = null, ?int $year = null)
    {
        $this
