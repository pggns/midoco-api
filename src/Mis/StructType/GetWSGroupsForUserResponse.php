...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Mis\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Mis\StructType\GetWSGroupsForUserResponse
     */
