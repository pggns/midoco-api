...
class GetCampaignNextPageWSResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMisCampaignResultWSForArrayConstraintFromSetMidocoMisCampaignResultWS(?array $values = []): string
    {
        ...
        foreach ($values as $getCampaignNextPageWSResponseMidocoMisCampaignResultWSItem) {
            ...
            if (!$getCampaignNextPageWSResponseMidocoMisCampaignResultWSItem instanceof \Pggns\MidocoApi\Mis\StructType\MisCampaignResultWSType) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MisCampaignResultWSType[] $midocoMisCampaignResultWS
     * @return \Pggns\MidocoApi\Mis\StructType\GetCampaignNextPageWSResponse
     */
    ...
    public static function validateMidocoMisCustomerResultForArrayConstraintFromSetMidocoMisCustomerResult(?array $values = []): string
    {
        ...
        foreach ($values as $getCampaignNextPageWSResponseMidocoMisCustomerResultItem) {
            // validation for constraint: itemType
            if (!$getCampaignNextPageWSResponseMidocoMisCustomerResultItem instanceof \Pggns\MidocoApi\Mis\StructType\MisCustomerResultDTO) {
