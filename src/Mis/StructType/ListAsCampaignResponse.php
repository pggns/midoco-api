...
/**
 * This class stands for ListAsCampaignResponse StructType
 * @subpackage Structs
 */
class ListAsCampaignResponse extends AbstractStructBase
{
    /**
     * The campaignId
     * @var int|null
    ...
    /**
     * Constructor method for ListAsCampaignResponse
     * @uses ListAsCampaignResponse::setCampaignId()
