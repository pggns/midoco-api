...
class GetAssignedPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAssignedPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAssignedPrintSelectsResponse
     */
