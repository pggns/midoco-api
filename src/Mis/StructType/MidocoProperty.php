...
class MidocoProperty extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass[]
     */
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass[] $midocoVisibleClass
    ...
    public static function validateMidocoVisibleClassForArrayConstraintFromSetMidocoVisibleClass(?array $values = []): string
    {
        ...
        foreach ($values as $midocoPropertyMidocoVisibleClassItem) {
            ...
            if (!$midocoPropertyMidocoVisibleClassItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVisibleClass property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass[] $midocoVisibleClass
     * @return \Pggns\MidocoApi\Mis\StructType\MidocoProperty
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass $item
     * @return \Pggns\MidocoApi\Mis\StructType\MidocoProperty
     */
    public function addToMidocoVisibleClass(\Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass) {
            throw new InvalidArgumentException(sprintf('The MidocoVisibleClass property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoVisibleClass, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
