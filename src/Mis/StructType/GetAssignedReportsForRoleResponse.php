...
class GetAssignedReportsForRoleResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMisReportForArrayConstraintsFromSetMidocoMisReport(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedReportsForRoleResponseMidocoMisReportItem) {
            ...
            if (!$getAssignedReportsForRoleResponseMidocoMisReportItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReport) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReport[] $midocoMisReport
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAssignedReportsForRoleResponse
     */
