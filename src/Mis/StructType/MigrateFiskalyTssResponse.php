...
class MigrateFiskalyTssResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Mis\StructType\Tss_Migration_Summary $migration_Summary = null, ?array $migration_Log = null, ?\Pggns\MidocoApi\Mis\StructType\Unprocessed_Units $unprocessed_Units = null)
    {
        $this
