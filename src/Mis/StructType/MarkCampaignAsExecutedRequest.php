...
class MarkCampaignAsExecutedRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for MarkCampaignAsExecutedRequest
     * @uses MarkCampaignAsExecutedRequest::setCampaignId()
     ...
     * @param int $campaignId
     * @return \Pggns\MidocoApi\Api\Mis\StructType\MarkCampaignAsExecutedRequest
     */
