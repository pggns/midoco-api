...
class GetAllReportsForRoleResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMisReportForArrayConstraintsFromSetMidocoMisReport(?array $values = []): string
    {
        ...
        foreach ($values as $getAllReportsForRoleResponseMidocoMisReportItem) {
            ...
            if (!$getAllReportsForRoleResponseMidocoMisReportItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReport) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MidocoMisReport[] $midocoMisReport
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAllReportsForRoleResponse
     */
