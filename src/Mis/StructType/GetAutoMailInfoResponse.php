...
class GetAutoMailInfoResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO[] $midocoAutoMailInfo
     */
    ...
    public static function validateMidocoAutoMailInfoForArrayConstraintsFromSetMidocoAutoMailInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getAutoMailInfoResponseMidocoAutoMailInfoItem) {
            ...
            if (!$getAutoMailInfoResponseMidocoAutoMailInfoItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAutoMailInfo property can only contain items of type \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO[] $midocoAutoMailInfo
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAutoMailInfoResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO $item
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetAutoMailInfoResponse
     */
    public function addToMidocoAutoMailInfo(\Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAutoMailInfo property can only contain items of type \Pggns\MidocoApi\Api\Mis\StructType\AutoMailDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
