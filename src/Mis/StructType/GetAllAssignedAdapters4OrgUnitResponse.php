...
class GetAllAssignedAdapters4OrgUnitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO[] $midocoAdapterAssign
     */
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem) {
            ...
            if (!$getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Mis\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
     ...
     * @return \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO[]
     */
    ...
    public static function validateMidocoAdapterAssignForArrayConstraintFromSetMidocoAdapterAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedAdapters4OrgUnitResponseMidocoAdapterAssignItem) {
            // validation for constraint: itemType
            if (!$getAllAssignedAdapters4OrgUnitResponseMidocoAdapterAssignItem instanceof \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdapterAssign property can only contain items of type \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO $item
     * @return \Pggns\MidocoApi\Mis\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
    public function addToMidocoAdapterAssign(\Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAdapterAssign property can only contain items of type \Pggns\MidocoApi\Mis\StructType\AdapterAssignDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
