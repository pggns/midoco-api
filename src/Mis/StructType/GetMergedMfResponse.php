...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\Mis\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\Mis\StructType\GetMergedMfResponse
     */
