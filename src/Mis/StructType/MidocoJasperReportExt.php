...
class MidocoJasperReportExt extends JasperReportDTO
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec[]
     */
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec[] $midocoJasperReportParamForExec
     */
    ...
    public static function validateMidocoJasperReportParamForExecForArrayConstraintFromSetMidocoJasperReportParamForExec(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperReportExtMidocoJasperReportParamForExecItem) {
            ...
            if (!$midocoJasperReportExtMidocoJasperReportParamForExecItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoJasperReportParamForExec property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec $item
     * @return \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportExt
     */
    public function addToMidocoJasperReportParamForExec(\Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec) {
            throw new InvalidArgumentException(sprintf('The MidocoJasperReportParamForExec property can only contain items of type \Pggns\MidocoApi\Mis\StructType\MidocoJasperReportParamForExec, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
