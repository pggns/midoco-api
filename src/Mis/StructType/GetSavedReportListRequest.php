...
/**
 * This class stands for GetSavedReportListRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetSavedReportListRequest extends AbstractStructBase
{
    /**
     * The versionId
     * @var int|null
    ...
    /**
     * Constructor method for GetSavedReportListRequest
     * @uses GetSavedReportListRequest::setVersionId()
     * @uses GetSavedReportListRequest::setReportId()
     * @param int $versionId
     * @param int $reportId
     */
