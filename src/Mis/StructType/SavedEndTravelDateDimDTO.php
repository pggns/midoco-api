...
/**
 * This class stands for SavedEndTravelDateDimDTO StructType
 * @subpackage Structs
 */
class SavedEndTravelDateDimDTO extends AbstractStructBase
{
    /**
     * The databaseDate
     * @var string|null
    ...
    /**
     * Constructor method for SavedEndTravelDateDimDTO
     * @uses SavedEndTravelDateDimDTO::setDatabaseDate()
     * @uses SavedEndTravelDateDimDTO::setDayNoInMonth()
     * @uses SavedEndTravelDateDimDTO::setDayOfWeek()
     * @uses SavedEndTravelDateDimDTO::setEndTravelDateId()
     * @uses SavedEndTravelDateDimDTO::setMonth()
     * @uses SavedEndTravelDateDimDTO::setQuarter()
     * @uses SavedEndTravelDateDimDTO::setWeekNoInYear()
     * @uses SavedEndTravelDateDimDTO::setWeekend()
     * @uses SavedEndTravelDateDimDTO::setYear()
     ...
     * @param int $year
     */
    public function __construct(?string $databaseDate = null, ?int $dayNoInMonth = null, ?string $dayOfWeek = null, ?int $endTravelDateId = null, ?int $month = null, ?int $quarter = null, ?int $weekNoInYear = null, ?bool $weekend = null, ?int $year = null)
    {
        $this
     ...
     * @param string $databaseDate
     * @return \Pggns\MidocoApi\Api\Mis\StructType\SavedEndTravelDateDimDTO
     */
