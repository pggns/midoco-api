...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\Mis\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Mis\StructType\GetUserWithCrsExpedientResponse
     */
