...
/**
 * This class stands for MisContactSourceDTO StructType
 * @subpackage Structs
 */
class MisContactSourceDTO extends AbstractStructBase
{
    /**
     * The contactId
     * @var int|null
    ...
    /**
     * Constructor method for MisContactSourceDTO
     * @uses MisContactSourceDTO::setContactId()
     * @uses MisContactSourceDTO::setMailingProhibited()
     * @uses MisContactSourceDTO::setSourceId()
     * @param int $contactId
     ...
     * Set contactId value
     * @param int $contactId
     * @return \Pggns\MidocoApi\Api\Mis\StructType\MisContactSourceDTO
     */
