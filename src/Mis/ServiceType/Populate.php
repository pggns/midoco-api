...
class Populate extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Mis\ServiceType\Populate
     */
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\PopulateMisTimeTablesRequest $paramPopulateMisTimeTablesRequest
     * @return \Pggns\MidocoApi\Api\Mis\StructType\PopulateMisTimeTablesResponse|bool
     */
    public function populateMisTimeTables(\Pggns\MidocoApi\Api\Mis\StructType\PopulateMisTimeTablesRequest $paramPopulateMisTimeTablesRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Mis\StructType\PopulateMisTimeTablesResponse
     */
