...
class Fill extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Mis\ServiceType\Fill
     */
     ...
     * @param \Pggns\MidocoApi\Api\Mis\StructType\FillJasperReportRequest $paramFillJasperReportRequest
     * @return \Pggns\MidocoApi\Api\Mis\StructType\FillJasperReportResponse|bool
     */
    public function fillJasperReport(\Pggns\MidocoApi\Api\Mis\StructType\FillJasperReportRequest $paramFillJasperReportRequest)
    {
        try {
