...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\RefreshTssClientStateRequest
     */
