...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoTssClient
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient[]
     */
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTssClient property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetAllTssClients4UnitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetAllTssClients4UnitResponse
     */
    public function addToMidocoTssClient(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient) {
            throw new InvalidArgumentException(sprintf('The MidocoTssClient property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
