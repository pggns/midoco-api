...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoWsGroup
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO[] $midocoWsGroup
     */
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO[]
     */
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoWsGroup property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetWSGroupsForUserResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetWSGroupsForUserResponse
     */
    public function addToMidocoWsGroup(\Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoWsGroup property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
