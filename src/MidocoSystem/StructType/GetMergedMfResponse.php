...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetMergedMfResponse
     */
