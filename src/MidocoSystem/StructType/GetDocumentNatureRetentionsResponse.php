...
class GetDocumentNatureRetentionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType[]
     */
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType[]
     */
    ...
    public static function validateMidocoDocumentNatureRetentionForArrayConstraintFromSetMidocoDocumentNatureRetention(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNatureRetentionsResponseMidocoDocumentNatureRetentionItem) {
            ...
            if (!$getDocumentNatureRetentionsResponseMidocoDocumentNatureRetentionItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNatureRetention property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType[] $midocoDocumentNatureRetention
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetDocumentNatureRetentionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetDocumentNatureRetentionsResponse
     */
    public function addToMidocoDocumentNatureRetention(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNatureRetention property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoDocumentNatureRetentionType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
