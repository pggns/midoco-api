...
class GetPrintjobListResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoPrintjob
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO[]
     */
    ...
    public static function validateMidocoPrintjobForArrayConstraintFromSetMidocoPrintjob(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintjobListResponseMidocoPrintjobItem) {
            ...
            if (!$getPrintjobListResponseMidocoPrintjobItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintjob property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO[] $midocoPrintjob
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetPrintjobListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetPrintjobListResponse
     */
    public function addToMidocoPrintjob(\Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintjob property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\PrintjobDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
