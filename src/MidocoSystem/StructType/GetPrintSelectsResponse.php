...
class GetPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintSelectForArrayConstraintFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetPrintSelectsResponse
     */
