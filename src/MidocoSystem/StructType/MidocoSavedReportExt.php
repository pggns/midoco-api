...
class MidocoSavedReportExt extends JasperReportDTO
{
     ...
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType[]
     */
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType[] $jasperReportType
     */
    ...
    public static function validateJasperReportTypeForArrayConstraintFromSetJasperReportType(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSavedReportExtJasperReportTypeItem) {
            ...
            if (!$midocoSavedReportExtJasperReportTypeItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The JasperReportType property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType[] $jasperReportType
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoSavedReportExt
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoSavedReportExt
     */
    public function addToJasperReportType(\Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType) {
            throw new InvalidArgumentException(sprintf('The JasperReportType property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\JasperReportType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
