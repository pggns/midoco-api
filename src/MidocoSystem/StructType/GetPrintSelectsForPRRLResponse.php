...
class GetPrintSelectsForPRRLResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect[]
     */
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect[] $midocoPrintSelect
     */
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect[]
     */
    ...
    public static function validateMidocoPrintSelectForArrayConstraintFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsForPRRLResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsForPRRLResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetPrintSelectsForPRRLResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetPrintSelectsForPRRLResponse
     */
    public function addToMidocoPrintSelect(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintSelect, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
