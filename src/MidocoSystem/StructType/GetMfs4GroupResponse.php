...
class GetMfs4GroupResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfs4GroupResponseMidocoMfItem) {
            ...
            if (!$getMfs4GroupResponseMidocoMfItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetMfs4GroupResponse
     */
