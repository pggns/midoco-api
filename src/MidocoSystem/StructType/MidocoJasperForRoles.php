...
class MidocoJasperForRoles extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport[]
     */
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport[] $midocoJasperReport
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport[] $midocoAccessJasperReport
     */
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport[]
     */
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperForRolesMidocoJasperReportItem) {
            ...
            if (!$midocoJasperForRolesMidocoJasperReportItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoJasperReport property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperForRoles
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperForRoles
     */
    public function addToMidocoJasperReport(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport) {
            throw new InvalidArgumentException(sprintf('The MidocoJasperReport property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport[]
     */
    ...
    public static function validateMidocoAccessJasperReportForArrayConstraintFromSetMidocoAccessJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperForRolesMidocoAccessJasperReportItem) {
            // validation for constraint: itemType
            if (!$midocoJasperForRolesMidocoAccessJasperReportItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAccessJasperReport property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperForRoles
     */
    public function addToMidocoAccessJasperReport(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport) {
            throw new InvalidArgumentException(sprintf('The MidocoAccessJasperReport property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAccessJasperReport, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
