...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetUserWithCrsExpedientRequest
     */
