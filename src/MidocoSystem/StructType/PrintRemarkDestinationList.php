...
class PrintRemarkDestinationList extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRemarkDestinationForArrayConstraintFromSetMidocoPrintRemarkDestination(?array $values = []): string
    {
        ...
        foreach ($values as $printRemarkDestinationListMidocoPrintRemarkDestinationItem) {
            ...
            if (!$printRemarkDestinationListMidocoPrintRemarkDestinationItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintRemarkDestination) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\PrintRemarkDestinationList
     */
