...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetWSGroupsResponse
     */
