...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\RefreshTssClientStateResponse
     */
