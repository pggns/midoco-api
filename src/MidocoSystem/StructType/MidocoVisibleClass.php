...
class MidocoVisibleClass extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute[]
     */
    ...
    public static function validateMidocoPropertyAttributeForArrayConstraintFromSetMidocoPropertyAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVisibleClassMidocoPropertyAttributeItem) {
            ...
            if (!$midocoVisibleClassMidocoPropertyAttributeItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoVisibleClass
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute $item
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoVisibleClass
     */
    public function addToMidocoPropertyAttribute(\Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\MidocoSystem\StructType\MidocoPropertyAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
