...
class CreateCcProxySingleUseTokenRequest extends AbstractStructBase
{
    ...
    /**
     * The emailData
     * @var \Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO|null
     */
    protected ?\Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO $emailData = null;
    /**
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO $emailData
     */
    public function __construct(?string $token = null, ?string $tokenValue = null, ?string $sensitiveId = null, ?int $lifespanInSeconds = null, ?int $userId = null, ?string $orgUnit = null, ?\Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO $emailData = null)
    {
        $this
            ->setToken($token)
     ...
     * Set token value
     * @param string $token
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\CreateCcProxySingleUseTokenRequest
     */
    ...
    /**
     * Get emailData value
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO|null
     */
    public function getEmailData(): ?\Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO
    {
     ...
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\CreateCcProxySingleUseTokenRequest
     */
    public function setEmailData(?\Pggns\MidocoApi\MidocoSystem\StructType\CcProxyEmailDataDTO $emailData = null): self
    {
