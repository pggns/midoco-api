...
class SaveVerkDataPrintRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoVerkDataPrintForArrayConstraintFromSetMidocoVerkDataPrint(?array $values = []): string
    {
        ...
        foreach ($values as $saveVerkDataPrintRequestMidocoVerkDataPrintItem) {
            ...
            if (!$saveVerkDataPrintRequestMidocoVerkDataPrintItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\VerkDataPrintDTO) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\VerkDataPrintDTO[] $midocoVerkDataPrint
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\SaveVerkDataPrintRequest
     */
