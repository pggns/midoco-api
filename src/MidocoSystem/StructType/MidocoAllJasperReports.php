...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\MidocoAllJasperReports
     */
