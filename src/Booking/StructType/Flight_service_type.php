...
class Flight_service_type extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request[] $special_service_request
    ...
    public static function validateMealForArrayConstraintsFromSetMeal(?array $values = []): string
    {
        ...
        foreach ($values as $flight_service_typeMealItem) {
            ...
            if (!$flight_service_typeMealItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\FlightMealType) {
    ...
    public static function validateSeatForArrayConstraintsFromSetSeat(?array $values = []): string
    {
        ...
        foreach ($values as $flight_service_typeSeatItem) {
            // validation for constraint: itemType
            if (!$flight_service_typeSeatItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\FlightSeatType) {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request[]
     */
    ...
    public static function validateSpecial_service_requestForArrayConstraintsFromSetSpecial_service_request(?array $values = []): string
    {
        ...
        foreach ($values as $flight_service_typeSpecial_service_requestItem) {
            // validation for constraint: itemType
            if (!$flight_service_typeSpecial_service_requestItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The special_service_request property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Flight_service_type
     */
    public function addToSpecial_service_request(\Pggns\MidocoApi\Api\Booking\StructType\Special_service_request $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request) {
            throw new InvalidArgumentException(sprintf('The special_service_request property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Special_service_request, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
