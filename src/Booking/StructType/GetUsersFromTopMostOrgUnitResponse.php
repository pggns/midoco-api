...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Booking\StructType\GetUsersFromTopMostOrgUnitResponse
     */
