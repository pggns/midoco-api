...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Booking\StructType\RefreshTssClientStateRequest
     */
