...
class Person extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos $AdditionalFlightPassengerInfos = null;
    /**
     * The AdditionalRailPassengerInfos
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: AdditionalRailPassengerInfos
     * @var \Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos $AdditionalRailPassengerInfos = null;
    /**
     * The crs_salutation
     * Meta information extracted from the WSDL
     ...
     * @var float|null
     */
    protected ?float $personPrice = null;
    /**
     * The crsSalutation
     * Meta information extracted from the WSDL
     * - documentation: original name from crs system e.g. in capital letters MEIER/JOE MR
     ...
     * @var string|null
     */
    protected ?string $crsSalutation = null;
    /**
     * The crsName
     * Meta information extracted from the WSDL
     * - documentation: original salutation from crs system e.g. MRS/MRS in foreign language
     ...
     * @uses Person::setPersonPrice()
     * @uses Person::setCrsSalutation()
     * @uses Person::setCrsName()
     * @param int $position
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos
     * @param \Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos
     ...
     */
    public function __construct(int $position, ?string $salutation = null, ?string $title = null, ?string $forename = null, ?string $middleName = null, ?string $name = null, ?string $birthday = null, ?int $age = null, ?float $person_price = null, ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null, ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null, ?string $crs_salutation = null, ?string $crs_name = null, ?string $nationality = null, ?float $personPrice = null, ?string $crsSalutation = null, ?string $crsName = null)
    {
        $this
            ...
            ->setCrsSalutation($crsSalutation)
            ->setCrsName($crsName);
    }
    /**
     * Get position value
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos|null
     */
    public function getAdditionalFlightPassengerInfos(): ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Person
     */
    public function setAdditionalFlightPassengerInfos(?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos|null
     */
    public function getAdditionalRailPassengerInfos(): ?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Person
     */
    public function setAdditionalRailPassengerInfos(?\Pggns\MidocoApi\Api\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null): self
    {
    ...
    {
        // validation for constraint: float
        if (!is_null($personPrice) && !(is_float($personPrice) || is_numeric($personPrice))) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a float value, %s given', var_export($personPrice, true), gettype($personPrice)), __LINE__);
        }
    ...
    /**
     * Get crsSalutation value
     * @return string|null
     */
    public function getCrsSalutation(): ?string
    {
        return $this->crsSalutation;
    }
    /**
    ...
    {
        // validation for constraint: string
        if (!is_null($crsSalutation) && !is_string($crsSalutation)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($crsSalutation, true), gettype($crsSalutation)), __LINE__);
        }
        $this->crsSalutation = $crsSalutation;
