...
class Person extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos $AdditionalFlightPassengerInfos = null;
    /**
     * The AdditionalRailPassengerInfos
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: AdditionalRailPassengerInfos
     * @var \Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos $AdditionalRailPassengerInfos = null;
    /**
     * The crs_salutation
     * Meta information extracted from the WSDL
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos
     * @param \Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos
     ...
     */
    public function __construct(int $position, ?string $salutation = null, ?string $title = null, ?string $forename = null, ?string $middleName = null, ?string $name = null, ?string $birthday = null, ?string $gender = null, ?int $age = null, ?float $person_price = null, ?\Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null, ?\Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null, ?string $crs_salutation = null, ?string $crs_name = null, ?string $nationality = null, ?float $personPrice = null, ?string $crsSalutation = null, ?string $crsName = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos|null
     */
    public function getAdditionalFlightPassengerInfos(): ?\Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\Person
     */
    public function setAdditionalFlightPassengerInfos(?\Pggns\MidocoApi\Booking\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos|null
     */
    public function getAdditionalRailPassengerInfos(): ?\Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\Person
     */
    public function setAdditionalRailPassengerInfos(?\Pggns\MidocoApi\Booking\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null): self
    {
