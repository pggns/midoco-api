...
class GDSRemark extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\GDSRemarkSyntaxType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\GDSRemarkSyntaxType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $syntaxType
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GDSRemark
     */
    public function setSyntaxType(?string $syntaxType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\GDSRemarkSyntaxType::valueIsValid($syntaxType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\GDSRemarkSyntaxType', is_array($syntaxType) ? implode(', ', $syntaxType) : var_export($syntaxType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\GDSRemarkSyntaxType::getValidValues())), __LINE__);
        }
