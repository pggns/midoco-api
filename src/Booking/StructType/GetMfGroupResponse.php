...
class GetMfGroupResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoMfGroup
     * @var \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup[]
     */
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup[]
     */
    ...
    public static function validateMidocoMfGroupForArrayConstraintFromSetMidocoMfGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getMfGroupResponseMidocoMfGroupItem) {
            ...
            if (!$getMfGroupResponseMidocoMfGroupItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMfGroup property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup[] $midocoMfGroup
     * @return \Pggns\MidocoApi\Booking\StructType\GetMfGroupResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup $item
     * @return \Pggns\MidocoApi\Booking\StructType\GetMfGroupResponse
     */
    public function addToMidocoMfGroup(\Pggns\MidocoApi\Booking\StructType\MidocoMfGroup $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup) {
            throw new InvalidArgumentException(sprintf('The MidocoMfGroup property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoMfGroup, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
