...
class GetOrderRetentionPeriodResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderRetentionPeriodForArrayConstraintsFromSetMidocoOrderRetentionPeriod(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderRetentionPeriodResponseMidocoOrderRetentionPeriodItem) {
            ...
            if (!$getOrderRetentionPeriodResponseMidocoOrderRetentionPeriodItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderRetentionPeriod property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod[] $midocoOrderRetentionPeriod
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetOrderRetentionPeriodResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetOrderRetentionPeriodResponse
     */
    public function addToMidocoOrderRetentionPeriod(\Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderRetentionPeriod property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoOrderRetentionPeriod, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
