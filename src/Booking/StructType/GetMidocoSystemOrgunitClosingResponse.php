...
class GetMidocoSystemOrgunitClosingResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO[]
     */
    ...
    public static function validateMidocoSystemOrgunitClosingForArrayConstraintFromSetMidocoSystemOrgunitClosing(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoSystemOrgunitClosingResponseMidocoSystemOrgunitClosingItem) {
            ...
            if (!$getMidocoSystemOrgunitClosingResponseMidocoSystemOrgunitClosingItem instanceof \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSystemOrgunitClosing property can only contain items of type \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO[] $midocoSystemOrgunitClosing
     * @return \Pggns\MidocoApi\Booking\StructType\GetMidocoSystemOrgunitClosingResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO $item
     * @return \Pggns\MidocoApi\Booking\StructType\GetMidocoSystemOrgunitClosingResponse
     */
    public function addToMidocoSystemOrgunitClosing(\Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSystemOrgunitClosing property can only contain items of type \Pggns\MidocoApi\Booking\StructType\OrgunitClosingDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
