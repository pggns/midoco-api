...
class GetAssignedPrintTypeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     */
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign[]
     */
    ...
    public static function validateMidocoPrintTypeAssignForArrayConstraintsFromSetMidocoPrintTypeAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintTypeResponseMidocoPrintTypeAssignItem) {
            ...
            if (!$getAssignedPrintTypeResponseMidocoPrintTypeAssignItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetAssignedPrintTypeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetAssignedPrintTypeResponse
     */
    public function addToMidocoPrintTypeAssign(\Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoPrintTypeAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
