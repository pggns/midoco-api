...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Booking\StructType\GetAllTssClients4UnitResponse
     */
