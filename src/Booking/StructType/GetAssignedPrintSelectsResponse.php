...
class GetAssignedPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAssignedPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Booking\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Booking\StructType\GetAssignedPrintSelectsResponse
     */
