...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Booking\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Booking\StructType\GetWSGroupsResponse
     */
