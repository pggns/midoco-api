...
class FlightBooking extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: FlightSegment
     * @var \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment[]
     */
     ...
     * - minOccurs: 0
     * - ref: Ticket
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1[]
     */
     ...
     * - minOccurs: 0
     * - ref: TicketPrice
     * @var \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment[] $flightSegment
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1[] $ticket
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice[] $ticketPrice
     * @param \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest[] $specialServiceRequest
     * @param \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance[] $baggageAllowance
     * @param int[] $travelerRefId
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice[] $travelerTotalPrice
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment[]
     */
    ...
    public static function validateFlightSegmentForArrayConstraintsFromSetFlightSegment(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingFlightSegmentItem) {
            ...
            if (!$flightBookingFlightSegmentItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FlightSegment property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToFlightSegment(\Pggns\MidocoApi\Api\Booking\StructType\FlightSegment $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment) {
            throw new InvalidArgumentException(sprintf('The FlightSegment property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\FlightSegment, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    /**
     * Get Ticket value
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1[]
     */
    ...
    public static function validateTicketForArrayConstraintsFromSetTicket(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingTicketItem) {
            // validation for constraint: itemType
            if (!$flightBookingTicketItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Ticket property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1 $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToTicket(\Pggns\MidocoApi\Api\Booking\StructType\Ticket_1 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1) {
            throw new InvalidArgumentException(sprintf('The Ticket property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->Ticket[] = $item;
    ...
    public static function validateTicketPriceForArrayConstraintsFromSetTicketPrice(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingTicketPriceItem) {
            // validation for constraint: itemType
            if (!$flightBookingTicketPriceItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketPrice property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToTicketPrice(\Pggns\MidocoApi\Api\Booking\StructType\TicketPrice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice) {
            throw new InvalidArgumentException(sprintf('The TicketPrice property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TicketPrice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest[]
     */
    ...
    public static function validateSpecialServiceRequestForArrayConstraintsFromSetSpecialServiceRequest(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingSpecialServiceRequestItem) {
            // validation for constraint: itemType
            if (!$flightBookingSpecialServiceRequestItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SpecialServiceRequest property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToSpecialServiceRequest(\Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest) {
            throw new InvalidArgumentException(sprintf('The SpecialServiceRequest property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\SpecialServiceRequest, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateBaggageAllowanceForArrayConstraintsFromSetBaggageAllowance(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingBaggageAllowanceItem) {
            // validation for constraint: itemType
            if (!$flightBookingBaggageAllowanceItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The BaggageAllowance property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToBaggageAllowance(\Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance) {
            throw new InvalidArgumentException(sprintf('The BaggageAllowance property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\BaggageAllowance, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice[]
     */
    ...
    public static function validateTravelerTotalPriceForArrayConstraintsFromSetTravelerTotalPrice(?array $values = []): string
    {
        ...
        foreach ($values as $flightBookingTravelerTotalPriceItem) {
            // validation for constraint: itemType
            if (!$flightBookingTravelerTotalPriceItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TravelerTotalPrice property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\FlightBooking
     */
    public function addToTravelerTotalPrice(\Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice) {
            throw new InvalidArgumentException(sprintf('The TravelerTotalPrice property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TravelerTotalPrice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
