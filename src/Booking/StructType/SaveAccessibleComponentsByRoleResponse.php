...
class SaveAccessibleComponentsByRoleResponse extends AbstractStructBase
{
     ...
     * Set success value
     * @param bool $success
     * @return \Pggns\MidocoApi\Booking\StructType\SaveAccessibleComponentsByRoleResponse
     */
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $saveAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$saveAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAccessibleComponentByRole property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType $item
     * @return \Pggns\MidocoApi\Booking\StructType\SaveAccessibleComponentsByRoleResponse
     */
    public function addToMidocoAccessibleComponentByRole(\Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType) {
            throw new InvalidArgumentException(sprintf('The MidocoAccessibleComponentByRole property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
