...
class GetDocumentNaturesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType[]
     */
    ...
    public static function validateMidocoDocumentNatureForArrayConstraintsFromSetMidocoDocumentNature(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNaturesResponseMidocoDocumentNatureItem) {
            ...
            if (!$getDocumentNaturesResponseMidocoDocumentNatureItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNature property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType[] $midocoDocumentNature
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetDocumentNaturesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\GetDocumentNaturesResponse
     */
    public function addToMidocoDocumentNature(\Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNature property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoDocumentNatureType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
