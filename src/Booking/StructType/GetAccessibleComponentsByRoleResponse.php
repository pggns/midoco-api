...
class GetAccessibleComponentsByRoleResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoAccessibleComponentByRoleType[] $midocoAccessibleComponentByRole
     * @return \Pggns\MidocoApi\Booking\StructType\GetAccessibleComponentsByRoleResponse
     */
