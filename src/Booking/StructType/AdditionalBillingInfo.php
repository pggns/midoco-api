...
class AdditionalBillingInfo extends AbstractStructBase
{
    ...
    /**
     * Set name value
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\AdditionalBillingInfoNameType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\AdditionalBillingInfoNameType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $name
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AdditionalBillingInfo
     */
    public function setName(?string $name = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\AdditionalBillingInfoNameType::valueIsValid($name)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\AdditionalBillingInfoNameType', is_array($name) ? implode(', ', $name) : var_export($name, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\AdditionalBillingInfoNameType::getValidValues())), __LINE__);
        }
        $this->name = $name;
