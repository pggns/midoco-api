...
class GetDocumentNatureDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType[]
     */
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType[]
     */
    ...
    public static function validateMidocoDocumentNatureDescriptionForArrayConstraintFromSetMidocoDocumentNatureDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNatureDescriptionsResponseMidocoDocumentNatureDescriptionItem) {
            ...
            if (!$getDocumentNatureDescriptionsResponseMidocoDocumentNatureDescriptionItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNatureDescription property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType[] $midocoDocumentNatureDescription
     * @return \Pggns\MidocoApi\Booking\StructType\GetDocumentNatureDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType $item
     * @return \Pggns\MidocoApi\Booking\StructType\GetDocumentNatureDescriptionsResponse
     */
    public function addToMidocoDocumentNatureDescription(\Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNatureDescription property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoDocumentNatureDescriptionType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
