...
class GetPropertiesFromTemplateResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo[] $midocoPropertyInfo
     */
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo[]
     */
    ...
    public static function validateMidocoPropertyInfoForArrayConstraintFromSetMidocoPropertyInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getPropertiesFromTemplateResponseMidocoPropertyInfoItem) {
            ...
            if (!$getPropertiesFromTemplateResponseMidocoPropertyInfoItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPropertyInfo property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo[] $midocoPropertyInfo
     * @return \Pggns\MidocoApi\Booking\StructType\GetPropertiesFromTemplateResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo $item
     * @return \Pggns\MidocoApi\Booking\StructType\GetPropertiesFromTemplateResponse
     */
    public function addToMidocoPropertyInfo(\Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoPropertyInfo property can only contain items of type \Pggns\MidocoApi\Booking\StructType\MidocoPropertyInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
