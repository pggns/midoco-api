...
class CcToken extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: tokenAttributes
     * @var \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes[] $tokenAttributes
     */
     ...
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\CcTokenType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\CcTokenType::getValidValues()
    ...
    public function setCcTokenType(?string $ccTokenType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\CcTokenType::valueIsValid($ccTokenType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\CcTokenType', is_array($ccTokenType) ? implode(', ', $ccTokenType) : var_export($ccTokenType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\CcTokenType::getValidValues())), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes[]
     */
    ...
    public static function validateTokenAttributesForArrayConstraintsFromSetTokenAttributes(?array $values = []): string
    {
        ...
        foreach ($values as $ccTokenTokenAttributesItem) {
            ...
            if (!$ccTokenTokenAttributesItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The tokenAttributes property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CcToken
     */
    public function addToTokenAttributes(\Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes) {
            throw new InvalidArgumentException(sprintf('The tokenAttributes property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TokenAttributes, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(3)
