...
/**
 * This class stands for importedDocument StructType
 * Meta information extracted from the WSDL
 * - documentation: optional documents. the content is base64 coded and is decoded before storing.
 * @subpackage Structs
 */
class ImportedDocument extends AbstractStructBase
{
    /**
     * The name
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for importedDocument
     * @uses ImportedDocument::setName()
     * @uses ImportedDocument::setContent()
     * @uses ImportedDocument::setDescription()
     * @uses ImportedDocument::setDocumentNatureId()
     * @param string $name
