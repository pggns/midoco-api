...
class AttributeDefinitionType extends AttributeDefinitionDTO
{
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $attributeDefinitionTypeMidocoAttributeChoiceValueItem) {
            ...
            if (!$attributeDefinitionTypeMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\Booking\StructType\AttributeChoiceValueDTO) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\Booking\StructType\AttributeDefinitionType
     */
