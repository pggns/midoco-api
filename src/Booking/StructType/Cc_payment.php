...
class Cc_payment extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: cc-token
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Cc_token[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo[] $cc_additional_info
     * @param string $card_holder
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Cc_token[] $cc_token
    ...
    public static function validateCc_additional_infoForArrayConstraintsFromSetCc_additional_info(?array $values = []): string
    {
        ...
        foreach ($values as $cc_paymentCc_additional_infoItem) {
            ...
            if (!$cc_paymentCc_additional_infoItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The cc_additional_info property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Cc_payment
     */
    public function addToCc_additional_info(\Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo) {
            throw new InvalidArgumentException(sprintf('The cc_additional_info property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateCc_tokenForArrayConstraintsFromSetCc_token(?array $values = []): string
    {
        ...
        foreach ($values as $cc_paymentCc_tokenItem) {
            // validation for constraint: itemType
            if (!$cc_paymentCc_tokenItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\Cc_token) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The cc_token property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Cc_token, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Cc_token $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Cc_payment
     */
    public function addToCc_token(\Pggns\MidocoApi\Api\Booking\StructType\Cc_token $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\Cc_token) {
            throw new InvalidArgumentException(sprintf('The cc_token property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Cc_token, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
