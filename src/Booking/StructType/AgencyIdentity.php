...
class AgencyIdentity extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $crsAgencyNo = null, ?string $crsType = null, ?string $crsExpedientCode = null, ?int $midocoUserId = null, ?string $subagency = null, ?string $agent = null, ?string $agentAffiliate = null, ?string $agency_no = null, ?float $agency_commission_amount = null, ?string $invoicing_mode = null, ?string $underAgencyId = null, ?\Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType $agencyInfo = null)
    {
        $this
     ...
     * @param string $crsAgencyNo
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AgencyIdentity
     */
