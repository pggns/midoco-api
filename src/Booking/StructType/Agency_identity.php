...
class Agency_identity extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: AgencyInfo
     * @var \Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType $AgencyInfo = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType $agencyInfo
     */
    public function __construct(?string $crs_agency_no = null, ?string $crs_type = null, ?string $crs_expedient_code = null, ?int $midoco_user_id = null, ?string $subagency = null, ?string $agent = null, ?string $agent_affiliate = null, ?string $agency_no = null, ?float $agency_commission_amount = null, ?string $invoicing_mode = null, ?string $underAgencyId = null, ?\Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType $agencyInfo = null)
    {
        $this
     ...
     * @param string $crs_agency_no
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Agency_identity
     */
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType|null
     */
    public function getAgencyInfo(): ?\Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Agency_identity
     */
    public function setAgencyInfo(?\Pggns\MidocoApi\Api\Booking\StructType\AgencyInfoType $agencyInfo = null): self
    {
