...
class DeleteOrgunitDatastoresRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintsFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem) {
            ...
            if (!$deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Api\Booking\StructType\DeleteOrgunitDatastoresRequest
     */
