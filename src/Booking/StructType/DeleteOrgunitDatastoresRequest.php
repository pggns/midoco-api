...
class DeleteOrgunitDatastoresRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem) {
            ...
            if (!$deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Booking\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Booking\StructType\DeleteOrgunitDatastoresRequest
     */
