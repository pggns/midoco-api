...
class TransferServiceType extends AbstractStructBase
{
    ...
    /**
     * Set direction value
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\Direction::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\Direction::getValidValues()
    ...
    public function setDirection(?string $direction = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\Direction::valueIsValid($direction)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\Direction', is_array($direction) ? implode(', ', $direction) : var_export($direction, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\Direction::getValidValues())), __LINE__);
        }
