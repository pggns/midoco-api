...
class TransferServiceType extends AbstractStructBase
{
    ...
    /**
     * Set direction value
     * @uses \Pggns\MidocoApi\Booking\EnumType\Direction::valueIsValid()
     * @uses \Pggns\MidocoApi\Booking\EnumType\Direction::getValidValues()
    ...
    public function setDirection(?string $direction = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Booking\EnumType\Direction::valueIsValid($direction)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Booking\EnumType\Direction', is_array($direction) ? implode(', ', $direction) : var_export($direction, true), implode(', ', \Pggns\MidocoApi\Booking\EnumType\Direction::getValidValues())), __LINE__);
        }
