...
class CcAuthorisation extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $authCode = null, ?float $authAmount = null, ?string $currency = null, ?bool $captureExecuted = null, ?string $ccType = null, ?string $ccNumber = null, ?\Pggns\MidocoApi\Booking\StructType\CcToken $ccToken = null, ?int $position = null, ?string $transactionRefId = null)
    {
        $this
