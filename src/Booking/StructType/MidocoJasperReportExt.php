...
class MidocoJasperReportExt extends JasperReportDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec[] $midocoJasperReportParamForExec
     */
    ...
    public static function validateMidocoJasperReportParamForExecForArrayConstraintsFromSetMidocoJasperReportParamForExec(?array $values = []): string
    {
        ...
        foreach ($values as $midocoJasperReportExtMidocoJasperReportParamForExecItem) {
            ...
            if (!$midocoJasperReportExtMidocoJasperReportParamForExecItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoJasperReportParamForExec property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec[] $midocoJasperReportParamForExec
     * @return \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportExt
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportExt
     */
    public function addToMidocoJasperReportParamForExec(\Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec) {
            throw new InvalidArgumentException(sprintf('The MidocoJasperReportParamForExec property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\MidocoJasperReportParamForExec, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
