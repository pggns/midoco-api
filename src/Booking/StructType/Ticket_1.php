...
class Ticket_1 extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TicketCoupon
     * @var \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment $CreditCardPayment = null;
    /**
     * The ticketId
     * @var int|null
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon[] $ticketCoupon
     * @param int[] $bookingDetailRefId
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment $creditCardPayment
     * @param int $ticketId
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon[]
     */
    ...
    public static function validateTicketCouponForArrayConstraintsFromSetTicketCoupon(?array $values = []): string
    {
        ...
        foreach ($values as $ticketTicketCouponItem) {
            ...
            if (!$ticketTicketCouponItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketCoupon property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1
     */
    public function addToTicketCoupon(\Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon) {
            throw new InvalidArgumentException(sprintf('The TicketCoupon property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\TicketCoupon, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(TicketCoupon, BookingDetailRefId)
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment|null
     */
    public function getCreditCardPayment(): ?\Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1
     */
    public function setCreditCardPayment(?\Pggns\MidocoApi\Api\Booking\StructType\CreditCardPayment $creditCardPayment = null): self
    {
     ...
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\TicketType_1::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\TicketType_1::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticketType
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1
     */
    public function setTicketType(?string $ticketType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\TicketType_1::valueIsValid($ticketType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\TicketType_1', is_array($ticketType) ? implode(', ', $ticketType) : var_export($ticketType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\TicketType_1::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\TicketPrintType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\TicketPrintType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticketPrintType
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\TicketPrintType::valueIsValid($ticketPrintType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\TicketPrintType', is_array($ticketPrintType) ? implode(', ', $ticketPrintType) : var_export($ticketPrintType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\TicketPrintType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\PaymentType::valueIsValid($paymentType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\PaymentType', is_array($paymentType) ? implode(', ', $paymentType) : var_export($paymentType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\PaymentType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\ExternalPaymentType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Booking\EnumType\ExternalPaymentType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $extPaymentType
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Ticket_1
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Booking\EnumType\ExternalPaymentType::valueIsValid($extPaymentType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Booking\EnumType\ExternalPaymentType', is_array($extPaymentType) ? implode(', ', $extPaymentType) : var_export($extPaymentType, true), implode(', ', \Pggns\MidocoApi\Api\Booking\EnumType\ExternalPaymentType::getValidValues())), __LINE__);
        }
