...
class Ticket_1 extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TicketCoupon
     * @var \Pggns\MidocoApi\Booking\StructType\TicketCoupon[]
     */
     ...
     * @var \Pggns\MidocoApi\Booking\StructType\CreditCardPayment|null
     */
    protected ?\Pggns\MidocoApi\Booking\StructType\CreditCardPayment $CreditCardPayment = null;
    /**
     * The ticketId
     * @var int|null
     */
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\TicketCoupon[] $ticketCoupon
     * @param int[] $bookingDetailRefId
     * @param \Pggns\MidocoApi\Booking\StructType\CreditCardPayment $creditCardPayment
     * @param int $ticketId
    ...
    public static function validateTicketCouponForArrayConstraintsFromSetTicketCoupon(?array $values = []): string
    {
        ...
        foreach ($values as $ticketTicketCouponItem) {
            ...
            if (!$ticketTicketCouponItem instanceof \Pggns\MidocoApi\Booking\StructType\TicketCoupon) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketCoupon property can only contain items of type \Pggns\MidocoApi\Booking\StructType\TicketCoupon, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\TicketCoupon $item
     * @return \Pggns\MidocoApi\Booking\StructType\Ticket_1
     */
    public function addToTicketCoupon(\Pggns\MidocoApi\Booking\StructType\TicketCoupon $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\TicketCoupon) {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\CreditCardPayment|null
     */
    public function getCreditCardPayment(): ?\Pggns\MidocoApi\Booking\StructType\CreditCardPayment
    {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\Ticket_1
     */
    public function setCreditCardPayment(?\Pggns\MidocoApi\Booking\StructType\CreditCardPayment $creditCardPayment = null): self
    {
     ...
     * @uses \Pggns\MidocoApi\Booking\EnumType\TicketType_1::valueIsValid()
     * @uses \Pggns\MidocoApi\Booking\EnumType\TicketType_1::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticketType
     * @return \Pggns\MidocoApi\Booking\StructType\Ticket_1
     */
    public function setTicketType(?string $ticketType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Booking\EnumType\TicketType_1::valueIsValid($ticketType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Booking\EnumType\TicketType_1', is_array($ticketType) ? implode(', ', $ticketType) : var_export($ticketType, true), implode(', ', \Pggns\MidocoApi\Booking\EnumType\TicketType_1::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Booking\EnumType\TicketPrintType::valueIsValid()
     * @uses \Pggns\MidocoApi\Booking\EnumType\TicketPrintType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticketPrintType
     * @return \Pggns\MidocoApi\Booking\StructType\Ticket_1
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Booking\EnumType\TicketPrintType::valueIsValid($ticketPrintType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Booking\EnumType\TicketPrintType', is_array($ticketPrintType) ? implode(', ', $ticketPrintType) : var_export($ticketPrintType, true), implode(', ', \Pggns\MidocoApi\Booking\EnumType\TicketPrintType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Booking\EnumType\PaymentType::valueIsValid($paymentType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Booking\EnumType\PaymentType', is_array($paymentType) ? implode(', ', $paymentType) : var_export($paymentType, true), implode(', ', \Pggns\MidocoApi\Booking\EnumType\PaymentType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Booking\EnumType\ExternalPaymentType::valueIsValid()
     * @uses \Pggns\MidocoApi\Booking\EnumType\ExternalPaymentType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $extPaymentType
     * @return \Pggns\MidocoApi\Booking\StructType\Ticket_1
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Booking\EnumType\ExternalPaymentType::valueIsValid($extPaymentType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Booking\EnumType\ExternalPaymentType', is_array($extPaymentType) ? implode(', ', $extPaymentType) : var_export($extPaymentType, true), implode(', ', \Pggns\MidocoApi\Booking\EnumType\ExternalPaymentType::getValidValues())), __LINE__);
        }
