...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\Booking\StructType\MidocoAllJasperReports
     */
