...
class Customer extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Private_data|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\Private_data $private_data = null;
    /**
     * The company_data
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Company_data|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\Company_data $company_data = null;
    /**
     * The language
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\Communication[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\PrivateData|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\PrivateData $privateData = null;
    /**
     * The companyData
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\CompanyData|null
     */
    protected ?\Pggns\MidocoApi\Api\Booking\StructType\CompanyData $companyData = null;
    /**
     * The streetNo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Private_data $private_data
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Company_data $company_data
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Communication[] $communication
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\PrivateData $privateData
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CompanyData $companyData
     * @param string $streetNo
     * @param string $postalCode
     * @param bool $customerHasBusinessContract
     * @param bool $overrideExistingOrderCustomer
     */
    public function __construct(?int $midoco_customer_id = null, ?string $midoco_debitor = null, ?bool $force_debitor_infos = false, ?bool $use_mail_address_from_message = true, ?string $reference_customer_id = null, ?string $reference_system = null, ?string $reference_url = null, ?\Pggns\MidocoApi\Api\Booking\StructType\Private_data $private_data = null, ?\Pggns\MidocoApi\Api\Booking\StructType\Company_data $company_data = null, ?string $language = null, ?string $street = null, ?string $street_no = null, ?string $state = null, ?string $country = null, ?string $postal_code = null, ?string $city = null, ?string $endorsement = null, ?array $communication = null, ?bool $customer_has_business_contract = null, ?\Pggns\MidocoApi\Api\Booking\StructType\ConsentType $consent = null, ?string $type = 'INVOICE', ?bool $override_existing_order_customer = false, ?int $midocoCustomerId = null, ?string $midocoDebitor = null, ?bool $forceDebitorInfos = false, ?bool $useMailAddressFromMessage = true, ?string $referenceCustomerId = null, ?string $referenceSystem = null, ?string $referenceUrl = null, ?\Pggns\MidocoApi\Api\Booking\StructType\PrivateData $privateData = null, ?\Pggns\MidocoApi\Api\Booking\StructType\CompanyData $companyData = null, ?string $streetNo = null, ?string $postalCode = null, ?bool $customerHasBusinessContract = null, ?bool $overrideExistingOrderCustomer = false)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Private_data|null
     */
    public function getPrivate_data(): ?\Pggns\MidocoApi\Api\Booking\StructType\Private_data
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Customer
     */
    public function setPrivate_data(?\Pggns\MidocoApi\Api\Booking\StructType\Private_data $private_data = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Company_data|null
     */
    public function getCompany_data(): ?\Pggns\MidocoApi\Api\Booking\StructType\Company_data
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Customer
     */
    public function setCompany_data(?\Pggns\MidocoApi\Api\Booking\StructType\Company_data $company_data = null): self
    {
    ...
    public static function validateCommunicationForArrayConstraintsFromSetCommunication(?array $values = []): string
    {
        ...
        foreach ($values as $customerCommunicationItem) {
            ...
            if (!$customerCommunicationItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\Communication) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The communication property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Communication, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\Communication $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Customer
     */
    public function addToCommunication(\Pggns\MidocoApi\Api\Booking\StructType\Communication $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\Communication) {
            throw new InvalidArgumentException(sprintf('The communication property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\Communication, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\PrivateData|null
     */
    public function getPrivateData(): ?\Pggns\MidocoApi\Api\Booking\StructType\PrivateData
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Customer
     */
    public function setPrivateData(?\Pggns\MidocoApi\Api\Booking\StructType\PrivateData $privateData = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CompanyData|null
     */
    public function getCompanyData(): ?\Pggns\MidocoApi\Api\Booking\StructType\CompanyData
    {
     ...
     * @return \Pggns\MidocoApi\Api\Booking\StructType\Customer
     */
    public function setCompanyData(?\Pggns\MidocoApi\Api\Booking\StructType\CompanyData $companyData = null): self
    {
