...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Booking\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Booking\StructType\RefreshTssClientStateResponse
     */
