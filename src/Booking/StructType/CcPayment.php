...
class CcPayment extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo[]
     */
     ...
     * - minOccurs: 0
     * - ref: ccToken
     * @var \Pggns\MidocoApi\Api\Booking\StructType\CcToken[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo[] $ccAdditionalInfo
     * @param string $cardHolder
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CcToken[] $ccToken
    ...
    /**
     * This method is responsible for validating the values passed to the setCcAdditionalInfo method
     ...
     */
    public static function validateCcAdditionalInfoForArrayConstraintsFromSetCcAdditionalInfo(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $ccPaymentCcAdditionalInfoItem) {
            ...
            if (!$ccPaymentCcAdditionalInfoItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ccAdditionalInfo property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    public function setCcAdditionalInfo(?array $ccAdditionalInfo = null): self
    {
        ...
        if ('' !== ($ccAdditionalInfoArrayErrorMessage = self::validateCcAdditionalInfoForArrayConstraintsFromSetCcAdditionalInfo($ccAdditionalInfo))) {
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CcPayment
     */
    public function addToCcAdditionalInfo(\Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo) {
            throw new InvalidArgumentException(sprintf('The ccAdditionalInfo property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    /**
     * Get ccToken value
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CcToken[]
     */
    ...
    /**
     * This method is responsible for validating the values passed to the setCcToken method
     * This method is willingly generated in order to preserve the one-line inline validation within the setCcToken method
     * @param array $values
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateCcTokenForArrayConstraintsFromSetCcToken(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $ccPaymentCcTokenItem) {
            // validation for constraint: itemType
            if (!$ccPaymentCcTokenItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\CcToken) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ccToken property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CcToken, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    {
        // validation for constraint: array
        if ('' !== ($ccTokenArrayErrorMessage = self::validateCcTokenForArrayConstraintsFromSetCcToken($ccToken))) {
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Booking\StructType\CcToken $item
     * @return \Pggns\MidocoApi\Api\Booking\StructType\CcPayment
     */
    public function addToCcToken(\Pggns\MidocoApi\Api\Booking\StructType\CcToken $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Booking\StructType\CcToken) {
            throw new InvalidArgumentException(sprintf('The ccToken property can only contain items of type \Pggns\MidocoApi\Api\Booking\StructType\CcToken, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->ccToken[] = $item;
