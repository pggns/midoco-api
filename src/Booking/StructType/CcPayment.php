...
class CcPayment extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo[]
     */
     ...
     * - minOccurs: 0
     * - ref: ccToken
     * @var \Pggns\MidocoApi\Booking\StructType\CcToken[]
     */
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo[] $ccAdditionalInfo
    ...
    public static function validateCcAdditionalInfoForArrayConstraintsFromSetCcAdditionalInfo(?array $values = []): string
    {
        ...
        foreach ($values as $ccPaymentCcAdditionalInfoItem) {
            ...
            if (!$ccPaymentCcAdditionalInfoItem instanceof \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ccAdditionalInfo property can only contain items of type \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo $item
     * @return \Pggns\MidocoApi\Booking\StructType\CcPayment
     */
    public function addToCcAdditionalInfo(\Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo) {
            throw new InvalidArgumentException(sprintf('The ccAdditionalInfo property can only contain items of type \Pggns\MidocoApi\Booking\StructType\CCPaymentAdditionalInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateCcTokenForArrayConstraintsFromSetCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $ccPaymentCcTokenItem) {
            // validation for constraint: itemType
            if (!$ccPaymentCcTokenItem instanceof \Pggns\MidocoApi\Booking\StructType\CcToken) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ccToken property can only contain items of type \Pggns\MidocoApi\Booking\StructType\CcToken, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Booking\StructType\CcToken $item
     * @return \Pggns\MidocoApi\Booking\StructType\CcPayment
     */
    public function addToCcToken(\Pggns\MidocoApi\Booking\StructType\CcToken $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Booking\StructType\CcToken) {
            throw new InvalidArgumentException(sprintf('The ccToken property can only contain items of type \Pggns\MidocoApi\Booking\StructType\CcToken, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->ccToken[] = $item;
