...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Booking\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\Booking\StructType\AssignedAdaptersResponse
     */
