...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Api\Booking\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Booking\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\Api\Booking\StructType\AssignedAdaptersResponse
     */
