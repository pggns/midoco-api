...
class Marketing_info extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Booking\StructType\Search_criteria|null
     */
    protected ?\Pggns\MidocoApi\Booking\StructType\Search_criteria $search_criteria = null;
    /**
     * The attribute
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * @param \Pggns\MidocoApi\Booking\StructType\Search_criteria $search_criteria
     * @param \Pggns\MidocoApi\Booking\StructType\Attribute[] $attribute
     */
    public function __construct(?string $area_code = null, ?string $travel_duration = null, ?string $season = null, ?string $travel_type = null, ?string $transportation = null, ?string $person_count = null, ?\Pggns\MidocoApi\Booking\StructType\Search_criteria $search_criteria = null, ?array $attribute = null)
    {
        $this
     ...
     * Set area_code value
     * @param string $area_code
     * @return \Pggns\MidocoApi\Booking\StructType\Marketing_info
     */
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\Search_criteria|null
     */
    public function getSearch_criteria(): ?\Pggns\MidocoApi\Booking\StructType\Search_criteria
    {
     ...
     * @return \Pggns\MidocoApi\Booking\StructType\Marketing_info
     */
    public function setSearch_criteria(?\Pggns\MidocoApi\Booking\StructType\Search_criteria $search_criteria = null): self
    {
    ...
    public static function validateAttributeForArrayConstraintFromSetAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $marketing_infoAttributeItem) {
            ...
            if (!$marketing_infoAttributeItem instanceof \Pggns\MidocoApi\Booking\StructType\Attribute) {
