...
class MidocoCcReport extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord[] $midocoCcReportRecord
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord[]
     */
    ...
    public static function validateMidocoCcReportRecordForArrayConstraintsFromSetMidocoCcReportRecord(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCcReportMidocoCcReportRecordItem) {
            ...
            if (!$midocoCcReportMidocoCcReportRecordItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCcReportRecord property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord[] $midocoCcReportRecord
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReport
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReport
     */
    public function addToMidocoCcReportRecord(\Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord) {
            throw new InvalidArgumentException(sprintf('The MidocoCcReportRecord property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcReportRecord, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
