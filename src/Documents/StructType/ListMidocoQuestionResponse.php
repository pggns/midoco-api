...
class ListMidocoQuestionResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoQuestion
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion[]
     */
    ...
    public static function validateMidocoQuestionForArrayConstraintsFromSetMidocoQuestion(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoQuestionResponseMidocoQuestionItem) {
            ...
            if (!$listMidocoQuestionResponseMidocoQuestionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQuestion property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion[] $midocoQuestion
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListMidocoQuestionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListMidocoQuestionResponse
     */
    public function addToMidocoQuestion(\Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion) {
            throw new InvalidArgumentException(sprintf('The MidocoQuestion property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoQuestion, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
