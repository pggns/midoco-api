...
class TransferDetailDTO extends AbstractStructBase
{
     ...
     * @param string $baggageAllowance
     * @return \Pggns\MidocoApi\Api\Documents\StructType\TransferDetailDTO
     */
