...
class CashBookPageInfo4Printing extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing[] $cashBookLineInfo4Printing
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing[] $cashBookReceiptPosition4Printing
     ...
     * Set pageNo value
     * @param string $pageNo
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CashBookPageInfo4Printing
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing[]
     */
    ...
    public static function validateCashBookLineInfo4PrintingForArrayConstraintsFromSetCashBookLineInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $cashBookPageInfo4PrintingCashBookLineInfo4PrintingItem) {
            ...
            if (!$cashBookPageInfo4PrintingCashBookLineInfo4PrintingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CashBookLineInfo4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CashBookPageInfo4Printing
     */
    public function addToCashBookLineInfo4Printing(\Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing) {
            throw new InvalidArgumentException(sprintf('The CashBookLineInfo4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CashBookLineInfo4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing[]
     */
    ...
    public static function validateCashBookReceiptPosition4PrintingForArrayConstraintsFromSetCashBookReceiptPosition4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $cashBookPageInfo4PrintingCashBookReceiptPosition4PrintingItem) {
            // validation for constraint: itemType
            if (!$cashBookPageInfo4PrintingCashBookReceiptPosition4PrintingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CashBookReceiptPosition4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CashBookPageInfo4Printing
     */
    public function addToCashBookReceiptPosition4Printing(\Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing) {
            throw new InvalidArgumentException(sprintf('The CashBookReceiptPosition4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CashBookReceiptPosition4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
