...
class GetTempDocumentRepositoryByIdRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetTempDocumentRepositoryByIdRequest
     * @uses GetTempDocumentRepositoryByIdRequest::setRepositoryId()
     ...
     * @param int $repositoryId
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetTempDocumentRepositoryByIdRequest
     */
