...
class GetValidVatCodesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDefinitionForArrayConstraintFromSetMidocoVatDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getValidVatCodesResponseMidocoVatDefinitionItem) {
            ...
            if (!$getValidVatCodesResponseMidocoVatDefinitionItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoVatDefinition) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoVatDefinition[] $midocoVatDefinition
     * @return \Pggns\MidocoApi\Documents\StructType\GetValidVatCodesResponse
     */
