...
class GetValidVatCodesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDefinitionForArrayConstraintsFromSetMidocoVatDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getValidVatCodesResponseMidocoVatDefinitionItem) {
            ...
            if (!$getValidVatCodesResponseMidocoVatDefinitionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDefinition) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDefinition[] $midocoVatDefinition
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetValidVatCodesResponse
     */
