...
/**
 * This class stands for MidocoOrdCriteriaTypeInfo StructType
 * @subpackage Structs
 */
class MidocoOrdCriteriaTypeInfo extends AbstractStructBase
{
    /**
     * The typeId
    ...
    /**
     * Constructor method for MidocoOrdCriteriaTypeInfo
     * @uses MidocoOrdCriteriaTypeInfo::setTypeId()
     * @uses MidocoOrdCriteriaTypeInfo::setGuiPosition()
     * @param string $typeId
     ...
     * Set typeId value
     * @param string $typeId
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeInfo
     */
