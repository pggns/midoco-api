...
class MidocoOnlinePayment extends OnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePayment
     */
