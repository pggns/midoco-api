...
class ListTssClientResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $listTssClientResponseMidocoTssClientItem) {
            ...
            if (!$listTssClientResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Documents\StructType\ListTssClientResponse
     */
