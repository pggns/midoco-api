...
class GetSupplierAddressListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress[]
     */
    ...
    public static function validateMidocoSupplierAddressForArrayConstraintsFromSetMidocoSupplierAddress(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierAddressListResponseMidocoSupplierAddressItem) {
            ...
            if (!$getSupplierAddressListResponseMidocoSupplierAddressItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierAddress property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress[] $midocoSupplierAddress
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierAddressListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierAddressListResponse
     */
    public function addToMidocoSupplierAddress(\Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierAddress property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAddress, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
