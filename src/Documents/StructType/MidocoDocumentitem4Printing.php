...
class MidocoDocumentitem4Printing extends DocumentitemDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing $MidocoPassengerInfo4Printing = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO[] $midocoDocumentTaxInfo4Printing
     ...
     */
    public function __construct(?bool $isReferenced = true, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing $midocoPassengerInfo4Printing = null, ?array $midocoFlightDetailsInfo4Printing = null, ?array $midocoRemarks = null, ?bool $isPrinted = false, ?bool $needsInvoicePrint = false, ?array $midocoDocumentTaxInfo4Printing = null, ?string $bspValidatorName = null, ?bool $preventPrinting = false, ?array $midocoOrdersDbiInfo = null, ?array $midocoInvoicePosition = null, ?array $midocoInvoiceVatPosition = null, ?float $oldPrice = null, ?array $midocoSellPassenger = null, ?array $midocoTouchedVatCode = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing|null
     */
    public function getMidocoPassengerInfo4Printing(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentitem4Printing
     */
    public function setMidocoPassengerInfo4Printing(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPassengerInfo4Printing $midocoPassengerInfo4Printing = null): self
    {
    ...
    public static function validateMidocoFlightDetailsInfo4PrintingForArrayConstraintsFromSetMidocoFlightDetailsInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoFlightDetailsInfo4PrintingItem) {
            ...
            if (!$midocoDocumentitem4PrintingMidocoFlightDetailsInfo4PrintingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDetailsInfo4Printing) {
    ...
    public static function validateMidocoRemarksForArrayConstraintsFromSetMidocoRemarks(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoRemarksItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoRemarksItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoRemarkType) {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO[]
     */
    ...
    public static function validateMidocoDocumentTaxInfo4PrintingForArrayConstraintsFromSetMidocoDocumentTaxInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoDocumentTaxInfo4PrintingItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoDocumentTaxInfo4PrintingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentTaxInfo4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoDocumentTaxInfo4Printing(\Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentTaxInfo4Printing property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\DocumentTaxCalculationDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoOrdersDbiInfoForArrayConstraintsFromSetMidocoOrdersDbiInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoOrdersDbiInfoItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoOrdersDbiInfoItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdersDbiInfo) {
    ...
    public static function validateMidocoInvoicePositionForArrayConstraintsFromSetMidocoInvoicePosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoInvoicePositionItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoInvoicePositionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoInvoicePosition) {
    ...
    public static function validateMidocoInvoiceVatPositionForArrayConstraintsFromSetMidocoInvoiceVatPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoInvoiceVatPositionItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoInvoiceVatPositionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoInvoiceVatPosition) {
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoSellPassengerItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellPassenger) {
    ...
    public static function validateMidocoTouchedVatCodeForArrayConstraintsFromSetMidocoTouchedVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoTouchedVatCodeItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoTouchedVatCodeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\TouchedVatCodeType) {
