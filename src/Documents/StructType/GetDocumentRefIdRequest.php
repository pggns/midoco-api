...
/**
 * This class stands for GetDocumentRefIdRequest StructType
 * @subpackage Structs
 */
class GetDocumentRefIdRequest extends AbstractStructBase
{
    /**
     * The repositoryId
     * @var int|null
    ...
    /**
     * Constructor method for GetDocumentRefIdRequest
     * @uses GetDocumentRefIdRequest::setRepositoryId()
     ...
     * @param int $repositoryId
     * @return \Pggns\MidocoApi\Documents\StructType\GetDocumentRefIdRequest
     */
