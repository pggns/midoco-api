...
class GetSupplierVatSchemasResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO[] $midocoSupplierVatSchema
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO[]
     */
    ...
    public static function validateMidocoSupplierVatSchemaForArrayConstraintsFromSetMidocoSupplierVatSchema(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierVatSchemasResponseMidocoSupplierVatSchemaItem) {
            ...
            if (!$getSupplierVatSchemasResponseMidocoSupplierVatSchemaItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierVatSchema property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO[] $midocoSupplierVatSchema
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierVatSchemasResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierVatSchemasResponse
     */
    public function addToMidocoSupplierVatSchema(\Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierVatSchema property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SupplierVatSchemaDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
