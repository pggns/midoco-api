...
class GetPagedBillingDocumentsForCustomerResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer[] $midocoBillingDocInfoForCustomer
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer[]
     */
    ...
    public static function validateMidocoBillingDocInfoForCustomerForArrayConstraintFromSetMidocoBillingDocInfoForCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $getPagedBillingDocumentsForCustomerResponseMidocoBillingDocInfoForCustomerItem) {
            ...
            if (!$getPagedBillingDocumentsForCustomerResponseMidocoBillingDocInfoForCustomerItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBillingDocInfoForCustomer property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer[] $midocoBillingDocInfoForCustomer
     * @return \Pggns\MidocoApi\Documents\StructType\GetPagedBillingDocumentsForCustomerResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer $item
     * @return \Pggns\MidocoApi\Documents\StructType\GetPagedBillingDocumentsForCustomerResponse
     */
    public function addToMidocoBillingDocInfoForCustomer(\Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoBillingDocInfoForCustomer property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoBillingDocInfoForCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
