...
class GetConnectionTypeListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO[]
     */
    ...
    public static function validateMidocoConnectionTypeForArrayConstraintFromSetMidocoConnectionType(?array $values = []): string
    {
        ...
        foreach ($values as $getConnectionTypeListResponseMidocoConnectionTypeItem) {
            ...
            if (!$getConnectionTypeListResponseMidocoConnectionTypeItem instanceof \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoConnectionType property can only contain items of type \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO[] $midocoConnectionType
     * @return \Pggns\MidocoApi\Documents\StructType\GetConnectionTypeListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO $item
     * @return \Pggns\MidocoApi\Documents\StructType\GetConnectionTypeListResponse
     */
    public function addToMidocoConnectionType(\Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoConnectionType property can only contain items of type \Pggns\MidocoApi\Documents\StructType\ConnectionTypeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
