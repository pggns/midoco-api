...
class MidocoExtendedCustomerTravel extends MidocoCustomerTravelType
{
     ...
     * - minOccurs: 0
     * - ref: MidocoFeeItem
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem[] $midocoFeeItem
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem[]
     */
    ...
    public static function validateMidocoFeeItemForArrayConstraintFromSetMidocoFeeItem(?array $values = []): string
    {
        ...
        foreach ($values as $midocoExtendedCustomerTravelMidocoFeeItemItem) {
            ...
            if (!$midocoExtendedCustomerTravelMidocoFeeItemItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeItem property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem[] $midocoFeeItem
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoExtendedCustomerTravel
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoExtendedCustomerTravel
     */
    public function addToMidocoFeeItem(\Pggns\MidocoApi\Documents\StructType\MidocoFeeItem $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeItem property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoFeeItem, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
