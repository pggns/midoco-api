...
class ReceiptOnlinePaymentInfo extends OnlinePaymentInfoType
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $receiptOnlinePaymentInfoMidocoCcTokenItem) {
            ...
            if (!$receiptOnlinePaymentInfoMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ReceiptOnlinePaymentInfo
     */
