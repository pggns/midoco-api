...
class CrmMidocoChargeInfoType extends CrmMidocoChargeDTO
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Documents\StructType\CrmMidocoChargeInfoType
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO $item
     * @return \Pggns\MidocoApi\Documents\StructType\CrmMidocoChargeInfoType
     */
    public function addToMidocoAssignedMidocoChargeOu(\Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
