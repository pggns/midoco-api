...
class GetAvailablePrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailablePrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAvailablePrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Documents\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Documents\StructType\GetAvailablePrintSelectsResponse
     */
