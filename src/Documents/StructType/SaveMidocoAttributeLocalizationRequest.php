...
class SaveMidocoAttributeLocalizationRequest extends AbstractStructBase
{
     ...
     * @param bool $isNew
     */
    public function __construct(?\Pggns\MidocoApi\Api\Documents\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization = null, ?bool $isNew = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SaveMidocoAttributeLocalizationRequest
     */
