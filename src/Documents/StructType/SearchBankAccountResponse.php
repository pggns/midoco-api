...
class SearchBankAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBankAccountForArrayConstraintsFromSetMidocoBankAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchBankAccountResponseMidocoBankAccountItem) {
            ...
            if (!$searchBankAccountResponseMidocoBankAccountItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoBankAccount) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoBankAccount[] $midocoBankAccount
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SearchBankAccountResponse
     */
