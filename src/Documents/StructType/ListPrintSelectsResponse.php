...
class ListPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $listPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$listPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Documents\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Documents\StructType\ListPrintSelectsResponse
     */
