...
class GetAvailablePrintQueues4UserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintQueueForArrayConstraintFromSetMidocoPrintQueue(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailablePrintQueues4UserResponseMidocoPrintQueueItem) {
            ...
            if (!$getAvailablePrintQueues4UserResponseMidocoPrintQueueItem instanceof \Pggns\MidocoApi\Documents\StructType\PrintQueueDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\PrintQueueDTO[] $midocoPrintQueue
     * @return \Pggns\MidocoApi\Documents\StructType\GetAvailablePrintQueues4UserResponse
     */
