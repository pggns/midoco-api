...
class ListAssignedMidocoFeeTypesResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoFeeType
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType[]
     */
    ...
    public static function validateMidocoFeeTypeForArrayConstraintsFromSetMidocoFeeType(?array $values = []): string
    {
        ...
        foreach ($values as $listAssignedMidocoFeeTypesResponseMidocoFeeTypeItem) {
            ...
            if (!$listAssignedMidocoFeeTypesResponseMidocoFeeTypeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeType property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType[] $midocoFeeType
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListAssignedMidocoFeeTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListAssignedMidocoFeeTypesResponse
     */
    public function addToMidocoFeeType(\Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeType property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
