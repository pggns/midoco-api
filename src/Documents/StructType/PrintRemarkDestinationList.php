...
class PrintRemarkDestinationList extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRemarkDestinationForArrayConstraintFromSetMidocoPrintRemarkDestination(?array $values = []): string
    {
        ...
        foreach ($values as $printRemarkDestinationListMidocoPrintRemarkDestinationItem) {
            ...
            if (!$printRemarkDestinationListMidocoPrintRemarkDestinationItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoPrintRemarkDestination) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     * @return \Pggns\MidocoApi\Documents\StructType\PrintRemarkDestinationList
     */
