...
/**
 * This class stands for OrderLayoutDTO StructType
 * @subpackage Structs
 */
class OrderLayoutDTO extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for OrderLayoutDTO
     * @uses OrderLayoutDTO::setCreationTimestamp()
     * @uses OrderLayoutDTO::setCreationUser()
     * @uses OrderLayoutDTO::setDescription()
     * @uses OrderLayoutDTO::setEndTravel()
     * @uses OrderLayoutDTO::setId()
     * @uses OrderLayoutDTO::setLayoutType()
     * @uses OrderLayoutDTO::setModifyTimestamp()
     * @uses OrderLayoutDTO::setModifyUser()
     * @uses OrderLayoutDTO::setRepositoryId()
     * @uses OrderLayoutDTO::setStartTravel()
     * @uses OrderLayoutDTO::setSupplierId()
     * @uses OrderLayoutDTO::setTravelNo()
     * @uses OrderLayoutDTO::setUnitName()
     ...
     */
    public function __construct(?string $creationTimestamp = null, ?int $creationUser = null, ?string $description = null, ?string $endTravel = null, ?int $id = null, ?int $layoutType = null, ?string $modifyTimestamp = null, ?int $modifyUser = null, ?int $repositoryId = null, ?string $startTravel = null, ?string $supplierId = null, ?string $travelNo = null, ?string $unitName = null)
    {
        $this
     ...
     * @param string $creationTimestamp
     * @return \Pggns\MidocoApi\Api\Documents\StructType\OrderLayoutDTO
     */
    ...
    {
        // validation for constraint: int
        if (!is_null($layoutType) && !(is_int($layoutType) || ctype_digit($layoutType))) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide an integer value, %s given', var_export($layoutType, true), gettype($layoutType)), __LINE__);
        }
