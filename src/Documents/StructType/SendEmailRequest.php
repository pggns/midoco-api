...
class SendEmailRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoMailMessageType $midocoMailMessage = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoMailMessageType $midocoMailMessage
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SendEmailRequest
     */
