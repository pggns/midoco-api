...
class GetPrintSelectsForPRRLResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintSelectForArrayConstraintsFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsForPRRLResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsForPRRLResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPrintSelect) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetPrintSelectsForPRRLResponse
     */
