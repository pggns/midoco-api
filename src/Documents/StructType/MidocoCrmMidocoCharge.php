...
class MidocoCrmMidocoCharge extends CrmMidocoChargeDTO
{
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmMidocoCharge
     */
