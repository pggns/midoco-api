...
class GetDocumentNaturesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType[]
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType[]
     */
    ...
    public static function validateMidocoDocumentNatureForArrayConstraintFromSetMidocoDocumentNature(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNaturesResponseMidocoDocumentNatureItem) {
            ...
            if (!$getDocumentNaturesResponseMidocoDocumentNatureItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNature property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType[] $midocoDocumentNature
     * @return \Pggns\MidocoApi\Documents\StructType\GetDocumentNaturesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType $item
     * @return \Pggns\MidocoApi\Documents\StructType\GetDocumentNaturesResponse
     */
    public function addToMidocoDocumentNature(\Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNature property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoDocumentNatureType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
