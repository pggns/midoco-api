...
class GetDbiDefinitionRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Documents\StructType\MidocoDbiCcInfo $midocoDbiCcInfo = null, ?bool $emailIfNew = true, ?string $publisherId = null, ?string $dbiItemType = null)
    {
        $this
