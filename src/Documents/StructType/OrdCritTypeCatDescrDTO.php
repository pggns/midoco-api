...
class OrdCritTypeCatDescrDTO extends AbstractStructBase
{
    ...
    /**
     * Constructor method for OrdCritTypeCatDescrDTO
     * @uses OrdCritTypeCatDescrDTO::setCategoryId()
     * @uses OrdCritTypeCatDescrDTO::setCultureId()
     * @uses OrdCritTypeCatDescrDTO::setDescription()
