...
class ListTourOperatorsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator[]
     */
    ...
    public static function validateMidocoTourOperatorForArrayConstraintsFromSetMidocoTourOperator(?array $values = []): string
    {
        ...
        foreach ($values as $listTourOperatorsResponseMidocoTourOperatorItem) {
            ...
            if (!$listTourOperatorsResponseMidocoTourOperatorItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTourOperator property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator[] $midocoTourOperator
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListTourOperatorsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListTourOperatorsResponse
     */
    public function addToMidocoTourOperator(\Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator) {
            throw new InvalidArgumentException(sprintf('The MidocoTourOperator property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoTourOperator, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
