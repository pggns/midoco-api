...
class GetMidocoOrgUnitGuiAttributeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute[] $midocoOrgunitGuiAttribute
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute[]
     */
    ...
    public static function validateMidocoOrgunitGuiAttributeForArrayConstraintsFromSetMidocoOrgunitGuiAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoOrgUnitGuiAttributeResponseMidocoOrgunitGuiAttributeItem) {
            ...
            if (!$getMidocoOrgUnitGuiAttributeResponseMidocoOrgunitGuiAttributeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitGuiAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute[] $midocoOrgunitGuiAttribute
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetMidocoOrgUnitGuiAttributeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetMidocoOrgUnitGuiAttributeResponse
     */
    public function addToMidocoOrgunitGuiAttribute(\Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitGuiAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrgunitGuiAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
