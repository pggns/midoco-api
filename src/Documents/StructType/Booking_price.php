...
class Booking_price extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - documentation: Sets the foreign currency customer selling price of a sell item. This element price has priority and could overwrite base-total-price. Only available for non-package-child sellitems. The element displayed-currency with foreign
     * currency for order is mandatory. Order-Adapter-Settings: FX_CALC_CUSTOMER_SELLING_PRICE_EDITABLE = Y required
     * - minOccurs: 0
     * @var float|null
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Documents\StructType\Vat_division[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\Vat_division[] $vat_division
     ...
     * @uses \Pggns\MidocoApi\Documents\EnumType\Deposit_payment_type::valueIsValid()
     * @uses \Pggns\MidocoApi\Documents\EnumType\Deposit_payment_type::getValidValues()
    ...
    public function setDeposit_payment_type(?string $deposit_payment_type = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Documents\EnumType\Deposit_payment_type::valueIsValid($deposit_payment_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Documents\EnumType\Deposit_payment_type', is_array($deposit_payment_type) ? implode(', ', $deposit_payment_type) : var_export($deposit_payment_type, true), implode(', ', \Pggns\MidocoApi\Documents\EnumType\Deposit_payment_type::getValidValues())), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\Vat_division[]
     */
    ...
    public static function validateVat_divisionForArrayConstraintsFromSetVat_division(?array $values = []): string
    {
        ...
        foreach ($values as $booking_priceVat_divisionItem) {
            ...
            if (!$booking_priceVat_divisionItem instanceof \Pggns\MidocoApi\Documents\StructType\Vat_division) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The vat_division property can only contain items of type \Pggns\MidocoApi\Documents\StructType\Vat_division, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\Vat_division $item
     * @return \Pggns\MidocoApi\Documents\StructType\Booking_price
     */
    public function addToVat_division(\Pggns\MidocoApi\Documents\StructType\Vat_division $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\Vat_division) {
            throw new InvalidArgumentException(sprintf('The vat_division property can only contain items of type \Pggns\MidocoApi\Documents\StructType\Vat_division, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Documents\EnumType\Mode_revenue_calculation::valueIsValid()
     * @uses \Pggns\MidocoApi\Documents\EnumType\Mode_revenue_calculation::getValidValues()
     * @throws InvalidArgumentException
     * @param string $mode_revenue_calculation
     * @return \Pggns\MidocoApi\Documents\StructType\Booking_price
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Documents\EnumType\Mode_revenue_calculation::valueIsValid($mode_revenue_calculation)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Documents\EnumType\Mode_revenue_calculation', is_array($mode_revenue_calculation) ? implode(', ', $mode_revenue_calculation) : var_export($mode_revenue_calculation, true), implode(', ', \Pggns\MidocoApi\Documents\EnumType\Mode_revenue_calculation::getValidValues())), __LINE__);
        }
