...
/**
 * This class stands for MidocoSupplierAddress StructType
 * @subpackage Structs
 */
class MidocoSupplierAddress extends SupplierAddressDTO
{
    /**
     * The isInheritance
     * @var bool|null
    ...
    /**
     * Constructor method for MidocoSupplierAddress
     * @uses MidocoSupplierAddress::setIsInheritance()
     * @uses MidocoSupplierAddress::setOrgunit()
