...
class MidocoAgency extends AgencyDetailDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO $MidocoCustomerPayment = null;
    /**
     * The cooperationName
     * @var string|null
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO $midocoCustomerPayment
     * @param string $cooperationName
     */
    public function __construct(?array $midocoAgencyCommission = null, ?\Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?\Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO $midocoCustomerPayment = null, ?string $cooperationName = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO[]
     */
    ...
    public static function validateMidocoAgencyCommissionForArrayConstraintsFromSetMidocoAgencyCommission(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAgencyMidocoAgencyCommissionItem) {
            ...
            if (!$midocoAgencyMidocoAgencyCommissionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAgencyCommission property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoAgency
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoAgency
     */
    public function addToMidocoAgencyCommission(\Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAgencyCommission property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\AgencyCommissionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO|null
     */
    public function getMidocoCustomerPayment(): ?\Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoAgency
     */
    public function setMidocoCustomerPayment(?\Pggns\MidocoApi\Api\Documents\StructType\CrmCustomerPaymentDTO $midocoCustomerPayment = null): self
    {
