...
class MidocoFlightDetailsInfo4Printing extends FlightDetailDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration $MidocoFlightDuration = null;
    /**
     * The MidocoRemarks
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration $midocoFlightDuration
     ...
     */
    public function __construct(?array $midocoFlightSegmentDetails4Printing = null, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration $midocoFlightDuration = null, ?array $midocoRemarks = null, ?string $carrierName = null, ?string $carrierVatId = null, ?string $carrierAddress = null, ?string $days = null, ?string $operatingCarrierName = null, ?string $operatingCarrierVatId = null, ?string $operatingCarrierAddress = null)
    {
        $this
    ...
    public static function validateMidocoFlightSegmentDetails4PrintingForArrayConstraintsFromSetMidocoFlightSegmentDetails4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoFlightDetailsInfo4PrintingMidocoFlightSegmentDetails4PrintingItem) {
            ...
            if (!$midocoFlightDetailsInfo4PrintingMidocoFlightSegmentDetails4PrintingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightSegmentDetails4Printing) {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration|null
     */
    public function getMidocoFlightDuration(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDetailsInfo4Printing
     */
    public function setMidocoFlightDuration(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDuration $midocoFlightDuration = null): self
    {
    ...
    public static function validateMidocoRemarksForArrayConstraintsFromSetMidocoRemarks(?array $values = []): string
    {
        ...
        foreach ($values as $midocoFlightDetailsInfo4PrintingMidocoRemarksItem) {
            // validation for constraint: itemType
            if (!$midocoFlightDetailsInfo4PrintingMidocoRemarksItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoRemarkType) {
