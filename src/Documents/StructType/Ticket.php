...
class Ticket extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Documents\StructType\Tax_information[]
     */
     ...
     * - minOccurs: 0
     * - ref: cc-information
     * @var \Pggns\MidocoApi\Api\Documents\StructType\Cc_information|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\Cc_information $cc_information = null;
    /**
     * The is_domestic
     * @var bool|null
     */
     ...
     * - minOccurs: 0
     * - ref: saving
     * @var \Pggns\MidocoApi\Api\Documents\StructType\Saving[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\Tax_information[] $tax_information
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\Cc_information $cc_information
     ...
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_type::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_type::getValidValues()
    ...
    public function setTicket_type(?string $ticket_type = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Documents\EnumType\Ticket_type::valueIsValid($ticket_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_type', is_array($ticket_type) ? implode(', ', $ticket_type) : var_export($ticket_type, true), implode(', ', \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_type::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_subtype::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_subtype::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticket_subtype
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Documents\EnumType\Ticket_subtype::valueIsValid($ticket_subtype)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_subtype', is_array($ticket_subtype) ? implode(', ', $ticket_subtype) : var_export($ticket_subtype, true), implode(', ', \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_subtype::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_media::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_media::getValidValues()
     * @throws InvalidArgumentException
     * @param string $ticket_media
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Documents\EnumType\Ticket_media::valueIsValid($ticket_media)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_media', is_array($ticket_media) ? implode(', ', $ticket_media) : var_export($ticket_media, true), implode(', ', \Pggns\MidocoApi\Api\Documents\EnumType\Ticket_media::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Payment_type::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Payment_type::getValidValues()
     * @throws InvalidArgumentException
     * @param string $payment_type
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Documents\EnumType\Payment_type::valueIsValid($payment_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Documents\EnumType\Payment_type', is_array($payment_type) ? implode(', ', $payment_type) : var_export($payment_type, true), implode(', ', \Pggns\MidocoApi\Api\Documents\EnumType\Payment_type::getValidValues())), __LINE__);
        }
    ...
    /**
     * Set fare_type value
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Fare_type::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Documents\EnumType\Fare_type::getValidValues()
     * @throws InvalidArgumentException
     * @param string $fare_type
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Documents\EnumType\Fare_type::valueIsValid($fare_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Documents\EnumType\Fare_type', is_array($fare_type) ? implode(', ', $fare_type) : var_export($fare_type, true), implode(', ', \Pggns\MidocoApi\Api\Documents\EnumType\Fare_type::getValidValues())), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Tax_information[]
     */
    ...
    public static function validateTax_informationForArrayConstraintsFromSetTax_information(?array $values = []): string
    {
        ...
        foreach ($values as $ticketTax_informationItem) {
            ...
            if (!$ticketTax_informationItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\Tax_information) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The tax_information property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\Tax_information, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\Tax_information $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    public function addToTax_information(\Pggns\MidocoApi\Api\Documents\StructType\Tax_information $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\Tax_information) {
            throw new InvalidArgumentException(sprintf('The tax_information property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\Tax_information, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Cc_information|null
     */
    public function getCc_information(): ?\Pggns\MidocoApi\Api\Documents\StructType\Cc_information
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    public function setCc_information(?\Pggns\MidocoApi\Api\Documents\StructType\Cc_information $cc_information = null): self
    {
    ...
    /**
     * Get saving value
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Saving[]
     */
    ...
    public static function validateSavingForArrayConstraintsFromSetSaving(?array $values = []): string
    {
        ...
        foreach ($values as $ticketSavingItem) {
            // validation for constraint: itemType
            if (!$ticketSavingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\Saving) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The saving property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\Saving, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\Saving $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\Ticket
     */
    public function addToSaving(\Pggns\MidocoApi\Api\Documents\StructType\Saving $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\Saving) {
            throw new InvalidArgumentException(sprintf('The saving property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\Saving, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->saving[] = $item;
