...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Documents\StructType\GetUserWithCrsExpedientRequest
     */
