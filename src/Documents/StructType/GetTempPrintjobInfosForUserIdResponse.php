...
class GetTempPrintjobInfosForUserIdResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoTempPrintjobInfo) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\Documents\StructType\GetTempPrintjobInfosForUserIdResponse
     */
