...
class GetOrgUnitInfoRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetOrgUnitInfoRequest
     * @uses GetOrgUnitInfoRequest::setUnitName()
     ...
     * Set unitName value
     * @param string $unitName
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrgUnitInfoRequest
     */
