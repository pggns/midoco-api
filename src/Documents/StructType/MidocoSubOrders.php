...
class MidocoSubOrders extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoOrder
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType[]
     */
    protected ?array $MidocoOrder = null;
    /**
     * Constructor method for MidocoSubOrders
     * @uses MidocoSubOrders::setMidocoOrder()
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType[] $midocoOrder
     */
    ...
    public static function validateMidocoOrderForArrayConstraintsFromSetMidocoOrder(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSubOrdersMidocoOrderItem) {
            ...
            if (!$midocoSubOrdersMidocoOrderItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrder property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType[] $midocoOrder
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSubOrders
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSubOrders
     */
    public function addToMidocoOrder(\Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType) {
            throw new InvalidArgumentException(sprintf('The MidocoOrder property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
