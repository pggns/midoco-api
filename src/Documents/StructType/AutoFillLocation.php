...
/**
 * This class stands for AutoFillLocation StructType
 * Meta information extracted from the WSDL
 * - documentation: Location of box which will be auto-filled (with static text, used to prefill travel agency signatures) page location (upper left) size of rect (width, height) values in cm and alternatively in coordinates cm offsets are calculated
...
class AutoFillLocation extends AbstractStructBase
{
     ...
     * @var string|null
     */
    protected ?string $autofill_text = null;
    /**
     * Constructor method for AutoFillLocation
     * @uses AutoFillLocation::setPage()
     * @uses AutoFillLocation::setLocationX()
     * @uses AutoFillLocation::setLocationY()
     * @uses AutoFillLocation::setLocationXcm()
     * @uses AutoFillLocation::setLocationYcm()
     * @uses AutoFillLocation::setWidth()
     * @uses AutoFillLocation::setHeight()
     * @uses AutoFillLocation::setWidthcm()
     * @uses AutoFillLocation::setHeightcm()
     * @uses AutoFillLocation::setPhrase()
     * @uses AutoFillLocation::setDescription()
     * @uses AutoFillLocation::setAutofill_text()
     * @param int $page
     ...
     * @param string $autofill_text
     */
    public function __construct(?int $page = null, ?float $locationX = null, ?float $locationY = null, ?float $locationXcm = null, ?float $locationYcm = null, ?float $width = null, ?float $height = null, ?float $widthcm = null, ?float $heightcm = null, ?string $phrase = null, ?string $description = null, ?string $autofill_text = null)
    {
        $this
            ->setPage($page)
            ...
            ->setAutofill_text($autofill_text);
    }
    /**
     * Get page value
     * @return int|null
    ...
    /**
     * Get autofill_text value
     * @return string|null
     */
    public function getAutofill_text(): ?string
    {
        return $this->{'autofill-text'};
    }
    /**
     * Set autofill_text value
     * @param string $autofill_text
     * @return \Pggns\MidocoApi\Documents\StructType\AutoFillLocation
     */
    public function setAutofill_text(?string $autofill_text = null): self
    {
        // validation for constraint: string
        if (!is_null($autofill_text) && !is_string($autofill_text)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($autofill_text, true), gettype($autofill_text)), __LINE__);
        }
        $this->autofill_text = $this->{'autofill-text'} = $autofill_text;
