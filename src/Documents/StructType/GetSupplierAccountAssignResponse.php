...
class GetSupplierAccountAssignResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierAccountAssignForArrayConstraintsFromSetMidocoSupplierAccountAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierAccountAssignResponseMidocoSupplierAccountAssignItem) {
            ...
            if (!$getSupplierAccountAssignResponseMidocoSupplierAccountAssignItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAccountAssign) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierAccountAssign[] $midocoSupplierAccountAssign
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierAccountAssignResponse
     */
