...
class OnlinePaymentInfoType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata|null
     */
    protected ?\Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata $CcOnlinePaymentMetadata = null;
    /**
     * The ccType
     * @var string|null
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata $ccOnlinePaymentMetadata
     * @param string $ccType
     * @param string $ccNo
     * @param string $ccCvc
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata $ccOnlinePaymentMetadata = null, ?string $ccType = null, ?string $ccNo = null, ?string $ccCvc = null, ?string $ccCvcToken = null, ?string $ccExpiry = null, ?string $cardHolder = null, ?string $ccToken = null, ?string $ccTokenType = null, ?bool $isRecurring = null, ?string $ccTokenCreationTimestamp = null, ?string $xid = null, ?string $paymentChannelIndicator = null, ?string $cardholderAuthVerification = null, ?string $electronicCommerceIndicator = null, ?float $authAmount = null, ?float $remainingAuthAmount = null, ?string $v3ds = null, ?string $dstid = null, ?string $initialEcomTransactionId = null, ?string $currency = null, ?string $settlementDate = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata|null
     */
    public function getCcOnlinePaymentMetadata(): ?\Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata
    {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata $ccOnlinePaymentMetadata
     * @return \Pggns\MidocoApi\Documents\StructType\OnlinePaymentInfoType
     */
    public function setCcOnlinePaymentMetadata(?\Pggns\MidocoApi\Documents\StructType\CcOnlinePaymentMetadata $ccOnlinePaymentMetadata = null): self
    {
