...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Documents\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Documents\StructType\GetWSGroupsResponse
     */
