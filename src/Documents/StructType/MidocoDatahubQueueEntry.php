...
class MidocoDatahubQueueEntry extends DatahubQueueDTO
{
     ...
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference[] $midocoDatahubQueueBookingReference
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference[]
     */
    ...
    public static function validateMidocoDatahubQueueBookingReferenceForArrayConstraintsFromSetMidocoDatahubQueueBookingReference(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDatahubQueueEntryMidocoDatahubQueueBookingReferenceItem) {
            ...
            if (!$midocoDatahubQueueEntryMidocoDatahubQueueBookingReferenceItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDatahubQueueBookingReference property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference[] $midocoDatahubQueueBookingReference
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueEntry
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueEntry
     */
    public function addToMidocoDatahubQueueBookingReference(\Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference) {
            throw new InvalidArgumentException(sprintf('The MidocoDatahubQueueBookingReference property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoDatahubQueueBookingReference, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
