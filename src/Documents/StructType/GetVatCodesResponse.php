...
class GetVatCodesResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoVatCode
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode[]
     */
    ...
    public static function validateMidocoVatCodeForArrayConstraintsFromSetMidocoVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $getVatCodesResponseMidocoVatCodeItem) {
            ...
            if (!$getVatCodesResponseMidocoVatCodeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVatCode property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode[] $midocoVatCode
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetVatCodesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetVatCodesResponse
     */
    public function addToMidocoVatCode(\Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode) {
            throw new InvalidArgumentException(sprintf('The MidocoVatCode property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatCode, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
