...
class GetOrdCriteriaTypeCategoryDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeCategoryDescriptionForArrayConstraintsFromSetMidocoOrdCriteriaTypeCategoryDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdCriteriaTypeCategoryDescriptionsResponseMidocoOrdCriteriaTypeCategoryDescriptionItem) {
            ...
            if (!$getOrdCriteriaTypeCategoryDescriptionsResponseMidocoOrdCriteriaTypeCategoryDescriptionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaTypeCategoryDescription property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO[] $midocoOrdCriteriaTypeCategoryDescription
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrdCriteriaTypeCategoryDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrdCriteriaTypeCategoryDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaTypeCategoryDescription(\Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaTypeCategoryDescription property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\OrdCritTypeCatDescrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
