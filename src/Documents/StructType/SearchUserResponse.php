...
class SearchUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $searchUserResponseMidocoUserItem) {
            ...
            if (!$searchUserResponseMidocoUserItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SearchUserResponse
     */
