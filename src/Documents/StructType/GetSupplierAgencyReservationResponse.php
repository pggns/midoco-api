...
class GetSupplierAgencyReservationResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation[]
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation[]
     */
    ...
    public static function validateMidocoSupplierAgencyReservationForArrayConstraintsFromSetMidocoSupplierAgencyReservation(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierAgencyReservationResponseMidocoSupplierAgencyReservationItem) {
            ...
            if (!$getSupplierAgencyReservationResponseMidocoSupplierAgencyReservationItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierAgencyReservation property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation[] $midocoSupplierAgencyReservation
     * @return \Pggns\MidocoApi\Documents\StructType\GetSupplierAgencyReservationResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation $item
     * @return \Pggns\MidocoApi\Documents\StructType\GetSupplierAgencyReservationResponse
     */
    public function addToMidocoSupplierAgencyReservation(\Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierAgencyReservation property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoSupplierAgencyReservation, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
