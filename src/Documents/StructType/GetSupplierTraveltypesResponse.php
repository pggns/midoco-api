...
class GetSupplierTraveltypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO[]
     */
    ...
    public static function validateMidocoSupplierTraveltypeForArrayConstraintsFromSetMidocoSupplierTraveltype(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierTraveltypesResponseMidocoSupplierTraveltypeItem) {
            ...
            if (!$getSupplierTraveltypesResponseMidocoSupplierTraveltypeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierTraveltype property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO[] $midocoSupplierTraveltype
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierTraveltypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierTraveltypesResponse
     */
    public function addToMidocoSupplierTraveltype(\Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierTraveltype property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SupplierTraveltypeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
