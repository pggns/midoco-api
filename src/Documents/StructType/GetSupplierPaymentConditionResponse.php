...
class GetSupplierPaymentConditionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierPaymentConditionForArrayConstraintsFromSetMidocoSupplierPaymentCondition(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierPaymentConditionResponseMidocoSupplierPaymentConditionItem) {
            ...
            if (!$getSupplierPaymentConditionResponseMidocoSupplierPaymentConditionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierPaymentCondition) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSupplierPaymentCondition[] $midocoSupplierPaymentCondition
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetSupplierPaymentConditionResponse
     */
