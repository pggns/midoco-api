...
class GetOrgUnitsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitForArrayConstraintsFromSetMidocoOrgunit(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgUnitsForUserResponseMidocoOrgunitItem) {
            ...
            if (!$getOrgUnitsForUserResponseMidocoOrgunitItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\OrgunitDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\OrgunitDTO[] $midocoOrgunit
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrgUnitsForUserResponse
     */
