...
class GetOrgUnitsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitForArrayConstraintFromSetMidocoOrgunit(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgUnitsForUserResponseMidocoOrgunitItem) {
            ...
            if (!$getOrgUnitsForUserResponseMidocoOrgunitItem instanceof \Pggns\MidocoApi\Documents\StructType\OrgunitDTO) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\OrgunitDTO[] $midocoOrgunit
     * @return \Pggns\MidocoApi\Documents\StructType\GetOrgUnitsForUserResponse
     */
