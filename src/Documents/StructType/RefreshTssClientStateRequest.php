...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Documents\StructType\RefreshTssClientStateRequest
     */
