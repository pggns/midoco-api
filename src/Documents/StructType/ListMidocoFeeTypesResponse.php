...
class ListMidocoFeeTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFeeTypeForArrayConstraintsFromSetMidocoFeeType(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoFeeTypesResponseMidocoFeeTypeItem) {
            ...
            if (!$listMidocoFeeTypesResponseMidocoFeeTypeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoFeeType[] $midocoFeeType
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListMidocoFeeTypesResponse
     */
