...
/**
 * This class stands for MidocoAccount StructType
 * @subpackage Structs
 */
class MidocoAccount extends AccountDTO
{
    /**
     * The isInheritance
     * @var bool|null
    ...
    /**
     * Constructor method for MidocoAccount
     * @uses MidocoAccount::setIsInheritance()
     * @uses MidocoAccount::setOrgunit()
