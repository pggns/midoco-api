...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Documents\StructType\AvailableAdaptersResponse
     */
