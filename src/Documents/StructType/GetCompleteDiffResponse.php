...
/**
 * This class stands for GetCompleteDiffResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetCompleteDiffResponse extends AbstractStructBase
{
    /**
     * The diff
     * @var string|null
    ...
    /**
     * Constructor method for GetCompleteDiffResponse
     * @uses GetCompleteDiffResponse::setDiff()
     * @param string $diff
     */
     ...
     * Set diff value
     * @param string $diff
     * @return \Pggns\MidocoApi\Documents\StructType\GetCompleteDiffResponse
     */
