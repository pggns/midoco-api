...
class GetConsentResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoConsentForArrayConstraintFromSetMidocoConsent(?array $values = []): string
    {
        ...
        foreach ($values as $getConsentResponseMidocoConsentItem) {
            ...
            if (!$getConsentResponseMidocoConsentItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoConsent) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoConsent[] $midocoConsent
     * @return \Pggns\MidocoApi\Documents\StructType\GetConsentResponse
     */
