...
class GetCheckDtdAnswerResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCheckDtdAnswerForArrayConstraintsFromSetMidocoCheckDtdAnswer(?array $values = []): string
    {
        ...
        foreach ($values as $getCheckDtdAnswerResponseMidocoCheckDtdAnswerItem) {
            ...
            if (!$getCheckDtdAnswerResponseMidocoCheckDtdAnswerItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer[] $midocoCheckDtdAnswer
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetCheckDtdAnswerResponse
     */
