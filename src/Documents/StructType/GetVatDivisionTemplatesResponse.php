...
class GetVatDivisionTemplatesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate[]
     */
    ...
    public static function validateMidocoVatDivisionTemplateForArrayConstraintsFromSetMidocoVatDivisionTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem) {
            ...
            if (!$getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVatDivisionTemplate property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate[] $midocoVatDivisionTemplate
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetVatDivisionTemplatesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetVatDivisionTemplatesResponse
     */
    public function addToMidocoVatDivisionTemplate(\Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate) {
            throw new InvalidArgumentException(sprintf('The MidocoVatDivisionTemplate property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoVatDivisionTemplate, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
