...
class ListSettlementChargesForOrgUnitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO[]
     */
    ...
    public static function validateMidocoSettlementChargeForArrayConstraintsFromSetMidocoSettlementCharge(?array $values = []): string
    {
        ...
        foreach ($values as $listSettlementChargesForOrgUnitResponseMidocoSettlementChargeItem) {
            ...
            if (!$listSettlementChargesForOrgUnitResponseMidocoSettlementChargeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSettlementCharge property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO[] $midocoSettlementCharge
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListSettlementChargesForOrgUnitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListSettlementChargesForOrgUnitResponse
     */
    public function addToMidocoSettlementCharge(\Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSettlementCharge property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
