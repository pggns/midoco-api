...
class ListSignatureDocsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSignatureDocForArrayConstraintsFromSetMidocoSignatureDoc(?array $values = []): string
    {
        ...
        foreach ($values as $listSignatureDocsResponseMidocoSignatureDocItem) {
            ...
            if (!$listSignatureDocsResponseMidocoSignatureDocItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSignatureDoc) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSignatureDoc[] $midocoSignatureDoc
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListSignatureDocsResponse
     */
