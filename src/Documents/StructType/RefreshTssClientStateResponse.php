...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Documents\StructType\RefreshTssClientStateResponse
     */
