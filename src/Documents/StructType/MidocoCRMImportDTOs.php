...
class MidocoCRMImportDTOs extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer[] $midocoImportCustomer
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard[] $midocoImportCCard
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute[] $midocoImportAttribute
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice[] $midocoImportNotice
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor[] $midocoImportDebitor
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory[] $midocoImportHistory
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory[] $midocoImportContactHistory
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress[] $midocoImportAddress
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType[] $midocoImportContactType
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo[] $midocoImportAgencyInfo
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer[]
     */
    ...
    public static function validateMidocoImportCustomerForArrayConstraintFromSetMidocoImportCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportCustomerItem) {
            ...
            if (!$midocoCRMImportDTOsMidocoImportCustomerItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportCustomer property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer[] $midocoImportCustomer
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportCustomer(\Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoImportCustomer property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard[]
     */
    ...
    public static function validateMidocoImportCCardForArrayConstraintFromSetMidocoImportCCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportCCardItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportCCardItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportCCard property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportCCard(\Pggns\MidocoApi\Documents\StructType\MidocoImportCCard $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard) {
            throw new InvalidArgumentException(sprintf('The MidocoImportCCard property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportCCard, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute[]
     */
    ...
    public static function validateMidocoImportAttributeForArrayConstraintFromSetMidocoImportAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAttributeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAttributeItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAttribute property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAttribute(\Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAttribute property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice[]
     */
    ...
    public static function validateMidocoImportNoticeForArrayConstraintFromSetMidocoImportNotice(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportNoticeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportNoticeItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportNotice property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportNotice(\Pggns\MidocoApi\Documents\StructType\MidocoImportNotice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice) {
            throw new InvalidArgumentException(sprintf('The MidocoImportNotice property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportNotice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor[]
     */
    ...
    public static function validateMidocoImportDebitorForArrayConstraintFromSetMidocoImportDebitor(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportDebitorItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportDebitorItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportDebitor property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportDebitor(\Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor) {
            throw new InvalidArgumentException(sprintf('The MidocoImportDebitor property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportDebitor, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory[]
     */
    ...
    public static function validateMidocoImportHistoryForArrayConstraintFromSetMidocoImportHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportHistoryItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportHistory property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportHistory(\Pggns\MidocoApi\Documents\StructType\MidocoImportHistory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory) {
            throw new InvalidArgumentException(sprintf('The MidocoImportHistory property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportHistory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory[]
     */
    ...
    public static function validateMidocoImportContactHistoryForArrayConstraintFromSetMidocoImportContactHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportContactHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportContactHistoryItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportContactHistory property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportContactHistory(\Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory) {
            throw new InvalidArgumentException(sprintf('The MidocoImportContactHistory property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportContactHistory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoImportAddressForArrayConstraintFromSetMidocoImportAddress(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAddressItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAddressItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAddress property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAddress(\Pggns\MidocoApi\Documents\StructType\MidocoImportAddress $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAddress property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAddress, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoImportContactTypeForArrayConstraintFromSetMidocoImportContactType(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportContactTypeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportContactTypeItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportContactType property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportContactType(\Pggns\MidocoApi\Documents\StructType\MidocoImportContactType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType) {
            throw new InvalidArgumentException(sprintf('The MidocoImportContactType property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportContactType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoImportAgencyInfoForArrayConstraintFromSetMidocoImportAgencyInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAgencyInfoItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAgencyInfoItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAgencyInfo property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAgencyInfo(\Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAgencyInfo property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoImportAgencyInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
