...
class MidocoVisibleClass extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute[]
     */
    ...
    public static function validateMidocoPropertyAttributeForArrayConstraintsFromSetMidocoPropertyAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVisibleClassMidocoPropertyAttributeItem) {
            ...
            if (!$midocoVisibleClassMidocoPropertyAttributeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoVisibleClass
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoVisibleClass
     */
    public function addToMidocoPropertyAttribute(\Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoPropertyAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
