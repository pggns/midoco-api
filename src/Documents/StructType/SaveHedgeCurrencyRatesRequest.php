...
class SaveHedgeCurrencyRatesRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO[] $midocoCurrencyRateHedge
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO[]
     */
    ...
    public static function validateMidocoCurrencyRateHedgeForArrayConstraintsFromSetMidocoCurrencyRateHedge(?array $values = []): string
    {
        ...
        foreach ($values as $saveHedgeCurrencyRatesRequestMidocoCurrencyRateHedgeItem) {
            ...
            if (!$saveHedgeCurrencyRatesRequestMidocoCurrencyRateHedgeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCurrencyRateHedge property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO[] $midocoCurrencyRateHedge
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SaveHedgeCurrencyRatesRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SaveHedgeCurrencyRatesRequest
     */
    public function addToMidocoCurrencyRateHedge(\Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCurrencyRateHedge property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CurrencyRateHedgeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
