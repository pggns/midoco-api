...
/**
 * This class stands for TransformDiffRequest StructType
 * @subpackage Structs
 */
class TransformDiffRequest extends AbstractStructBase
{
    /**
     * The diff
     * @var string|null
    ...
    /**
     * Constructor method for TransformDiffRequest
     * @uses TransformDiffRequest::setDiff()
     * @param string $diff
     */
     ...
     * Set diff value
     * @param string $diff
     * @return \Pggns\MidocoApi\Api\Documents\StructType\TransformDiffRequest
     */
