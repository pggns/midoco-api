...
/**
 * This class stands for GetExternDocumentDescRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetExternDocumentDescRequest extends AbstractStructBase
{
    /**
     * The id
     * @var int|null
    ...
    /**
     * Constructor method for GetExternDocumentDescRequest
     * @uses GetExternDocumentDescRequest::setId()
     * @uses GetExternDocumentDescRequest::setPreferredAdapter()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Pggns\MidocoApi\Documents\StructType\GetExternDocumentDescRequest
     */
