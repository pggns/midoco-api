...
class DeleteExternDocumentRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for DeleteExternDocumentRequest
     * @uses DeleteExternDocumentRequest::setId()
     * @uses DeleteExternDocumentRequest::setPreferredAdapter()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Pggns\MidocoApi\Documents\StructType\DeleteExternDocumentRequest
     */
