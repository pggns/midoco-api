...
class MidocoSellItemType extends SellItemDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem $MidocoDocumentItem = null;
    /**
     * The MidocoTravelItem
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoTravelItem
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType $MidocoTravelItem = null;
    /**
     * The MidocoManualItem
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoManualItem
     * @var \Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO $MidocoManualItem = null;
    /**
     * The MidocoCalcItem
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoCalcItem
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO $MidocoCalcItem = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing $MidocoSellItemPricing = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO $MidocoSellItemItem = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO $MidocoSellItemEinvoice = null;
    /**
     * The unitAlias
     * @var string|null
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType[] $midocoPriceDetail
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark[] $midocoSellRemark
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem $midocoDocumentItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType $midocoTravelItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO $midocoManualItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO $midocoCalcItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\PackageitemDTO $midocoPackageInfo
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing $midocoSellItemPricing
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO[] $midocoSellItemError
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType[] $midocoSellItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType[] $revenueBookingInfo
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO[] $midocoSellItemAttribute
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO $midocoSellItemItem
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO[] $midocoSellItemSaving
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO $midocoSellItemEinvoice
     ...
     */
    public function __construct(?array $midocoPriceDetail = null, ?array $midocoOnlinePaymentTransaction = null, ?array $midocoSellPassenger = null, ?array $midocoSellRemark = null, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem $midocoDocumentItem = null, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType $midocoTravelItem = null, ?\Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO $midocoManualItem = null, ?\Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO $midocoCalcItem = null, ?\Pggns\MidocoApi\Api\Documents\StructType\PackageitemDTO $midocoPackageInfo = null, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing $midocoSellItemPricing = null, ?array $midocoSellItemError = null, ?array $midocoSellItem = null, ?array $revenueBookingInfo = null, ?array $midocoSellItemAttribute = null, ?array $midocoSellItemVatDivision = null, ?array $midocoSellDetailsPrice = null, ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO $midocoSellItemItem = null, ?array $midocoSellItemSaving = null, ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO $midocoSellItemEinvoice = null, ?string $unitAlias = null, ?bool $isPackageChild = null, ?int $billingStatus = null, ?bool $is_deletable = null, ?float $displayedItemPrice = null, ?string $displayedCurrency = null)
    {
        $this
    ...
    public static function validateMidocoPriceDetailForArrayConstraintsFromSetMidocoPriceDetail(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoPriceDetailItem) {
            ...
            if (!$midocoSellItemTypeMidocoPriceDetailItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPriceDetail property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoPriceDetail(\Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType) {
            throw new InvalidArgumentException(sprintf('The MidocoPriceDetail property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoPriceDetailType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction[]
     */
    ...
    public static function validateMidocoOnlinePaymentTransactionForArrayConstraintsFromSetMidocoOnlinePaymentTransaction(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoOnlinePaymentTransactionItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoOnlinePaymentTransactionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOnlinePaymentTransaction property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoOnlinePaymentTransaction(\Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction) {
            throw new InvalidArgumentException(sprintf('The MidocoOnlinePaymentTransaction property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOnlinePaymentTransaction, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellPassengerItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellPassenger) {
    ...
    public static function validateMidocoSellRemarkForArrayConstraintsFromSetMidocoSellRemark(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellRemarkItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellRemarkItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellRemark property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoSellRemark(\Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark) {
            throw new InvalidArgumentException(sprintf('The MidocoSellRemark property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellRemark, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem|null
     */
    public function getMidocoDocumentItem(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoDocumentItem(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoDocumentItem $midocoDocumentItem = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType|null
     */
    public function getMidocoTravelItem(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoTravelItem(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoTravelItemType $midocoTravelItem = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO|null
     */
    public function getMidocoManualItem(): ?\Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoManualItem(?\Pggns\MidocoApi\Api\Documents\StructType\ManualitemDTO $midocoManualItem = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO|null
     */
    public function getMidocoCalcItem(): ?\Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoCalcItem(?\Pggns\MidocoApi\Api\Documents\StructType\CalcitemDTO $midocoCalcItem = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing|null
     */
    public function getMidocoSellItemPricing(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoSellItemPricing(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemPricing $midocoSellItemPricing = null): self
    {
    ...
    public static function validateMidocoSellItemErrorForArrayConstraintsFromSetMidocoSellItemError(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellItemErrorItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellItemErrorItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellItemError property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoSellItemError(\Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSellItemError property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemErrorDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellItemForArrayConstraintsFromSetMidocoSellItem(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellItemItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellItemItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType) {
    ...
    public static function validateRevenueBookingInfoForArrayConstraintsFromSetRevenueBookingInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeRevenueBookingInfoItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeRevenueBookingInfoItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The RevenueBookingInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToRevenueBookingInfo(\Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType) {
            throw new InvalidArgumentException(sprintf('The RevenueBookingInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\RevenueBookingInfoType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO[]
     */
    ...
    public static function validateMidocoSellItemAttributeForArrayConstraintsFromSetMidocoSellItemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellItemAttributeItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellItemAttributeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoSellItemAttribute(\Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemAttributeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellItemVatDivisionForArrayConstraintsFromSetMidocoSellItemVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellItemVatDivisionItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellItemVatDivisionItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemVatDivision) {
    ...
    public static function validateMidocoSellDetailsPriceForArrayConstraintsFromSetMidocoSellDetailsPrice(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellDetailsPriceItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellDetailsPriceItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellDetailsPrice) {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO|null
     */
    public function getMidocoSellItemItem(): ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoSellItemItem(?\Pggns\MidocoApi\Api\Documents\StructType\SellItemItemDTO $midocoSellItemItem = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO[]
     */
    ...
    public static function validateMidocoSellItemSavingForArrayConstraintsFromSetMidocoSellItemSaving(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemTypeMidocoSellItemSavingItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemTypeMidocoSellItemSavingItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellItemSaving property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function addToMidocoSellItemSaving(\Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSellItemSaving property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellItemSavingDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO|null
     */
    public function getMidocoSellItemEinvoice(): ?\Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellItemType
     */
    public function setMidocoSellItemEinvoice(?\Pggns\MidocoApi\Api\Documents\StructType\SellItemEinvoiceDTO $midocoSellItemEinvoice = null): self
    {
