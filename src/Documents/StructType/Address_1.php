...
class Address_1 extends AbstractStructBase
{
    /**
     * The customerName
     * @var string|null
     ...
     * @uses Address_1::setCustomerName()
     * @uses Address_1::setPostOfficeBox()
     * @uses Address_1::setPostalCode()
     * @uses Address_1::setCity()
     * @uses Address_1::setCountryCode()
     * @uses Address_1::setStreet()
     * @uses Address_1::setStreetNumber()
     * @uses Address_1::setEmail()
     ...
     * @param string $customerName
     * @return \Pggns\MidocoApi\Documents\StructType\Address_1
     */
