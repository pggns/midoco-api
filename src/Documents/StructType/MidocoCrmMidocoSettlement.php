...
class MidocoCrmMidocoSettlement extends CrmMidocoSettlementDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO[] $midocoCrmMidocoSettlLevel
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO[] $midocoCrmMidocoSettlFee
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO[] $midocoAssignedMidocoSettlOUnit
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlLevelForArrayConstraintsFromSetMidocoCrmMidocoSettlLevel(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoCrmMidocoSettlLevelItem) {
            ...
            if (!$midocoCrmMidocoSettlementMidocoCrmMidocoSettlLevelItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlLevel property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO[] $midocoCrmMidocoSettlLevel
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCrmMidocoSettlement
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoCrmMidocoSettlLevel(\Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlLevel property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlLevelDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlFeeForArrayConstraintsFromSetMidocoCrmMidocoSettlFee(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoCrmMidocoSettlFeeItem) {
            // validation for constraint: itemType
            if (!$midocoCrmMidocoSettlementMidocoCrmMidocoSettlFeeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlFee property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoCrmMidocoSettlFee(\Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlFee property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\CrmMidocoSettlFeeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoSettlOUnitForArrayConstraintsFromSetMidocoAssignedMidocoSettlOUnit(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoAssignedMidocoSettlOUnitItem) {
            // validation for constraint: itemType
            if (!$midocoCrmMidocoSettlementMidocoAssignedMidocoSettlOUnitItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoSettlOUnit property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoAssignedMidocoSettlOUnit(\Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoSettlOUnit property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\AssignedMidocoSettlOUnitDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
