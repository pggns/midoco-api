...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoAllJasperReports
     */
