...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintsFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoAllJasperReports
     */
