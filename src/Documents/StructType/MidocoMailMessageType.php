...
class MidocoMailMessageType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType[]
     */
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType[] $midocoMailAttachment
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType[] $midocoMailHeader
     ...
     * @param string[] $to
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoMailMessageType
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType[]
     */
    ...
    public static function validateMidocoMailAttachmentForArrayConstraintFromSetMidocoMailAttachment(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailAttachmentItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailAttachmentItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailAttachment(\Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoMailAttachmentType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType[]
     */
    ...
    public static function validateMidocoMailHeaderForArrayConstraintFromSetMidocoMailHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailHeaderItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailHeaderItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailHeader(\Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoMailHeaderType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
