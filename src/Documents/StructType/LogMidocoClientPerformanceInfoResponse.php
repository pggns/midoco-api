...
class LogMidocoClientPerformanceInfoResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCheckDtdAnswerForArrayConstraintsFromSetMidocoCheckDtdAnswer(?array $values = []): string
    {
        ...
        foreach ($values as $logMidocoClientPerformanceInfoResponseMidocoCheckDtdAnswerItem) {
            ...
            if (!$logMidocoClientPerformanceInfoResponseMidocoCheckDtdAnswerItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCheckDtdAnswer property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer[] $midocoCheckDtdAnswer
     * @return \Pggns\MidocoApi\Api\Documents\StructType\LogMidocoClientPerformanceInfoResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\LogMidocoClientPerformanceInfoResponse
     */
    public function addToMidocoCheckDtdAnswer(\Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer) {
            throw new InvalidArgumentException(sprintf('The MidocoCheckDtdAnswer property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCheckDtdAnswer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
