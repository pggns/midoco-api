...
class ProfileAttributes extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute[] $midocoProfileAttribute
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute[]
     */
    ...
    public static function validateMidocoProfileAttributeForArrayConstraintsFromSetMidocoProfileAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $profileAttributesMidocoProfileAttributeItem) {
            ...
            if (!$profileAttributesMidocoProfileAttributeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProfileAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute[] $midocoProfileAttribute
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ProfileAttributes
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ProfileAttributes
     */
    public function addToMidocoProfileAttribute(\Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoProfileAttribute property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoProfileAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
