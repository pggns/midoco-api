...
class ListSettlementChargesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSettlementChargeForArrayConstraintsFromSetMidocoSettlementCharge(?array $values = []): string
    {
        ...
        foreach ($values as $listSettlementChargesResponseMidocoSettlementChargeItem) {
            ...
            if (!$listSettlementChargesResponseMidocoSettlementChargeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SettlementChargeDTO[] $midocoSettlementCharge
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListSettlementChargesResponse
     */
