...
class ListOrdCriteriaTypeCategoriesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo[] $midocoOrdCriteriaTypeCategoryInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeCategoryInfoForArrayConstraintsFromSetMidocoOrdCriteriaTypeCategoryInfo(?array $values = []): string
    {
        ...
        foreach ($values as $listOrdCriteriaTypeCategoriesResponseMidocoOrdCriteriaTypeCategoryInfoItem) {
            ...
            if (!$listOrdCriteriaTypeCategoriesResponseMidocoOrdCriteriaTypeCategoryInfoItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaTypeCategoryInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo[] $midocoOrdCriteriaTypeCategoryInfo
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListOrdCriteriaTypeCategoriesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\ListOrdCriteriaTypeCategoriesResponse
     */
    public function addToMidocoOrdCriteriaTypeCategoryInfo(\Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaTypeCategoryInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaTypeCategoryInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
