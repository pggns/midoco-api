...
class MidocoSubBookingInfoType extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderCustomer $midocoOrderCustomer = null, ?array $midocoSellPassenger = null, ?int $position = null, ?int $customerId = null, ?string $customerName = null, ?string $customerForename = null, ?bool $isSubItem = null, ?int $positionReference = null, ?string $itemType = null, ?string $subBookingId = null, ?float $subBookingAmount = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderCustomer $midocoOrderCustomer
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoSubBookingInfoType
     */
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSubBookingInfoTypeMidocoSellPassengerItem) {
            ...
            if (!$midocoSubBookingInfoTypeMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoSellPassenger) {
