...
class MidocoCreditCardPosition extends MidocoOnlinePaymentTransactionPosition
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos|null
     */
    protected ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos $MidocoPaymentOrdersInfos = null;
    /**
     * The MidocoCcToken
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[] $midocoCcToken
     * @param string $ccToken
     * @param string $ccTokenType
     * @param bool $isRecurring
     * @param int $preferredReceiptId
     */
    public function __construct(?string $ccType = null, ?string $ccNo = null, ?string $ccCvc = null, ?string $ccValidYear = null, ?string $ccValidMonth = null, ?string $ccOwner = null, ?string $ccAuthCode = null, ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null, ?array $midocoCcToken = null, ?string $ccToken = null, ?string $ccTokenType = null, ?bool $isRecurring = null, ?int $preferredReceiptId = null)
    {
        $this
            ->setCcType($ccType)
            ->setCcNo($ccNo)
     ...
     * Set ccType value
     * @param string $ccType
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCreditCardPosition
     */
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos|null
     */
    public function getMidocoPaymentOrdersInfos(): ?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCreditCardPosition
     */
    public function setMidocoPaymentOrdersInfos(?\Pggns\MidocoApi\Api\Documents\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[]
     */
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCreditCardPositionMidocoCcTokenItem) {
            ...
            if (!$midocoCreditCardPositionMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCcToken property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoCreditCardPosition
     */
    public function addToMidocoCcToken(\Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken) {
            throw new InvalidArgumentException(sprintf('The MidocoCcToken property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
