...
class GetOrdCriteriaTypeDescriptionsRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrdCriteriaTypeForArrayConstraintsFromSetMidocoOrdCriteriaType(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdCriteriaTypeDescriptionsRequestMidocoOrdCriteriaTypeItem) {
            ...
            if (!$getOrdCriteriaTypeDescriptionsRequestMidocoOrdCriteriaTypeItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaType) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrdCriteriaType[] $midocoOrdCriteriaType
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrdCriteriaTypeDescriptionsRequest
     */
