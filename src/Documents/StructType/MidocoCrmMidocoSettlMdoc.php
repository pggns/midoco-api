...
class MidocoCrmMidocoSettlMdoc extends CrmMidocoSettlMdocDTO
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO[] $midocoCrmMidocoSettlMdocLevel
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO[] $midocoAssignedMidocoMdocOUnit
     */
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlMdocLevelForArrayConstraintFromSetMidocoCrmMidocoSettlMdocLevel(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlMdocMidocoCrmMidocoSettlMdocLevelItem) {
            ...
            if (!$midocoCrmMidocoSettlMdocMidocoCrmMidocoSettlMdocLevelItem instanceof \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlMdocLevel property can only contain items of type \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO[] $midocoCrmMidocoSettlMdocLevel
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmMidocoSettlMdoc
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmMidocoSettlMdoc
     */
    public function addToMidocoCrmMidocoSettlMdocLevel(\Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlMdocLevel property can only contain items of type \Pggns\MidocoApi\Documents\StructType\CrmMidocoSettlMdocLevelDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoMdocOUnitForArrayConstraintFromSetMidocoAssignedMidocoMdocOUnit(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlMdocMidocoAssignedMidocoMdocOUnitItem) {
            // validation for constraint: itemType
            if (!$midocoCrmMidocoSettlMdocMidocoAssignedMidocoMdocOUnitItem instanceof \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoMdocOUnit property can only contain items of type \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmMidocoSettlMdoc
     */
    public function addToMidocoAssignedMidocoMdocOUnit(\Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoMdocOUnit property can only contain items of type \Pggns\MidocoApi\Documents\StructType\AssignedMidocoMdocOUnitDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
