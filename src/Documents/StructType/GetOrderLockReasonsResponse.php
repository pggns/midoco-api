...
class GetOrderLockReasonsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO[]
     */
    ...
    public static function validateMidocoOrderLockReasonForArrayConstraintsFromSetMidocoOrderLockReason(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderLockReasonsResponseMidocoOrderLockReasonItem) {
            ...
            if (!$getOrderLockReasonsResponseMidocoOrderLockReasonItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderLockReason property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO[] $midocoOrderLockReason
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrderLockReasonsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetOrderLockReasonsResponse
     */
    public function addToMidocoOrderLockReason(\Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderLockReason property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\OrderLockReasonDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
