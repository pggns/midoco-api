...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Documents\StructType\GetUserWithCrsExpedientResponse
     */
