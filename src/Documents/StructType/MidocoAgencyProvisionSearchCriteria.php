...
class MidocoAgencyProvisionSearchCriteria extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $startDate = null, ?string $endDate = null, ?string $agencyId = null, ?string $cooperationId = null, ?string $receiptDate = null, ?bool $onlyPaid = false, ?int $orderId = null, ?string $domesticInternational = 'ALL', ?string $creationFromDate = null, ?string $creationToDate = null)
    {
        $this
     ...
     * Set startDate value
     * @param string $startDate
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoAgencyProvisionSearchCriteria
     */
