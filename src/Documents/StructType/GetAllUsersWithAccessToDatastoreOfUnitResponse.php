...
class GetAllUsersWithAccessToDatastoreOfUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem) {
            ...
            if (!$getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Documents\StructType\GetAllUsersWithAccessToDatastoreOfUnitResponse
     */
