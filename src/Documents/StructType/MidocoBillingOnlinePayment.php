...
class MidocoBillingOnlinePayment extends BillingOnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoBillingOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoBillingOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoBillingOnlinePayment
     */
