...
class GetAvailableSupplierIdResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierIdResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierIdResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Documents\StructType\GetAvailableSupplierIdResponse
     */
