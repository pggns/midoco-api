...
class CreateCcProxySingleUseTokenRequest extends AbstractStructBase
{
    ...
    /**
     * The emailData
     * @var \Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO|null
     */
    protected ?\Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO $emailData = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO $emailData
     */
    public function __construct(?string $token = null, ?string $tokenValue = null, ?string $sensitiveId = null, ?int $lifespanInSeconds = null, ?int $userId = null, ?string $orgUnit = null, ?\Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO $emailData = null)
    {
        $this
            ->setToken($token)
     ...
     * Set token value
     * @param string $token
     * @return \Pggns\MidocoApi\Documents\StructType\CreateCcProxySingleUseTokenRequest
     */
    ...
    /**
     * Get emailData value
     * @return \Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO|null
     */
    public function getEmailData(): ?\Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO
    {
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\CreateCcProxySingleUseTokenRequest
     */
    public function setEmailData(?\Pggns\MidocoApi\Documents\StructType\CcProxyEmailDataDTO $emailData = null): self
    {
