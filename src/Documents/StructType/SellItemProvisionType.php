...
class SellItemProvisionType extends SellItemProvisionDTO
{
    ...
    public static function validateMidocoRevenueBookingVatDivForArrayConstraintsFromSetMidocoRevenueBookingVatDiv(?array $values = []): string
    {
        ...
        foreach ($values as $sellItemProvisionTypeMidocoRevenueBookingVatDivItem) {
            ...
            if (!$sellItemProvisionTypeMidocoRevenueBookingVatDivItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoRevenueBookingVatDiv) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoRevenueBookingVatDiv[] $midocoRevenueBookingVatDiv
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellItemProvisionType
     */
