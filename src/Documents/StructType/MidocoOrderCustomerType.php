...
class MidocoOrderCustomerType extends OrderCustomerDTO
{
    ...
    public static function validateMidocoCommunicationForArrayConstraintsFromSetMidocoCommunication(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderCustomerTypeMidocoCommunicationItem) {
            ...
            if (!$midocoOrderCustomerTypeMidocoCommunicationItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoCommunication) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoCommunication[] $midocoCommunication
     * @return \Pggns\MidocoApi\Api\Documents\StructType\MidocoOrderCustomerType
     */
