...
class MidocoCrmImportErrors extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors[]
     */
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors[] $midocoCrmDetailErrors
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors[]
     */
    ...
    public static function validateMidocoCrmDetailErrorsForArrayConstraintFromSetMidocoCrmDetailErrors(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportErrorsMidocoCrmDetailErrorsItem) {
            ...
            if (!$midocoCrmImportErrorsMidocoCrmDetailErrorsItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmDetailErrors property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors[] $midocoCrmDetailErrors
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmImportErrors
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors $item
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoCrmImportErrors
     */
    public function addToMidocoCrmDetailErrors(\Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmDetailErrors property can only contain items of type \Pggns\MidocoApi\Documents\StructType\MidocoCrmDetailErrors, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
