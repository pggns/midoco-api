...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Documents\StructType\GetMergedMfResponse
     */
