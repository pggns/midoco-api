...
class GetPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintSelectForArrayConstraintsFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoPrintSelect) {
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\Api\Documents\StructType\GetPrintSelectsResponse
     */
