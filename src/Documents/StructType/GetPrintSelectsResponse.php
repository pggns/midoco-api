...
class GetPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintSelectForArrayConstraintFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoPrintSelect) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\Documents\StructType\GetPrintSelectsResponse
     */
