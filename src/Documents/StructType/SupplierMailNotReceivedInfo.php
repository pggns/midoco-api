...
class SupplierMailNotReceivedInfo extends SupplierMailNotReceivedSellItemInfo
{
     ...
     * @var \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO[] $supplierMailNotReceivedCustomerInfo
     ...
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO[]
     */
    ...
    public static function validateSupplierMailNotReceivedCustomerInfoForArrayConstraintsFromSetSupplierMailNotReceivedCustomerInfo(?array $values = []): string
    {
        ...
        foreach ($values as $supplierMailNotReceivedInfoSupplierMailNotReceivedCustomerInfoItem) {
            ...
            if (!$supplierMailNotReceivedInfoSupplierMailNotReceivedCustomerInfoItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SupplierMailNotReceivedCustomerInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO[] $supplierMailNotReceivedCustomerInfo
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SupplierMailNotReceivedInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO $item
     * @return \Pggns\MidocoApi\Api\Documents\StructType\SupplierMailNotReceivedInfo
     */
    public function addToSupplierMailNotReceivedCustomerInfo(\Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO) {
            throw new InvalidArgumentException(sprintf('The SupplierMailNotReceivedCustomerInfo property can only contain items of type \Pggns\MidocoApi\Api\Documents\StructType\SellPassengerDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoFlightDetailForArrayConstraintsFromSetMidocoFlightDetail(?array $values = []): string
    {
        ...
        foreach ($values as $supplierMailNotReceivedInfoMidocoFlightDetailItem) {
            // validation for constraint: itemType
            if (!$supplierMailNotReceivedInfoMidocoFlightDetailItem instanceof \Pggns\MidocoApi\Api\Documents\StructType\MidocoFlightDetail) {
