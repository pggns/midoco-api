...
/**
 * This class stands for ImportCustomersStatus StructType
 * @subpackage Structs
 */
class ImportCustomersStatus extends AbstractStructBase
{
    /**
     * The countSaved
     * @var int|null
    ...
    /**
     * Constructor method for ImportCustomersStatus
     * @uses ImportCustomersStatus::setCountSaved()
     * @uses ImportCustomersStatus::setCountNotSaved()
     ...
     * @param int $countSaved
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ImportCustomersStatus
     */
