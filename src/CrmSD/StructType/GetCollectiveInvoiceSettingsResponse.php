...
class GetCollectiveInvoiceSettingsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO[] $midocoCollectiveInvoiceSetting
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO[]
     */
    ...
    public static function validateMidocoCollectiveInvoiceSettingForArrayConstraintsFromSetMidocoCollectiveInvoiceSetting(?array $values = []): string
    {
        ...
        foreach ($values as $getCollectiveInvoiceSettingsResponseMidocoCollectiveInvoiceSettingItem) {
            ...
            if (!$getCollectiveInvoiceSettingsResponseMidocoCollectiveInvoiceSettingItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCollectiveInvoiceSetting property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO[] $midocoCollectiveInvoiceSetting
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCollectiveInvoiceSettingsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCollectiveInvoiceSettingsResponse
     */
    public function addToMidocoCollectiveInvoiceSetting(\Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCollectiveInvoiceSetting property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CollectInvSettingDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
