...
class DeleteOrgunitDatastoresRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO[]
     */
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintsFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem) {
            ...
            if (!$deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitDatastore property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DeleteOrgunitDatastoresRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DeleteOrgunitDatastoresRequest
     */
    public function addToMidocoOrgunitDatastore(\Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitDatastore property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\DatastoreAssignDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
