...
class SaveAgencyDetailsResponse extends AbstractStructBase
{
    ...
    /**
     * Constructor method for SaveAgencyDetailsResponse
     * @uses SaveAgencyDetailsResponse::setInternalVersion()
     ...
     * @param int $internalVersion
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveAgencyDetailsResponse
     */
