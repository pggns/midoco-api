...
class GetMfDefResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoMfDef
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef[]
     */
    ...
    public static function validateMidocoMfDefForArrayConstraintsFromSetMidocoMfDef(?array $values = []): string
    {
        ...
        foreach ($values as $getMfDefResponseMidocoMfDefItem) {
            ...
            if (!$getMfDefResponseMidocoMfDefItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMfDef property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef[] $midocoMfDef
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMfDefResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMfDefResponse
     */
    public function addToMidocoMfDef(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef) {
            throw new InvalidArgumentException(sprintf('The MidocoMfDef property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMfDef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
