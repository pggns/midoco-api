...
class MergeCustomersRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO[]
     */
     ...
     * - minOccurs: 0
     * - ref: MidocoDebitorNo
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO[] $midocoDebitorNo
     ...
     * @param int $custIdSave
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MergeCustomersRequest
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO[]
     */
    ...
    public static function validateMidocoCrmAddressIDForArrayConstraintsFromSetMidocoCrmAddressID(?array $values = []): string
    {
        ...
        foreach ($values as $mergeCustomersRequestMidocoCrmAddressIDItem) {
            ...
            if (!$mergeCustomersRequestMidocoCrmAddressIDItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmAddressID property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MergeCustomersRequest
     */
    public function addToMidocoCrmAddressID(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmAddressID property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddressIDDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO[]
     */
    ...
    public static function validateMidocoDebitorNoForArrayConstraintsFromSetMidocoDebitorNo(?array $values = []): string
    {
        ...
        foreach ($values as $mergeCustomersRequestMidocoDebitorNoItem) {
            // validation for constraint: itemType
            if (!$mergeCustomersRequestMidocoDebitorNoItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDebitorNo property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MergeCustomersRequest
     */
    public function addToMidocoDebitorNo(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDebitorNo property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoDebitorNoDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
