...
class GetCommissionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO[] $midocoCommissionExt
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO[]
     */
    ...
    public static function validateMidocoCommissionExtForArrayConstraintsFromSetMidocoCommissionExt(?array $values = []): string
    {
        ...
        foreach ($values as $getCommissionsResponseMidocoCommissionExtItem) {
            ...
            if (!$getCommissionsResponseMidocoCommissionExtItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCommissionExt property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO[] $midocoCommissionExt
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCommissionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCommissionsResponse
     */
    public function addToMidocoCommissionExt(\Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCommissionExt property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CommissionExtDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
