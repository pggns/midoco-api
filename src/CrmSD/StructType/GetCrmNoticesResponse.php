...
class GetCrmNoticesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmNoticeForArrayConstraintsFromSetMidocoCrmNotice(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmNoticesResponseMidocoCrmNoticeItem) {
            ...
            if (!$getCrmNoticesResponseMidocoCrmNoticeItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmNotice) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmNotice[] $midocoCrmNotice
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCrmNoticesResponse
     */
