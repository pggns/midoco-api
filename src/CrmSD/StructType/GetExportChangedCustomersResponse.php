...
class GetExportChangedCustomersResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO[] $midocoExportChangedCustomersLog
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO[]
     */
    ...
    public static function validateMidocoExportChangedCustomersLogForArrayConstraintsFromSetMidocoExportChangedCustomersLog(?array $values = []): string
    {
        ...
        foreach ($values as $getExportChangedCustomersResponseMidocoExportChangedCustomersLogItem) {
            ...
            if (!$getExportChangedCustomersResponseMidocoExportChangedCustomersLogItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoExportChangedCustomersLog property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO[] $midocoExportChangedCustomersLog
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetExportChangedCustomersResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetExportChangedCustomersResponse
     */
    public function addToMidocoExportChangedCustomersLog(\Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoExportChangedCustomersLog property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
