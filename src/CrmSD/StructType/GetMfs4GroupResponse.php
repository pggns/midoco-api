...
class GetMfs4GroupResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfs4GroupResponseMidocoMfItem) {
            ...
            if (!$getMfs4GroupResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMfs4GroupResponse
     */
