...
/**
 * This class stands for ImportContactsStatus StructType
 * @subpackage Structs
 */
class ImportContactsStatus extends AbstractStructBase
{
    /**
     * The countSaved
     * @var int|null
    ...
    /**
     * Constructor method for ImportContactsStatus
     * @uses ImportContactsStatus::setCountSaved()
     * @uses ImportContactsStatus::setCountNotSaved()
     ...
     * @param int $countSaved
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ImportContactsStatus
     */
