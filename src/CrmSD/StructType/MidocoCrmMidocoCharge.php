...
class MidocoCrmMidocoCharge extends CrmMidocoChargeDTO
{
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintsFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AssignedMidocoChargeOuDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmMidocoCharge
     */
