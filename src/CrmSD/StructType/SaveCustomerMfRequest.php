...
class SaveCustomerMfRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerMfForArrayConstraintsFromSetMidocoCustomerMf(?array $values = []): string
    {
        ...
        foreach ($values as $saveCustomerMfRequestMidocoCustomerMfItem) {
            ...
            if (!$saveCustomerMfRequestMidocoCustomerMfItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMfDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMfDTO[] $midocoCustomerMf
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveCustomerMfRequest
     */
