...
class GetAgencyExternalSystemAttributesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoExternalSystemAttributeForArrayConstraintsFromSetMidocoExternalSystemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getAgencyExternalSystemAttributesResponseMidocoExternalSystemAttributeItem) {
            ...
            if (!$getAgencyExternalSystemAttributesResponseMidocoExternalSystemAttributeItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\SystemAttributeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\SystemAttributeDTO[] $midocoExternalSystemAttribute
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetAgencyExternalSystemAttributesResponse
     */
