...
class GetAgencyNumbersResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO[]
     */
    ...
    public static function validateMidocoAgencyNumberForArrayConstraintsFromSetMidocoAgencyNumber(?array $values = []): string
    {
        ...
        foreach ($values as $getAgencyNumbersResponseMidocoAgencyNumberItem) {
            ...
            if (!$getAgencyNumbersResponseMidocoAgencyNumberItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAgencyNumber property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO[] $midocoAgencyNumber
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetAgencyNumbersResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetAgencyNumbersResponse
     */
    public function addToMidocoAgencyNumber(\Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAgencyNumber property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyNumberDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
