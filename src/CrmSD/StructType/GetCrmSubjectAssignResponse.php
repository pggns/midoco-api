...
class GetCrmSubjectAssignResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmSubjectAssignForArrayConstraintsFromSetMidocoCrmSubjectAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmSubjectAssignResponseMidocoCrmSubjectAssignItem) {
            ...
            if (!$getCrmSubjectAssignResponseMidocoCrmSubjectAssignItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign[] $midocoCrmSubjectAssign
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCrmSubjectAssignResponse
     */
