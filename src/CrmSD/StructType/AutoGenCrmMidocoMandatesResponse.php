...
class AutoGenCrmMidocoMandatesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm[] $midocoMandateGenErrorCrm
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm[]
     */
    ...
    public static function validateMidocoMandateGenErrorCrmForArrayConstraintsFromSetMidocoMandateGenErrorCrm(?array $values = []): string
    {
        ...
        foreach ($values as $autoGenCrmMidocoMandatesResponseMidocoMandateGenErrorCrmItem) {
            ...
            if (!$autoGenCrmMidocoMandatesResponseMidocoMandateGenErrorCrmItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMandateGenErrorCrm property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm[] $midocoMandateGenErrorCrm
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\AutoGenCrmMidocoMandatesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\AutoGenCrmMidocoMandatesResponse
     */
    public function addToMidocoMandateGenErrorCrm(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm) {
            throw new InvalidArgumentException(sprintf('The MidocoMandateGenErrorCrm property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandateGenErrorCrm, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
