...
/**
 * This class stands for GetCrmMidocoSettlFeeRequest StructType
 * @subpackage Structs
 */
class GetCrmMidocoSettlFeeRequest extends AbstractStructBase
{
    /**
     * The feeId
     * @var int|null
    ...
    /**
     * Constructor method for GetCrmMidocoSettlFeeRequest
     * @uses GetCrmMidocoSettlFeeRequest::setFeeId()
     * @param int $feeId
     */
     ...
     * Set feeId value
     * @param int $feeId
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCrmMidocoSettlFeeRequest
     */
