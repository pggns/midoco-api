...
class ListAddressTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAddressTypeDescriptionForArrayConstraintsFromSetMidocoAddressTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $listAddressTypesResponseMidocoAddressTypeDescriptionItem) {
            ...
            if (!$listAddressTypesResponseMidocoAddressTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AddressTypeDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AddressTypeDescriptionDTO[] $midocoAddressTypeDescription
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ListAddressTypesResponse
     */
