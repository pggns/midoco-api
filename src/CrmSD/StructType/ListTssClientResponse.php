...
class ListTssClientResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintsFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $listTssClientResponseMidocoTssClientItem) {
            ...
            if (!$listTssClientResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ListTssClientResponse
     */
