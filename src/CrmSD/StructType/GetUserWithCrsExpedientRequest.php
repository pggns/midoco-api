...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetUserWithCrsExpedientRequest
     */
