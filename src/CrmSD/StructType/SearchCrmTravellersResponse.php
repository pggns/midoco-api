...
class SearchCrmTravellersResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller[]
     */
    ...
    public static function validateMidocoCrmTravellerForArrayConstraintsFromSetMidocoCrmTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $searchCrmTravellersResponseMidocoCrmTravellerItem) {
            ...
            if (!$searchCrmTravellersResponseMidocoCrmTravellerItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmTraveller property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller[] $midocoCrmTraveller
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SearchCrmTravellersResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SearchCrmTravellersResponse
     */
    public function addToMidocoCrmTraveller(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmTraveller property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
