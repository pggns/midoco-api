...
class GetModifiedCustomersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(?array $values = []): string
    {
        ...
        foreach ($values as $getModifiedCustomersResponseMidocoCustomerIdItem) {
            ...
            if (!$getModifiedCustomersResponseMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerIdDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetModifiedCustomersResponse
     */
