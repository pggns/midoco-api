...
class FindCustomerOrDebitorResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerSearchForArrayConstraintsFromSetMidocoCustomerSearch(?array $values = []): string
    {
        ...
        foreach ($values as $findCustomerOrDebitorResponseMidocoCustomerSearchItem) {
            ...
            if (!$findCustomerOrDebitorResponseMidocoCustomerSearchItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerSearch) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerSearch[] $midocoCustomerSearch
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\FindCustomerOrDebitorResponse
     */
