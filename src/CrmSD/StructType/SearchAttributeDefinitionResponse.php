...
class SearchAttributeDefinitionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeDefinitionForArrayConstraintsFromSetMidocoAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $searchAttributeDefinitionResponseMidocoAttributeDefinitionItem) {
            ...
            if (!$searchAttributeDefinitionResponseMidocoAttributeDefinitionItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AttributeDefinitionType) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AttributeDefinitionType[] $midocoAttributeDefinition
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SearchAttributeDefinitionResponse
     */
