...
class GetMidocoAgencyResponse extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMidocoAgencyResponse
     */
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoAgencyResponseMidocoCrmDebitCardItem) {
            ...
            if (!$getMidocoAgencyResponseMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmDebitCard) {
