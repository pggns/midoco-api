...
class GetMidocoChargesListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType[]
     */
    ...
    public static function validateMidocoCrmMidocoChargeInfoForArrayConstraintsFromSetMidocoCrmMidocoChargeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoChargesListResponseMidocoCrmMidocoChargeInfoItem) {
            ...
            if (!$getMidocoChargesListResponseMidocoCrmMidocoChargeInfoItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoChargeInfo property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType[] $midocoCrmMidocoChargeInfo
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMidocoChargesListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMidocoChargesListResponse
     */
    public function addToMidocoCrmMidocoChargeInfo(\Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoChargeInfo property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
