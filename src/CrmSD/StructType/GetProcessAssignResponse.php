...
class GetProcessAssignResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO[] $midocoProcessAssign
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO[]
     */
    ...
    public static function validateMidocoProcessAssignForArrayConstraintsFromSetMidocoProcessAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getProcessAssignResponseMidocoProcessAssignItem) {
            ...
            if (!$getProcessAssignResponseMidocoProcessAssignItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProcessAssign property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO[] $midocoProcessAssign
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetProcessAssignResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetProcessAssignResponse
     */
    public function addToMidocoProcessAssign(\Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoProcessAssign property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\ProcessAssignDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
