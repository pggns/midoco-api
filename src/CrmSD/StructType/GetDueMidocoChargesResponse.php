...
class GetDueMidocoChargesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmMidocoChargeInfoForArrayConstraintsFromSetMidocoCrmMidocoChargeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getDueMidocoChargesResponseMidocoCrmMidocoChargeInfoItem) {
            ...
            if (!$getDueMidocoChargesResponseMidocoCrmMidocoChargeInfoItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmMidocoChargeInfoType[] $midocoCrmMidocoChargeInfo
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetDueMidocoChargesResponse
     */
