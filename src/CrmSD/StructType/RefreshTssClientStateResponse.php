...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Crmsd\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Crmsd\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Crmsd\StructType\RefreshTssClientStateResponse
     */
