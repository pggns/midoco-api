...
class GetDebitCardsResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoCrmPerson
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO $MidocoCrmPerson = null;
    /**
     ...
     */
    public function __construct(?array $midocoCrmDebitCard = null, ?array $midocoCrmAddress = null, ?\Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO $midocoCrmCompany = null, ?\Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO $midocoCrmPerson = null, ?array $midocoContactEntry = null, ?\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMandate $midocoMandate = null, ?string $salutationId = null)
    {
        $this
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $getDebitCardsResponseMidocoCrmDebitCardItem) {
            ...
            if (!$getDebitCardsResponseMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmDebitCard) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmDebitCard[] $midocoCrmDebitCard
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetDebitCardsResponse
     */
    ...
    public static function validateMidocoCrmAddressForArrayConstraintsFromSetMidocoCrmAddress(?array $values = []): string
    {
        ...
        foreach ($values as $getDebitCardsResponseMidocoCrmAddressItem) {
            // validation for constraint: itemType
            if (!$getDebitCardsResponseMidocoCrmAddressItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddress) {
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO|null
     */
    public function getMidocoCrmPerson(): ?\Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetDebitCardsResponse
     */
    public function setMidocoCrmPerson(?\Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO $midocoCrmPerson = null): self
    {
    ...
    public static function validateMidocoContactEntryForArrayConstraintsFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $getDebitCardsResponseMidocoContactEntryItem) {
            // validation for constraint: itemType
            if (!$getDebitCardsResponseMidocoContactEntryItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoContactEntryType) {
