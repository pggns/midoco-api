...
class GetOrderTasksResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoOrderTask
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask[]
     */
    ...
    public static function validateMidocoOrderTaskForArrayConstraintsFromSetMidocoOrderTask(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderTasksResponseMidocoOrderTaskItem) {
            ...
            if (!$getOrderTasksResponseMidocoOrderTaskItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderTask property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask[] $midocoOrderTask
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetOrderTasksResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetOrderTasksResponse
     */
    public function addToMidocoOrderTask(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderTask property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoOrderTask, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
