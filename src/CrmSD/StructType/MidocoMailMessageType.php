...
class MidocoMailMessageType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType[] $midocoMailAttachment
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType[] $midocoMailHeader
     ...
     * @param string[] $to
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailMessageType
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType[]
     */
    ...
    public static function validateMidocoMailAttachmentForArrayConstraintsFromSetMidocoMailAttachment(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailAttachmentItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailAttachmentItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailAttachment(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailAttachmentType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType[]
     */
    ...
    public static function validateMidocoMailHeaderForArrayConstraintsFromSetMidocoMailHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailHeaderItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailHeaderItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailHeader(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoMailHeaderType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
