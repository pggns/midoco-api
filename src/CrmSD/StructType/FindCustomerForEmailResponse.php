...
class FindCustomerForEmailResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerInfoForArrayConstraintsFromSetMidocoCustomerInfo(?array $values = []): string
    {
        ...
        foreach ($values as $findCustomerForEmailResponseMidocoCustomerInfoItem) {
            ...
            if (!$findCustomerForEmailResponseMidocoCustomerInfoItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerInfo) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerInfo[] $midocoCustomerInfo
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\FindCustomerForEmailResponse
     */
