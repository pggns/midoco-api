...
class GetAgencyCommissionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAgencyCommissionForArrayConstraintsFromSetMidocoAgencyCommission(?array $values = []): string
    {
        ...
        foreach ($values as $getAgencyCommissionResponseMidocoAgencyCommissionItem) {
            ...
            if (!$getAgencyCommissionResponseMidocoAgencyCommissionItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyCommissionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetAgencyCommissionResponse
     */
