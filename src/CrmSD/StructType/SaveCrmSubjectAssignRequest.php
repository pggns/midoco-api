...
class SaveCrmSubjectAssignRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign[]
     */
    ...
    public static function validateMidocoCrmSubjectAssignForArrayConstraintsFromSetMidocoCrmSubjectAssign(?array $values = []): string
    {
        ...
        foreach ($values as $saveCrmSubjectAssignRequestMidocoCrmSubjectAssignItem) {
            ...
            if (!$saveCrmSubjectAssignRequestMidocoCrmSubjectAssignItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmSubjectAssign property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign[] $midocoCrmSubjectAssign
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveCrmSubjectAssignRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveCrmSubjectAssignRequest
     */
    public function addToMidocoCrmSubjectAssign(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmSubjectAssign property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmSubjectAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
