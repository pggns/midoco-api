...
class SaveAddressRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\CrmSD\StructType\SaveAddressDTO $midocoSaveAddress = null, ?bool $makeDefault = false, ?int $internalVersion = null, ?int $customerId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\SaveAddressDTO $midocoSaveAddress
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveAddressRequest
     */
