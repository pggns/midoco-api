...
class GetYearlyTurnoverResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover[] $midocoYearlyTurnover
     ...
     * @param int $customerId
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetYearlyTurnoverResponse
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover[]
     */
    ...
    public static function validateMidocoYearlyTurnoverForArrayConstraintsFromSetMidocoYearlyTurnover(?array $values = []): string
    {
        ...
        foreach ($values as $getYearlyTurnoverResponseMidocoYearlyTurnoverItem) {
            ...
            if (!$getYearlyTurnoverResponseMidocoYearlyTurnoverItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoYearlyTurnover property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetYearlyTurnoverResponse
     */
    public function addToMidocoYearlyTurnover(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover) {
            throw new InvalidArgumentException(sprintf('The MidocoYearlyTurnover property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoYearlyTurnover, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
