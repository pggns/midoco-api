...
class GetCrmPersonTravellersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmPersonTravellerForArrayConstraintsFromSetMidocoCrmPersonTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmPersonTravellersResponseMidocoCrmPersonTravellerItem) {
            ...
            if (!$getCrmPersonTravellersResponseMidocoCrmPersonTravellerItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonTravellerDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonTravellerDTO[] $midocoCrmPersonTraveller
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCrmPersonTravellersResponse
     */
