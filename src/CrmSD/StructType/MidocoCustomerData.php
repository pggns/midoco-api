...
class MidocoCustomerData extends CustomerDTO
{
     ...
     * - minOccurs: 0
     * - ref: MidocoCrmPerson
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO[] $midocoCrmPerson
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO[]
     */
    ...
    public static function validateMidocoCrmPersonForArrayConstraintsFromSetMidocoCrmPerson(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmPersonItem) {
            ...
            if (!$midocoCustomerDataMidocoCrmPersonItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmPerson property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO[] $midocoCrmPerson
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerData
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerData
     */
    public function addToMidocoCrmPerson(\Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmPerson property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmPersonDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmNoticeForArrayConstraintsFromSetMidocoCrmNotice(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmNoticeItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmNoticeItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmNotice) {
    ...
    public static function validateMidocoCrmAddressForArrayConstraintsFromSetMidocoCrmAddress(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmAddressItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmAddressItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmAddress) {
    ...
    public static function validateMidocoCrmCcCardForArrayConstraintsFromSetMidocoCrmCcCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmCcCardItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmCcCardItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCcCard) {
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO[]
     */
    ...
    public static function validateMidocoCrmCompanyForArrayConstraintsFromSetMidocoCrmCompany(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmCompanyItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmCompanyItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCompany property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerData
     */
    public function addToMidocoCrmCompany(\Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCompany property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCompanyDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmCriteriaItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCriteriaDTO) {
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmDebitCardItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmDebitCard) {
    ...
    public static function validateMidocoDebitorForArrayConstraintsFromSetMidocoDebitor(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoDebitorItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoDebitorItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\DebitorDTO) {
    ...
    public static function validateMidocoContactHistoryForArrayConstraintsFromSetMidocoContactHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoContactHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoContactHistoryItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoContactHistory) {
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment[]
     */
    ...
    public static function validateMidocoCrmCustomerPaymentForArrayConstraintsFromSetMidocoCrmCustomerPayment(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmCustomerPaymentItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmCustomerPaymentItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCustomerPayment property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerData
     */
    public function addToMidocoCrmCustomerPayment(\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCustomerPayment property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmCustomerPayment, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCustomerTravelItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCustomerTravelType) {
