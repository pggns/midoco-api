...
class GetPrintDescriptionListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintDescriptionListResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getPrintDescriptionListResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetPrintDescriptionListResponse
     */
