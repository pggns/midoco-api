...
class GetTravellerResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmTravellerForArrayConstraintsFromSetMidocoCrmTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $getTravellerResponseMidocoCrmTravellerItem) {
            ...
            if (!$getTravellerResponseMidocoCrmTravellerItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmTraveller[] $midocoCrmTraveller
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetTravellerResponse
     */
