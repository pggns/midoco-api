...
class MarkExportChangedCustomersRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoExportChangedCustomersLogForArrayConstraintsFromSetMidocoExportChangedCustomersLog(?array $values = []): string
    {
        ...
        foreach ($values as $markExportChangedCustomersRequestMidocoExportChangedCustomersLogItem) {
            ...
            if (!$markExportChangedCustomersRequestMidocoExportChangedCustomersLogItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ExportChangedCustomersLogDTO[] $midocoExportChangedCustomersLog
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\MarkExportChangedCustomersRequest
     */
