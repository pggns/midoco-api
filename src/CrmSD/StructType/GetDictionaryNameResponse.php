...
class GetDictionaryNameResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO[]
     */
    ...
    public static function validateMidocoDictionaryNameForArrayConstraintsFromSetMidocoDictionaryName(?array $values = []): string
    {
        ...
        foreach ($values as $getDictionaryNameResponseMidocoDictionaryNameItem) {
            ...
            if (!$getDictionaryNameResponseMidocoDictionaryNameItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDictionaryName property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO[] $midocoDictionaryName
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetDictionaryNameResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetDictionaryNameResponse
     */
    public function addToMidocoDictionaryName(\Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDictionaryName property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\DictionaryNameDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
