...
class DeleteJobFunctionRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoJobFunctionForArrayConstraintsFromSetMidocoJobFunction(?array $values = []): string
    {
        ...
        foreach ($values as $deleteJobFunctionRequestMidocoJobFunctionItem) {
            ...
            if (!$deleteJobFunctionRequestMidocoJobFunctionItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\JobFunctionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\JobFunctionDTO[] $midocoJobFunction
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DeleteJobFunctionRequest
     */
