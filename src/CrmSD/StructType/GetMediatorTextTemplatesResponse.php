...
class GetMediatorTextTemplatesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO[]
     */
    ...
    public static function validateMidocoCustomerTextTemplateForArrayConstraintsFromSetMidocoCustomerTextTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getMediatorTextTemplatesResponseMidocoCustomerTextTemplateItem) {
            ...
            if (!$getMediatorTextTemplatesResponseMidocoCustomerTextTemplateItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCustomerTextTemplate property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO[] $midocoCustomerTextTemplate
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMediatorTextTemplatesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetMediatorTextTemplatesResponse
     */
    public function addToMidocoCustomerTextTemplate(\Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCustomerTextTemplate property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\TextTemplateDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
