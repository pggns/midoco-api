...
class SaveCrmNoticesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmNoticeForArrayConstraintsFromSetMidocoCrmNotice(?array $values = []): string
    {
        ...
        foreach ($values as $saveCrmNoticesResponseMidocoCrmNoticeItem) {
            ...
            if (!$saveCrmNoticesResponseMidocoCrmNoticeItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmNotice) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCrmNotice[] $midocoCrmNotice
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveCrmNoticesResponse
     */
