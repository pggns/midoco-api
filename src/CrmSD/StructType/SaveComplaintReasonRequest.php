...
class SaveComplaintReasonRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\CrmSD\StructType\ComplaintReasonDTO $midocoComplaintReason = null, ?int $internalVersion = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ComplaintReasonDTO $midocoComplaintReason
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\SaveComplaintReasonRequest
     */
