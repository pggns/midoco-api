...
class DeleteCommunicationHistoriesRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCommunicationHistory $midocoCommunicationHistory = null, ?int $internalVersion = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\MidocoCommunicationHistory $midocoCommunicationHistory
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\DeleteCommunicationHistoriesRequest
     */
