...
class GetCustomerCriteriaResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $getCustomerCriteriaResponseMidocoCrmCriteriaItem) {
            ...
            if (!$getCustomerCriteriaResponseMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCriteriaDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmCriteriaDTO[] $midocoCrmCriteria
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCustomerCriteriaResponse
     */
