...
class GetBankNameResponse extends AbstractStructBase
{
    ...
    /**
     * Get Bank value
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\Bank[]
     */
    ...
    public static function validateBankForArrayConstraintsFromSetBank(?array $values = []): string
    {
        ...
        foreach ($values as $getBankNameResponseBankItem) {
            ...
            if (!$getBankNameResponseBankItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\Bank) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Bank property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\Bank, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\Bank[] $bank
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetBankNameResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\Bank $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetBankNameResponse
     */
    public function addToBank(\Pggns\MidocoApi\Api\CrmSD\StructType\Bank $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\Bank) {
            throw new InvalidArgumentException(sprintf('The Bank property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\Bank, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->Bank[] = $item;
