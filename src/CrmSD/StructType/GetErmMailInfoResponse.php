...
class GetErmMailInfoResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO[] $midocoCustomerMailErm
     */
     ...
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO[]
     */
    ...
    public static function validateMidocoCustomerMailErmForArrayConstraintsFromSetMidocoCustomerMailErm(?array $values = []): string
    {
        ...
        foreach ($values as $getErmMailInfoResponseMidocoCustomerMailErmItem) {
            ...
            if (!$getErmMailInfoResponseMidocoCustomerMailErmItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCustomerMailErm property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO[] $midocoCustomerMailErm
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetErmMailInfoResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO $item
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetErmMailInfoResponse
     */
    public function addToMidocoCustomerMailErm(\Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCustomerMailErm property can only contain items of type \Pggns\MidocoApi\Api\CrmSD\StructType\CustomerMailErmDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
