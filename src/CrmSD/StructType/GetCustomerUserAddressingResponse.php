...
class GetCustomerUserAddressingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmUserAddressingForArrayConstraintsFromSetMidocoCrmUserAddressing(?array $values = []): string
    {
        ...
        foreach ($values as $getCustomerUserAddressingResponseMidocoCrmUserAddressingItem) {
            ...
            if (!$getCustomerUserAddressingResponseMidocoCrmUserAddressingItem instanceof \Pggns\MidocoApi\Api\CrmSD\StructType\CrmUserAddressingDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\CrmUserAddressingDTO[] $midocoCrmUserAddressing
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\GetCustomerUserAddressingResponse
     */
