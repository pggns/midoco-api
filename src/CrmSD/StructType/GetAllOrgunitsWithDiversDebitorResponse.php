...
class GetAllOrgunitsWithDiversDebitorResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitForArrayConstraintsFromSetMidocoOrgunit(?array $values = []): string
    {
        ...
        foreach ($values as $getAllOrgunitsWithDiversDebitorResponseMidocoOrgunitItem) {
            ...
            if (!$getAllOrgunitsWithDiversDebitorResponseMidocoOrgunitItem instanceof \Pggns\MidocoApi\CrmSD\StructType\OrgunitDTO) {
     ...
     * @param \Pggns\MidocoApi\CrmSD\StructType\OrgunitDTO[] $midocoOrgunit
     * @return \Pggns\MidocoApi\CrmSD\StructType\GetAllOrgunitsWithDiversDebitorResponse
     */
