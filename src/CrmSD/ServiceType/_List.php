...
class _List extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\CrmSD\ServiceType\_List
     */
     ...
     * @param \Pggns\MidocoApi\Api\CrmSD\StructType\ListCriteriaTypeCategoriesRequest $paramListCriteriaTypeCategoriesRequest
     * @return \Pggns\MidocoApi\Api\CrmSD\StructType\ListCriteriaTypeCategoriesResponse|bool
     */
    public function listCriteriaTypeCategories(\Pggns\MidocoApi\Api\CrmSD\StructType\ListCriteriaTypeCategoriesRequest $paramListCriteriaTypeCategoriesRequest)
    {
        try {
