...
class GetCcProxyTargetResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget[]
     */
    ...
    public static function validateMidocoCcProxyTargetForArrayConstraintsFromSetMidocoCcProxyTarget(?array $values = []): string
    {
        ...
        foreach ($values as $getCcProxyTargetResponseMidocoCcProxyTargetItem) {
            ...
            if (!$getCcProxyTargetResponseMidocoCcProxyTargetItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCcProxyTarget property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget[] $midocoCcProxyTarget
     * @return \Pggns\MidocoApi\Api\System\StructType\GetCcProxyTargetResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget $item
     * @return \Pggns\MidocoApi\Api\System\StructType\GetCcProxyTargetResponse
     */
    public function addToMidocoCcProxyTarget(\Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget) {
            throw new InvalidArgumentException(sprintf('The MidocoCcProxyTarget property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoCcProxyTarget, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
