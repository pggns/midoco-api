...
class GetPrintJobs4PrintQueueResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintsFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintJobs4PrintQueueResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getPrintJobs4PrintQueueResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\System\StructType\MidocoTempPrintjobInfo) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\System\StructType\GetPrintJobs4PrintQueueResponse
     */
