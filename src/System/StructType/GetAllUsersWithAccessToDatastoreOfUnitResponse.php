...
class GetAllUsersWithAccessToDatastoreOfUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem) {
            ...
            if (!$getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\System\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\System\StructType\GetAllUsersWithAccessToDatastoreOfUnitResponse
     */
