...
class GetDocumentNatureDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType[]
     */
    ...
    public static function validateMidocoDocumentNatureDescriptionForArrayConstraintsFromSetMidocoDocumentNatureDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentNatureDescriptionsResponseMidocoDocumentNatureDescriptionItem) {
            ...
            if (!$getDocumentNatureDescriptionsResponseMidocoDocumentNatureDescriptionItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentNatureDescription property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType[] $midocoDocumentNatureDescription
     * @return \Pggns\MidocoApi\Api\System\StructType\GetDocumentNatureDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType $item
     * @return \Pggns\MidocoApi\Api\System\StructType\GetDocumentNatureDescriptionsResponse
     */
    public function addToMidocoDocumentNatureDescription(\Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentNatureDescription property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoDocumentNatureDescriptionType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
