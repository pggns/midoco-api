...
class GetOrgUnitsInSameDBResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit[] $midocoSearchUnit
     */
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit[]
     */
    ...
    public static function validateMidocoSearchUnitForArrayConstraintsFromSetMidocoSearchUnit(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgUnitsInSameDBResponseMidocoSearchUnitItem) {
            ...
            if (!$getOrgUnitsInSameDBResponseMidocoSearchUnitItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSearchUnit property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit[] $midocoSearchUnit
     * @return \Pggns\MidocoApi\Api\System\StructType\GetOrgUnitsInSameDBResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit $item
     * @return \Pggns\MidocoApi\Api\System\StructType\GetOrgUnitsInSameDBResponse
     */
    public function addToMidocoSearchUnit(\Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit) {
            throw new InvalidArgumentException(sprintf('The MidocoSearchUnit property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoSearchUnit, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
