...
class GetPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintSelectForArrayConstraintsFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\System\StructType\MidocoPrintSelect) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\System\StructType\GetPrintSelectsResponse
     */
