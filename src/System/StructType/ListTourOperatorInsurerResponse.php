...
class ListTourOperatorInsurerResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer[]
     */
    ...
    public static function validateMidocoTourOperatorInsurerForArrayConstraintsFromSetMidocoTourOperatorInsurer(?array $values = []): string
    {
        ...
        foreach ($values as $listTourOperatorInsurerResponseMidocoTourOperatorInsurerItem) {
            ...
            if (!$listTourOperatorInsurerResponseMidocoTourOperatorInsurerItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTourOperatorInsurer property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer[] $midocoTourOperatorInsurer
     * @return \Pggns\MidocoApi\Api\System\StructType\ListTourOperatorInsurerResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer $item
     * @return \Pggns\MidocoApi\Api\System\StructType\ListTourOperatorInsurerResponse
     */
    public function addToMidocoTourOperatorInsurer(\Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer) {
            throw new InvalidArgumentException(sprintf('The MidocoTourOperatorInsurer property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoTourOperatorInsurer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
