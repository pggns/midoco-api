...
class GetOrgunitDatastoresResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintsFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem) {
            ...
            if (!$getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Api\System\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Api\System\StructType\GetOrgunitDatastoresResponse
     */
