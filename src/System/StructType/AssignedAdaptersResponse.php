...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Api\System\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\Api\System\StructType\AssignedAdaptersResponse
     */
