...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Api\System\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\Api\System\StructType\AvailableAdaptersResponse
     */
