...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\System\StructType\AdapterDTO) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\AdapterDTO[] $midocoAdapter
     * @return \Pggns\MidocoApi\System\StructType\AvailableAdaptersResponse
     */
