...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\System\StructType\GetMergedMfResponse
     */
