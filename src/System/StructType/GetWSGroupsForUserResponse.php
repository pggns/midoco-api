...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Api\System\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Api\System\StructType\GetWSGroupsForUserResponse
     */
