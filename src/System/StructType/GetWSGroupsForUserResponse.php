...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\System\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\System\StructType\GetWSGroupsForUserResponse
     */
