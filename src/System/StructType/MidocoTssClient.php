...
class MidocoTssClient extends TssClientDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata[] $midocoTssClientMetadata
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata[]
     */
    ...
    public static function validateMidocoTssClientMetadataForArrayConstraintsFromSetMidocoTssClientMetadata(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTssClientMidocoTssClientMetadataItem) {
            ...
            if (!$midocoTssClientMidocoTssClientMetadataItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTssClientMetadata property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata[] $midocoTssClientMetadata
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoTssClient
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata $item
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoTssClient
     */
    public function addToMidocoTssClientMetadata(\Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata) {
            throw new InvalidArgumentException(sprintf('The MidocoTssClientMetadata property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoTssClientMetadata, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
