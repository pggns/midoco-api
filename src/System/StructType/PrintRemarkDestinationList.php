...
class PrintRemarkDestinationList extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRemarkDestinationForArrayConstraintsFromSetMidocoPrintRemarkDestination(?array $values = []): string
    {
        ...
        foreach ($values as $printRemarkDestinationListMidocoPrintRemarkDestinationItem) {
            ...
            if (!$printRemarkDestinationListMidocoPrintRemarkDestinationItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoPrintRemarkDestination) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     * @return \Pggns\MidocoApi\Api\System\StructType\PrintRemarkDestinationList
     */
