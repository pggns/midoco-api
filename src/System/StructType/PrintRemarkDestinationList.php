...
class PrintRemarkDestinationList extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRemarkDestinationForArrayConstraintsFromSetMidocoPrintRemarkDestination(?array $values = []): string
    {
        ...
        foreach ($values as $printRemarkDestinationListMidocoPrintRemarkDestinationItem) {
            ...
            if (!$printRemarkDestinationListMidocoPrintRemarkDestinationItem instanceof \Pggns\MidocoApi\System\StructType\MidocoPrintRemarkDestination) {
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     * @return \Pggns\MidocoApi\System\StructType\PrintRemarkDestinationList
     */
