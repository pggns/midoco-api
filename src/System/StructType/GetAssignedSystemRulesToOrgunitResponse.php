...
class GetAssignedSystemRulesToOrgunitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset[]
     */
    ...
    public static function validateMidocoUnitRulesetForArrayConstraintsFromSetMidocoUnitRuleset(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedSystemRulesToOrgunitResponseMidocoUnitRulesetItem) {
            ...
            if (!$getAssignedSystemRulesToOrgunitResponseMidocoUnitRulesetItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUnitRuleset property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset[] $midocoUnitRuleset
     * @return \Pggns\MidocoApi\Api\System\StructType\GetAssignedSystemRulesToOrgunitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset $item
     * @return \Pggns\MidocoApi\Api\System\StructType\GetAssignedSystemRulesToOrgunitResponse
     */
    public function addToMidocoUnitRuleset(\Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset) {
            throw new InvalidArgumentException(sprintf('The MidocoUnitRuleset property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoUnitRuleset, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
