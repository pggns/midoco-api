...
class GetAssignedPrintTypeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign[]
     */
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     */
     ...
     * @return \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign[]
     */
    ...
    public static function validateMidocoPrintTypeAssignForArrayConstraintsFromSetMidocoPrintTypeAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintTypeResponseMidocoPrintTypeAssignItem) {
            ...
            if (!$getAssignedPrintTypeResponseMidocoPrintTypeAssignItem instanceof \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign[] $midocoPrintTypeAssign
     * @return \Pggns\MidocoApi\System\StructType\GetAssignedPrintTypeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign $item
     * @return \Pggns\MidocoApi\System\StructType\GetAssignedPrintTypeResponse
     */
    public function addToMidocoPrintTypeAssign(\Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintTypeAssign property can only contain items of type \Pggns\MidocoApi\System\StructType\MidocoPrintTypeAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
