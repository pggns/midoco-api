...
class GetRolesFromProcessRoleAssignResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign[]
     */
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign[] $midocoProcessRoleAssign
     */
     ...
     * @return \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign[]
     */
    ...
    public static function validateMidocoProcessRoleAssignForArrayConstraintsFromSetMidocoProcessRoleAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getRolesFromProcessRoleAssignResponseMidocoProcessRoleAssignItem) {
            ...
            if (!$getRolesFromProcessRoleAssignResponseMidocoProcessRoleAssignItem instanceof \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProcessRoleAssign property can only contain items of type \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign[] $midocoProcessRoleAssign
     * @return \Pggns\MidocoApi\System\StructType\GetRolesFromProcessRoleAssignResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign $item
     * @return \Pggns\MidocoApi\System\StructType\GetRolesFromProcessRoleAssignResponse
     */
    public function addToMidocoProcessRoleAssign(\Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoProcessRoleAssign property can only contain items of type \Pggns\MidocoApi\System\StructType\MidocoProcessRoleAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
