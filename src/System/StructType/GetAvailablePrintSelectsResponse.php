...
class GetAvailablePrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailablePrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAvailablePrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Api\System\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Api\System\StructType\GetAvailablePrintSelectsResponse
     */
