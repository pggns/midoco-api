...
/**
 * This class stands for SaveTourOperatorDisabledUnitsRequest StructType
...
class SaveTourOperatorDisabledUnitsRequest extends AbstractStructBase
{
     ...
     * @uses SaveTourOperatorDisabledUnitsRequest::setInsurerId()
     * @uses SaveTourOperatorDisabledUnitsRequest::setDisabledUnitName()
     ...
     * @param int $touroperatorId
     * @return \Pggns\MidocoApi\Api\System\StructType\SaveTourOperatorDisabledUnitsRequest
     */
    ...
    public static function validateDisabledUnitNameForArrayConstraintsFromSetDisabledUnitName(?array $values = []): string
    {
        ...
        foreach ($values as $saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem) {
            ...
            if (!is_string($saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem)) {
                $invalidValues[] = is_object($saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem) ? get_class($saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem) : sprintf('%s(%s)', gettype($saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem), var_export($saveTourOperatorDisabledUnitsRequestDisabledUnitNameItem, true));
            }
        }
