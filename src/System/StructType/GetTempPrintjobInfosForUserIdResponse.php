...
class GetTempPrintjobInfosForUserIdResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintsFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoTempPrintjobInfo) {
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\Api\System\StructType\GetTempPrintjobInfosForUserIdResponse
     */
