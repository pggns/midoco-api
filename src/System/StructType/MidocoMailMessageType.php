...
class MidocoMailMessageType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType[] $midocoMailAttachment
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType[] $midocoMailHeader
     ...
     * @param string[] $to
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoMailMessageType
     */
     ...
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType[]
     */
    ...
    public static function validateMidocoMailAttachmentForArrayConstraintsFromSetMidocoMailAttachment(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailAttachmentItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailAttachmentItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType $item
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailAttachment(\Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailAttachment property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoMailAttachmentType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoMailHeaderForArrayConstraintsFromSetMidocoMailHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMailMessageTypeMidocoMailHeaderItem) {
            // validation for constraint: itemType
            if (!$midocoMailMessageTypeMidocoMailHeaderItem instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType $item
     * @return \Pggns\MidocoApi\Api\System\StructType\MidocoMailMessageType
     */
    public function addToMidocoMailHeader(\Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType) {
            throw new InvalidArgumentException(sprintf('The MidocoMailHeader property can only contain items of type \Pggns\MidocoApi\Api\System\StructType\MidocoMailHeaderType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
