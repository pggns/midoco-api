...
class ListTssClientRequest extends AbstractStructBase
{
     ...
     * @param bool $extern
     */
    public function __construct(?array $unit = null, ?\Pggns\MidocoApi\Api\System\StructType\MidocoTssClient $midocoTssClient = null, ?bool $extern = null)
    {
        $this
            ->setUnit($unit)
     ...
     * @param string[] $unit
     * @return \Pggns\MidocoApi\Api\System\StructType\ListTssClientRequest
     */
