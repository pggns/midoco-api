...
class AssignedAdaptersAttrResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO[]
     */
    ...
    public static function validateMidocoAdapterAttrForArrayConstraintFromSetMidocoAdapterAttr(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersAttrResponseMidocoAdapterAttrItem) {
            ...
            if (!$assignedAdaptersAttrResponseMidocoAdapterAttrItem instanceof \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdapterAttr property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO[] $midocoAdapterAttr
     * @return \Pggns\MidocoApi\Bank\StructType\AssignedAdaptersAttrResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\AssignedAdaptersAttrResponse
     */
    public function addToMidocoAdapterAttr(\Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAdapterAttr property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AdapterAttrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
