...
class GetMfBeanNamesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal[] $midocoMfBeanLocal
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal[]
     */
    ...
    public static function validateMidocoMfBeanLocalForArrayConstraintFromSetMidocoMfBeanLocal(?array $values = []): string
    {
        ...
        foreach ($values as $getMfBeanNamesResponseMidocoMfBeanLocalItem) {
            ...
            if (!$getMfBeanNamesResponseMidocoMfBeanLocalItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMfBeanLocal property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal[] $midocoMfBeanLocal
     * @return \Pggns\MidocoApi\Bank\StructType\GetMfBeanNamesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetMfBeanNamesResponse
     */
    public function addToMidocoMfBeanLocal(\Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal) {
            throw new InvalidArgumentException(sprintf('The MidocoMfBeanLocal property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoMfBeanLocal, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
