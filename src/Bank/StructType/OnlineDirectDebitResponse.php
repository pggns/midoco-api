...
/**
 * This class stands for OnlineDirectDebitResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class OnlineDirectDebitResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for OnlineDirectDebitResponse
     * @uses OnlineDirectDebitResponse::setMidocoDirectDebitProtocol()
     * @uses OnlineDirectDebitResponse::setFileId()
     * @uses OnlineDirectDebitResponse::setErrorCount()
     * @uses OnlineDirectDebitResponse::setCreatedTransactionCount()
     * @uses OnlineDirectDebitResponse::setErrorCode()
     * @uses OnlineDirectDebitResponse::setErrorBundle()
    ...
    public static function validateMidocoDirectDebitProtocolForArrayConstraintFromSetMidocoDirectDebitProtocol(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $onlineDirectDebitResponseMidocoDirectDebitProtocolItem) {
            // validation for constraint: itemType
            if (!$onlineDirectDebitResponseMidocoDirectDebitProtocolItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoDirectDebitProtocol) {
                $invalidValues[] = is_object($onlineDirectDebitResponseMidocoDirectDebitProtocolItem) ? get_class($onlineDirectDebitResponseMidocoDirectDebitProtocolItem) : sprintf('%s(%s)', gettype($onlineDirectDebitResponseMidocoDirectDebitProtocolItem), var_export($onlineDirectDebitResponseMidocoDirectDebitProtocolItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoDirectDebitProtocol[] $midocoDirectDebitProtocol
     * @return \Pggns\MidocoApi\Bank\StructType\OnlineDirectDebitResponse
     */
