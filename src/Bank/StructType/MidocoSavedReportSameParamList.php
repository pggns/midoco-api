...
class MidocoSavedReportSameParamList extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt $MidocoJasperReportExt = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt $midocoJasperReportExt
     * @param \Pggns\MidocoApi\Bank\StructType\JasperReportParamValueDTO[] $midocoJasperReportParamValue
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt $midocoJasperReportExt = null, ?array $midocoJasperReportParamValue = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt|null
     */
    public function getMidocoJasperReportExt(): ?\Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt
    {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt $midocoJasperReportExt
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSavedReportSameParamList
     */
    public function setMidocoJasperReportExt(?\Pggns\MidocoApi\Bank\StructType\MidocoJasperReportExt $midocoJasperReportExt = null): self
    {
    ...
    public static function validateMidocoJasperReportParamValueForArrayConstraintFromSetMidocoJasperReportParamValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSavedReportSameParamListMidocoJasperReportParamValueItem) {
            ...
            if (!$midocoSavedReportSameParamListMidocoJasperReportParamValueItem instanceof \Pggns\MidocoApi\Bank\StructType\JasperReportParamValueDTO) {
