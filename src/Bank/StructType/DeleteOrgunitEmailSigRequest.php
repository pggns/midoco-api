...
class DeleteOrgunitEmailSigRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $deleteOrgunitEmailSigRequestMidocoOrgunitEmailSigItem) {
            ...
            if (!$deleteOrgunitEmailSigRequestMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\Bank\StructType\DeleteOrgunitEmailSigRequest
     */
