...
class MidocoTripAppraisalInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo[] $tripAppraisalInfo
     */
    ...
    public static function validateTripAppraisalInfoForArrayConstraintFromSetTripAppraisalInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTripAppraisalInfoTripAppraisalInfoItem) {
            ...
            if (!$midocoTripAppraisalInfoTripAppraisalInfoItem instanceof \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TripAppraisalInfo property can only contain items of type \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo[] $tripAppraisalInfo
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoTripAppraisalInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoTripAppraisalInfo
     */
    public function addToTripAppraisalInfo(\Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo) {
            throw new InvalidArgumentException(sprintf('The TripAppraisalInfo property can only contain items of type \Pggns\MidocoApi\Bank\StructType\TripAppraisalInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
