...
class GetSubjectElementsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement[] $midocoSubjectElement
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement[]
     */
    ...
    public static function validateMidocoSubjectElementForArrayConstraintFromSetMidocoSubjectElement(?array $values = []): string
    {
        ...
        foreach ($values as $getSubjectElementsResponseMidocoSubjectElementItem) {
            ...
            if (!$getSubjectElementsResponseMidocoSubjectElementItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSubjectElement property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement[] $midocoSubjectElement
     * @return \Pggns\MidocoApi\Bank\StructType\GetSubjectElementsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetSubjectElementsResponse
     */
    public function addToMidocoSubjectElement(\Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement) {
            throw new InvalidArgumentException(sprintf('The MidocoSubjectElement property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSubjectElement, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
