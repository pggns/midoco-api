...
/**
 * This class stands for SaveBankCacheRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveBankCacheRequest extends AbstractStructBase
{
    /**
     * The MidocoBankCache
    ...
    /**
     * Constructor method for SaveBankCacheRequest
     * @uses SaveBankCacheRequest::setMidocoBankCache()
    ...
    public static function validateMidocoBankCacheForArrayConstraintFromSetMidocoBankCache(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $saveBankCacheRequestMidocoBankCacheItem) {
            // validation for constraint: itemType
            if (!$saveBankCacheRequestMidocoBankCacheItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoBankCache) {
                $invalidValues[] = is_object($saveBankCacheRequestMidocoBankCacheItem) ? get_class($saveBankCacheRequestMidocoBankCacheItem) : sprintf('%s(%s)', gettype($saveBankCacheRequestMidocoBankCacheItem), var_export($saveBankCacheRequestMidocoBankCacheItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoBankCache[] $midocoBankCache
     * @return \Pggns\MidocoApi\Bank\StructType\SaveBankCacheRequest
     */
