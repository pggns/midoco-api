...
class Cc_authorisation extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $auth_code = null, ?float $auth_amount = null, ?string $currency = null, ?bool $capture_executed = null, ?string $cc_type = null, ?string $cc_number = null, ?\Pggns\MidocoApi\Bank\StructType\Cc_token $cc_token = null, ?int $position = null, ?string $transaction_ref_id = null)
    {
        $this
