...
/**
 * This class stands for GetBankCacheRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetBankCacheRequest extends AbstractStructBase
{
    /**
     * The MidocoBankCache
    ...
    /**
     * Constructor method for GetBankCacheRequest
     * @uses GetBankCacheRequest::setMidocoBankCache()
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoBankCache $midocoBankCache
     * @return \Pggns\MidocoApi\Bank\StructType\GetBankCacheRequest
     */
