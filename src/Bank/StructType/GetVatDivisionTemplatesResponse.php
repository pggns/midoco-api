...
class GetVatDivisionTemplatesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDivisionTemplateForArrayConstraintFromSetMidocoVatDivisionTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem) {
            ...
            if (!$getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem instanceof \Pggns\MidocoApi\Bank\StructType\VatDivisionTemplateType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\VatDivisionTemplateType[] $midocoVatDivisionTemplate
     * @return \Pggns\MidocoApi\Bank\StructType\GetVatDivisionTemplatesResponse
     */
