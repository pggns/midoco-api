...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoAllJasperReports
     */
