...
/**
 * This class stands for DeleteBankStatementProtocolRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteBankStatementProtocolRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for DeleteBankStatementProtocolRequest
     * @uses DeleteBankStatementProtocolRequest::setMidocoBankStatementProtocol()
    ...
    public static function validateMidocoBankStatementProtocolForArrayConstraintFromSetMidocoBankStatementProtocol(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem) {
            // validation for constraint: itemType
            if (!$deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoBankStatementProtocol) {
                $invalidValues[] = is_object($deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem) ? get_class($deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem) : sprintf('%s(%s)', gettype($deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem), var_export($deleteBankStatementProtocolRequestMidocoBankStatementProtocolItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoBankStatementProtocol[] $midocoBankStatementProtocol
     * @return \Pggns\MidocoApi\Bank\StructType\DeleteBankStatementProtocolRequest
     */
