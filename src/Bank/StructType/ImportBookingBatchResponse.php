...
/**
 * This class stands for ImportBookingBatchResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ImportBookingBatchResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ImportBookingBatchResponse
     * @uses ImportBookingBatchResponse::setMidocoManualBooking()
    ...
    public static function validateMidocoManualBookingForArrayConstraintFromSetMidocoManualBooking(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $importBookingBatchResponseMidocoManualBookingItem) {
            // validation for constraint: itemType
            if (!$importBookingBatchResponseMidocoManualBookingItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoManualBooking) {
                $invalidValues[] = is_object($importBookingBatchResponseMidocoManualBookingItem) ? get_class($importBookingBatchResponseMidocoManualBookingItem) : sprintf('%s(%s)', gettype($importBookingBatchResponseMidocoManualBookingItem), var_export($importBookingBatchResponseMidocoManualBookingItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoManualBooking[] $midocoManualBooking
     * @return \Pggns\MidocoApi\Bank\StructType\ImportBookingBatchResponse
     */
