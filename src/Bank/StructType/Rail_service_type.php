...
class Rail_service_type extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\Ticket_category::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\Ticket_category::getValidValues()
    ...
    public function setTicket_category(?string $ticket_category = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Bank\EnumType\Ticket_category::valueIsValid($ticket_category)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\Ticket_category', is_array($ticket_category) ? implode(', ', $ticket_category) : var_export($ticket_category, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\Ticket_category::getValidValues())), __LINE__);
        }
