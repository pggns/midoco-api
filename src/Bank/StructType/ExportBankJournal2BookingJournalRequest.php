...
/**
 * This class stands for ExportBankJournal2BookingJournalRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ExportBankJournal2BookingJournalRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ExportBankJournal2BookingJournalRequest
     * @uses ExportBankJournal2BookingJournalRequest::setMidocoBankStatementAccount()
    ...
    public static function validateMidocoBankStatementAccountForArrayConstraintFromSetMidocoBankStatementAccount(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem) {
            // validation for constraint: itemType
            if (!$exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoBankStatementAccountType) {
                $invalidValues[] = is_object($exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem) ? get_class($exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem) : sprintf('%s(%s)', gettype($exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem), var_export($exportBankJournal2BookingJournalRequestMidocoBankStatementAccountItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoBankStatementAccountType[] $midocoBankStatementAccount
     * @return \Pggns\MidocoApi\Bank\StructType\ExportBankJournal2BookingJournalRequest
     */
