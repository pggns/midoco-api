...
class GetAvailableSupplierHistoricResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierHistoricResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierHistoricResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Bank\StructType\GetAvailableSupplierHistoricResponse
     */
