...
class GetOrgunitEmailSigListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO[]
     */
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem) {
            ...
            if (!$getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitEmailSig property can only contain items of type \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\Bank\StructType\GetOrgunitEmailSigListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetOrgunitEmailSigListResponse
     */
    public function addToMidocoOrgunitEmailSig(\Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitEmailSig property can only contain items of type \Pggns\MidocoApi\Bank\StructType\OrgunitEmailSigDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
