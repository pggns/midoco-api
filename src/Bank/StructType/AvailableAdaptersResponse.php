...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Bank\StructType\AvailableAdaptersResponse
     */
