...
/**
 * This class stands for GetDebitFileRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetDebitFileRequest extends AbstractStructBase
{
    /**
     * The fileId
     * @var int|null
    ...
    /**
     * Constructor method for GetDebitFileRequest
     * @uses GetDebitFileRequest::setFileId()
     * @param int $fileId
     */
     ...
     * Set fileId value
     * @param int $fileId
     * @return \Pggns\MidocoApi\Bank\StructType\GetDebitFileRequest
     */
