...
class MidocoSellItemInfo4Printing extends MidocoSellItemDetails
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing $MidocoVoucherInfo4Printing = null;
    /**
     * The MidocoTravelCm
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * - ref: MidocoTravelCm
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType[] $midocoTouchedVatCode
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing $midocoVoucherInfo4Printing
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm[] $midocoTravelCm
     ...
     */
    public function __construct(?string $orderPosition = null, ?float $originalPrice = null, ?float $actualPrice = null, ?float $totalPrice = null, ?float $salePrice = null, ?float $oldPrice = null, ?float $oldNonBookedVatAmount = 0, ?string $currency = null, ?string $originalCurrency = null, ?string $vatPercent = null, ?float $vatAmount = null, ?float $feeAmount = null, ?float $taxAmount = null, ?string $supplierVatPercent = null, ?float $supplierVatAmount = null, ?bool $isReferenced = true, ?int $printOptionId = null, ?string $reducedVatPercent = null, ?float $reducedVatAmount = null, ?string $supplierReducedVatPercent = null, ?float $supplierReducedVatAmount = null, ?string $geographicalCategory = null, ?bool $isTicketBased = true, ?string $countryCode = 'true', ?string $countryDescription = 'true', ?float $commissionAmount = null, ?float $commissionPercent = null, ?\Pggns\MidocoApi\Bank\StructType\TravelSupplierInfoDTO $midocoTravelSupplierInfo = null, ?int $expedientUserId = null, ?string $crsExpedientId = null, ?array $midocoSellItemVatDivision = null, ?string $turnaroundPoint = null, ?float $depositPercent = null, ?int $noOfItems = null, ?float $singlePrice = null, ?string $category = null, ?string $extPaymentType = null, ?array $midocoInvoicePosition = null, ?array $midocoInvoiceVatPosition = null, ?string $groupItemName = null, ?bool $groupItemFlag = false, ?bool $isMarginVat = null, ?string $travelNo = null, ?array $midocoTouchedVatCode = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing $midocoVoucherInfo4Printing = null, ?array $midocoTravelCm = null, ?array $midocoSellItemSaving = null, ?int $atolIndex = null, ?string $atolPeriod = null, ?int $parentItemId = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoSellItemPricing $midocoSellItemPricing = null)
    {
        $this
    ...
    public static function validateMidocoSellItemVatDivisionForArrayConstraintFromSetMidocoSellItemVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoSellItemVatDivisionItem) {
            ...
            if (!$midocoSellItemInfo4PrintingMidocoSellItemVatDivisionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSellItemVatDivision) {
    ...
    public static function validateMidocoInvoicePositionForArrayConstraintFromSetMidocoInvoicePosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoInvoicePositionItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemInfo4PrintingMidocoInvoicePositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoicePosition) {
    ...
    public static function validateMidocoInvoiceVatPositionForArrayConstraintFromSetMidocoInvoiceVatPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoInvoiceVatPositionItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemInfo4PrintingMidocoInvoiceVatPositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceVatPosition) {
    ...
    public static function validateMidocoTouchedVatCodeForArrayConstraintFromSetMidocoTouchedVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoTouchedVatCodeItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemInfo4PrintingMidocoTouchedVatCodeItem instanceof \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTouchedVatCode property can only contain items of type \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSellItemInfo4Printing
     */
    public function addToMidocoTouchedVatCode(\Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType) {
            throw new InvalidArgumentException(sprintf('The MidocoTouchedVatCode property can only contain items of type \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing|null
     */
    public function getMidocoVoucherInfo4Printing(): ?\Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSellItemInfo4Printing
     */
    public function setMidocoVoucherInfo4Printing(?\Pggns\MidocoApi\Bank\StructType\MidocoVoucherInfo4Printing $midocoVoucherInfo4Printing = null): self
    {
    ...
    public static function validateMidocoTravelCmForArrayConstraintFromSetMidocoTravelCm(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoTravelCmItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemInfo4PrintingMidocoTravelCmItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelCm property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSellItemInfo4Printing
     */
    public function addToMidocoTravelCm(\Pggns\MidocoApi\Bank\StructType\MidocoTravelCm $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelCm property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoTravelCm, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellItemSavingForArrayConstraintFromSetMidocoSellItemSaving(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSellItemInfo4PrintingMidocoSellItemSavingItem) {
            // validation for constraint: itemType
            if (!$midocoSellItemInfo4PrintingMidocoSellItemSavingItem instanceof \Pggns\MidocoApi\Bank\StructType\SellItemSavingDTO) {
