...
class Transfer_service_type extends AbstractStructBase
{
    ...
    /**
     * Set direction value
     * @uses \Pggns\MidocoApi\Bank\EnumType\Direction::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\Direction::getValidValues()
    ...
    public function setDirection(?string $direction = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Bank\EnumType\Direction::valueIsValid($direction)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\Direction', is_array($direction) ? implode(', ', $direction) : var_export($direction, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\Direction::getValidValues())), __LINE__);
        }
