...
/**
 * This class stands for GetBankCacheResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetBankCacheResponse extends AbstractStructBase
{
    /**
     * The MidocoBankCache
    ...
    /**
     * Constructor method for GetBankCacheResponse
     * @uses GetBankCacheResponse::setMidocoBankCache()
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoBankCache $midocoBankCache
     * @return \Pggns\MidocoApi\Bank\StructType\GetBankCacheResponse
     */
