...
class AttributeDefinitionType extends AttributeDefinitionDTO
{
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $attributeDefinitionTypeMidocoAttributeChoiceValueItem) {
            ...
            if (!$attributeDefinitionTypeMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\Bank\StructType\AttributeChoiceValueDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\Bank\StructType\AttributeDefinitionType
     */
