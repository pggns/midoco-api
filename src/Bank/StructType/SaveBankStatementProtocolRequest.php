...
/**
 * This class stands for SaveBankStatementProtocolRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveBankStatementProtocolRequest extends AbstractStructBase
{
    /**
     * The protocolId
     * @var int|null
    ...
    /**
     * Constructor method for SaveBankStatementProtocolRequest
     * @uses SaveBankStatementProtocolRequest::setProtocolId()
     * @uses SaveBankStatementProtocolRequest::setStatementId()
     * @uses SaveBankStatementProtocolRequest::setAccountPosition()
     * @uses SaveBankStatementProtocolRequest::setRepositoryId()
     ...
     * @param int $protocolId
     * @return \Pggns\MidocoApi\Bank\StructType\SaveBankStatementProtocolRequest
     */
