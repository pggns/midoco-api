...
class CrmMidocoChargeInfoType extends CrmMidocoChargeDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Bank\StructType\CrmMidocoChargeInfoType
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\CrmMidocoChargeInfoType
     */
    public function addToMidocoAssignedMidocoChargeOu(\Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
