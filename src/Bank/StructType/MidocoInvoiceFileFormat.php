...
class MidocoInvoiceFileFormat extends InvoiceFileFormatDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO[] $midocoInvoiceFileFormatContent
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO[]
     */
    ...
    public static function validateMidocoInvoiceFileFormatContentForArrayConstraintFromSetMidocoInvoiceFileFormatContent(?array $values = []): string
    {
        ...
        foreach ($values as $midocoInvoiceFileFormatMidocoInvoiceFileFormatContentItem) {
            ...
            if (!$midocoInvoiceFileFormatMidocoInvoiceFileFormatContentItem instanceof \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoInvoiceFileFormatContent property can only contain items of type \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO[] $midocoInvoiceFileFormatContent
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceFileFormat
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceFileFormat
     */
    public function addToMidocoInvoiceFileFormatContent(\Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoInvoiceFileFormatContent property can only contain items of type \Pggns\MidocoApi\Bank\StructType\InvoiceFileFormatContentDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
