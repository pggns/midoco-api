...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Bank\StructType\GetUserWithCrsExpedientRequest
     */
