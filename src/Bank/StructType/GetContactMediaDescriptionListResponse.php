...
class GetContactMediaDescriptionListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO[]
     */
    ...
    public static function validateMidocoContactMediaDescriptionForArrayConstraintFromSetMidocoContactMediaDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getContactMediaDescriptionListResponseMidocoContactMediaDescriptionItem) {
            ...
            if (!$getContactMediaDescriptionListResponseMidocoContactMediaDescriptionItem instanceof \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoContactMediaDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO[] $midocoContactMediaDescription
     * @return \Pggns\MidocoApi\Bank\StructType\GetContactMediaDescriptionListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetContactMediaDescriptionListResponse
     */
    public function addToMidocoContactMediaDescription(\Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoContactMediaDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MediaDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
