...
class SearchSupplierDocumentShippingResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping[]
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping[]
     */
    ...
    public static function validateMidocoSupplierDocumentShippingForArrayConstraintFromSetMidocoSupplierDocumentShipping(?array $values = []): string
    {
        ...
        foreach ($values as $searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem) {
            ...
            if (!$searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping[] $midocoSupplierDocumentShipping
     * @return \Pggns\MidocoApi\Bank\StructType\SearchSupplierDocumentShippingResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping $item
     * @return \Pggns\MidocoApi\Bank\StructType\SearchSupplierDocumentShippingResponse
     */
    public function addToMidocoSupplierDocumentShipping(\Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSupplierDocumentShipping, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
