...
class MidocoCcToken extends CcTokenDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr[] $midocoCcTokenAttr
     * @param string $ccMask
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr[]
     */
    ...
    public static function validateMidocoCcTokenAttrForArrayConstraintFromSetMidocoCcTokenAttr(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCcTokenMidocoCcTokenAttrItem) {
            ...
            if (!$midocoCcTokenMidocoCcTokenAttrItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCcTokenAttr property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCcToken
     */
    public function addToMidocoCcTokenAttr(\Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr) {
            throw new InvalidArgumentException(sprintf('The MidocoCcTokenAttr property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCcTokenAttr, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
