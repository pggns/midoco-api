...
class GetPagedInvoiceDocumentsForCustomerResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer[] $midocoInvoiceDocInfoForCustomer
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer[]
     */
    ...
    public static function validateMidocoInvoiceDocInfoForCustomerForArrayConstraintFromSetMidocoInvoiceDocInfoForCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $getPagedInvoiceDocumentsForCustomerResponseMidocoInvoiceDocInfoForCustomerItem) {
            ...
            if (!$getPagedInvoiceDocumentsForCustomerResponseMidocoInvoiceDocInfoForCustomerItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoInvoiceDocInfoForCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer[] $midocoInvoiceDocInfoForCustomer
     * @return \Pggns\MidocoApi\Bank\StructType\GetPagedInvoiceDocumentsForCustomerResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetPagedInvoiceDocumentsForCustomerResponse
     */
    public function addToMidocoInvoiceDocInfoForCustomer(\Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoInvoiceDocInfoForCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceDocInfoForCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
