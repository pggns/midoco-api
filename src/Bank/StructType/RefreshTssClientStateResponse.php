...
class RefreshTssClientStateResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateResponseMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Bank\StructType\RefreshTssClientStateResponse
     */
