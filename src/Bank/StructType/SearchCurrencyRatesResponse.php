...
class SearchCurrencyRatesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCurrencyRateForArrayConstraintFromSetMidocoCurrencyRate(?array $values = []): string
    {
        ...
        foreach ($values as $searchCurrencyRatesResponseMidocoCurrencyRateItem) {
            ...
            if (!$searchCurrencyRatesResponseMidocoCurrencyRateItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCurrencyRate) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCurrencyRate[] $midocoCurrencyRate
     * @return \Pggns\MidocoApi\Bank\StructType\SearchCurrencyRatesResponse
     */
