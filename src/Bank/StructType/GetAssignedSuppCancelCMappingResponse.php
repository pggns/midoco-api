...
class GetAssignedSuppCancelCMappingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSuppCancelCMappingForArrayConstraintFromSetMidocoSuppCancelCMapping(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedSuppCancelCMappingResponseMidocoSuppCancelCMappingItem) {
            ...
            if (!$getAssignedSuppCancelCMappingResponseMidocoSuppCancelCMappingItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSuppCancelCMapping) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSuppCancelCMapping[] $midocoSuppCancelCMapping
     * @return \Pggns\MidocoApi\Bank\StructType\GetAssignedSuppCancelCMappingResponse
     */
