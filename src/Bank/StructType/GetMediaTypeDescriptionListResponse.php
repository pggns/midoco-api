...
class GetMediaTypeDescriptionListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO[] $midocoMediaTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO[]
     */
    ...
    public static function validateMidocoMediaTypeDescriptionForArrayConstraintFromSetMidocoMediaTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getMediaTypeDescriptionListResponseMidocoMediaTypeDescriptionItem) {
            ...
            if (!$getMediaTypeDescriptionListResponseMidocoMediaTypeDescriptionItem instanceof \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMediaTypeDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO[] $midocoMediaTypeDescription
     * @return \Pggns\MidocoApi\Bank\StructType\GetMediaTypeDescriptionListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetMediaTypeDescriptionListResponse
     */
    public function addToMidocoMediaTypeDescription(\Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoMediaTypeDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MediaTypeDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
