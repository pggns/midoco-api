...
class GetAccessibleComponentsByRoleResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$getAccessibleComponentsByRoleResponseMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoAccessibleComponentByRoleType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAccessibleComponentByRoleType[] $midocoAccessibleComponentByRole
     * @return \Pggns\MidocoApi\Bank\StructType\GetAccessibleComponentsByRoleResponse
     */
