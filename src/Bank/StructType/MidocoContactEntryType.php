...
class MidocoContactEntryType extends ContactEntryDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoContactSource[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoContactSource[] $midocoContactSource
     * @param int $mediaType
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoContactSource[]
     */
    ...
    public static function validateMidocoContactSourceForArrayConstraintFromSetMidocoContactSource(?array $values = []): string
    {
        ...
        foreach ($values as $midocoContactEntryTypeMidocoContactSourceItem) {
            ...
            if (!$midocoContactEntryTypeMidocoContactSourceItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoContactSource) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoContactSource property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoContactSource, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoContactSource $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoContactEntryType
     */
    public function addToMidocoContactSource(\Pggns\MidocoApi\Bank\StructType\MidocoContactSource $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoContactSource) {
            throw new InvalidArgumentException(sprintf('The MidocoContactSource property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoContactSource, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
