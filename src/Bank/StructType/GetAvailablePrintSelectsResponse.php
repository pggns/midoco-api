...
class GetAvailablePrintSelectsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO[]
     */
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailablePrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAvailablePrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Bank\StructType\GetAvailablePrintSelectsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetAvailablePrintSelectsResponse
     */
    public function addToMidocoPrintDescription(\Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintDescription property can only contain items of type \Pggns\MidocoApi\Bank\StructType\PrintDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
