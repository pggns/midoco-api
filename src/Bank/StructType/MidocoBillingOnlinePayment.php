...
class MidocoBillingOnlinePayment extends BillingOnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoBillingOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoBillingOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoBillingOnlinePayment
     */
