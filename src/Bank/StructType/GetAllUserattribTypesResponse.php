...
class GetAllUserattribTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType[] $midocoUserattribType
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType[]
     */
    ...
    public static function validateMidocoUserattribTypeForArrayConstraintFromSetMidocoUserattribType(?array $values = []): string
    {
        ...
        foreach ($values as $getAllUserattribTypesResponseMidocoUserattribTypeItem) {
            ...
            if (!$getAllUserattribTypesResponseMidocoUserattribTypeItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserattribType property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType[] $midocoUserattribType
     * @return \Pggns\MidocoApi\Bank\StructType\GetAllUserattribTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetAllUserattribTypesResponse
     */
    public function addToMidocoUserattribType(\Pggns\MidocoApi\Bank\StructType\MidocoUserattribType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType) {
            throw new InvalidArgumentException(sprintf('The MidocoUserattribType property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUserattribType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
