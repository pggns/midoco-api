...
class GetAssignedSuppliersToTemplateResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedSuppliersToTemplateResponseMidocoSupplierItem) {
            ...
            if (!$getAssignedSuppliersToTemplateResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Bank\StructType\GetAssignedSuppliersToTemplateResponse
     */
