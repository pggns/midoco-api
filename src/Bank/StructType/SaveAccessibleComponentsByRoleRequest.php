...
class SaveAccessibleComponentsByRoleRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoAccessibleComponentByRoleForArrayConstraintFromSetMidocoAccessibleComponentByRole(?array $values = []): string
    {
        ...
        foreach ($values as $saveAccessibleComponentsByRoleRequestMidocoAccessibleComponentByRoleItem) {
            ...
            if (!$saveAccessibleComponentsByRoleRequestMidocoAccessibleComponentByRoleItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoAccessibleComponentByRoleType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAccessibleComponentByRoleType[] $midocoAccessibleComponentByRole
     * @return \Pggns\MidocoApi\Bank\StructType\SaveAccessibleComponentsByRoleRequest
     */
