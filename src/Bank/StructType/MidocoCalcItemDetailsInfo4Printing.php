...
class MidocoCalcItemDetailsInfo4Printing extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization[] $feeTypeLocalization
    ...
    public static function validateMidocoSellItemVatDivisionForArrayConstraintFromSetMidocoSellItemVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoSellItemVatDivisionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoSellItemVatDivisionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSellItemVatDivision) {
    ...
    public static function validateMidocoInvoicePositionForArrayConstraintFromSetMidocoInvoicePosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoInvoicePositionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoInvoicePositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoicePosition) {
    ...
    public static function validateMidocoInvoiceVatPositionForArrayConstraintFromSetMidocoInvoiceVatPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoInvoiceVatPositionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoInvoiceVatPositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoInvoiceVatPosition) {
    ...
    public static function validateFeeTypeLocalizationForArrayConstraintFromSetFeeTypeLocalization(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingFeeTypeLocalizationItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingFeeTypeLocalizationItem instanceof \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FeeTypeLocalization property can only contain items of type \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCalcItemDetailsInfo4Printing
     */
    public function addToFeeTypeLocalization(\Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization) {
            throw new InvalidArgumentException(sprintf('The FeeTypeLocalization property can only contain items of type \Pggns\MidocoApi\Bank\StructType\FeeTypeLocalization, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoTouchedVatCodeForArrayConstraintFromSetMidocoTouchedVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoTouchedVatCodeItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoTouchedVatCodeItem instanceof \Pggns\MidocoApi\Bank\StructType\TouchedVatCodeType) {
