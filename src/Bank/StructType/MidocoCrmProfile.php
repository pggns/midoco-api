...
class MidocoCrmProfile extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: ExternalProfile
     * @var \Pggns\MidocoApi\Bank\StructType\ExternalProfile[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\ProfileAttributes|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\ProfileAttributes $ProfileAttributes = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\ExternalProfile[] $externalProfile
     * @param \Pggns\MidocoApi\Bank\StructType\ProfileAttributes $profileAttributes
     * @param \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO[] $midocoCrmCustomerLink
     * @param \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO[] $midocoFrequentFlyerNumber
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?array $externalProfile = null, ?\Pggns\MidocoApi\Bank\StructType\ProfileAttributes $profileAttributes = null, ?array $midocoCrmCustomerLink = null, ?array $midocoFrequentFlyerNumber = null, ?array $midocoCrmAddress = null, ?array $midocoContactEntry = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmProfile
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\ExternalProfile[]
     */
    ...
    public static function validateExternalProfileForArrayConstraintFromSetExternalProfile(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileExternalProfileItem) {
            ...
            if (!$midocoCrmProfileExternalProfileItem instanceof \Pggns\MidocoApi\Bank\StructType\ExternalProfile) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ExternalProfile property can only contain items of type \Pggns\MidocoApi\Bank\StructType\ExternalProfile, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\ExternalProfile $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmProfile
     */
    public function addToExternalProfile(\Pggns\MidocoApi\Bank\StructType\ExternalProfile $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\ExternalProfile) {
            throw new InvalidArgumentException(sprintf('The ExternalProfile property can only contain items of type \Pggns\MidocoApi\Bank\StructType\ExternalProfile, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\ProfileAttributes|null
     */
    public function getProfileAttributes(): ?\Pggns\MidocoApi\Bank\StructType\ProfileAttributes
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmProfile
     */
    public function setProfileAttributes(?\Pggns\MidocoApi\Bank\StructType\ProfileAttributes $profileAttributes = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO[]
     */
    ...
    public static function validateMidocoCrmCustomerLinkForArrayConstraintFromSetMidocoCrmCustomerLink(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoCrmCustomerLinkItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoCrmCustomerLinkItem instanceof \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCustomerLink property can only contain items of type \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmProfile
     */
    public function addToMidocoCrmCustomerLink(\Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCustomerLink property can only contain items of type \Pggns\MidocoApi\Bank\StructType\CrmCustomerLinkDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO[]
     */
    ...
    public static function validateMidocoFrequentFlyerNumberForArrayConstraintFromSetMidocoFrequentFlyerNumber(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoFrequentFlyerNumberItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoFrequentFlyerNumberItem instanceof \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFrequentFlyerNumber property can only contain items of type \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmProfile
     */
    public function addToMidocoFrequentFlyerNumber(\Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoFrequentFlyerNumber property can only contain items of type \Pggns\MidocoApi\Bank\StructType\FrequentFlyerNumberDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmAddressForArrayConstraintFromSetMidocoCrmAddress(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoCrmAddressItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoCrmAddressItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmAddress) {
    ...
    public static function validateMidocoContactEntryForArrayConstraintFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoContactEntryItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoContactEntryItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoContactEntryType) {
