...
class MidocoProperty extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass[] $midocoVisibleClass
    ...
    public static function validateMidocoVisibleClassForArrayConstraintFromSetMidocoVisibleClass(?array $values = []): string
    {
        ...
        foreach ($values as $midocoPropertyMidocoVisibleClassItem) {
            ...
            if (!$midocoPropertyMidocoVisibleClassItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVisibleClass property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass[] $midocoVisibleClass
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoProperty
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoProperty
     */
    public function addToMidocoVisibleClass(\Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass) {
            throw new InvalidArgumentException(sprintf('The MidocoVisibleClass property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoVisibleClass, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
