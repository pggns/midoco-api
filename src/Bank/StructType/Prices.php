...
class Prices extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Booking_price[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Flight_price[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Fee[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Details_price[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\Booking_price[] $booking_price
     * @param \Pggns\MidocoApi\Bank\StructType\Flight_price[] $flight_price
     * @param \Pggns\MidocoApi\Bank\StructType\Fee[] $fee
     * @param \Pggns\MidocoApi\Bank\StructType\Details_price[] $details_price
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\Booking_price[]
     */
    ...
    public static function validateBooking_priceForArrayConstraintFromSetBooking_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesBooking_priceItem) {
            ...
            if (!$pricesBooking_priceItem instanceof \Pggns\MidocoApi\Bank\StructType\Booking_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The booking_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Booking_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\Booking_price[] $booking_price
     * @return \Pggns\MidocoApi\Bank\StructType\Prices
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Booking_price $item
     * @return \Pggns\MidocoApi\Bank\StructType\Prices
     */
    public function addToBooking_price(\Pggns\MidocoApi\Bank\StructType\Booking_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Booking_price) {
            throw new InvalidArgumentException(sprintf('The booking_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Booking_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\Flight_price[]
     */
    ...
    public static function validateFlight_priceForArrayConstraintFromSetFlight_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesFlight_priceItem) {
            // validation for constraint: itemType
            if (!$pricesFlight_priceItem instanceof \Pggns\MidocoApi\Bank\StructType\Flight_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The flight_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Flight_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Flight_price $item
     * @return \Pggns\MidocoApi\Bank\StructType\Prices
     */
    public function addToFlight_price(\Pggns\MidocoApi\Bank\StructType\Flight_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Flight_price) {
            throw new InvalidArgumentException(sprintf('The flight_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Flight_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    /**
     * Get fee value
     * @return \Pggns\MidocoApi\Bank\StructType\Fee[]
     */
    ...
    public static function validateFeeForArrayConstraintFromSetFee(?array $values = []): string
    {
        ...
        foreach ($values as $pricesFeeItem) {
            // validation for constraint: itemType
            if (!$pricesFeeItem instanceof \Pggns\MidocoApi\Bank\StructType\Fee) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The fee property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Fee, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Fee $item
     * @return \Pggns\MidocoApi\Bank\StructType\Prices
     */
    public function addToFee(\Pggns\MidocoApi\Bank\StructType\Fee $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Fee) {
            throw new InvalidArgumentException(sprintf('The fee property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Fee, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->fee[] = $item;
    ...
    public static function validateDetails_priceForArrayConstraintFromSetDetails_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesDetails_priceItem) {
            // validation for constraint: itemType
            if (!$pricesDetails_priceItem instanceof \Pggns\MidocoApi\Bank\StructType\Details_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The details_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Details_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Details_price $item
     * @return \Pggns\MidocoApi\Bank\StructType\Prices
     */
    public function addToDetails_price(\Pggns\MidocoApi\Bank\StructType\Details_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Details_price) {
            throw new InvalidArgumentException(sprintf('The details_price property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Details_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
