...
class MidocoAdviceSettlementDetailInfo extends AdviceSettlemDetailDTO
{
    ...
    public static function validateMidocoAdviceDetailVatDivForArrayConstraintFromSetMidocoAdviceDetailVatDiv(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAdviceSettlementDetailInfoMidocoAdviceDetailVatDivItem) {
            ...
            if (!$midocoAdviceSettlementDetailInfoMidocoAdviceDetailVatDivItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoAdviceDetailVatDiv) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAdviceDetailVatDiv[] $midocoAdviceDetailVatDiv
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoAdviceSettlementDetailInfo
     */
