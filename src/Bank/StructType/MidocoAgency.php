...
class MidocoAgency extends AgencyDetailDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment $MidocoCrmCustomerPayment = null;
    /**
     * The cooperationName
     * @var string|null
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     ...
     */
    public function __construct(?array $midocoAgencyCommission = null, ?\Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment $midocoCrmCustomerPayment = null, ?string $cooperationName = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO[]
     */
    ...
    public static function validateMidocoAgencyCommissionForArrayConstraintFromSetMidocoAgencyCommission(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAgencyMidocoAgencyCommissionItem) {
            ...
            if (!$midocoAgencyMidocoAgencyCommissionItem instanceof \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAgencyCommission property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoAgency
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoAgency
     */
    public function addToMidocoAgencyCommission(\Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAgencyCommission property can only contain items of type \Pggns\MidocoApi\Bank\StructType\AgencyCommissionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment|null
     */
    public function getMidocoCrmCustomerPayment(): ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoAgency
     */
    public function setMidocoCrmCustomerPayment(?\Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment $midocoCrmCustomerPayment = null): self
    {
