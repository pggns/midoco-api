...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Bank\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Bank\StructType\GetWSGroupsForUserResponse
     */
