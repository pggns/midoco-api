...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Bank\StructType\GetUserWithCrsExpedientResponse
     */
