...
class GetMatchingFeeRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute[] $midocoSellItemAttribute
     ...
     * @param string $supplierId
     * @return \Pggns\MidocoApi\Bank\StructType\GetMatchingFeeRequest
     */
    ...
    public static function validateMidocoSellItemAttributeForArrayConstraintFromSetMidocoSellItemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoSellItemAttributeItem) {
            ...
            if (!$getMatchingFeeRequestMidocoSellItemAttributeItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetMatchingFeeRequest
     */
    public function addToMidocoSellItemAttribute(\Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoSellItemAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoOrderAttributeForArrayConstraintFromSetMidocoOrderAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoOrderAttributeItem) {
            // validation for constraint: itemType
            if (!$getMatchingFeeRequestMidocoOrderAttributeItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoOrderAttribute) {
    ...
    public static function validateMidocoVatDivisionForArrayConstraintFromSetMidocoVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoVatDivisionItem) {
            // validation for constraint: itemType
            if (!$getMatchingFeeRequestMidocoVatDivisionItem instanceof \Pggns\MidocoApi\Bank\StructType\VatDivisionDTO) {
