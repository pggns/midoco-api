...
class SaveMidocoAttributeLocalizationRequest extends AbstractStructBase
{
     ...
     * @param bool $isNew
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization = null, ?bool $isNew = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization
     * @return \Pggns\MidocoApi\Bank\StructType\SaveMidocoAttributeLocalizationRequest
     */
