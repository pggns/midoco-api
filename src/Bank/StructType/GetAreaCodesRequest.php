...
class GetAreaCodesRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoAreaCode $midocoAreaCode = null, ?string $cultureId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAreaCode $midocoAreaCode
     * @return \Pggns\MidocoApi\Bank\StructType\GetAreaCodesRequest
     */
