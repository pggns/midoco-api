...
class MidocoCustomerDataList extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData[]
     */
    ...
    public static function validateMidocoCustomerDataForArrayConstraintFromSetMidocoCustomerData(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataListMidocoCustomerDataItem) {
            ...
            if (!$midocoCustomerDataListMidocoCustomerDataItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCustomerData property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCustomerDataList
     */
    public function addToMidocoCustomerData(\Pggns\MidocoApi\Bank\StructType\MidocoCustomerData $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData) {
            throw new InvalidArgumentException(sprintf('The MidocoCustomerData property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
