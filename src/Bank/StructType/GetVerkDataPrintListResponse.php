...
class GetVerkDataPrintListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVerkDataPrintForArrayConstraintFromSetMidocoVerkDataPrint(?array $values = []): string
    {
        ...
        foreach ($values as $getVerkDataPrintListResponseMidocoVerkDataPrintItem) {
            ...
            if (!$getVerkDataPrintListResponseMidocoVerkDataPrintItem instanceof \Pggns\MidocoApi\Bank\StructType\VerkDataPrintDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\VerkDataPrintDTO[] $midocoVerkDataPrint
     * @return \Pggns\MidocoApi\Bank\StructType\GetVerkDataPrintListResponse
     */
