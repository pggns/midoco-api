...
/**
 * This class stands for MidocoSepaOnlineFilesData StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class MidocoSepaOnlineFilesData extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for MidocoSepaOnlineFilesData
     * @uses MidocoSepaOnlineFilesData::setMidocoDirectDebitProtocol()
     * @uses MidocoSepaOnlineFilesData::setFileId()
     * @uses MidocoSepaOnlineFilesData::setErrorCount()
     * @uses MidocoSepaOnlineFilesData::setCreatedTransactionCount()
     * @uses MidocoSepaOnlineFilesData::setErrorCode()
     * @uses MidocoSepaOnlineFilesData::setErrorBundle()
    ...
    public static function validateMidocoDirectDebitProtocolForArrayConstraintFromSetMidocoDirectDebitProtocol(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem) {
            // validation for constraint: itemType
            if (!$midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoDirectDebitProtocol) {
                $invalidValues[] = is_object($midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem) ? get_class($midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem) : sprintf('%s(%s)', gettype($midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem), var_export($midocoSepaOnlineFilesDataMidocoDirectDebitProtocolItem, true));
            }
        }
