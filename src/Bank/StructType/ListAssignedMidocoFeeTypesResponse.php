...
class ListAssignedMidocoFeeTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFeeTypeForArrayConstraintFromSetMidocoFeeType(?array $values = []): string
    {
        ...
        foreach ($values as $listAssignedMidocoFeeTypesResponseMidocoFeeTypeItem) {
            ...
            if (!$listAssignedMidocoFeeTypesResponseMidocoFeeTypeItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoFeeType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoFeeType[] $midocoFeeType
     * @return \Pggns\MidocoApi\Bank\StructType\ListAssignedMidocoFeeTypesResponse
     */
