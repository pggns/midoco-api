...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Bank\StructType\GetAllTssClients4UnitResponse
     */
