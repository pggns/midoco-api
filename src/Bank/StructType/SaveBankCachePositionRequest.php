...
class SaveBankCachePositionRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoBankCachePositionForArrayConstraintFromSetMidocoBankCachePosition(?array $values = []): string
    {
        ...
        foreach ($values as $saveBankCachePositionRequestMidocoBankCachePositionItem) {
            ...
            if (!$saveBankCachePositionRequestMidocoBankCachePositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoBankCachePosition) {
                $invalidValues[] = is_object($saveBankCachePositionRequestMidocoBankCachePositionItem) ? get_class($saveBankCachePositionRequestMidocoBankCachePositionItem) : sprintf('%s(%s)', gettype($saveBankCachePositionRequestMidocoBankCachePositionItem), var_export($saveBankCachePositionRequestMidocoBankCachePositionItem, true));
            }
        }
