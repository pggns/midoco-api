...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Bank\StructType\AssignedAdaptersResponse
     */
