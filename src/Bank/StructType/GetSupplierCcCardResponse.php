...
class GetSupplierCcCardResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierCcCardForArrayConstraintFromSetMidocoSupplierCcCard(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierCcCardResponseMidocoSupplierCcCardItem) {
            ...
            if (!$getSupplierCcCardResponseMidocoSupplierCcCardItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierCcCard) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierCcCard[] $midocoSupplierCcCard
     * @return \Pggns\MidocoApi\Bank\StructType\GetSupplierCcCardResponse
     */
