...
/**
 * This class stands for SetIncomingVatDivFromOutgoingRequest StructType
 * @subpackage Structs
 */
class SetIncomingVatDivFromOutgoingRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SetIncomingVatDivFromOutgoingRequest
     * @uses SetIncomingVatDivFromOutgoingRequest::setMidocoAdviceSettlementDetail()
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceSettlementDetail $midocoAdviceSettlementDetail
     * @return \Pggns\MidocoApi\Api\Order\StructType\SetIncomingVatDivFromOutgoingRequest
     */
