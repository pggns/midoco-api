...
class MidocoBillingOnlinePayment extends BillingOnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoBillingOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoBillingOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingOnlinePayment
     */
