...
class GetExternVoucherTypeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO[]
     */
    ...
    public static function validateMidocoExternVoucherTypeForArrayConstraintsFromSetMidocoExternVoucherType(?array $values = []): string
    {
        ...
        foreach ($values as $getExternVoucherTypeResponseMidocoExternVoucherTypeItem) {
            ...
            if (!$getExternVoucherTypeResponseMidocoExternVoucherTypeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoExternVoucherType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO[] $midocoExternVoucherType
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetExternVoucherTypeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetExternVoucherTypeResponse
     */
    public function addToMidocoExternVoucherType(\Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoExternVoucherType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\ExternVoucherTypeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
