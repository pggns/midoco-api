...
class SaveCurrencyRatesRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCurrencyRateForArrayConstraintsFromSetMidocoCurrencyRate(?array $values = []): string
    {
        ...
        foreach ($values as $saveCurrencyRatesRequestMidocoCurrencyRateItem) {
            ...
            if (!$saveCurrencyRatesRequestMidocoCurrencyRateItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCurrencyRate) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCurrencyRate[] $midocoCurrencyRate
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveCurrencyRatesRequest
     */
