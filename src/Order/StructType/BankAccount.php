...
class BankAccount extends AbstractStructBase
{
     ...
     * - choiceMinOccurs: 1
     * - ref: IbanBic
     * @var \Pggns\MidocoApi\Api\Order\StructType\IbanBic|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\IbanBic $IbanBic = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber $AccountNumberBankNumber = null;
    /**
     * The bankAccountId
     * @var int|null
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\IbanBic $ibanBic
     * @param \Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber $accountNumberBankNumber
     * @param int $bankAccountId
     * @param string $bankName
     * @param string $bankCity
     * @param string $ownerName
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\IbanBic $ibanBic = null, ?\Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber $accountNumberBankNumber = null, ?int $bankAccountId = null, ?string $bankName = null, ?string $bankCity = null, ?string $ownerName = null)
    {
        $this
            ->setIbanBic($ibanBic)
    ...
    /**
     * Get IbanBic value
     * @return \Pggns\MidocoApi\Api\Order\StructType\IbanBic|null
     */
    public function getIbanBic(): ?\Pggns\MidocoApi\Api\Order\StructType\IbanBic
    {
     ...
     */
    public function setIbanBic(?\Pggns\MidocoApi\Api\Order\StructType\IbanBic $ibanBic = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber|null
     */
    public function getAccountNumberBankNumber(): ?\Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\BankAccount
     */
    public function setAccountNumberBankNumber(?\Pggns\MidocoApi\Api\Order\StructType\AccountNumberBankNumber $accountNumberBankNumber = null): self
    {
        // validation for constraint: choice(IbanBic, AccountNumberBankNumber)
