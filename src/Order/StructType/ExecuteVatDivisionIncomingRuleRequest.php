...
class ExecuteVatDivisionIncomingRuleRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?array $midocoVatCode = null, ?\Pggns\MidocoApi\Api\Order\StructType\RevenueBookingInfoType $revenueBookingInfo = null)
    {
        $this
    ...
    public static function validateMidocoVatCodeForArrayConstraintsFromSetMidocoVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $executeVatDivisionIncomingRuleRequestMidocoVatCodeItem) {
            ...
            if (!$executeVatDivisionIncomingRuleRequestMidocoVatCodeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoVatCode) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoVatCode[] $midocoVatCode
     * @return \Pggns\MidocoApi\Api\Order\StructType\ExecuteVatDivisionIncomingRuleRequest
     */
