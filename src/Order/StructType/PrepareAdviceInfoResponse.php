...
class PrepareAdviceInfoResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdviceSettlementForArrayConstraintsFromSetMidocoAdviceSettlement(?array $values = []): string
    {
        ...
        foreach ($values as $prepareAdviceInfoResponseMidocoAdviceSettlementItem) {
            ...
            if (!$prepareAdviceInfoResponseMidocoAdviceSettlementItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceSettlement) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceSettlement[] $midocoAdviceSettlement
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrepareAdviceInfoResponse
     */
