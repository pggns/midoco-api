...
class MidocoCrmImport extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO $MidocoSaveAddress = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO $midocoSaveAddress
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmImport
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO|null
     */
    public function getMidocoSaveAddress(): ?\Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmImport
     */
    public function setMidocoSaveAddress(?\Pggns\MidocoApi\Api\Order\StructType\SaveAddressDTO $midocoSaveAddress = null): self
    {
    ...
    public static function validateMidocoContactEntryForArrayConstraintsFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoContactEntryItem) {
            ...
            if (!$midocoCrmImportMidocoContactEntryItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoContactEntryType) {
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCrmCriteriaItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Api\Order\StructType\CrmCriteriaDTO) {
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCustomerTravelItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCustomerTravelType) {
    ...
    public static function validateMidocoContactHistoryForArrayConstraintsFromSetMidocoContactHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoContactHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoContactHistoryItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoContactHistory) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO[]
     */
    ...
    public static function validateMidocoCrmPersonTravellerForArrayConstraintsFromSetMidocoCrmPersonTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCrmPersonTravellerItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCrmPersonTravellerItem instanceof \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmPersonTraveller property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmImport
     */
    public function addToMidocoCrmPersonTraveller(\Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmPersonTraveller property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\CrmPersonTravellerDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmNoticeForArrayConstraintsFromSetMidocoCrmNotice(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCrmNoticeItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCrmNoticeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmNotice) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO[]
     */
    ...
    public static function validateMidocoCrmBonusCardForArrayConstraintsFromSetMidocoCrmBonusCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCrmBonusCardItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCrmBonusCardItem instanceof \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmBonusCard property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmImport
     */
    public function addToMidocoCrmBonusCard(\Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmBonusCard property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\CrmBonusCardDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmCcCardForArrayConstraintsFromSetMidocoCrmCcCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportMidocoCrmCcCardItem) {
            // validation for constraint: itemType
            if (!$midocoCrmImportMidocoCrmCcCardItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmCcCard) {
