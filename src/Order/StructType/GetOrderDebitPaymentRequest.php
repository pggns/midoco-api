...
/**
 * This class stands for GetOrderDebitPaymentRequest StructType
 * @subpackage Structs
 */
class GetOrderDebitPaymentRequest extends AbstractStructBase
{
    /**
     * The MidocoOrderId
    ...
    /**
     * Constructor method for GetOrderDebitPaymentRequest
     * @uses GetOrderDebitPaymentRequest::setMidocoOrderId()
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderId $midocoOrderId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrderDebitPaymentRequest
     */
