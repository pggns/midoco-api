...
class GetAvailableMiscPaymentSettingRequest extends AbstractStructBase
{
     ...
     * @param string $typeID
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\CashPaymentSettingDTO $midocoMiscPaymentSetting = null, ?string $typeID = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\CashPaymentSettingDTO $midocoMiscPaymentSetting
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAvailableMiscPaymentSettingRequest
     */
