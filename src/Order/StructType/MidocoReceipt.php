...
class MidocoReceipt extends ReceiptDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt[] $midocoAdditionalInfoForReceipt
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOnlinePaymentTransaction $midocoOnlinePaymentTransaction
     */
    public function __construct(?array $midocoReceiptPosition = null, ?\Pggns\MidocoApi\Api\Order\StructType\MidocoDebitInfoForReceipt $midocoDebitInfoForReceipt = null, ?array $midocoAdditionalInfoForReceipt = null, ?\Pggns\MidocoApi\Api\Order\StructType\MidocoOnlinePaymentTransaction $midocoOnlinePaymentTransaction = null)
    {
        $this
    ...
    public static function validateMidocoReceiptPositionForArrayConstraintsFromSetMidocoReceiptPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptMidocoReceiptPositionItem) {
            ...
            if (!$midocoReceiptMidocoReceiptPositionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoReceiptPosition property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition[] $midocoReceiptPosition
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoReceipt
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoReceipt
     */
    public function addToMidocoReceiptPosition(\Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition) {
            throw new InvalidArgumentException(sprintf('The MidocoReceiptPosition property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoReceiptPosition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt[]
     */
    ...
    public static function validateMidocoAdditionalInfoForReceiptForArrayConstraintsFromSetMidocoAdditionalInfoForReceipt(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptMidocoAdditionalInfoForReceiptItem) {
            // validation for constraint: itemType
            if (!$midocoReceiptMidocoAdditionalInfoForReceiptItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdditionalInfoForReceipt property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoReceipt
     */
    public function addToMidocoAdditionalInfoForReceipt(\Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt) {
            throw new InvalidArgumentException(sprintf('The MidocoAdditionalInfoForReceipt property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoAdditionalInfoForReceipt, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
