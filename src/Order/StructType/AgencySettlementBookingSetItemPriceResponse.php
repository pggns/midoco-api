 ...
 * @subpackage Structs
 */
class AgencySettlementBookingSetItemPriceResponse extends AbstractStructBase
{
    /**
     * The success
     * @var bool|null
    ...
    /**
     * Constructor method for AgencySettlementBookingSetItemPriceResponse
     * @uses AgencySettlementBookingSetItemPriceResponse::setSuccess()
     * @param bool $success
     */
