...
class GetSupplierInkassoModesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType[] $supplierInkassoMode
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType[]
     */
    ...
    public static function validateSupplierInkassoModeForArrayConstraintsFromSetSupplierInkassoMode(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierInkassoModesResponseSupplierInkassoModeItem) {
            ...
            if (!$getSupplierInkassoModesResponseSupplierInkassoModeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SupplierInkassoMode property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType[] $supplierInkassoMode
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierInkassoModesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierInkassoModesResponse
     */
    public function addToSupplierInkassoMode(\Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType) {
            throw new InvalidArgumentException(sprintf('The SupplierInkassoMode property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SupplierInkassoModeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
