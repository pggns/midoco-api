...
class Booking_price extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Deposit_payment_type::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Deposit_payment_type::getValidValues()
    ...
    public function setDeposit_payment_type(?string $deposit_payment_type = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\Deposit_payment_type::valueIsValid($deposit_payment_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\Deposit_payment_type', is_array($deposit_payment_type) ? implode(', ', $deposit_payment_type) : var_export($deposit_payment_type, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\Deposit_payment_type::getValidValues())), __LINE__);
        }
    ...
    public static function validateVat_divisionForArrayConstraintsFromSetVat_division(?array $values = []): string
    {
        ...
        foreach ($values as $booking_priceVat_divisionItem) {
            ...
            if (!$booking_priceVat_divisionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Vat_division) {
     ...
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Mode_revenue_calculation::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Mode_revenue_calculation::getValidValues()
     * @throws InvalidArgumentException
     * @param string $mode_revenue_calculation
     * @return \Pggns\MidocoApi\Api\Order\StructType\Booking_price
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Order\EnumType\Mode_revenue_calculation::valueIsValid($mode_revenue_calculation)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\Mode_revenue_calculation', is_array($mode_revenue_calculation) ? implode(', ', $mode_revenue_calculation) : var_export($mode_revenue_calculation, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\Mode_revenue_calculation::getValidValues())), __LINE__);
        }
