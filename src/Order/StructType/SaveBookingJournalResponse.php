...
/**
 * This class stands for SaveBookingJournalResponse StructType
 * @subpackage Structs
 */
class SaveBookingJournalResponse extends AbstractStructBase
{
    /**
     * The journal_id
     * @var int|null
    ...
    /**
     * Constructor method for SaveBookingJournalResponse
     * @uses SaveBookingJournalResponse::setJournal_id()
     ...
     * @param int $journal_id
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveBookingJournalResponse
     */
