...
/**
 * This class stands for subitemStatus StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SubitemStatus extends AbstractStructBase
{
    /**
     * The price
     * @var float|null
    ...
    /**
     * Constructor method for subitemStatus
     * @uses SubitemStatus::setPrice()
     * @uses SubitemStatus::setStatus()
     * @uses SubitemStatus::setNoOfPersons()
     * @uses SubitemStatus::setStartTravel()
     * @uses SubitemStatus::setEndTravel()
     * @uses SubitemStatus::setExtId()
     * @uses SubitemStatus::setSupplierId()
     * @uses SubitemStatus::setBookingId()
     * @param float $price
     * @param string $status
     ...
     */
    public function __construct(?float $price = null, ?string $status = null, ?int $noOfPersons = null, ?string $startTravel = null, ?string $endTravel = null, ?string $extId = null, ?string $supplierId = null, ?string $bookingId = null)
    {
        $this
            ->setPrice($price)
            ->setStatus($status)
