...
class GetMidocoTemplatesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTemplateForArrayConstraintsFromSetMidocoTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoTemplatesResponseMidocoTemplateItem) {
            ...
            if (!$getMidocoTemplatesResponseMidocoTemplateItem instanceof \Pggns\MidocoApi\Api\Order\StructType\TemplateDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\TemplateDTO[] $midocoTemplate
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMidocoTemplatesResponse
     */
