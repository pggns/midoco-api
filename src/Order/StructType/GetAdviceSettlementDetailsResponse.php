...
class GetAdviceSettlementDetailsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdviceSettlementDetailForArrayConstraintsFromSetMidocoAdviceSettlementDetail(?array $values = []): string
    {
        ...
        foreach ($values as $getAdviceSettlementDetailsResponseMidocoAdviceSettlementDetailItem) {
            ...
            if (!$getAdviceSettlementDetailsResponseMidocoAdviceSettlementDetailItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceSettlementDetail) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceSettlementDetail[] $midocoAdviceSettlementDetail
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAdviceSettlementDetailsResponse
     */
