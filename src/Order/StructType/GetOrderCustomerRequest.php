...
/**
 * This class stands for GetOrderCustomerRequest StructType
 * @subpackage Structs
 */
class GetOrderCustomerRequest extends AbstractStructBase
{
    /**
     * The orderId
    ...
    /**
     * Constructor method for GetOrderCustomerRequest
     * @uses GetOrderCustomerRequest::setOrderId()
     * @uses GetOrderCustomerRequest::setOrderNo()
     * @param int $orderId
     * @param int $orderNo
     */
     ...
     * @param int $orderId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrderCustomerRequest
     */
