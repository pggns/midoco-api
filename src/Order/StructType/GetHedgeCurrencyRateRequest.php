...
class GetHedgeCurrencyRateRequest extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest[] $hedgeCurrencyRequest
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest[]
     */
    ...
    public static function validateHedgeCurrencyRequestForArrayConstraintsFromSetHedgeCurrencyRequest(?array $values = []): string
    {
        ...
        foreach ($values as $getHedgeCurrencyRateRequestHedgeCurrencyRequestItem) {
            ...
            if (!$getHedgeCurrencyRateRequestHedgeCurrencyRequestItem instanceof \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The hedgeCurrencyRequest property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest[] $hedgeCurrencyRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetHedgeCurrencyRateRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetHedgeCurrencyRateRequest
     */
    public function addToHedgeCurrencyRequest(\Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest) {
            throw new InvalidArgumentException(sprintf('The hedgeCurrencyRequest property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\HedgeCurrencyRequest, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
