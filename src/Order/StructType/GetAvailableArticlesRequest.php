...
class GetAvailableArticlesRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\ArticleDTO $midocoArticle = null, ?string $startDate = null, ?string $endDate = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ArticleDTO $midocoArticle
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAvailableArticlesRequest
     */
