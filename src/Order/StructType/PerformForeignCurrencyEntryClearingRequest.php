...
/**
 * This class stands for PerformForeignCurrencyEntryClearingRequest StructType
 * @subpackage Structs
 */
class PerformForeignCurrencyEntryClearingRequest extends AbstractStructBase
{
    /**
     * The clearingEntry
    ...
    /**
     * Constructor method for PerformForeignCurrencyEntryClearingRequest
     * @uses PerformForeignCurrencyEntryClearingRequest::setClearingEntry()
     * @uses PerformForeignCurrencyEntryClearingRequest::setReceiptNo()
     * @uses PerformForeignCurrencyEntryClearingRequest::setReceiptDate()
     * @uses PerformForeignCurrencyEntryClearingRequest::setAccountId()
     * @uses PerformForeignCurrencyEntryClearingRequest::setBookingText()
     * @uses PerformForeignCurrencyEntryClearingRequest::setCurrency()
     * @uses PerformForeignCurrencyEntryClearingRequest::setExchangeRate()
    ...
    public static function validateClearingEntryForArrayConstraintsFromSetClearingEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $performForeignCurrencyEntryClearingRequestClearingEntryItem) {
            // validation for constraint: itemType
            if (!$performForeignCurrencyEntryClearingRequestClearingEntryItem instanceof \Pggns\MidocoApi\Api\Order\StructType\EntryDTO) {
                $invalidValues[] = is_object($performForeignCurrencyEntryClearingRequestClearingEntryItem) ? get_class($performForeignCurrencyEntryClearingRequestClearingEntryItem) : sprintf('%s(%s)', gettype($performForeignCurrencyEntryClearingRequestClearingEntryItem), var_export($performForeignCurrencyEntryClearingRequestClearingEntryItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\EntryDTO[] $clearingEntry
     * @return \Pggns\MidocoApi\Api\Order\StructType\PerformForeignCurrencyEntryClearingRequest
     */
