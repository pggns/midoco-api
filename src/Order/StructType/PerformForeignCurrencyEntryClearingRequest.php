...
class PerformForeignCurrencyEntryClearingRequest extends AbstractStructBase
{
    ...
    public static function validateClearingEntryForArrayConstraintFromSetClearingEntry(?array $values = []): string
    {
        ...
        foreach ($values as $performForeignCurrencyEntryClearingRequestClearingEntryItem) {
            ...
            if (!$performForeignCurrencyEntryClearingRequestClearingEntryItem instanceof \Pggns\MidocoApi\Order\StructType\EntryDTO) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\EntryDTO[] $clearingEntry
     * @return \Pggns\MidocoApi\Order\StructType\PerformForeignCurrencyEntryClearingRequest
     */
