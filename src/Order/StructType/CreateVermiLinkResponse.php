...
/**
 * This class stands for CreateVermiLinkResponse StructType
 * @subpackage Structs
 */
class CreateVermiLinkResponse extends AbstractStructBase
{
    /**
     * The link
     * @var string|null
    ...
    /**
     * Constructor method for CreateVermiLinkResponse
     * @uses CreateVermiLinkResponse::setLink()
     * @param string $link
     */
