...
class CrmCustomerDTO extends CustomerDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress $MidocoCrmAddress = null;
    /**
     * The MidocoCrmPerson
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoCrmPerson
     * @var \Pggns\MidocoApi\Api\Order\StructType\CrmPersonDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\CrmPersonDTO $MidocoCrmPerson = null;
    /**
     * The MidocoCrmCompany
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoCrmCompany
     * @var \Pggns\MidocoApi\Api\Order\StructType\CrmCompanyDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\CrmCompanyDTO $MidocoCrmCompany = null;
    /**
     * The numTravels
     * @var int|null
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress|null
     */
    public function getMidocoCrmAddress(): ?\Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress
    {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress $midocoCrmAddress
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmCustomerDTO
     */
    public function setMidocoCrmAddress(?\Pggns\MidocoApi\Api\Order\StructType\MidocoCrmAddress $midocoCrmAddress = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmPersonDTO|null
     */
    public function getMidocoCrmPerson(): ?\Pggns\MidocoApi\Api\Order\StructType\CrmPersonDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmCustomerDTO
     */
    public function setMidocoCrmPerson(?\Pggns\MidocoApi\Api\Order\StructType\CrmPersonDTO $midocoCrmPerson = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmCompanyDTO|null
     */
    public function getMidocoCrmCompany(): ?\Pggns\MidocoApi\Api\Order\StructType\CrmCompanyDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmCustomerDTO
     */
    public function setMidocoCrmCompany(?\Pggns\MidocoApi\Api\Order\StructType\CrmCompanyDTO $midocoCrmCompany = null): self
    {
