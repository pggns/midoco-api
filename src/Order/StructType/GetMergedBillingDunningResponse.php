...
class GetMergedBillingDunningResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBillingDunningForArrayConstraintsFromSetMidocoBillingDunning(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedBillingDunningResponseMidocoBillingDunningItem) {
            ...
            if (!$getMergedBillingDunningResponseMidocoBillingDunningItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingDunning) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingDunning[] $midocoBillingDunning
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMergedBillingDunningResponse
     */
