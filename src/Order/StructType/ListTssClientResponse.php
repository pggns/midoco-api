...
class ListTssClientResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $listTssClientResponseMidocoTssClientItem) {
            ...
            if (!$listTssClientResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Order\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Order\StructType\ListTssClientResponse
     */
