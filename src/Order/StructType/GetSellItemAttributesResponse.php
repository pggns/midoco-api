...
class GetSellItemAttributesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeValueForArrayConstraintsFromSetMidocoAttributeValue(?array $values = []): string
    {
        ...
        foreach ($values as $getSellItemAttributesResponseMidocoAttributeValueItem) {
            ...
            if (!$getSellItemAttributesResponseMidocoAttributeValueItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAttributeValue) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAttributeValue[] $midocoAttributeValue
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSellItemAttributesResponse
     */
