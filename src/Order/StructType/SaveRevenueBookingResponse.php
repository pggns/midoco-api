...
/**
 * This class stands for SaveRevenueBookingResponse StructType
 * @subpackage Structs
 */
class SaveRevenueBookingResponse extends AbstractStructBase
{
    /**
     * The revenueId
     * @var int|null
    ...
    /**
     * Constructor method for SaveRevenueBookingResponse
     * @uses SaveRevenueBookingResponse::setRevenueId()
     * @uses SaveRevenueBookingResponse::setGrantedRevenue()
     * @uses SaveRevenueBookingResponse::setRevenueInclVat()
     * @uses SaveRevenueBookingResponse::setRevenueNoVat()
     * @uses SaveRevenueBookingResponse::setRevenueInsurance()
     * @uses SaveRevenueBookingResponse::setNewTotalAmount()
     * @uses SaveRevenueBookingResponse::setSupplierInvoice()
     * @param int $revenueId
     ...
     * Set revenueId value
     * @param int $revenueId
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveRevenueBookingResponse
     */
