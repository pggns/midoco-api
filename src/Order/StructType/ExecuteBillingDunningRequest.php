...
class ExecuteBillingDunningRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoBillingDunningForArrayConstraintsFromSetMidocoBillingDunning(?array $values = []): string
    {
        ...
        foreach ($values as $executeBillingDunningRequestMidocoBillingDunningItem) {
            ...
            if (!$executeBillingDunningRequestMidocoBillingDunningItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingDunning) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingDunning[] $midocoBillingDunning
     * @return \Pggns\MidocoApi\Api\Order\StructType\ExecuteBillingDunningRequest
     */
