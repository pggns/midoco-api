...
class SupplierMailNotReceivedInfo extends SupplierMailNotReceivedSellItemInfo
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO[] $supplierMailNotReceivedCustomerInfo
    ...
    public static function validateSupplierMailNotReceivedCustomerInfoForArrayConstraintsFromSetSupplierMailNotReceivedCustomerInfo(?array $values = []): string
    {
        ...
        foreach ($values as $supplierMailNotReceivedInfoSupplierMailNotReceivedCustomerInfoItem) {
            ...
            if (!$supplierMailNotReceivedInfoSupplierMailNotReceivedCustomerInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SupplierMailNotReceivedCustomerInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\SupplierMailNotReceivedInfo
     */
    public function addToSupplierMailNotReceivedCustomerInfo(\Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO) {
            throw new InvalidArgumentException(sprintf('The SupplierMailNotReceivedCustomerInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SellPassengerDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoFlightDetailForArrayConstraintsFromSetMidocoFlightDetail(?array $values = []): string
    {
        ...
        foreach ($values as $supplierMailNotReceivedInfoMidocoFlightDetailItem) {
            // validation for constraint: itemType
            if (!$supplierMailNotReceivedInfoMidocoFlightDetailItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightDetail) {
