...
class GetSupplierCcCardResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierCcCardForArrayConstraintsFromSetMidocoSupplierCcCard(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierCcCardResponseMidocoSupplierCcCardItem) {
            ...
            if (!$getSupplierCcCardResponseMidocoSupplierCcCardItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierCcCard) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierCcCard[] $midocoSupplierCcCard
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierCcCardResponse
     */
