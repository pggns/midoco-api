...
/**
 * This class stands for PrepareAgencyProvisionRequest StructType
 * @subpackage Structs
 */
class PrepareAgencyProvisionRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for PrepareAgencyProvisionRequest
     * @uses PrepareAgencyProvisionRequest::setMidocoAgencyProvisionSearchCriteria()
     * @uses PrepareAgencyProvisionRequest::setMidocoAgencySettlement()
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAgencyProvisionSearchCriteria $midocoAgencyProvisionSearchCriteria
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrepareAgencyProvisionRequest
     */
