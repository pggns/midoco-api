...
class MidocoTravelCm extends TravelCmDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr[] $midocoTravelAttr
     * @param \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO[] $midocoTravelExtraData
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr[]
     */
    ...
    public static function validateMidocoTravelAttrForArrayConstraintsFromSetMidocoTravelAttr(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTravelCmMidocoTravelAttrItem) {
            ...
            if (!$midocoTravelCmMidocoTravelAttrItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelAttr property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelCm
     */
    public function addToMidocoTravelAttr(\Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelAttr property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelAttr, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO[]
     */
    ...
    public static function validateMidocoTravelExtraDataForArrayConstraintsFromSetMidocoTravelExtraData(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTravelCmMidocoTravelExtraDataItem) {
            // validation for constraint: itemType
            if (!$midocoTravelCmMidocoTravelExtraDataItem instanceof \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelExtraData property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoTravelCm
     */
    public function addToMidocoTravelExtraData(\Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelExtraData property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\TravelExtraDataDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
