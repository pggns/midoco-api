...
class MidocoSubOrders extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderForArrayConstraintsFromSetMidocoOrder(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSubOrdersMidocoOrderItem) {
            ...
            if (!$midocoSubOrdersMidocoOrderItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType[] $midocoOrder
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoSubOrders
     */
