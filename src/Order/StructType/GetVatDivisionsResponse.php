...
class GetVatDivisionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDivisionForArrayConstraintsFromSetMidocoVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $getVatDivisionsResponseMidocoVatDivisionItem) {
            ...
            if (!$getVatDivisionsResponseMidocoVatDivisionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\VatDivisionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\VatDivisionDTO[] $midocoVatDivision
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetVatDivisionsResponse
     */
