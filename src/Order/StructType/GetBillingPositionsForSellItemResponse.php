...
/**
 * This class stands for GetBillingPositionsForSellItemResponse StructType
 * @subpackage Structs
 */
class GetBillingPositionsForSellItemResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetBillingPositionsForSellItemResponse
     * @uses GetBillingPositionsForSellItemResponse::setMidocoBillingPosition()
    ...
    public static function validateMidocoBillingPositionForArrayConstraintsFromSetMidocoBillingPosition(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $getBillingPositionsForSellItemResponseMidocoBillingPositionItem) {
            // validation for constraint: itemType
            if (!$getBillingPositionsForSellItemResponseMidocoBillingPositionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionType) {
                $invalidValues[] = is_object($getBillingPositionsForSellItemResponseMidocoBillingPositionItem) ? get_class($getBillingPositionsForSellItemResponseMidocoBillingPositionItem) : sprintf('%s(%s)', gettype($getBillingPositionsForSellItemResponseMidocoBillingPositionItem), var_export($getBillingPositionsForSellItemResponseMidocoBillingPositionItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionType[] $midocoBillingPosition
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetBillingPositionsForSellItemResponse
     */
