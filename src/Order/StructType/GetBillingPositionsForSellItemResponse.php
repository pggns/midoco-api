...
class GetBillingPositionsForSellItemResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBillingPositionForArrayConstraintFromSetMidocoBillingPosition(?array $values = []): string
    {
        ...
        foreach ($values as $getBillingPositionsForSellItemResponseMidocoBillingPositionItem) {
            ...
            if (!$getBillingPositionsForSellItemResponseMidocoBillingPositionItem instanceof \Pggns\MidocoApi\Order\StructType\MidocoBillingPositionType) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\MidocoBillingPositionType[] $midocoBillingPosition
     * @return \Pggns\MidocoApi\Order\StructType\GetBillingPositionsForSellItemResponse
     */
