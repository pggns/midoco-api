...
class MidocoFlightDetail extends FlightDetailDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails[] $midocoFlightSegmentDetails
     * @param string $route
     * @param float $price
     */
    ...
    public static function validateMidocoFlightSegmentDetailsForArrayConstraintsFromSetMidocoFlightSegmentDetails(?array $values = []): string
    {
        ...
        foreach ($values as $midocoFlightDetailMidocoFlightSegmentDetailsItem) {
            ...
            if (!$midocoFlightDetailMidocoFlightSegmentDetailsItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFlightSegmentDetails property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightDetail
     */
    public function addToMidocoFlightSegmentDetails(\Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails) {
            throw new InvalidArgumentException(sprintf('The MidocoFlightSegmentDetails property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
