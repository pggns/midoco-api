...
/**
 * This class stands for GetBillingInternalVersionRequest StructType
 * @subpackage Structs
 */
class GetBillingInternalVersionRequest extends AbstractStructBase
{
    /**
     * The billingId
     * @var int|null
    ...
    /**
     * Constructor method for GetBillingInternalVersionRequest
     * @uses GetBillingInternalVersionRequest::setBillingId()
     * @param int $billingId
     */
     ...
     * Set billingId value
     * @param int $billingId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetBillingInternalVersionRequest
     */
