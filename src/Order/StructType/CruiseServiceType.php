...
class CruiseServiceType extends AbstractStructBase
{
    ...
    public function setArrivalTransportType(?string $arrivalTransportType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\TransportType::valueIsValid($arrivalTransportType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\TransportType', is_array($arrivalTransportType) ? implode(', ', $arrivalTransportType) : var_export($arrivalTransportType, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\TransportType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Order\EnumType\TransportType::valueIsValid($returnTransportType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\TransportType', is_array($returnTransportType) ? implode(', ', $returnTransportType) : var_export($returnTransportType, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\TransportType::getValidValues())), __LINE__);
        }
