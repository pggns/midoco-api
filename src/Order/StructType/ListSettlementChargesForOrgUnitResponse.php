...
class ListSettlementChargesForOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSettlementChargeForArrayConstraintsFromSetMidocoSettlementCharge(?array $values = []): string
    {
        ...
        foreach ($values as $listSettlementChargesForOrgUnitResponseMidocoSettlementChargeItem) {
            ...
            if (!$listSettlementChargesForOrgUnitResponseMidocoSettlementChargeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\SettlementChargeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SettlementChargeDTO[] $midocoSettlementCharge
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListSettlementChargesForOrgUnitResponse
     */
