...
class CustAddrDebitorPayment extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO[] $midocoCrmBonusCard
     ...
     * @return \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO[]
     */
    ...
    public static function validateMidocoCrmBonusCardForArrayConstraintsFromSetMidocoCrmBonusCard(?array $values = []): string
    {
        ...
        foreach ($values as $custAddrDebitorPaymentMidocoCrmBonusCardItem) {
            // validation for constraint: itemType
            if (!$custAddrDebitorPaymentMidocoCrmBonusCardItem instanceof \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmBonusCard property can only contain items of type \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO $item
     * @return \Pggns\MidocoApi\Order\StructType\CustAddrDebitorPayment
     */
    public function addToMidocoCrmBonusCard(\Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmBonusCard property can only contain items of type \Pggns\MidocoApi\Order\StructType\CrmBonusCardDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $custAddrDebitorPaymentMidocoCrmCriteriaItem) {
            // validation for constraint: itemType
            if (!$custAddrDebitorPaymentMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Order\StructType\CrmCriteriaDTO) {
