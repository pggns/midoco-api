...
class GetAirportCodesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode[]
     */
    ...
    public static function validateMidocoAirportCodeForArrayConstraintsFromSetMidocoAirportCode(?array $values = []): string
    {
        ...
        foreach ($values as $getAirportCodesResponseMidocoAirportCodeItem) {
            ...
            if (!$getAirportCodesResponseMidocoAirportCodeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAirportCode property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode[] $midocoAirportCode
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAirportCodesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAirportCodesResponse
     */
    public function addToMidocoAirportCode(\Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode) {
            throw new InvalidArgumentException(sprintf('The MidocoAirportCode property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoAirportCode, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
