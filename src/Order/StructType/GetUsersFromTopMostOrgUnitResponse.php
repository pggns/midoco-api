...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetUsersFromTopMostOrgUnitResponse
     */
