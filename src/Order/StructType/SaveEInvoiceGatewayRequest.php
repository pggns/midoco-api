...
class SaveEInvoiceGatewayRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoEInvoiceGatewayForArrayConstraintsFromSetMidocoEInvoiceGateway(?array $values = []): string
    {
        ...
        foreach ($values as $saveEInvoiceGatewayRequestMidocoEInvoiceGatewayItem) {
            ...
            if (!$saveEInvoiceGatewayRequestMidocoEInvoiceGatewayItem instanceof \Pggns\MidocoApi\Api\Order\StructType\EinvoiceGatewayDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\EinvoiceGatewayDTO[] $midocoEInvoiceGateway
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveEInvoiceGatewayRequest
     */
