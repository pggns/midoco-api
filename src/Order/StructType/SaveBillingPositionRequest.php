...
class SaveBillingPositionRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoBillingPositionForArrayConstraintsFromSetMidocoBillingPosition(?array $values = []): string
    {
        ...
        foreach ($values as $saveBillingPositionRequestMidocoBillingPositionItem) {
            ...
            if (!$saveBillingPositionRequestMidocoBillingPositionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionType[] $midocoBillingPosition
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveBillingPositionRequest
     */
