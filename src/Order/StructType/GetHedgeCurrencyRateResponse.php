...
class GetHedgeCurrencyRateResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCurrencyRateHedgeForArrayConstraintFromSetMidocoCurrencyRateHedge(?array $values = []): string
    {
        ...
        foreach ($values as $getHedgeCurrencyRateResponseMidocoCurrencyRateHedgeItem) {
            ...
            if (!$getHedgeCurrencyRateResponseMidocoCurrencyRateHedgeItem instanceof \Pggns\MidocoApi\Order\StructType\CurrencyRateHedgeDTO) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\CurrencyRateHedgeDTO[] $midocoCurrencyRateHedge
     * @return \Pggns\MidocoApi\Order\StructType\GetHedgeCurrencyRateResponse
     */
