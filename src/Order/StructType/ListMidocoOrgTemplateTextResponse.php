...
class ListMidocoOrgTemplateTextResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo[] $midocoOrgTemplateTextInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo[]
     */
    ...
    public static function validateMidocoOrgTemplateTextInfoForArrayConstraintsFromSetMidocoOrgTemplateTextInfo(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoOrgTemplateTextResponseMidocoOrgTemplateTextInfoItem) {
            ...
            if (!$listMidocoOrgTemplateTextResponseMidocoOrgTemplateTextInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgTemplateTextInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo[] $midocoOrgTemplateTextInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListMidocoOrgTemplateTextResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListMidocoOrgTemplateTextResponse
     */
    public function addToMidocoOrgTemplateTextInfo(\Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgTemplateTextInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoOrgTemplateTextInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
