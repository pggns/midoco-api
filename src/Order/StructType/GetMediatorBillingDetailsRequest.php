...
/**
 * This class stands for GetMediatorBillingDetailsRequest StructType
 * @subpackage Structs
 */
class GetMediatorBillingDetailsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetMediatorBillingDetailsRequest
     * @uses GetMediatorBillingDetailsRequest::setMediatorBillingId()
     ...
     * @param int $mediatorBillingId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMediatorBillingDetailsRequest
     */
