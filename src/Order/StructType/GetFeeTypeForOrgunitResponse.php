...
class GetFeeTypeForOrgunitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit[]
     */
    ...
    public static function validateMidocoFeeTypeOrgUnitForArrayConstraintsFromSetMidocoFeeTypeOrgUnit(?array $values = []): string
    {
        ...
        foreach ($values as $getFeeTypeForOrgunitResponseMidocoFeeTypeOrgUnitItem) {
            ...
            if (!$getFeeTypeForOrgunitResponseMidocoFeeTypeOrgUnitItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeTypeOrgUnit property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit[] $midocoFeeTypeOrgUnit
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetFeeTypeForOrgunitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetFeeTypeForOrgunitResponse
     */
    public function addToMidocoFeeTypeOrgUnit(\Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeTypeOrgUnit property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoFeeTypeOrgUnit, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
