...
class MidocoDocumentItem extends DocumentitemDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType[] $midocoDocumentTax
     * @param \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO[] $midocoDocFlightDetail
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType[]
     */
    ...
    public static function validateMidocoDocumentTaxForArrayConstraintsFromSetMidocoDocumentTax(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentItemMidocoDocumentTaxItem) {
            ...
            if (!$midocoDocumentItemMidocoDocumentTaxItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentTax property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType[] $midocoDocumentTax
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentItem
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentItem
     */
    public function addToMidocoDocumentTax(\Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentTax property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentTaxType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO[]
     */
    ...
    public static function validateMidocoDocFlightDetailForArrayConstraintsFromSetMidocoDocFlightDetail(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentItemMidocoDocFlightDetailItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentItemMidocoDocFlightDetailItem instanceof \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocFlightDetail property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoDocumentItem
     */
    public function addToMidocoDocFlightDetail(\Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDocFlightDetail property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\DocFlightDetailDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
