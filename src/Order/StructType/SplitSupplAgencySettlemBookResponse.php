...
/**
 * This class stands for SplitSupplAgencySettlemBookResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SplitSupplAgencySettlemBookResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SplitSupplAgencySettlemBookResponse
     * @uses SplitSupplAgencySettlemBookResponse::setMidocoSupplierAgencySettlementBooking()
