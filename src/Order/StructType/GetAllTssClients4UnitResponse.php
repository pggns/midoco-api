...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoTssClient
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient[]
     */
    ...
    public static function validateMidocoTssClientForArrayConstraintsFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTssClient property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAllTssClients4UnitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAllTssClients4UnitResponse
     */
    public function addToMidocoTssClient(\Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient) {
            throw new InvalidArgumentException(sprintf('The MidocoTssClient property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoTssClient, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
