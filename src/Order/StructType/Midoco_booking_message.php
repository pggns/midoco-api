...
class Midoco_booking_message extends AbstractStructBase
{
    /**
     * The agency_identity
     * @var \Pggns\MidocoApi\Api\Order\StructType\Agency_identity|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\Agency_identity $agency_identity = null;
    /**
     * The customer
     * Meta information extracted from the WSDL
     * - maxOccurs: 2
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Package_info[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Marketing_info|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\Marketing_info $marketing_info = null;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Order_remark[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Imported_document[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\Agency_identity $agency_identity
     * @param \Pggns\MidocoApi\Api\Order\StructType\Customer[] $customer
     * @param \Pggns\MidocoApi\Api\Order\StructType\Package_info[] $package_info
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\Marketing_info $marketing_info
     * @param \Pggns\MidocoApi\Api\Order\StructType\Internal_treatment $internal_treatment
     * @param \Pggns\MidocoApi\Api\Order\StructType\Order_remark[] $order_remark
     * @param \Pggns\MidocoApi\Api\Order\StructType\ExternalPayment[] $externalPayment
     * @param \Pggns\MidocoApi\Api\Order\StructType\Imported_document[] $imported_document
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo[] $verk_data
     * @param int $message_version
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\Agency_identity $agency_identity = null, ?array $customer = null, ?array $package_info = null, ?array $booking = null, ?\Pggns\MidocoApi\Api\Order\StructType\Prices $prices = null, ?array $ticket = null, ?\Pggns\MidocoApi\Api\Order\StructType\Payment_info $payment_info = null, ?\Pggns\MidocoApi\Api\Order\StructType\Marketing_info $marketing_info = null, ?\Pggns\MidocoApi\Api\Order\StructType\Internal_treatment $internal_treatment = null, ?array $order_remark = null, ?array $externalPayment = null, ?array $imported_document = null, ?array $dunningInfo = null, ?array $voucher = null, ?array $verk_data = null, ?int $message_version = 1)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Agency_identity|null
     */
    public function getAgency_identity(): ?\Pggns\MidocoApi\Api\Order\StructType\Agency_identity
    {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\Agency_identity $agency_identity
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function setAgency_identity(?\Pggns\MidocoApi\Api\Order\StructType\Agency_identity $agency_identity = null): self
    {
    ...
    public static function validateCustomerForArrayConstraintsFromSetCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageCustomerItem) {
            ...
            if (!$midoco_booking_messageCustomerItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Customer) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Package_info[]
     */
    ...
    public static function validatePackage_infoForArrayConstraintsFromSetPackage_info(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messagePackage_infoItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messagePackage_infoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Package_info) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The package_info property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Package_info, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Package_info $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function addToPackage_info(\Pggns\MidocoApi\Api\Order\StructType\Package_info $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Package_info) {
            throw new InvalidArgumentException(sprintf('The package_info property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Package_info, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateBookingForArrayConstraintsFromSetBooking(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageBookingItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageBookingItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Booking) {
    ...
    public static function validateTicketForArrayConstraintsFromSetTicket(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageTicketItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageTicketItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Ticket) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Marketing_info|null
     */
    public function getMarketing_info(): ?\Pggns\MidocoApi\Api\Order\StructType\Marketing_info
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function setMarketing_info(?\Pggns\MidocoApi\Api\Order\StructType\Marketing_info $marketing_info = null): self
    {
    ...
    public static function validateOrder_remarkForArrayConstraintsFromSetOrder_remark(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageOrder_remarkItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageOrder_remarkItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Order_remark) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The order_remark property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Order_remark, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Order_remark $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function addToOrder_remark(\Pggns\MidocoApi\Api\Order\StructType\Order_remark $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Order_remark) {
            throw new InvalidArgumentException(sprintf('The order_remark property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Order_remark, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateExternalPaymentForArrayConstraintsFromSetExternalPayment(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageExternalPaymentItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageExternalPaymentItem instanceof \Pggns\MidocoApi\Api\Order\StructType\ExternalPayment) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Imported_document[]
     */
    ...
    public static function validateImported_documentForArrayConstraintsFromSetImported_document(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageImported_documentItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageImported_documentItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Imported_document) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The imported_document property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Imported_document, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Imported_document $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function addToImported_document(\Pggns\MidocoApi\Api\Order\StructType\Imported_document $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Imported_document) {
            throw new InvalidArgumentException(sprintf('The imported_document property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Imported_document, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateDunningInfoForArrayConstraintsFromSetDunningInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageDunningInfoItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageDunningInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\DunningInfo) {
    ...
    public static function validateVoucherForArrayConstraintsFromSetVoucher(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageVoucherItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageVoucherItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Voucher) {
    ...
    public static function validateVerk_dataForArrayConstraintsFromSetVerk_data(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageVerk_dataItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageVerk_dataItem instanceof \Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The verk_data property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Midoco_booking_message
     */
    public function addToVerk_data(\Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo) {
            throw new InvalidArgumentException(sprintf('The verk_data property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\VerkDataInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
