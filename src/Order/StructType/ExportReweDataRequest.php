...
/**
 * This class stands for ExportReweDataRequest StructType
 * @subpackage Structs
 */
class ExportReweDataRequest extends AbstractStructBase
{
    /**
     * The startTravel
     * @var string|null
    ...
    /**
     * Constructor method for ExportReweDataRequest
     * @uses ExportReweDataRequest::setStartTravel()
     * @uses ExportReweDataRequest::setEndTravel()
     * @param string $startTravel
     * @param string $endTravel
     */
    public function __construct(?string $startTravel = null, ?string $endTravel = null)
    {
        $this
