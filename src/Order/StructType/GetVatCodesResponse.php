...
class GetVatCodesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatCodeForArrayConstraintsFromSetMidocoVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $getVatCodesResponseMidocoVatCodeItem) {
            ...
            if (!$getVatCodesResponseMidocoVatCodeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoVatCode) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoVatCode[] $midocoVatCode
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetVatCodesResponse
     */
