...
class CCPaymentAdditionalInfo extends AbstractStructBase
{
    ...
    /**
     * Set name value
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Name::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\Name::getValidValues()
    ...
    public function setName(?string $name = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\Name::valueIsValid($name)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\Name', is_array($name) ? implode(', ', $name) : var_export($name, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\Name::getValidValues())), __LINE__);
        }
        $this->name = $name;
