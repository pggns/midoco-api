...
class SearchBankByBankNoResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoBankInfo
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo[]
     */
    ...
    public static function validateMidocoBankInfoForArrayConstraintsFromSetMidocoBankInfo(?array $values = []): string
    {
        ...
        foreach ($values as $searchBankByBankNoResponseMidocoBankInfoItem) {
            ...
            if (!$searchBankByBankNoResponseMidocoBankInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBankInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo[] $midocoBankInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchBankByBankNoResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchBankByBankNoResponse
     */
    public function addToMidocoBankInfo(\Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoBankInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoBankInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
