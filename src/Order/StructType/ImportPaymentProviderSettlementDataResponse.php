...
class ImportPaymentProviderSettlementDataResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFaultForArrayConstraintsFromSetMidocoFault(?array $values = []): string
    {
        ...
        foreach ($values as $importPaymentProviderSettlementDataResponseMidocoFaultItem) {
            ...
            if (!$importPaymentProviderSettlementDataResponseMidocoFaultItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFaultType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFaultType[] $midocoFault
     * @return \Pggns\MidocoApi\Api\Order\StructType\ImportPaymentProviderSettlementDataResponse
     */
