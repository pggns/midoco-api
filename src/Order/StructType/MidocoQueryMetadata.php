...
class MidocoQueryMetadata extends AbstractStructBase
{
    ...
    public static function validateMidocoQueryFieldForArrayConstraintsFromSetMidocoQueryField(?array $values = []): string
    {
        ...
        foreach ($values as $midocoQueryMetadataMidocoQueryFieldItem) {
            ...
            if (!$midocoQueryMetadataMidocoQueryFieldItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoQueryField) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoQueryField[] $midocoQueryField
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoQueryMetadata
     */
