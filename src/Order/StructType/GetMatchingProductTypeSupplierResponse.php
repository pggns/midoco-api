...
class GetMatchingProductTypeSupplierResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoProductTypeSupplierForArrayConstraintsFromSetMidocoProductTypeSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingProductTypeSupplierResponseMidocoProductTypeSupplierItem) {
            ...
            if (!$getMatchingProductTypeSupplierResponseMidocoProductTypeSupplierItem instanceof \Pggns\MidocoApi\Api\Order\StructType\ProductTypeSupplierDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ProductTypeSupplierDTO[] $midocoProductTypeSupplier
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMatchingProductTypeSupplierResponse
     */
