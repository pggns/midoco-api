...
class GetMfLocalRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\MidocoMfLocal $midocoMfLocal = null, ?string $unitName = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoMfLocal $midocoMfLocal
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMfLocalRequest
     */
