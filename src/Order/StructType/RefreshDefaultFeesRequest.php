...
class RefreshDefaultFeesRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for RefreshDefaultFeesRequest
     * @uses RefreshDefaultFeesRequest::setOrderId()
     * @param int $orderId
     */
     ...
     * Set orderId value
     * @param int $orderId
     * @return \Pggns\MidocoApi\Api\Order\StructType\RefreshDefaultFeesRequest
     */
