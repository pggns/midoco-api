...
class Cruise_service_type extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\TransportType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\TransportType::getValidValues()
    ...
    public function setArrival_transport_type(?string $arrival_transport_type = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\TransportType::valueIsValid($arrival_transport_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\TransportType', is_array($arrival_transport_type) ? implode(', ', $arrival_transport_type) : var_export($arrival_transport_type, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\TransportType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Order\EnumType\TransportType::valueIsValid($return_transport_type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\TransportType', is_array($return_transport_type) ? implode(', ', $return_transport_type) : var_export($return_transport_type, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\TransportType::getValidValues())), __LINE__);
        }
