...
class GetUnitNoticeReponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO[]
     */
    ...
    public static function validateMidocoOrgunitNoticeForArrayConstraintsFromSetMidocoOrgunitNotice(?array $values = []): string
    {
        ...
        foreach ($values as $getUnitNoticeReponseMidocoOrgunitNoticeItem) {
            ...
            if (!$getUnitNoticeReponseMidocoOrgunitNoticeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitNotice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO[] $midocoOrgunitNotice
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetUnitNoticeReponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetUnitNoticeReponse
     */
    public function addToMidocoOrgunitNotice(\Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitNotice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\UnitNoticeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
