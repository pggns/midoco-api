...
class GetSupplierFreeStornoDayssResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO[]
     */
    ...
    public static function validateMidocoSupplierFreeStornoDaysForArrayConstraintsFromSetMidocoSupplierFreeStornoDays(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierFreeStornoDayssResponseMidocoSupplierFreeStornoDaysItem) {
            ...
            if (!$getSupplierFreeStornoDayssResponseMidocoSupplierFreeStornoDaysItem instanceof \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierFreeStornoDays property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO[] $midocoSupplierFreeStornoDays
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierFreeStornoDayssResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierFreeStornoDayssResponse
     */
    public function addToMidocoSupplierFreeStornoDays(\Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierFreeStornoDays property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SupplierFreeStornoDayDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
