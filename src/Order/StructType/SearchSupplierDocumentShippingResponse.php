...
class SearchSupplierDocumentShippingResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping[]
     */
    ...
    public static function validateMidocoSupplierDocumentShippingForArrayConstraintsFromSetMidocoSupplierDocumentShipping(?array $values = []): string
    {
        ...
        foreach ($values as $searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem) {
            ...
            if (!$searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping[] $midocoSupplierDocumentShipping
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchSupplierDocumentShippingResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchSupplierDocumentShippingResponse
     */
    public function addToMidocoSupplierDocumentShipping(\Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierDocumentShipping, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
