...
/**
 * This class stands for PrepareAgencyProvisionResponse StructType
 * @subpackage Structs
 */
class PrepareAgencyProvisionResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for PrepareAgencyProvisionResponse
     * @uses PrepareAgencyProvisionResponse::setMidocoAgencyProvisionInfo()
    ...
    public static function validateMidocoAgencyProvisionInfoForArrayConstraintsFromSetMidocoAgencyProvisionInfo(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem) {
            // validation for constraint: itemType
            if (!$prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAgencyProvisionInfo) {
                $invalidValues[] = is_object($prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem) ? get_class($prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem) : sprintf('%s(%s)', gettype($prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem), var_export($prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAgencyProvisionInfo[] $midocoAgencyProvisionInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrepareAgencyProvisionResponse
     */
