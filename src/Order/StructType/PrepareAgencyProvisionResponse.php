...
class PrepareAgencyProvisionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAgencyProvisionInfoForArrayConstraintFromSetMidocoAgencyProvisionInfo(?array $values = []): string
    {
        ...
        foreach ($values as $prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem) {
            ...
            if (!$prepareAgencyProvisionResponseMidocoAgencyProvisionInfoItem instanceof \Pggns\MidocoApi\Order\StructType\MidocoAgencyProvisionInfo) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\MidocoAgencyProvisionInfo[] $midocoAgencyProvisionInfo
     * @return \Pggns\MidocoApi\Order\StructType\PrepareAgencyProvisionResponse
     */
