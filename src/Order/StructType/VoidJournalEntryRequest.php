...
class VoidJournalEntryRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for VoidJournalEntryRequest
     * @uses VoidJournalEntryRequest::setJournal_id()
     ...
     * @param int $journal_id
     * @return \Pggns\MidocoApi\Api\Order\StructType\VoidJournalEntryRequest
     */
