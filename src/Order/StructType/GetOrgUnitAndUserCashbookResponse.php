...
class GetOrgUnitAndUserCashbookResponse extends AbstractStructBase
{
    ...
    public static function validateCashBookInfoForArrayConstraintsFromSetCashBookInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgUnitAndUserCashbookResponseCashBookInfoItem) {
            ...
            if (!$getOrgUnitAndUserCashbookResponseCashBookInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\CashBookInfo) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\CashBookInfo[] $cashBookInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrgUnitAndUserCashbookResponse
     */
