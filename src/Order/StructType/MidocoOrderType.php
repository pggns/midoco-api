...
class MidocoOrderType extends OrderDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO $MidocoAdvisedPayment = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO $midocoAdvisedPayment
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\MidocoOnlinePayment $midocoOnlinePayment = null, ?\Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO $midocoAdvisedPayment = null, ?\Pggns\MidocoApi\Api\Order\StructType\MidocoDebitPayment $midocoDebitPayment = null, ?array $midocoSellItem = null, ?array $midocoOrderCustomer = null, ?array $midocoOrdersDbiInfo = null, ?array $externalPayment = null, ?float $calculatedMarginServices = null, ?string $unitAlias = null, ?string $mediatorPortal = null, ?bool $isModified = null, ?string $preferredPaymentType = null, ?string $paymentTypeInfo = null, ?bool $existTravelPlans = null, ?bool $existOrderDocuments = null, ?bool $existOrderNotices = null, ?bool $existOrderRemarks = null, ?bool $existPaymentPaycodes = null, ?bool $existOrderBillings = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOnlinePayment $midocoOnlinePayment
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO|null
     */
    public function getMidocoAdvisedPayment(): ?\Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType
     */
    public function setMidocoAdvisedPayment(?\Pggns\MidocoApi\Api\Order\StructType\AdvisedPaymentDTO $midocoAdvisedPayment = null): self
    {
    ...
    public static function validateMidocoSellItemForArrayConstraintsFromSetMidocoSellItem(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderTypeMidocoSellItemItem) {
            ...
            if (!$midocoOrderTypeMidocoSellItemItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSellItemType) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer[]
     */
    ...
    public static function validateMidocoOrderCustomerForArrayConstraintsFromSetMidocoOrderCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderTypeMidocoOrderCustomerItem) {
            // validation for constraint: itemType
            if (!$midocoOrderTypeMidocoOrderCustomerItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderCustomer property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType
     */
    public function addToMidocoOrderCustomer(\Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderCustomer property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(3)
    ...
    public static function validateMidocoOrdersDbiInfoForArrayConstraintsFromSetMidocoOrdersDbiInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderTypeMidocoOrdersDbiInfoItem) {
            // validation for constraint: itemType
            if (!$midocoOrderTypeMidocoOrdersDbiInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrdersDbiInfo) {
    ...
    public static function validateExternalPaymentForArrayConstraintsFromSetExternalPayment(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderTypeExternalPaymentItem) {
            // validation for constraint: itemType
            if (!$midocoOrderTypeExternalPaymentItem instanceof \Pggns\MidocoApi\Api\Order\StructType\ExternalPayment) {
