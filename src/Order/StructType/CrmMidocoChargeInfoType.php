...
class CrmMidocoChargeInfoType extends CrmMidocoChargeDTO
{
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintsFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$crmMidocoChargeInfoTypeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Api\Order\StructType\AssignedMidocoChargeOuDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Api\Order\StructType\CrmMidocoChargeInfoType
     */
