...
class ListCabinClassResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass[] $midocoCabinClass
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass[]
     */
    ...
    public static function validateMidocoCabinClassForArrayConstraintsFromSetMidocoCabinClass(?array $values = []): string
    {
        ...
        foreach ($values as $listCabinClassResponseMidocoCabinClassItem) {
            ...
            if (!$listCabinClassResponseMidocoCabinClassItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCabinClass property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass[] $midocoCabinClass
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListCabinClassResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListCabinClassResponse
     */
    public function addToMidocoCabinClass(\Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass) {
            throw new InvalidArgumentException(sprintf('The MidocoCabinClass property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoCabinClass, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
