...
class BaggageAllowance extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\WeightUnitsType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\WeightUnitsType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $weightUnit
     * @return \Pggns\MidocoApi\Api\Order\StructType\BaggageAllowance
     */
    public function setWeightUnit(?string $weightUnit = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\WeightUnitsType::valueIsValid($weightUnit)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\WeightUnitsType', is_array($weightUnit) ? implode(', ', $weightUnit) : var_export($weightUnit, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\WeightUnitsType::getValidValues())), __LINE__);
        }
