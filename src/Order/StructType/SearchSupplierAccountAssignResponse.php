...
class SearchSupplierAccountAssignResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierAccountAssignForArrayConstraintsFromSetMidocoSupplierAccountAssign(?array $values = []): string
    {
        ...
        foreach ($values as $searchSupplierAccountAssignResponseMidocoSupplierAccountAssignItem) {
            ...
            if (!$searchSupplierAccountAssignResponseMidocoSupplierAccountAssignItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierAccountAssign) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSupplierAccountAssign[] $midocoSupplierAccountAssign
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchSupplierAccountAssignResponse
     */
