...
class PrepareGroupAdvisorCommissionResponse extends AbstractStructBase
{
    ...
    public static function validateGroupAdvisorSettlementForArrayConstraintsFromSetGroupAdvisorSettlement(?array $values = []): string
    {
        ...
        foreach ($values as $prepareGroupAdvisorCommissionResponseGroupAdvisorSettlementItem) {
            ...
            if (!$prepareGroupAdvisorCommissionResponseGroupAdvisorSettlementItem instanceof \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlement) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlement[] $groupAdvisorSettlement
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrepareGroupAdvisorCommissionResponse
     */
