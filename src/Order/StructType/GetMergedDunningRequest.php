...
/**
 * This class stands for GetMergedDunningRequest StructType
 * @subpackage Structs
 */
class GetMergedDunningRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetMergedDunningRequest
     * @uses GetMergedDunningRequest::setMidocoDunningTemplate()
     * @uses GetMergedDunningRequest::setStartDate()
     * @uses GetMergedDunningRequest::setEndDate()
     * @uses GetMergedDunningRequest::setFromDunningLevel()
     * @uses GetMergedDunningRequest::setToDunningLevel()
     * @uses GetMergedDunningRequest::setSearchMode()
     * @uses GetMergedDunningRequest::setOrgUnit()
