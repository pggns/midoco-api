...
class GetDestinationAutoRemarksRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\DestinationAutoRemarkDTO $midocoDestinationAutoRemark = null, ?bool $ignoreCultureId = false)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\DestinationAutoRemarkDTO $midocoDestinationAutoRemark
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetDestinationAutoRemarksRequest
     */
