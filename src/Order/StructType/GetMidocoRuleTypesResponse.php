...
class GetMidocoRuleTypesResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoRuleType
     * @var \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO[] $midocoRuleType
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO[]
     */
    ...
    public static function validateMidocoRuleTypeForArrayConstraintsFromSetMidocoRuleType(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoRuleTypesResponseMidocoRuleTypeItem) {
            ...
            if (!$getMidocoRuleTypesResponseMidocoRuleTypeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRuleType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO[] $midocoRuleType
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMidocoRuleTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMidocoRuleTypesResponse
     */
    public function addToMidocoRuleType(\Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoRuleType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\RuleTypeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
