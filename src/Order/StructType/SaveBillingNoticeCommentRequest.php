...
/**
 * This class stands for SaveBillingNoticeCommentRequest StructType
 * @subpackage Structs
 */
class SaveBillingNoticeCommentRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SaveBillingNoticeCommentRequest
     * @uses SaveBillingNoticeCommentRequest::setMidocoBillingNoticeComment()
     * @uses SaveBillingNoticeCommentRequest::setDocumentInternalVersion()
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\BillingNoticeCommentDTO $midocoBillingNoticeComment = null, ?int $documentInternalVersion = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\BillingNoticeCommentDTO $midocoBillingNoticeComment
     * @return \Pggns\MidocoApi\Api\Order\StructType\SaveBillingNoticeCommentRequest
     */
