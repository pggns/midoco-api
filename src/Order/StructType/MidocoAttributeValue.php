...
class MidocoAttributeValue extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType[] $midocoChoiceValues
     * @param int $id
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType[]
     */
    ...
    public static function validateMidocoChoiceValuesForArrayConstraintsFromSetMidocoChoiceValues(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAttributeValueMidocoChoiceValuesItem) {
            ...
            if (!$midocoAttributeValueMidocoChoiceValuesItem instanceof \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoChoiceValues property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoAttributeValue
     */
    public function addToMidocoChoiceValues(\Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType) {
            throw new InvalidArgumentException(sprintf('The MidocoChoiceValues property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\AttributeChoiceValueType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
