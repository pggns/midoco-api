...
/**
 * This class stands for PrintUserBonusCalculationResponse StructType
 * @subpackage Structs
 */
class PrintUserBonusCalculationResponse extends AbstractStructBase
{
    /**
     * The PrintjobId
     * @var int|null
    ...
    /**
     * Constructor method for PrintUserBonusCalculationResponse
     * @uses PrintUserBonusCalculationResponse::setPrintjobId()
     ...
     * @param int $printjobId
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrintUserBonusCalculationResponse
     */
