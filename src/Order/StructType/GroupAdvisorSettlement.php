...
class GroupAdvisorSettlement extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail[] $groupAdvisorSettlementDetail
    ...
    public static function validateGroupAdvisorSettlementDetailForArrayConstraintsFromSetGroupAdvisorSettlementDetail(?array $values = []): string
    {
        ...
        foreach ($values as $groupAdvisorSettlementGroupAdvisorSettlementDetailItem) {
            ...
            if (!$groupAdvisorSettlementGroupAdvisorSettlementDetailItem instanceof \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The GroupAdvisorSettlementDetail property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlement
     */
    public function addToGroupAdvisorSettlementDetail(\Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail) {
            throw new InvalidArgumentException(sprintf('The GroupAdvisorSettlementDetail property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\GroupAdvisorSettlementDetail, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
