...
class Package_info extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Price_calculation[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Packagefee[]
     */
     ...
     * @param int $price_ref
     * @param \Pggns\MidocoApi\Api\Order\StructType\Price_calculation[] $price_calculation
     * @param \Pggns\MidocoApi\Api\Order\StructType\Packagefee[] $packagefee
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Price_calculation[]
     */
    ...
    public static function validatePrice_calculationForArrayConstraintsFromSetPrice_calculation(?array $values = []): string
    {
        ...
        foreach ($values as $package_infoPrice_calculationItem) {
            ...
            if (!$package_infoPrice_calculationItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Price_calculation) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The price_calculation property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Price_calculation, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Price_calculation $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Package_info
     */
    public function addToPrice_calculation(\Pggns\MidocoApi\Api\Order\StructType\Price_calculation $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Price_calculation) {
            throw new InvalidArgumentException(sprintf('The price_calculation property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Price_calculation, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Packagefee[]
     */
    ...
    public static function validatePackagefeeForArrayConstraintsFromSetPackagefee(?array $values = []): string
    {
        ...
        foreach ($values as $package_infoPackagefeeItem) {
            // validation for constraint: itemType
            if (!$package_infoPackagefeeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Packagefee) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The packagefee property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Packagefee, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Packagefee $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Package_info
     */
    public function addToPackagefee(\Pggns\MidocoApi\Api\Order\StructType\Packagefee $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Packagefee) {
            throw new InvalidArgumentException(sprintf('The packagefee property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Packagefee, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validatePersonForArrayConstraintsFromSetPerson(?array $values = []): string
    {
        ...
        foreach ($values as $package_infoPersonItem) {
            // validation for constraint: itemType
            if (!$package_infoPersonItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Person) {
    ...
    public static function validateAttributeForArrayConstraintsFromSetAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $package_infoAttributeItem) {
            // validation for constraint: itemType
            if (!$package_infoAttributeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Attribute) {
