...
/**
 * This class stands for SaveBillingEmailRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveBillingEmailRequest extends AbstractStructBase
{
    /**
     * The documentId
     * @var int|null
     ...
     * @uses SaveBillingEmailRequest::setMedia()
     * @uses SaveBillingEmailRequest::setRepositoryId()
     * @uses SaveBillingEmailRequest::setMidocoMailMessage()
