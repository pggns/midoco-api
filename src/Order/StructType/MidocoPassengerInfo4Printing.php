...
class MidocoPassengerInfo4Printing extends AbstractStructBase
{
     ...
     */
    public function __construct(?int $positionNo = null, ?string $salutation = null, ?string $title = null, ?string $forename = null, ?string $middleName = null, ?string $name = null, ?string $age = null, ?float $singlePrice = null, ?string $ticketNumber = null, ?string $ticketType = null, ?string $ticketMedia = null, ?float $tax = null, ?float $farePrice = null, ?string $vatPercent = null, ?float $vatAmount = null, ?float $feeAmount = null, ?float $originalFarePrice = null, ?string $birthDate = null, ?bool $ignoreInPartialInvoice = null, ?string $nationality = null, ?\Pggns\MidocoApi\Api\Order\StructType\PassengerInfosFlightDTO $midocoPassengerInfosFlight = null, ?\Pggns\MidocoApi\Api\Order\StructType\PassengerInfosRailDTO $midocoPassengerInfosRail = null, ?array $midocoFlightSegmentDetails4Printing = null)
    {
        $this
    ...
    public static function validateMidocoFlightSegmentDetails4PrintingForArrayConstraintsFromSetMidocoFlightSegmentDetails4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoPassengerInfo4PrintingMidocoFlightSegmentDetails4PrintingItem) {
            ...
            if (!$midocoPassengerInfo4PrintingMidocoFlightSegmentDetails4PrintingItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightSegmentDetails4Printing) {
