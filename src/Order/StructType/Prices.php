...
class Prices extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Booking_price[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Flight_price[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Fee[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Details_price[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\BookingPrice[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\FlightPrice[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\Booking_price[] $booking_price
     * @param \Pggns\MidocoApi\Api\Order\StructType\Flight_price[] $flight_price
     * @param \Pggns\MidocoApi\Api\Order\StructType\Fee[] $fee
     * @param \Pggns\MidocoApi\Api\Order\StructType\Details_price[] $details_price
     * @param string $displayed_currency
     * @param float $displayed_currency_rate
     * @param float $booking_currency_rate
     * @param \Pggns\MidocoApi\Api\Order\StructType\BookingPrice[] $bookingPrice
     * @param \Pggns\MidocoApi\Api\Order\StructType\FlightPrice[] $flightPrice
     * @param \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice[] $detailsPrice
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Booking_price[]
     */
    ...
    public static function validateBooking_priceForArrayConstraintsFromSetBooking_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesBooking_priceItem) {
            ...
            if (!$pricesBooking_priceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Booking_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The booking_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Booking_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\Booking_price[] $booking_price
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Booking_price $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToBooking_price(\Pggns\MidocoApi\Api\Order\StructType\Booking_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Booking_price) {
            throw new InvalidArgumentException(sprintf('The booking_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Booking_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Flight_price[]
     */
    ...
    public static function validateFlight_priceForArrayConstraintsFromSetFlight_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesFlight_priceItem) {
            // validation for constraint: itemType
            if (!$pricesFlight_priceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Flight_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The flight_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Flight_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Flight_price $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToFlight_price(\Pggns\MidocoApi\Api\Order\StructType\Flight_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Flight_price) {
            throw new InvalidArgumentException(sprintf('The flight_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Flight_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateFeeForArrayConstraintsFromSetFee(?array $values = []): string
    {
        ...
        foreach ($values as $pricesFeeItem) {
            // validation for constraint: itemType
            if (!$pricesFeeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Fee) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The fee property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Fee, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Fee $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToFee(\Pggns\MidocoApi\Api\Order\StructType\Fee $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Fee) {
            throw new InvalidArgumentException(sprintf('The fee property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Fee, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->fee[] = $item;
    ...
    public static function validateDetails_priceForArrayConstraintsFromSetDetails_price(?array $values = []): string
    {
        ...
        foreach ($values as $pricesDetails_priceItem) {
            // validation for constraint: itemType
            if (!$pricesDetails_priceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Details_price) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The details_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Details_price, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Details_price $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToDetails_price(\Pggns\MidocoApi\Api\Order\StructType\Details_price $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Details_price) {
            throw new InvalidArgumentException(sprintf('The details_price property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Details_price, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateBookingPriceForArrayConstraintsFromSetBookingPrice(?array $values = []): string
    {
        ...
        foreach ($values as $pricesBookingPriceItem) {
            // validation for constraint: itemType
            if (!$pricesBookingPriceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\BookingPrice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The bookingPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\BookingPrice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\BookingPrice $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToBookingPrice(\Pggns\MidocoApi\Api\Order\StructType\BookingPrice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\BookingPrice) {
            throw new InvalidArgumentException(sprintf('The bookingPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\BookingPrice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\FlightPrice[]
     */
    ...
    public static function validateFlightPriceForArrayConstraintsFromSetFlightPrice(?array $values = []): string
    {
        ...
        foreach ($values as $pricesFlightPriceItem) {
            // validation for constraint: itemType
            if (!$pricesFlightPriceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\FlightPrice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The flightPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\FlightPrice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\FlightPrice $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToFlightPrice(\Pggns\MidocoApi\Api\Order\StructType\FlightPrice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\FlightPrice) {
            throw new InvalidArgumentException(sprintf('The flightPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\FlightPrice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice[]
     */
    ...
    public static function validateDetailsPriceForArrayConstraintsFromSetDetailsPrice(?array $values = []): string
    {
        ...
        foreach ($values as $pricesDetailsPriceItem) {
            // validation for constraint: itemType
            if (!$pricesDetailsPriceItem instanceof \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The detailsPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Prices
     */
    public function addToDetailsPrice(\Pggns\MidocoApi\Api\Order\StructType\DetailsPrice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice) {
            throw new InvalidArgumentException(sprintf('The detailsPrice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\DetailsPrice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
