...
class SearchFlightTimeChangeEmailResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFlightTimeChangeEmailForArrayConstraintsFromSetMidocoFlightTimeChangeEmail(?array $values = []): string
    {
        ...
        foreach ($values as $searchFlightTimeChangeEmailResponseMidocoFlightTimeChangeEmailItem) {
            ...
            if (!$searchFlightTimeChangeEmailResponseMidocoFlightTimeChangeEmailItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightTimeChangeEmailType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoFlightTimeChangeEmailType[] $midocoFlightTimeChangeEmail
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchFlightTimeChangeEmailResponse
     */
