...
class DeleteMiscPaymentSettingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMiscPaymentSettingForArrayConstraintsFromSetMidocoMiscPaymentSetting(?array $values = []): string
    {
        ...
        foreach ($values as $deleteMiscPaymentSettingResponseMidocoMiscPaymentSettingItem) {
            ...
            if (!$deleteMiscPaymentSettingResponseMidocoMiscPaymentSettingItem instanceof \Pggns\MidocoApi\Api\Order\StructType\CashPaymentSettingDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\CashPaymentSettingDTO[] $midocoMiscPaymentSetting
     * @return \Pggns\MidocoApi\Api\Order\StructType\DeleteMiscPaymentSettingResponse
     */
