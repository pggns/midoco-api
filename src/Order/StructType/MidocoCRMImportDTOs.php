...
class MidocoCRMImportDTOs extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer[] $midocoImportCustomer
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard[] $midocoImportCCard
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute[] $midocoImportAttribute
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice[] $midocoImportNotice
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor[] $midocoImportDebitor
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory[] $midocoImportHistory
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory[] $midocoImportContactHistory
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress[] $midocoImportAddress
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType[] $midocoImportContactType
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo[] $midocoImportAgencyInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer[]
     */
    ...
    public static function validateMidocoImportCustomerForArrayConstraintsFromSetMidocoImportCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportCustomerItem) {
            ...
            if (!$midocoCRMImportDTOsMidocoImportCustomerItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportCustomer property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer[] $midocoImportCustomer
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportCustomer(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoImportCustomer property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoImportCCardForArrayConstraintsFromSetMidocoImportCCard(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportCCardItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportCCardItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportCCard property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportCCard(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard) {
            throw new InvalidArgumentException(sprintf('The MidocoImportCCard property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportCCard, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute[]
     */
    ...
    public static function validateMidocoImportAttributeForArrayConstraintsFromSetMidocoImportAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAttributeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAttributeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAttribute property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAttribute(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAttribute property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice[]
     */
    ...
    public static function validateMidocoImportNoticeForArrayConstraintsFromSetMidocoImportNotice(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportNoticeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportNoticeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportNotice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportNotice(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice) {
            throw new InvalidArgumentException(sprintf('The MidocoImportNotice property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportNotice, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor[]
     */
    ...
    public static function validateMidocoImportDebitorForArrayConstraintsFromSetMidocoImportDebitor(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportDebitorItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportDebitorItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportDebitor property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportDebitor(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor) {
            throw new InvalidArgumentException(sprintf('The MidocoImportDebitor property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportDebitor, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory[]
     */
    ...
    public static function validateMidocoImportHistoryForArrayConstraintsFromSetMidocoImportHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportHistoryItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportHistory property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportHistory(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory) {
            throw new InvalidArgumentException(sprintf('The MidocoImportHistory property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportHistory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory[]
     */
    ...
    public static function validateMidocoImportContactHistoryForArrayConstraintsFromSetMidocoImportContactHistory(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportContactHistoryItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportContactHistoryItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportContactHistory property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportContactHistory(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory) {
            throw new InvalidArgumentException(sprintf('The MidocoImportContactHistory property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactHistory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress[]
     */
    ...
    public static function validateMidocoImportAddressForArrayConstraintsFromSetMidocoImportAddress(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAddressItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAddressItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAddress property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAddress(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAddress property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAddress, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType[]
     */
    ...
    public static function validateMidocoImportContactTypeForArrayConstraintsFromSetMidocoImportContactType(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportContactTypeItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportContactTypeItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportContactType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportContactType(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType) {
            throw new InvalidArgumentException(sprintf('The MidocoImportContactType property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportContactType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo[]
     */
    ...
    public static function validateMidocoImportAgencyInfoForArrayConstraintsFromSetMidocoImportAgencyInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCRMImportDTOsMidocoImportAgencyInfoItem) {
            // validation for constraint: itemType
            if (!$midocoCRMImportDTOsMidocoImportAgencyInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoImportAgencyInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCRMImportDTOs
     */
    public function addToMidocoImportAgencyInfo(\Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoImportAgencyInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoImportAgencyInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
