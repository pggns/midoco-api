...
class VermiLinkAttributes extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderCustomer $midocoOrderCustomer
     * @return \Pggns\MidocoApi\Api\Order\StructType\VermiLinkAttributes
     */
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $vermiLinkAttributesMidocoSellPassengerItem) {
            ...
            if (!$vermiLinkAttributesMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSellPassenger) {
