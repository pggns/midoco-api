...
class Customer_1 extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\PrivateData_1|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\PrivateData_1 $PrivateData = null;
    /**
     * The CompanyData
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\CompanyData_1|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\CompanyData_1 $CompanyData = null;
    /**
     * The Address
     * Meta information extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * - ref: Address
     * @var \Pggns\MidocoApi\Api\Order\StructType\Address|null
     */
    protected ?\Pggns\MidocoApi\Api\Order\StructType\Address $Address = null;
    /**
     * The Communication
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\Communication_1[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\PrivateData_1 $privateData
     * @param \Pggns\MidocoApi\Api\Order\StructType\CompanyData_1 $companyData
     * @param \Pggns\MidocoApi\Api\Order\StructType\Address $address
     * @param \Pggns\MidocoApi\Api\Order\StructType\Communication_1[] $communication
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrivateData_1|null
     */
    public function getPrivateData(): ?\Pggns\MidocoApi\Api\Order\StructType\PrivateData_1
    {
     ...
     */
    public function setPrivateData(?\Pggns\MidocoApi\Api\Order\StructType\PrivateData_1 $privateData = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CompanyData_1|null
     */
    public function getCompanyData(): ?\Pggns\MidocoApi\Api\Order\StructType\CompanyData_1
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Customer_1
     */
    public function setCompanyData(?\Pggns\MidocoApi\Api\Order\StructType\CompanyData_1 $companyData = null): self
    {
    ...
    /**
     * Get Address value
     * @return \Pggns\MidocoApi\Api\Order\StructType\Address|null
     */
    public function getAddress(): ?\Pggns\MidocoApi\Api\Order\StructType\Address
    {
        return $this->Address;
    }
    /**
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Customer_1
     */
    public function setAddress(?\Pggns\MidocoApi\Api\Order\StructType\Address $address = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\Communication_1[]
     */
    ...
    public static function validateCommunicationForArrayConstraintsFromSetCommunication(?array $values = []): string
    {
        ...
        foreach ($values as $customerCommunicationItem) {
            ...
            if (!$customerCommunicationItem instanceof \Pggns\MidocoApi\Api\Order\StructType\Communication_1) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Communication property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Communication_1, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\Communication_1 $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\Customer_1
     */
    public function addToCommunication(\Pggns\MidocoApi\Api\Order\StructType\Communication_1 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\Communication_1) {
            throw new InvalidArgumentException(sprintf('The Communication property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\Communication_1, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
