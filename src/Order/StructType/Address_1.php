...
class Address_1 extends AbstractStructBase
{
     ...
     * @uses Address_1::setStreetNo()
     * @uses Address_1::setState()
     * @uses Address_1::setCountry()
     * @uses Address_1::setPostalCode()
     * @uses Address_1::setPostOfficeBox()
     * @uses Address_1::setCity()
     * @uses Address_1::setEndorsement()
     * @param string $street
     ...
     * Set street value
     * @param string $street
     * @return \Pggns\MidocoApi\Order\StructType\Address_1
     */
