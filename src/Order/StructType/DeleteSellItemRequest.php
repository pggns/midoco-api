...
/**
 * This class stands for DeleteSellItemRequest StructType
 * @subpackage Structs
 */
class DeleteSellItemRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for DeleteSellItemRequest
     * @uses DeleteSellItemRequest::setMidocoSellItemId()
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSellItemId $midocoSellItemId
     * @return \Pggns\MidocoApi\Api\Order\StructType\DeleteSellItemRequest
     */
