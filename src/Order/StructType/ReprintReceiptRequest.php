...
class ReprintReceiptRequest extends AbstractStructBase
{
     ...
     * @param int $receiptId
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\MidocoReceipt $midocoReceipt = null, ?bool $asCopy = true, ?bool $saveDocument = false, ?bool $saveAsTravelPlan = false, ?string $printJob = null, ?int $receiptId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoReceipt $midocoReceipt
     * @return \Pggns\MidocoApi\Api\Order\StructType\ReprintReceiptRequest
     */
