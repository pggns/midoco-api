...
class MidocoOrderPaymentReminderInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo[] $paymentReminderInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo[]
     */
    ...
    public static function validatePaymentReminderInfoForArrayConstraintsFromSetPaymentReminderInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderPaymentReminderInfoPaymentReminderInfoItem) {
            ...
            if (!$midocoOrderPaymentReminderInfoPaymentReminderInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PaymentReminderInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo[] $paymentReminderInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderPaymentReminderInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderPaymentReminderInfo
     */
    public function addToPaymentReminderInfo(\Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo) {
            throw new InvalidArgumentException(sprintf('The PaymentReminderInfo property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\PaymentReminderInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
