...
class GetSellItemVatDivisionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSellItemVatDivisionForArrayConstraintsFromSetMidocoSellItemVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $getSellItemVatDivisionsResponseMidocoSellItemVatDivisionItem) {
            ...
            if (!$getSellItemVatDivisionsResponseMidocoSellItemVatDivisionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoSellItemVatDivision) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoSellItemVatDivision[] $midocoSellItemVatDivision
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSellItemVatDivisionsResponse
     */
