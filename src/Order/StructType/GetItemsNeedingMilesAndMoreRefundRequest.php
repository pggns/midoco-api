...
/**
 * This class stands for GetItemsNeedingMilesAndMoreRefundRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetItemsNeedingMilesAndMoreRefundRequest extends AbstractStructBase
{
    /**
     * The orderId
    ...
    /**
     * Constructor method for GetItemsNeedingMilesAndMoreRefundRequest
     * @uses GetItemsNeedingMilesAndMoreRefundRequest::setOrderId()
     * @uses GetItemsNeedingMilesAndMoreRefundRequest::setOrderNo()
     * @param int $orderId
     * @param int $orderNo
     */
     ...
     * @param int $orderId
     * @return \Pggns\MidocoApi\Order\StructType\GetItemsNeedingMilesAndMoreRefundRequest
     */
