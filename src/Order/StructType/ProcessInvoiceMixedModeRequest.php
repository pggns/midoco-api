...
/**
 * This class stands for ProcessInvoiceMixedModeRequest StructType
 * @subpackage Structs
 */
class ProcessInvoiceMixedModeRequest extends AbstractStructBase
{
    /**
     * The invoiceId
     * @var int|null
    ...
    /**
     * Constructor method for ProcessInvoiceMixedModeRequest
     * @uses ProcessInvoiceMixedModeRequest::setInvoiceId()
     * @param int $invoiceId
     */
     ...
     * Set invoiceId value
     * @param int $invoiceId
     * @return \Pggns\MidocoApi\Api\Order\StructType\ProcessInvoiceMixedModeRequest
     */
