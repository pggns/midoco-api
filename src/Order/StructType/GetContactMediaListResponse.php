...
class GetContactMediaListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO[]
     */
    ...
    public static function validateMidocoContactMediaForArrayConstraintsFromSetMidocoContactMedia(?array $values = []): string
    {
        ...
        foreach ($values as $getContactMediaListResponseMidocoContactMediaItem) {
            ...
            if (!$getContactMediaListResponseMidocoContactMediaItem instanceof \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoContactMedia property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO[] $midocoContactMedia
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetContactMediaListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetContactMediaListResponse
     */
    public function addToMidocoContactMedia(\Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoContactMedia property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\ContactMediaDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
