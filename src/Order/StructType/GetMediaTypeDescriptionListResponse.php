...
class GetMediaTypeDescriptionListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO[] $midocoMediaTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO[]
     */
    ...
    public static function validateMidocoMediaTypeDescriptionForArrayConstraintsFromSetMidocoMediaTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getMediaTypeDescriptionListResponseMidocoMediaTypeDescriptionItem) {
            ...
            if (!$getMediaTypeDescriptionListResponseMidocoMediaTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMediaTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO[] $midocoMediaTypeDescription
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMediaTypeDescriptionListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMediaTypeDescriptionListResponse
     */
    public function addToMidocoMediaTypeDescription(\Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoMediaTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MediaTypeDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
