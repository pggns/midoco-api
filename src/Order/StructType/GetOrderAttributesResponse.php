...
class GetOrderAttributesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAttributeValueForArrayConstraintsFromSetMidocoAttributeValue(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderAttributesResponseMidocoAttributeValueItem) {
            ...
            if (!$getOrderAttributesResponseMidocoAttributeValueItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoAttributeValue) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoAttributeValue[] $midocoAttributeValue
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrderAttributesResponse
     */
