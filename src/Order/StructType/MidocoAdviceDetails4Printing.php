...
class MidocoAdviceDetails4Printing extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails[] $adviceDetails
     */
    ...
    public static function validateAdviceDetailsForArrayConstraintsFromSetAdviceDetails(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAdviceDetails4PrintingAdviceDetailsItem) {
            ...
            if (!$midocoAdviceDetails4PrintingAdviceDetailsItem instanceof \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AdviceDetails property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails[] $adviceDetails
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceDetails4Printing
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoAdviceDetails4Printing
     */
    public function addToAdviceDetails(\Pggns\MidocoApi\Api\Order\StructType\AdviceDetails $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails) {
            throw new InvalidArgumentException(sprintf('The AdviceDetails property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\AdviceDetails, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
