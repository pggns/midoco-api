...
class GetRuleSetsResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoRuleSet
     * @var \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO[]
     */
    ...
    public static function validateMidocoRuleSetForArrayConstraintsFromSetMidocoRuleSet(?array $values = []): string
    {
        ...
        foreach ($values as $getRuleSetsResponseMidocoRuleSetItem) {
            ...
            if (!$getRuleSetsResponseMidocoRuleSetItem instanceof \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRuleSet property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO[] $midocoRuleSet
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetRuleSetsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetRuleSetsResponse
     */
    public function addToMidocoRuleSet(\Pggns\MidocoApi\Api\Order\StructType\RulesetDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoRuleSet property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\RulesetDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
