...
class MarketingKeyType extends MarketingKeyDTO
{
    ...
    public static function validateMidocoMarketingKeyDescriptionForArrayConstraintsFromSetMidocoMarketingKeyDescription(?array $values = []): string
    {
        ...
        foreach ($values as $marketingKeyTypeMidocoMarketingKeyDescriptionItem) {
            ...
            if (!$marketingKeyTypeMidocoMarketingKeyDescriptionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MarketingKeyDescriptionType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MarketingKeyDescriptionType[] $midocoMarketingKeyDescription
     * @return \Pggns\MidocoApi\Api\Order\StructType\MarketingKeyType
     */
