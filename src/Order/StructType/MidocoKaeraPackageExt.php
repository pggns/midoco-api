...
class MidocoKaeraPackageExt extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Order\StructType\PackageitemDTO $midocoPackageInfo = null, ?bool $success = null, ?string $description = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\PackageitemDTO $midocoPackageInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoKaeraPackageExt
     */
