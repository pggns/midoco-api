...
class GetVatDivisionTemplatesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDivisionTemplateForArrayConstraintsFromSetMidocoVatDivisionTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem) {
            ...
            if (!$getVatDivisionTemplatesResponseMidocoVatDivisionTemplateItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoVatDivisionTemplate) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoVatDivisionTemplate[] $midocoVatDivisionTemplate
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetVatDivisionTemplatesResponse
     */
