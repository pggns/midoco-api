...
/**
 * This class stands for GenerateCsvForBatchInvoicingResponse StructType
 * @subpackage Structs
 */
class GenerateCsvForBatchInvoicingResponse extends AbstractStructBase
{
    /**
     * The message
    ...
    /**
     * Constructor method for GenerateCsvForBatchInvoicingResponse
     * @uses GenerateCsvForBatchInvoicingResponse::setMessage()
     * @uses GenerateCsvForBatchInvoicingResponse::setMidocoMailMessage()
     ...
     * Set message value
     * @param string $message
     * @return \Pggns\MidocoApi\Api\Order\StructType\GenerateCsvForBatchInvoicingResponse
     */
