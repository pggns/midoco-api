...
/**
 * This class stands for GetSupplierAgencySettlementDetailsRequest StructType
 * @subpackage Structs
 */
class GetSupplierAgencySettlementDetailsRequest extends AbstractStructBase
{
    /**
     * The settlementId
     * @var int|null
    ...
    /**
     * Constructor method for GetSupplierAgencySettlementDetailsRequest
     * @uses GetSupplierAgencySettlementDetailsRequest::setSettlementId()
     * @uses GetSupplierAgencySettlementDetailsRequest::setBookingPosition()
     ...
     * @param int $settlementId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetSupplierAgencySettlementDetailsRequest
     */
