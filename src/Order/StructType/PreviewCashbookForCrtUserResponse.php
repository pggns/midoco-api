...
/**
 * This class stands for PreviewCashbookForCrtUserResponse StructType
 * @subpackage Structs
 */
class PreviewCashbookForCrtUserResponse extends AbstractStructBase
{
    /**
     * The responseString
     * @var string|null
    ...
    /**
     * Constructor method for PreviewCashbookForCrtUserResponse
     * @uses PreviewCashbookForCrtUserResponse::setResponseString()
     ...
     * @param string $responseString
     * @return \Pggns\MidocoApi\Api\Order\StructType\PreviewCashbookForCrtUserResponse
     */
