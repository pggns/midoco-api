...
class FlightServiceType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest[] $specialServiceRequest
    ...
    public static function validateMealForArrayConstraintsFromSetMeal(?array $values = []): string
    {
        ...
        foreach ($values as $flightServiceTypeMealItem) {
            ...
            if (!$flightServiceTypeMealItem instanceof \Pggns\MidocoApi\Api\Order\StructType\FlightMealType) {
    ...
    public static function validateSeatForArrayConstraintsFromSetSeat(?array $values = []): string
    {
        ...
        foreach ($values as $flightServiceTypeSeatItem) {
            // validation for constraint: itemType
            if (!$flightServiceTypeSeatItem instanceof \Pggns\MidocoApi\Api\Order\StructType\FlightSeatType) {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest[]
     */
    ...
    public static function validateSpecialServiceRequestForArrayConstraintsFromSetSpecialServiceRequest(?array $values = []): string
    {
        ...
        foreach ($values as $flightServiceTypeSpecialServiceRequestItem) {
            // validation for constraint: itemType
            if (!$flightServiceTypeSpecialServiceRequestItem instanceof \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The specialServiceRequest property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\FlightServiceType
     */
    public function addToSpecialServiceRequest(\Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest) {
            throw new InvalidArgumentException(sprintf('The specialServiceRequest property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\SpecialServiceRequest, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
