...
class GetDestinationDocumentsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument[]
     */
    ...
    public static function validateMidocoDestinationDocumentForArrayConstraintsFromSetMidocoDestinationDocument(?array $values = []): string
    {
        ...
        foreach ($values as $getDestinationDocumentsResponseMidocoDestinationDocumentItem) {
            ...
            if (!$getDestinationDocumentsResponseMidocoDestinationDocumentItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDestinationDocument property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument[] $midocoDestinationDocument
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetDestinationDocumentsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetDestinationDocumentsResponse
     */
    public function addToMidocoDestinationDocument(\Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument) {
            throw new InvalidArgumentException(sprintf('The MidocoDestinationDocument property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoDestinationDocument, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
