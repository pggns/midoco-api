...
class Remark extends AbstractStructBase
{
     ...
     */
    public function __construct(int $position, ?bool $print_allowed = null, ?string $text = null, ?string $printType = null, ?int $servicePosition = null, ?bool $printAllowed = null)
    {
        $this
