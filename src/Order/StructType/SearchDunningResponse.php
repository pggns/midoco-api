...
class SearchDunningResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoDunningForArrayConstraintsFromSetMidocoDunning(?array $values = []): string
    {
        ...
        foreach ($values as $searchDunningResponseMidocoDunningItem) {
            ...
            if (!$searchDunningResponseMidocoDunningItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoDunning) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoDunning[] $midocoDunning
     * @return \Pggns\MidocoApi\Api\Order\StructType\SearchDunningResponse
     */
