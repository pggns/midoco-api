...
class PrepareSubOrdersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderForArrayConstraintsFromSetMidocoOrder(?array $values = []): string
    {
        ...
        foreach ($values as $prepareSubOrdersResponseMidocoOrderItem) {
            ...
            if (!$prepareSubOrdersResponseMidocoOrderItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderType[] $midocoOrder
     * @return \Pggns\MidocoApi\Api\Order\StructType\PrepareSubOrdersResponse
     */
