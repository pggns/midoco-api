...
/**
 * This class stands for GetBillingPrintSettingsRequest StructType
 * @subpackage Structs
 */
class GetBillingPrintSettingsRequest extends AbstractStructBase
{
    /**
     * The billingId
     * @var int|null
    ...
    /**
     * Constructor method for GetBillingPrintSettingsRequest
     * @uses GetBillingPrintSettingsRequest::setBillingId()
     * @param int $billingId
     */
     ...
     * Set billingId value
     * @param int $billingId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetBillingPrintSettingsRequest
     */
