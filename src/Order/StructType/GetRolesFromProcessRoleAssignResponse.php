...
class GetRolesFromProcessRoleAssignResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign[]
     */
    ...
    public static function validateMidocoProcessRoleAssignForArrayConstraintsFromSetMidocoProcessRoleAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getRolesFromProcessRoleAssignResponseMidocoProcessRoleAssignItem) {
            ...
            if (!$getRolesFromProcessRoleAssignResponseMidocoProcessRoleAssignItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProcessRoleAssign property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign[] $midocoProcessRoleAssign
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetRolesFromProcessRoleAssignResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetRolesFromProcessRoleAssignResponse
     */
    public function addToMidocoProcessRoleAssign(\Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoProcessRoleAssign property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MidocoProcessRoleAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
