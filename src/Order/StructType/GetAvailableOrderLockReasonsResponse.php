...
class GetAvailableOrderLockReasonsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonForArrayConstraintsFromSetMidocoOrderLockReason(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableOrderLockReasonsResponseMidocoOrderLockReasonItem) {
            ...
            if (!$getAvailableOrderLockReasonsResponseMidocoOrderLockReasonItem instanceof \Pggns\MidocoApi\Api\Order\StructType\OrderLockReasonDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\OrderLockReasonDTO[] $midocoOrderLockReason
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetAvailableOrderLockReasonsResponse
     */
