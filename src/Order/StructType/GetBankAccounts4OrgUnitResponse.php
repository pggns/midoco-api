...
class GetBankAccounts4OrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBankAccountForArrayConstraintFromSetMidocoBankAccount(?array $values = []): string
    {
        ...
        foreach ($values as $getBankAccounts4OrgUnitResponseMidocoBankAccountItem) {
            ...
            if (!$getBankAccounts4OrgUnitResponseMidocoBankAccountItem instanceof \Pggns\MidocoApi\Order\StructType\MidocoBankAccount) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\MidocoBankAccount[] $midocoBankAccount
     * @return \Pggns\MidocoApi\Order\StructType\GetBankAccounts4OrgUnitResponse
     */
