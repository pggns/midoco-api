...
class GetBillingPositionsForOrderResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBillingPositionInfoForArrayConstraintsFromSetMidocoBillingPositionInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getBillingPositionsForOrderResponseMidocoBillingPositionInfoItem) {
            ...
            if (!$getBillingPositionsForOrderResponseMidocoBillingPositionInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionInfoType) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoBillingPositionInfoType[] $midocoBillingPositionInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetBillingPositionsForOrderResponse
     */
