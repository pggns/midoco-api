...
class GetPPTransactionsRequest extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetPPTransactionsRequest
     * @uses GetPPTransactionsRequest::setOrderId()
     * @param int $orderId
     */
     ...
     * Set orderId value
     * @param int $orderId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetPPTransactionsRequest
     */
