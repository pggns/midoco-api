...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetMergedMfResponse
     */
