...
class GetContactMediaDescriptionListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO[]
     */
    ...
    public static function validateMidocoContactMediaDescriptionForArrayConstraintsFromSetMidocoContactMediaDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getContactMediaDescriptionListResponseMidocoContactMediaDescriptionItem) {
            ...
            if (!$getContactMediaDescriptionListResponseMidocoContactMediaDescriptionItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoContactMediaDescription property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO[] $midocoContactMediaDescription
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetContactMediaDescriptionListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO $item
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetContactMediaDescriptionListResponse
     */
    public function addToMidocoContactMediaDescription(\Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoContactMediaDescription property can only contain items of type \Pggns\MidocoApi\Api\Order\StructType\MediaDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
