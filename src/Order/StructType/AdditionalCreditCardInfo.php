...
class AdditionalCreditCardInfo extends AbstractStructBase
{
    ...
    /**
     * Set name value
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\AdditionalCreditCardInfoNameType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\AdditionalCreditCardInfoNameType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $name
     * @return \Pggns\MidocoApi\Api\Order\StructType\AdditionalCreditCardInfo
     */
    public function setName(?string $name = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\AdditionalCreditCardInfoNameType::valueIsValid($name)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\AdditionalCreditCardInfoNameType', is_array($name) ? implode(', ', $name) : var_export($name, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\AdditionalCreditCardInfoNameType::getValidValues())), __LINE__);
        }
        $this->name = $name;
