...
class GetOrdersDbiInfosResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrdersDbiInfoForArrayConstraintsFromSetMidocoOrdersDbiInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdersDbiInfosResponseMidocoOrdersDbiInfoItem) {
            ...
            if (!$getOrdersDbiInfosResponseMidocoOrdersDbiInfoItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoOrdersDbiInfo) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrdersDbiInfo[] $midocoOrdersDbiInfo
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrdersDbiInfosResponse
     */
