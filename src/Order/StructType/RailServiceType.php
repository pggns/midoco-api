...
class RailServiceType extends AbstractStructBase
{
     ...
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\TicketCategory::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Order\EnumType\TicketCategory::getValidValues()
    ...
    public function setTicketCategory(?string $ticketCategory = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Order\EnumType\TicketCategory::valueIsValid($ticketCategory)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Order\EnumType\TicketCategory', is_array($ticketCategory) ? implode(', ', $ticketCategory) : var_export($ticketCategory, true), implode(', ', \Pggns\MidocoApi\Api\Order\EnumType\TicketCategory::getValidValues())), __LINE__);
        }
