...
/**
 * This class stands for GetOrderPaymentsRequest StructType
 * @subpackage Structs
 */
class GetOrderPaymentsRequest extends AbstractStructBase
{
    /**
     * The MidocoOrderId
    ...
    /**
     * Constructor method for GetOrderPaymentsRequest
     * @uses GetOrderPaymentsRequest::setMidocoOrderId()
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\MidocoOrderId $midocoOrderId
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetOrderPaymentsRequest
     */
