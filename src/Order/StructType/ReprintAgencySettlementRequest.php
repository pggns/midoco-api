...
/**
 * This class stands for ReprintAgencySettlementRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReprintAgencySettlementRequest extends AbstractStructBase
{
    /**
     * The settlementId
     * @var int|null
    ...
    /**
     * Constructor method for ReprintAgencySettlementRequest
     * @uses ReprintAgencySettlementRequest::setSettlementId()
     * @uses ReprintAgencySettlementRequest::setAgencyId()
