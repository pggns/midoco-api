...
/**
 * This class stands for ExportCashTurnoverRequest StructType
 * @subpackage Structs
 */
class ExportCashTurnoverRequest extends AbstractStructBase
{
    /**
     * The cashBookId
    ...
    /**
     * Constructor method for ExportCashTurnoverRequest
     * @uses ExportCashTurnoverRequest::setCashBookId()
     ...
     * @param int $cashBookId
     * @return \Pggns\MidocoApi\Api\Order\StructType\ExportCashTurnoverRequest
     */
