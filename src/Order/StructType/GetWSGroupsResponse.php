...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Api\Order\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Api\Order\StructType\GetWSGroupsResponse
     */
