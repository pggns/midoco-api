...
class MidocoCreditCardPosition extends MidocoOnlinePaymentTransactionPosition
{
     ...
     */
    public function __construct(?string $ccType = null, ?string $ccNo = null, ?string $ccCvc = null, ?string $ccValidYear = null, ?string $ccValidMonth = null, ?string $ccOwner = null, ?string $ccAuthCode = null, ?\Pggns\MidocoApi\Api\Order\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null, ?array $midocoCcToken = null, ?string $ccToken = null, ?string $ccTokenType = null, ?bool $isRecurring = null, ?int $preferredReceiptId = null)
    {
        $this
            ->setCcType($ccType)
            ->setCcNo($ccNo)
     ...
     * Set ccType value
     * @param string $ccType
     * @return \Pggns\MidocoApi\Api\Order\StructType\MidocoCreditCardPosition
     */
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCreditCardPositionMidocoCcTokenItem) {
            ...
            if (!$midocoCreditCardPositionMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Order\StructType\MidocoCcToken) {
