...
class GetOrderLockReasonDescriptionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonDescriptionForArrayConstraintFromSetMidocoOrderLockReasonDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem) {
            ...
            if (!$getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem instanceof \Pggns\MidocoApi\Order\StructType\OrderLockReasonDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\OrderLockReasonDescriptionDTO[] $midocoOrderLockReasonDescription
     * @return \Pggns\MidocoApi\Order\StructType\GetOrderLockReasonDescriptionsResponse
     */
