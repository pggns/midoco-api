...
class _List extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\_List
     */
    ...
    /**
     * Method to call the operation originally named listMidocoOrderQm
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ListMidocoOrderQmRequest $paramListMidocoOrderQmRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\ListMidocoOrderQmResponse|bool
     */
    public function listMidocoOrderQm(\Pggns\MidocoApi\Api\Order\StructType\ListMidocoOrderQmRequest $paramListMidocoOrderQmRequest)
    {
        try {
            $this->setResult($resultListMidocoOrderQm = $this->getSoapClient()->__soapCall('listMidocoOrderQm', [
                $paramListMidocoOrderQmRequest,
            ], [], [], $this->outputHeaders));
        
            return $resultListMidocoOrderQm;
