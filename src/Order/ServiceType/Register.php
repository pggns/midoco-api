...
class Register extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Register
     */
    ...
    /**
     * Method to call the operation originally named registerFairplane
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\RegisterFairplaneRequest $paramRegisterFairplaneRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\RegisterFairplaneResponse|bool
     */
    public function registerFairplane(\Pggns\MidocoApi\Api\Order\StructType\RegisterFairplaneRequest $paramRegisterFairplaneRequest)
    {
        try {
            $this->setResult($resultRegisterFairplane = $this->getSoapClient()->__soapCall('registerFairplane', [
                $paramRegisterFairplaneRequest,
            ], [], [], $this->outputHeaders));
        
            return $resultRegisterFairplane;
