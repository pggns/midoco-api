...
class Recalculate extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Order\ServiceType\Recalculate
     */
     ...
     * @param \Pggns\MidocoApi\Order\StructType\RecalculateTravelNoMarginRequest $paramRecalculateTravelNoMarginRequest
     * @return \Pggns\MidocoApi\Order\StructType\RecalculateTravelNoMarginResponse|bool
     */
    public function recalculateTravelNoMargin(\Pggns\MidocoApi\Order\StructType\RecalculateTravelNoMarginRequest $paramRecalculateTravelNoMarginRequest)
    {
        try {
