...
class Flight extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Flight
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\FlightTimeChangeEmailOrderSaveRequest $paramFlightTimeChangeEmailOrderSaveRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\FlightTimeChangeEmailOrderSaveResponse|bool
     */
    public function flightTimeChangeEmailOrderSave(\Pggns\MidocoApi\Api\Order\StructType\FlightTimeChangeEmailOrderSaveRequest $paramFlightTimeChangeEmailOrderSaveRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\FlightTimeChangeEmailOrderSaveResponse
     */
