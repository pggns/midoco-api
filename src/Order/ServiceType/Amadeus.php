...
class Amadeus extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Amadeus
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\AmadeusManualClearingRequest $paramAmadeusManualClearingRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\AmadeusManualClearingResponse|bool
     */
    public function amadeusManualClearing(\Pggns\MidocoApi\Api\Order\StructType\AmadeusManualClearingRequest $paramAmadeusManualClearingRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\AmadeusManualClearingResponse
     */
