...
class Close extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Close
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\CloseCashBookSignatureRequest $paramCloseCashBookSignatureRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\CloseCashBookSignatureResponse|bool
     */
    public function closeCashBookSignature(\Pggns\MidocoApi\Api\Order\StructType\CloseCashBookSignatureRequest $paramCloseCashBookSignatureRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\CloseCashBookSignatureResponse
     */
