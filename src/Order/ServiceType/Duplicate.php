...
class Duplicate extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Duplicate
     */
    ...
    /**
     * Method to call the operation originally named duplicateOrder
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\DuplicateOrderRequest $paramDuplicateOrderRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\DuplicateOrderResponse|bool
     */
    public function duplicateOrder(\Pggns\MidocoApi\Api\Order\StructType\DuplicateOrderRequest $paramDuplicateOrderRequest)
    {
        try {
            $this->setResult($resultDuplicateOrder = $this->getSoapClient()->__soapCall('duplicateOrder', [
                $paramDuplicateOrderRequest,
            ], [], [], $this->outputHeaders));
        
            return $resultDuplicateOrder;
