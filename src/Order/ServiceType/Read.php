...
class Read extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Read
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\ReadNumberOfBookingsForBonusCalculationRequest $paramReadNumberOfBookingsForBonusCalculationRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\ReadNumberOfBookingsForBonusCalculationResponse|bool
     */
    public function readNumberOfBookingsForBonusCalculation(\Pggns\MidocoApi\Api\Order\StructType\ReadNumberOfBookingsForBonusCalculationRequest $paramReadNumberOfBookingsForBonusCalculationRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Order\StructType\ReadNumberOfBookingsForBonusCalculationResponse
     */
