...
class Pseudo extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Order\ServiceType\Pseudo
     */
     ...
     * @param \Pggns\MidocoApi\Api\Order\StructType\PseudoRBCsvExportRequest $paramPseudoRBCsvExportRequest
     * @return \Pggns\MidocoApi\Api\Order\StructType\PseudoRBCsvExportResponse|bool
     */
    public function pseudoRBCsvExport(\Pggns\MidocoApi\Api\Order\StructType\PseudoRBCsvExportRequest $paramPseudoRBCsvExportRequest)
    {
        try {
