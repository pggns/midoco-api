...
class GetAllUserattribTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType[] $midocoUserattribType
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType[]
     */
    ...
    public static function validateMidocoUserattribTypeForArrayConstraintsFromSetMidocoUserattribType(?array $values = []): string
    {
        ...
        foreach ($values as $getAllUserattribTypesResponseMidocoUserattribTypeItem) {
            ...
            if (!$getAllUserattribTypesResponseMidocoUserattribTypeItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserattribType property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType[] $midocoUserattribType
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAllUserattribTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAllUserattribTypesResponse
     */
    public function addToMidocoUserattribType(\Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType) {
            throw new InvalidArgumentException(sprintf('The MidocoUserattribType property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoUserattribType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
