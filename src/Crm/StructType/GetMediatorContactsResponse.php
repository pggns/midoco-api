...
class GetMediatorContactsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoContactEntryForArrayConstraintsFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $getMediatorContactsResponseMidocoContactEntryItem) {
            ...
            if (!$getMediatorContactsResponseMidocoContactEntryItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactEntryType) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactEntryType[] $midocoContactEntry
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMediatorContactsResponse
     */
