...
class GetAutoBillingMatrixResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAutoBillingMatrixForArrayConstraintsFromSetMidocoAutoBillingMatrix(?array $values = []): string
    {
        ...
        foreach ($values as $getAutoBillingMatrixResponseMidocoAutoBillingMatrixItem) {
            ...
            if (!$getAutoBillingMatrixResponseMidocoAutoBillingMatrixItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\AutoBillingMatrixDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\AutoBillingMatrixDTO[] $midocoAutoBillingMatrix
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAutoBillingMatrixResponse
     */
