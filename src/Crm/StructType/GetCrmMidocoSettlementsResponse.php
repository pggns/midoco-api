...
class GetCrmMidocoSettlementsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlementForArrayConstraintsFromSetMidocoCrmMidocoSettlement(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmMidocoSettlementsResponseMidocoCrmMidocoSettlementItem) {
            ...
            if (!$getCrmMidocoSettlementsResponseMidocoCrmMidocoSettlementItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlement property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement[] $midocoCrmMidocoSettlement
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmMidocoSettlementsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmMidocoSettlementsResponse
     */
    public function addToMidocoCrmMidocoSettlement(\Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlement property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlement, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
