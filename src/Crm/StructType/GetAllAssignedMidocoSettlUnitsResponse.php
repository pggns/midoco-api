...
class GetAllAssignedMidocoSettlUnitsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAssignedMidocoSettlOUnitForArrayConstraintsFromSetMidocoAssignedMidocoSettlOUnit(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedMidocoSettlUnitsResponseMidocoAssignedMidocoSettlOUnitItem) {
            ...
            if (!$getAllAssignedMidocoSettlUnitsResponseMidocoAssignedMidocoSettlOUnitItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoSettlOUnitDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoSettlOUnitDTO[] $midocoAssignedMidocoSettlOUnit
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAllAssignedMidocoSettlUnitsResponse
     */
