...
class CalculateSubjectRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?array $midocoSubjectElement = null, ?\Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmPrintType $midocoCrmPrintType = null, ?int $orderNo = null, ?int $customerId = null, ?int $documentNo = null, ?string $subjectText = null, ?string $id = null, ?int $documentId = null)
    {
        $this
    ...
    public static function validateMidocoSubjectElementForArrayConstraintsFromSetMidocoSubjectElement(?array $values = []): string
    {
        ...
        foreach ($values as $calculateSubjectRequestMidocoSubjectElementItem) {
            ...
            if (!$calculateSubjectRequestMidocoSubjectElementItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoSubjectElement) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoSubjectElement[] $midocoSubjectElement
     * @return \Pggns\MidocoApi\Api\Crm\StructType\CalculateSubjectRequest
     */
