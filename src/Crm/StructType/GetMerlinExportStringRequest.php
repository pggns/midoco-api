...
class GetMerlinExportStringRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?array $midocoSelectedCrmPersonTraveller = null, ?bool $exportBirthday = null, ?bool $exportAge = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMerlinExportStringRequest
     */
    ...
    public static function validateMidocoSelectedCrmPersonTravellerForArrayConstraintsFromSetMidocoSelectedCrmPersonTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $getMerlinExportStringRequestMidocoSelectedCrmPersonTravellerItem) {
            ...
            if (!$getMerlinExportStringRequestMidocoSelectedCrmPersonTravellerItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoSelectedCrmPersonTraveller) {
