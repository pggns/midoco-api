...
class GetSupplierReportForSupplierResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMediatorRevenueForArrayConstraintsFromSetMidocoMediatorRevenue(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierReportForSupplierResponseMidocoMediatorRevenueItem) {
            ...
            if (!$getSupplierReportForSupplierResponseMidocoMediatorRevenueItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoMediatorRevenue) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoMediatorRevenue[] $midocoMediatorRevenue
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSupplierReportForSupplierResponse
     */
