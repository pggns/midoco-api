...
class DeleteCustomerCriteriaRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $deleteCustomerCriteriaRequestMidocoCrmCriteriaItem) {
            ...
            if (!$deleteCustomerCriteriaRequestMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmCriteriaDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCriteriaDTO[] $midocoCrmCriteria
     * @return \Pggns\MidocoApi\Api\Crm\StructType\DeleteCustomerCriteriaRequest
     */
