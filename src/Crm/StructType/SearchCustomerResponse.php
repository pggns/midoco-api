...
class SearchCustomerResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerSearchForArrayConstraintsFromSetMidocoCustomerSearch(?array $values = []): string
    {
        ...
        foreach ($values as $searchCustomerResponseMidocoCustomerSearchItem) {
            ...
            if (!$searchCustomerResponseMidocoCustomerSearchItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerSearch) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerSearch[] $midocoCustomerSearch
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SearchCustomerResponse
     */
