...
class AssignCustomerRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CustomerAssignDTO $midocoAssignCustomer = null, ?bool $isFirm = null, ?int $originCustomerGender = null, ?int $assignedCustomerGender = null, ?int $internalVersion = null, ?int $customerId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerAssignDTO $midocoAssignCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\AssignCustomerRequest
     */
