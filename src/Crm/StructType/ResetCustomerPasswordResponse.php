...
/**
 * This class stands for ResetCustomerPasswordResponse StructType
...
class ResetCustomerPasswordResponse extends AbstractStructBase
{
    ...
    /**
     * Constructor method for ResetCustomerPasswordResponse
     * @uses ResetCustomerPasswordResponse::setErrorCode()
     * @uses ResetCustomerPasswordResponse::setErrorText()
     ...
     * Set errorCode value
     * @param string $errorCode
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ResetCustomerPasswordResponse
     */
