...
class GetBonusCardsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmBonusCardForArrayConstraintsFromSetMidocoCrmBonusCard(?array $values = []): string
    {
        ...
        foreach ($values as $getBonusCardsResponseMidocoCrmBonusCardItem) {
            ...
            if (!$getBonusCardsResponseMidocoCrmBonusCardItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmBonusCardDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmBonusCardDTO[] $midocoCrmBonusCard
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetBonusCardsResponse
     */
