...
class MidocoAgency extends AgencyDetailDTO
{
     ...
     */
    public function __construct(?array $midocoAgencyCommission = null, ?\Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?\Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerPaymentDTO $midocoCustomerPayment = null, ?string $cooperationName = null)
    {
        $this
    ...
    public static function validateMidocoAgencyCommissionForArrayConstraintsFromSetMidocoAgencyCommission(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAgencyMidocoAgencyCommissionItem) {
            ...
            if (!$midocoAgencyMidocoAgencyCommissionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\AgencyCommissionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\AgencyCommissionDTO[] $midocoAgencyCommission
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoAgency
     */
