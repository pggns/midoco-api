...
class GetMidocoAgencyResponse extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMidocoAgencyResponse
     */
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoAgencyResponseMidocoCrmDebitCardItem) {
            ...
            if (!$getMidocoAgencyResponseMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmDebitCard) {
