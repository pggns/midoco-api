...
class GetCustomerMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerMfForArrayConstraintsFromSetMidocoCustomerMf(?array $values = []): string
    {
        ...
        foreach ($values as $getCustomerMfResponseMidocoCustomerMfItem) {
            ...
            if (!$getCustomerMfResponseMidocoCustomerMfItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfDTO[] $midocoCustomerMf
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCustomerMfResponse
     */
