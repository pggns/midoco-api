...
class CheckContactEntriesRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(?array $values = []): string
    {
        ...
        foreach ($values as $checkContactEntriesRequestMidocoCustomerIdItem) {
            ...
            if (!$checkContactEntriesRequestMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\CheckContactEntriesRequest
     */
