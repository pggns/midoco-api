...
class UpdateContactEntriesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(?array $values = []): string
    {
        ...
        foreach ($values as $updateContactEntriesResponseMidocoCustomerIdItem) {
            ...
            if (!$updateContactEntriesResponseMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\UpdateContactEntriesResponse
     */
