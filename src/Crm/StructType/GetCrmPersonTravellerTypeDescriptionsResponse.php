...
class GetCrmPersonTravellerTypeDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO[] $midocoCrmPersonTravellerTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO[]
     */
    ...
    public static function validateMidocoCrmPersonTravellerTypeDescriptionForArrayConstraintsFromSetMidocoCrmPersonTravellerTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmPersonTravellerTypeDescriptionsResponseMidocoCrmPersonTravellerTypeDescriptionItem) {
            ...
            if (!$getCrmPersonTravellerTypeDescriptionsResponseMidocoCrmPersonTravellerTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmPersonTravellerTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO[] $midocoCrmPersonTravellerTypeDescription
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmPersonTravellerTypeDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmPersonTravellerTypeDescriptionsResponse
     */
    public function addToMidocoCrmPersonTravellerTypeDescription(\Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmPersonTravellerTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmTravellerTypeDescrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
