...
class GetAgencyExternalSystemAttributesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO[]
     */
    ...
    public static function validateMidocoExternalSystemAttributeForArrayConstraintsFromSetMidocoExternalSystemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getAgencyExternalSystemAttributesResponseMidocoExternalSystemAttributeItem) {
            ...
            if (!$getAgencyExternalSystemAttributesResponseMidocoExternalSystemAttributeItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoExternalSystemAttribute property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO[] $midocoExternalSystemAttribute
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAgencyExternalSystemAttributesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAgencyExternalSystemAttributesResponse
     */
    public function addToMidocoExternalSystemAttribute(\Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoExternalSystemAttribute property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
