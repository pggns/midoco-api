...
class GetSalutationTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO[] $midocoSalutationTypeExt
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO[]
     */
    ...
    public static function validateMidocoSalutationTypeExtForArrayConstraintsFromSetMidocoSalutationTypeExt(?array $values = []): string
    {
        ...
        foreach ($values as $getSalutationTypesResponseMidocoSalutationTypeExtItem) {
            ...
            if (!$getSalutationTypesResponseMidocoSalutationTypeExtItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSalutationTypeExt property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO[] $midocoSalutationTypeExt
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSalutationTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSalutationTypesResponse
     */
    public function addToMidocoSalutationTypeExt(\Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSalutationTypeExt property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SalutationTypeExtDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
