...
class DeleteLetterTemplateRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO[]
     */
    ...
    public static function validateMidocoLetterTemplateForArrayConstraintsFromSetMidocoLetterTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $deleteLetterTemplateRequestMidocoLetterTemplateItem) {
            ...
            if (!$deleteLetterTemplateRequestMidocoLetterTemplateItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoLetterTemplate property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO[] $midocoLetterTemplate
     * @return \Pggns\MidocoApi\Api\Crm\StructType\DeleteLetterTemplateRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\DeleteLetterTemplateRequest
     */
    public function addToMidocoLetterTemplate(\Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoLetterTemplate property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
