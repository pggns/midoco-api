...
class GetPrintSelectsForCustomerResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer[] $midocoPrintSelectionGroupForCustomer
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect[]
     */
    ...
    public static function validateMidocoPrintSelectForArrayConstraintsFromSetMidocoPrintSelect(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsForCustomerResponseMidocoPrintSelectItem) {
            ...
            if (!$getPrintSelectsForCustomerResponseMidocoPrintSelectItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect[] $midocoPrintSelect
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetPrintSelectsForCustomerResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetPrintSelectsForCustomerResponse
     */
    public function addToMidocoPrintSelect(\Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintSelect property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelect, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer[]
     */
    ...
    public static function validateMidocoPrintSelectionGroupForCustomerForArrayConstraintsFromSetMidocoPrintSelectionGroupForCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintSelectsForCustomerResponseMidocoPrintSelectionGroupForCustomerItem) {
            // validation for constraint: itemType
            if (!$getPrintSelectsForCustomerResponseMidocoPrintSelectionGroupForCustomerItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintSelectionGroupForCustomer property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetPrintSelectsForCustomerResponse
     */
    public function addToMidocoPrintSelectionGroupForCustomer(\Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintSelectionGroupForCustomer property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintSelectionGroupForCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
