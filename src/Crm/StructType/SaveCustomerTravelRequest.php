...
class SaveCustomerTravelRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(?array $values = []): string
    {
        ...
        foreach ($values as $saveCustomerTravelRequestMidocoCustomerTravelItem) {
            ...
            if (!$saveCustomerTravelRequestMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType[] $midocoCustomerTravel
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SaveCustomerTravelRequest
     */
