...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetUserWithCrsExpedientResponse
     */
