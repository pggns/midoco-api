...
class MidocoCrmMidocoCharge extends CrmMidocoChargeDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoChargeOuForArrayConstraintsFromSetMidocoAssignedMidocoChargeOu(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem) {
            ...
            if (!$midocoCrmMidocoChargeMidocoAssignedMidocoChargeOuItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO[] $midocoAssignedMidocoChargeOu
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoCharge
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoCharge
     */
    public function addToMidocoAssignedMidocoChargeOu(\Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoChargeOu property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\AssignedMidocoChargeOuDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
