...
class GetAvailableComplaintReasonDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO[] $midocoComplaintReasonDescription
     */
    ...
    public static function validateMidocoComplaintReasonDescriptionForArrayConstraintsFromSetMidocoComplaintReasonDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableComplaintReasonDescriptionsResponseMidocoComplaintReasonDescriptionItem) {
            ...
            if (!$getAvailableComplaintReasonDescriptionsResponseMidocoComplaintReasonDescriptionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoComplaintReasonDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO[] $midocoComplaintReasonDescription
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableComplaintReasonDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableComplaintReasonDescriptionsResponse
     */
    public function addToMidocoComplaintReasonDescription(\Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoComplaintReasonDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
