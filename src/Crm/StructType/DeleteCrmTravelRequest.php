...
class DeleteCrmTravelRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(?array $values = []): string
    {
        ...
        foreach ($values as $deleteCrmTravelRequestMidocoCustomerTravelItem) {
            ...
            if (!$deleteCrmTravelRequestMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType[] $midocoCustomerTravel
     * @return \Pggns\MidocoApi\Api\Crm\StructType\DeleteCrmTravelRequest
     */
