...
class DeletePaymentConditionRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoPaymentConditionForArrayConstraintsFromSetMidocoPaymentCondition(?array $values = []): string
    {
        ...
        foreach ($values as $deletePaymentConditionRequestMidocoPaymentConditionItem) {
            ...
            if (!$deletePaymentConditionRequestMidocoPaymentConditionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\PaymentConditionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\PaymentConditionDTO[] $midocoPaymentCondition
     * @return \Pggns\MidocoApi\Api\Crm\StructType\DeletePaymentConditionRequest
     */
