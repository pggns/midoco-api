...
class GetCustomerMfRequest extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType[] $customerMfRuleAttribute
     * @param string $bean
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId = null, ?array $customerMfRuleAttribute = null, ?string $bean = null, ?string $className = null, ?string $attrName = null, ?string $unitName = null, ?bool $onlyNumeric = null, ?bool $printEnforced = null, ?bool $presetContent = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCustomerMfRequest
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType[]
     */
    ...
    public static function validateCustomerMfRuleAttributeForArrayConstraintsFromSetCustomerMfRuleAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getCustomerMfRequestCustomerMfRuleAttributeItem) {
            ...
            if (!$getCustomerMfRequestCustomerMfRuleAttributeItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CustomerMfRuleAttribute property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCustomerMfRequest
     */
    public function addToCustomerMfRuleAttribute(\Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType) {
            throw new InvalidArgumentException(sprintf('The CustomerMfRuleAttribute property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CustomerMfRuleAttributeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
