...
class GetCrmHistoryResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO[] $midocoCrmHistory
     */
    ...
    public static function validateMidocoCrmHistoryForArrayConstraintsFromSetMidocoCrmHistory(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmHistoryResponseMidocoCrmHistoryItem) {
            ...
            if (!$getCrmHistoryResponseMidocoCrmHistoryItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmHistory property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO[] $midocoCrmHistory
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmHistoryResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmHistoryResponse
     */
    public function addToMidocoCrmHistory(\Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmHistory property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmHistoryDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
