...
class GetSalutationsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation[]
     */
    ...
    public static function validateMidocoSalutationForArrayConstraintsFromSetMidocoSalutation(?array $values = []): string
    {
        ...
        foreach ($values as $getSalutationsResponseMidocoSalutationItem) {
            ...
            if (!$getSalutationsResponseMidocoSalutationItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSalutation property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation[] $midocoSalutation
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSalutationsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSalutationsResponse
     */
    public function addToMidocoSalutation(\Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation) {
            throw new InvalidArgumentException(sprintf('The MidocoSalutation property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoSalutation, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
