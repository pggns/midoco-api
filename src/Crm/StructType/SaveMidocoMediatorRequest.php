...
class SaveMidocoMediatorRequest extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SaveMidocoMediatorRequest
     */
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $saveMidocoMediatorRequestMidocoCrmDebitCardItem) {
            ...
            if (!$saveMidocoMediatorRequestMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmDebitCard) {
