...
class SaveMidocoAgencyRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?\Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCustomerPayment $midocoCrmCustomerPayment = null, ?array $midocoCrmDebitCard = null, ?\Pggns\MidocoApi\Api\Crm\StructType\AgencyProperties $agencyProperties = null, ?array $midocoAgencyCommission = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SaveMidocoAgencyRequest
     */
    ...
    public static function validateMidocoCrmDebitCardForArrayConstraintsFromSetMidocoCrmDebitCard(?array $values = []): string
    {
        ...
        foreach ($values as $saveMidocoAgencyRequestMidocoCrmDebitCardItem) {
            ...
            if (!$saveMidocoAgencyRequestMidocoCrmDebitCardItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmDebitCard) {
    ...
    public static function validateMidocoAgencyCommissionForArrayConstraintsFromSetMidocoAgencyCommission(?array $values = []): string
    {
        ...
        foreach ($values as $saveMidocoAgencyRequestMidocoAgencyCommissionItem) {
            // validation for constraint: itemType
            if (!$saveMidocoAgencyRequestMidocoAgencyCommissionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\AgencyCommissionDTO) {
