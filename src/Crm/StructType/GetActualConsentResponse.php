...
class GetActualConsentResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoConsentForArrayConstraintsFromSetMidocoConsent(?array $values = []): string
    {
        ...
        foreach ($values as $getActualConsentResponseMidocoConsentItem) {
            ...
            if (!$getActualConsentResponseMidocoConsentItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoConsent) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoConsent[] $midocoConsent
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetActualConsentResponse
     */
