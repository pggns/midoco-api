...
class SearchCustomerByTravelResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(?array $values = []): string
    {
        ...
        foreach ($values as $searchCustomerByTravelResponseMidocoCustomerIdItem) {
            ...
            if (!$searchCustomerByTravelResponseMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SearchCustomerByTravelResponse
     */
