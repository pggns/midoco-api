...
class GetCustomerRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId = null, ?bool $fetchHistory = true, ?bool $withDetails = true, ?bool $calledFromOrder = false, ?bool $overruleRightCrmDisplayMediator = false)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCustomerRequest
     */
