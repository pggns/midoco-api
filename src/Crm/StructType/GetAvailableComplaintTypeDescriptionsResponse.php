...
class GetAvailableComplaintTypeDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO[] $midocoComplaintTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO[]
     */
    ...
    public static function validateMidocoComplaintTypeDescriptionForArrayConstraintsFromSetMidocoComplaintTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableComplaintTypeDescriptionsResponseMidocoComplaintTypeDescriptionItem) {
            ...
            if (!$getAvailableComplaintTypeDescriptionsResponseMidocoComplaintTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoComplaintTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO[] $midocoComplaintTypeDescription
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableComplaintTypeDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableComplaintTypeDescriptionsResponse
     */
    public function addToMidocoComplaintTypeDescription(\Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoComplaintTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ComplaintTypeDescrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
