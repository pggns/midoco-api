...
class GetMidocoChargesListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmMidocoChargeInfoForArrayConstraintsFromSetMidocoCrmMidocoChargeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoChargesListResponseMidocoCrmMidocoChargeInfoItem) {
            ...
            if (!$getMidocoChargesListResponseMidocoCrmMidocoChargeInfoItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmMidocoChargeInfoType) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmMidocoChargeInfoType[] $midocoCrmMidocoChargeInfo
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMidocoChargesListResponse
     */
