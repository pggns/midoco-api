...
class GetMidocoSettlMDocsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlMdocForArrayConstraintsFromSetMidocoCrmMidocoSettlMdoc(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoSettlMDocsResponseMidocoCrmMidocoSettlMdocItem) {
            ...
            if (!$getMidocoSettlMDocsResponseMidocoCrmMidocoSettlMdocItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlMdoc property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc[] $midocoCrmMidocoSettlMdoc
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMidocoSettlMDocsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMidocoSettlMDocsResponse
     */
    public function addToMidocoCrmMidocoSettlMdoc(\Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlMdoc property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmMidocoSettlMdoc, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
