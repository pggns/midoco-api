...
class GetOrgunitDatastoresResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintsFromSetMidocoOrgunitDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem) {
            ...
            if (!$getOrgunitDatastoresResponseMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetOrgunitDatastoresResponse
     */
