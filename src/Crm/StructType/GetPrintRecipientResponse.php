...
class GetPrintRecipientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRecipientForArrayConstraintsFromSetMidocoPrintRecipient(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintRecipientResponseMidocoPrintRecipientItem) {
            ...
            if (!$getPrintRecipientResponseMidocoPrintRecipientItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintRecipient) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoPrintRecipient[] $midocoPrintRecipient
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetPrintRecipientResponse
     */
