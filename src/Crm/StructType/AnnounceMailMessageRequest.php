...
class AnnounceMailMessageRequest extends AbstractStructBase
{
     ...
     * Set mailId value
     * @param int $mailId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\AnnounceMailMessageRequest
     */
    ...
    /**
     * Set type value
     * @uses \Pggns\MidocoApi\Api\Crm\EnumType\Type::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Crm\EnumType\Type::getValidValues()
    ...
    public function setType(?string $type = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Crm\EnumType\Type::valueIsValid($type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Crm\EnumType\Type', is_array($type) ? implode(', ', $type) : var_export($type, true), implode(', ', \Pggns\MidocoApi\Api\Crm\EnumType\Type::getValidValues())), __LINE__);
        }
        $this->type = $type;
     ...
     * @uses \Pggns\MidocoApi\Api\Crm\EnumType\MessageType::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Crm\EnumType\MessageType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $messageType
     * @return \Pggns\MidocoApi\Api\Crm\StructType\AnnounceMailMessageRequest
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Api\Crm\EnumType\MessageType::valueIsValid($messageType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Crm\EnumType\MessageType', is_array($messageType) ? implode(', ', $messageType) : var_export($messageType, true), implode(', ', \Pggns\MidocoApi\Api\Crm\EnumType\MessageType::getValidValues())), __LINE__);
        }
