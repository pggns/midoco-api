...
class GetCrmCampaignesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign[] $midocoCrmCampaign
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign[]
     */
    ...
    public static function validateMidocoCrmCampaignForArrayConstraintsFromSetMidocoCrmCampaign(?array $values = []): string
    {
        ...
        foreach ($values as $getCrmCampaignesResponseMidocoCrmCampaignItem) {
            ...
            if (!$getCrmCampaignesResponseMidocoCrmCampaignItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCampaign property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign[] $midocoCrmCampaign
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmCampaignesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCrmCampaignesResponse
     */
    public function addToMidocoCrmCampaign(\Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCampaign property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoCrmCampaign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
