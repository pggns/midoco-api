...
class GetIrisPlusExportStringRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?array $midocoSelectedCrmPersonTraveller = null, ?bool $isNewConnected = false, ?bool $isExportCustomer = false, ?bool $exportBirthday = null, ?bool $exportAge = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetIrisPlusExportStringRequest
     */
    ...
    public static function validateMidocoSelectedCrmPersonTravellerForArrayConstraintsFromSetMidocoSelectedCrmPersonTraveller(?array $values = []): string
    {
        ...
        foreach ($values as $getIrisPlusExportStringRequestMidocoSelectedCrmPersonTravellerItem) {
            ...
            if (!$getIrisPlusExportStringRequestMidocoSelectedCrmPersonTravellerItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoSelectedCrmPersonTraveller) {
