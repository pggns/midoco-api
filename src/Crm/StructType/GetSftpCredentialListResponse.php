...
class GetSftpCredentialListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO[]
     */
    ...
    public static function validateMidocoSftpCredentialForArrayConstraintsFromSetMidocoSftpCredential(?array $values = []): string
    {
        ...
        foreach ($values as $getSftpCredentialListResponseMidocoSftpCredentialItem) {
            ...
            if (!$getSftpCredentialListResponseMidocoSftpCredentialItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO[] $midocoSftpCredential
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSftpCredentialListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetSftpCredentialListResponse
     */
    public function addToMidocoSftpCredential(\Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\SftpCredentialDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
