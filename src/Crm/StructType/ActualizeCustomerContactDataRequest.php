...
class ActualizeCustomerContactDataRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType[] $midocoContactType
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType[]
     */
    ...
    public static function validateMidocoContactTypeForArrayConstraintsFromSetMidocoContactType(?array $values = []): string
    {
        ...
        foreach ($values as $actualizeCustomerContactDataRequestMidocoContactTypeItem) {
            ...
            if (!$actualizeCustomerContactDataRequestMidocoContactTypeItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoContactType property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType[] $midocoContactType
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerContactDataRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerContactDataRequest
     */
    public function addToMidocoContactType(\Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType) {
            throw new InvalidArgumentException(sprintf('The MidocoContactType property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoContactType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(2)
