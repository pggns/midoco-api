...
class GetBookingSourcesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO[]
     */
    ...
    public static function validateMidocoBookingSourceForArrayConstraintsFromSetMidocoBookingSource(?array $values = []): string
    {
        ...
        foreach ($values as $getBookingSourcesResponseMidocoBookingSourceItem) {
            ...
            if (!$getBookingSourcesResponseMidocoBookingSourceItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBookingSource property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO[] $midocoBookingSource
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetBookingSourcesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetBookingSourcesResponse
     */
    public function addToMidocoBookingSource(\Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoBookingSource property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\BookingSourceDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
