...
class GetJobFunctionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoJobFunctionForArrayConstraintsFromSetMidocoJobFunction(?array $values = []): string
    {
        ...
        foreach ($values as $getJobFunctionResponseMidocoJobFunctionItem) {
            ...
            if (!$getJobFunctionResponseMidocoJobFunctionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\JobFunctionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\JobFunctionDTO[] $midocoJobFunction
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetJobFunctionResponse
     */
