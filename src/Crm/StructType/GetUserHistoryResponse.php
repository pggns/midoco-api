...
class GetUserHistoryResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO[]
     */
    ...
    public static function validateMidocoUserHistoryForArrayConstraintsFromSetMidocoUserHistory(?array $values = []): string
    {
        ...
        foreach ($values as $getUserHistoryResponseMidocoUserHistoryItem) {
            ...
            if (!$getUserHistoryResponseMidocoUserHistoryItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserHistory property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO[] $midocoUserHistory
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetUserHistoryResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetUserHistoryResponse
     */
    public function addToMidocoUserHistory(\Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUserHistory property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\UserHistoryDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
