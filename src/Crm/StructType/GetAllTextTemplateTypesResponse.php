...
class GetAllTextTemplateTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO[]
     */
    ...
    public static function validateMidocoTextTemplateTypeExtForArrayConstraintsFromSetMidocoTextTemplateTypeExt(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTextTemplateTypesResponseMidocoTextTemplateTypeExtItem) {
            ...
            if (!$getAllTextTemplateTypesResponseMidocoTextTemplateTypeExtItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTextTemplateTypeExt property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO[] $midocoTextTemplateTypeExt
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAllTextTemplateTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAllTextTemplateTypesResponse
     */
    public function addToMidocoTextTemplateTypeExt(\Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoTextTemplateTypeExt property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\TextTemplateTypeExtDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
