...
class GetDocumentsRequest extends AbstractStructBase
{
     ...
     * @param bool $isManual
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId = null, ?int $beginIndex = null, ?int $endIndex = null, ?bool $isManual = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CustomerIdDTO $midocoCustomerId
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetDocumentsRequest
     */
