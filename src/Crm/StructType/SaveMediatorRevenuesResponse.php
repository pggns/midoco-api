...
class SaveMediatorRevenuesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument[] $errorInfoAgencyMissingInDocument
     * @param int[] $excelRows
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument[]
     */
    ...
    public static function validateErrorInfoAgencyMissingInDocumentForArrayConstraintsFromSetErrorInfoAgencyMissingInDocument(?array $values = []): string
    {
        ...
        foreach ($values as $saveMediatorRevenuesResponseErrorInfoAgencyMissingInDocumentItem) {
            ...
            if (!$saveMediatorRevenuesResponseErrorInfoAgencyMissingInDocumentItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ErrorInfoAgencyMissingInDocument property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument[] $errorInfoAgencyMissingInDocument
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SaveMediatorRevenuesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\SaveMediatorRevenuesResponse
     */
    public function addToErrorInfoAgencyMissingInDocument(\Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument) {
            throw new InvalidArgumentException(sprintf('The ErrorInfoAgencyMissingInDocument property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ErrorInfoAgencyMissingInDocument, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
