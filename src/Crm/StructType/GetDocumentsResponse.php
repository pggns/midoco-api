...
class GetDocumentsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmDocumentForArrayConstraintsFromSetMidocoCrmDocument(?array $values = []): string
    {
        ...
        foreach ($values as $getDocumentsResponseMidocoCrmDocumentItem) {
            ...
            if (!$getDocumentsResponseMidocoCrmDocumentItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO[] $midocoCrmDocument
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetDocumentsResponse
     */
