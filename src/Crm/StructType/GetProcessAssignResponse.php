...
class GetProcessAssignResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO[]
     */
    ...
    public static function validateMidocoProcessAssignForArrayConstraintsFromSetMidocoProcessAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getProcessAssignResponseMidocoProcessAssignItem) {
            ...
            if (!$getProcessAssignResponseMidocoProcessAssignItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProcessAssign property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO[] $midocoProcessAssign
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetProcessAssignResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetProcessAssignResponse
     */
    public function addToMidocoProcessAssign(\Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoProcessAssign property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\ProcessAssignDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
