...
class GetMergedMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMergedMfResponseMidocoMfItem) {
            ...
            if (!$getMergedMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetMergedMfResponse
     */
