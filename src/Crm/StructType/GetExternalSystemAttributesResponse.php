...
class GetExternalSystemAttributesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoExternalSystemAttributeForArrayConstraintsFromSetMidocoExternalSystemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getExternalSystemAttributesResponseMidocoExternalSystemAttributeItem) {
            ...
            if (!$getExternalSystemAttributesResponseMidocoExternalSystemAttributeItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\SystemAttributeDTO[] $midocoExternalSystemAttribute
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetExternalSystemAttributesResponse
     */
