...
class MultiPrintResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso[] $midocoMailDescription4Inexso
     */
    public function __construct(?\Pggns\MidocoApi\Api\Crm\StructType\MidocoMailMessageType $midocoMailMessage = null, ?array $historyId = null, ?array $rtfData = null, ?array $midocoMailDescription4Inexso = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailMessageType $midocoMailMessage
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MultiPrintResponse
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso[]
     */
    ...
    public static function validateMidocoMailDescription4InexsoForArrayConstraintsFromSetMidocoMailDescription4Inexso(?array $values = []): string
    {
        ...
        foreach ($values as $multiPrintResponseMidocoMailDescription4InexsoItem) {
            // validation for constraint: itemType
            if (!$multiPrintResponseMidocoMailDescription4InexsoItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMailDescription4Inexso property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MultiPrintResponse
     */
    public function addToMidocoMailDescription4Inexso(\Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso) {
            throw new InvalidArgumentException(sprintf('The MidocoMailDescription4Inexso property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\MidocoMailDescription4Inexso, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
