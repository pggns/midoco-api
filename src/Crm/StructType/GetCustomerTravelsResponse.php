...
class GetCustomerTravelsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(?array $values = []): string
    {
        ...
        foreach ($values as $getCustomerTravelsResponseMidocoCustomerTravelItem) {
            ...
            if (!$getCustomerTravelsResponseMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MidocoCustomerTravelType[] $midocoCustomerTravel
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetCustomerTravelsResponse
     */
