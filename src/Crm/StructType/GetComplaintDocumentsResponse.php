...
class GetComplaintDocumentsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO[]
     */
    ...
    public static function validateMidocoCrmDocumentForArrayConstraintsFromSetMidocoCrmDocument(?array $values = []): string
    {
        ...
        foreach ($values as $getComplaintDocumentsResponseMidocoCrmDocumentItem) {
            ...
            if (!$getComplaintDocumentsResponseMidocoCrmDocumentItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmDocument property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO[] $midocoCrmDocument
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetComplaintDocumentsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetComplaintDocumentsResponse
     */
    public function addToMidocoCrmDocument(\Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmDocument property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmDocumentDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
