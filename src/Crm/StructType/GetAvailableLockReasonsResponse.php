...
class GetAvailableLockReasonsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO[]
     */
    ...
    public static function validateMidocoCrmLockReasonForArrayConstraintsFromSetMidocoCrmLockReason(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableLockReasonsResponseMidocoCrmLockReasonItem) {
            ...
            if (!$getAvailableLockReasonsResponseMidocoCrmLockReasonItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmLockReason property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO[] $midocoCrmLockReason
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableLockReasonsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO $item
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetAvailableLockReasonsResponse
     */
    public function addToMidocoCrmLockReason(\Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmLockReason property can only contain items of type \Pggns\MidocoApi\Api\Crm\StructType\CrmLockReasonDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
