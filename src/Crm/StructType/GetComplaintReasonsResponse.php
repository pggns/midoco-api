...
class GetComplaintReasonsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoComplaintReasonDescriptionForArrayConstraintsFromSetMidocoComplaintReasonDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getComplaintReasonsResponseMidocoComplaintReasonDescriptionItem) {
            ...
            if (!$getComplaintReasonsResponseMidocoComplaintReasonDescriptionItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ComplaintReasonDescrDTO[] $midocoComplaintReasonDescription
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetComplaintReasonsResponse
     */
