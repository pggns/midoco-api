...
class GetLetterTemplatesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoLetterTemplateForArrayConstraintsFromSetMidocoLetterTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $getLetterTemplatesResponseMidocoLetterTemplateItem) {
            ...
            if (!$getLetterTemplatesResponseMidocoLetterTemplateItem instanceof \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\LetterTemplateDTO[] $midocoLetterTemplate
     * @return \Pggns\MidocoApi\Api\Crm\StructType\GetLetterTemplatesResponse
     */
