...
class Duplicate extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Crm\ServiceType\Duplicate
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\DuplicateCrmMidocoSettlementRequest $paramDuplicateCrmMidocoSettlementRequest
     * @return \Pggns\MidocoApi\Crm\StructType\DuplicateCrmMidocoSettlementResponse|bool
     */
    public function duplicateCrmMidocoSettlement(\Pggns\MidocoApi\Crm\StructType\DuplicateCrmMidocoSettlementRequest $paramDuplicateCrmMidocoSettlementRequest)
    {
        try {
