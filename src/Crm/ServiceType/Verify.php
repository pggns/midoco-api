...
class Verify extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Crm\ServiceType\Verify
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\VerifyPasswordRequest $paramVerifyPasswordRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\VerifyPasswordResponse|bool
     */
    public function verifyPassword(\Pggns\MidocoApi\Api\Crm\StructType\VerifyPasswordRequest $paramVerifyPasswordRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\VerifyPasswordResponse
     */
