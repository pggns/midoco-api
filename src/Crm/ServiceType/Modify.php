...
class Modify extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Crm\ServiceType\Modify
     */
    ...
    /**
     * Method to call the operation originally named modifyPassword
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\ModifyPasswordRequest $paramModifyPasswordRequest
     * @return \Pggns\MidocoApi\Crm\StructType\ModifyPasswordResponse|bool
     */
    public function modifyPassword(\Pggns\MidocoApi\Crm\StructType\ModifyPasswordRequest $paramModifyPasswordRequest)
    {
        try {
            $this->setResult($resultModifyPassword = $this->getSoapClient()->__soapCall('modifyPassword', [
                $paramModifyPasswordRequest,
            ], [], [], $this->outputHeaders));
        
            return $resultModifyPassword;
