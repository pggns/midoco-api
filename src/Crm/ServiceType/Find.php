...
class Find extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Crm\ServiceType\Find
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\FindCustomerForEmailRequest $paramFindCustomerForEmailRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\FindCustomerForEmailResponse|bool
     */
    public function findCustomerForEmail(\Pggns\MidocoApi\Api\Crm\StructType\FindCustomerForEmailRequest $paramFindCustomerForEmailRequest)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \Pggns\MidocoApi\Api\Crm\StructType\FindCustomerOrDebitorRequest $paramFindCustomerOrDebitorRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\FindCustomerOrDebitorResponse|bool
     */
    public function findCustomerOrDebitor(\Pggns\MidocoApi\Api\Crm\StructType\FindCustomerOrDebitorRequest $paramFindCustomerOrDebitorRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\FindCustomerForEmailResponse|\Pggns\MidocoApi\Api\Crm\StructType\FindCustomerOrDebitorResponse
     */
