...
class Export extends AbstractSoapClientBase
{
     ...
     * @return \Pggns\MidocoApi\Crm\ServiceType\Export
     */
    ...
    /**
     * Method to call the operation originally named exportDebitors
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\ExportDebitorsRequest $paramExportDebitorsRequest
     * @return \Pggns\MidocoApi\Crm\StructType\ExportDebitorsResponse|bool
     */
    public function exportDebitors(\Pggns\MidocoApi\Crm\StructType\ExportDebitorsRequest $paramExportDebitorsRequest)
    {
        try {
            $this->setResult($resultExportDebitors = $this->getSoapClient()->__soapCall('exportDebitors', [
                $paramExportDebitorsRequest,
            ], [], [], $this->outputHeaders));
        
            return $resultExportDebitors;
