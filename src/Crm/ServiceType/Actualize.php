...
class Actualize extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Crm\ServiceType\Actualize
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ActualizePhoneticDataRequest $paramActualizePhoneticDataRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ActualizePhoneticDataResponse|bool
     */
    public function actualizePhoneticData(\Pggns\MidocoApi\Api\Crm\StructType\ActualizePhoneticDataRequest $paramActualizePhoneticDataRequest)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerErmMailRequest $paramActualizeCustomerErmMailRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerErmMailResponse|bool
     */
    public function actualizeCustomerErmMail(\Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerErmMailRequest $paramActualizeCustomerErmMailRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\ActualizeCustomerErmMailResponse|\Pggns\MidocoApi\Api\Crm\StructType\ActualizePhoneticDataResponse
     */
