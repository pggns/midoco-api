...
class _Do extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Crm\ServiceType\_Do
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\MultiPrintRequest $paramMultiPrintRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\MultiPrintResponse|bool
     */
    public function doMultiPrint(\Pggns\MidocoApi\Api\Crm\StructType\MultiPrintRequest $paramMultiPrintRequest)
    {
        try {
