...
class Lock extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Crm\ServiceType\Lock
     */
     ...
     * @param \Pggns\MidocoApi\Api\Crm\StructType\LockCustomerByDebitorRequest $paramLockCustomerByDebitorRequest
     * @return \Pggns\MidocoApi\Api\Crm\StructType\LockCustomerByDebitorResponse|bool
     */
    public function lockCustomerByDebitor(\Pggns\MidocoApi\Api\Crm\StructType\LockCustomerByDebitorRequest $paramLockCustomerByDebitorRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\Crm\StructType\LockCustomerByDebitorResponse
     */
