...
class Load extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Crm\ServiceType\Load
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\StatistikAtLoadDataRequest $paramStatistikAtLoadDataRequest
     * @return \Pggns\MidocoApi\Crm\StructType\StatistikAtLoadDataResponse|bool
     */
    public function loadDataStatistikAt(\Pggns\MidocoApi\Crm\StructType\StatistikAtLoadDataRequest $paramStatistikAtLoadDataRequest)
    {
        try {
