...
class GetTaskViewbyTimeRestrictionResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTaskViewForArrayConstraintFromSetMidocoTaskView(?array $values = []): string
    {
        ...
        foreach ($values as $getTaskViewbyTimeRestrictionResponseMidocoTaskViewItem) {
            ...
            if (!$getTaskViewbyTimeRestrictionResponseMidocoTaskViewItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTaskView) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTaskView[] $midocoTaskView
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetTaskViewbyTimeRestrictionResponse
     */
