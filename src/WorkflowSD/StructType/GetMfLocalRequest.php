...
class GetMfLocalRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\WorkflowSD\StructType\MidocoMfLocal $midocoMfLocal = null, ?string $unitName = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoMfLocal $midocoMfLocal
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetMfLocalRequest
     */
