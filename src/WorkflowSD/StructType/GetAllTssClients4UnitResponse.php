...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetAllTssClients4UnitResponse
     */
