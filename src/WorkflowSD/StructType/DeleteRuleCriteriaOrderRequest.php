...
/**
 * This class stands for DeleteRuleCriteriaOrderRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteRuleCriteriaOrderRequest extends AbstractStructBase
{
    /**
     * The unitName
    ...
    /**
     * Constructor method for DeleteRuleCriteriaOrderRequest
     * @uses DeleteRuleCriteriaOrderRequest::setUnitName()
     * @uses DeleteRuleCriteriaOrderRequest::setCriteriaId()
     ...
     * Set unitName value
     * @param string $unitName
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\DeleteRuleCriteriaOrderRequest
     */
