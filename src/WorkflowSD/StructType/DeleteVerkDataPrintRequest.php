...
class DeleteVerkDataPrintRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoVerkDataPrintForArrayConstraintFromSetMidocoVerkDataPrint(?array $values = []): string
    {
        ...
        foreach ($values as $deleteVerkDataPrintRequestMidocoVerkDataPrintItem) {
            ...
            if (!$deleteVerkDataPrintRequestMidocoVerkDataPrintItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\VerkDataPrintDTO) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\VerkDataPrintDTO[] $midocoVerkDataPrint
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\DeleteVerkDataPrintRequest
     */
