...
class GetOrgunitEmailSigListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitEmailSigForArrayConstraintFromSetMidocoOrgunitEmailSig(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem) {
            ...
            if (!$getOrgunitEmailSigListResponseMidocoOrgunitEmailSigItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\OrgunitEmailSigDTO) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\OrgunitEmailSigDTO[] $midocoOrgunitEmailSig
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetOrgunitEmailSigListResponse
     */
