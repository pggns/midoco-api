...
class CreateCcProxySingleUseTokenRequest extends AbstractStructBase
{
    ...
    /**
     * The emailData
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO|null
     */
    protected ?\Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO $emailData = null;
    /**
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO $emailData
     */
    public function __construct(?string $token = null, ?string $tokenValue = null, ?string $sensitiveId = null, ?int $lifespanInSeconds = null, ?int $userId = null, ?string $orgUnit = null, ?\Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO $emailData = null)
    {
        $this
            ->setToken($token)
     ...
     * Set token value
     * @param string $token
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\CreateCcProxySingleUseTokenRequest
     */
    ...
    /**
     * Get emailData value
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO|null
     */
    public function getEmailData(): ?\Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO
    {
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\CreateCcProxySingleUseTokenRequest
     */
    public function setEmailData(?\Pggns\MidocoApi\WorkflowSD\StructType\CcProxyEmailDataDTO $emailData = null): self
    {
