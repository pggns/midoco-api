...
class SaveMyTaskViewUnitsRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoMyTaskViewUnitForArrayConstraintFromSetMidocoMyTaskViewUnit(?array $values = []): string
    {
        ...
        foreach ($values as $saveMyTaskViewUnitsRequestMidocoMyTaskViewUnitItem) {
            ...
            if (!$saveMyTaskViewUnitsRequestMidocoMyTaskViewUnitItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoMyTaskViewUnit) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoMyTaskViewUnit[] $midocoMyTaskViewUnit
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\SaveMyTaskViewUnitsRequest
     */
