...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\RefreshTssClientStateRequest
     */
