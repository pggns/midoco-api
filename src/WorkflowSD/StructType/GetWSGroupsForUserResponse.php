...
class GetWSGroupsForUserResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoWsGroup
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO[] $midocoWsGroup
     */
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO[]
     */
    ...
    public static function validateMidocoWsGroupForArrayConstraintFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsForUserResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsForUserResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoWsGroup property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetWSGroupsForUserResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO $item
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetWSGroupsForUserResponse
     */
    public function addToMidocoWsGroup(\Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoWsGroup property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\WsgroupDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
