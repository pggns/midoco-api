...
class GetSftpCredentialListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO[]
     */
    ...
    public static function validateMidocoSftpCredentialForArrayConstraintFromSetMidocoSftpCredential(?array $values = []): string
    {
        ...
        foreach ($values as $getSftpCredentialListResponseMidocoSftpCredentialItem) {
            ...
            if (!$getSftpCredentialListResponseMidocoSftpCredentialItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO[] $midocoSftpCredential
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetSftpCredentialListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO $item
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetSftpCredentialListResponse
     */
    public function addToMidocoSftpCredential(\Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSftpCredential property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\SftpCredentialDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
