...
class GetAssignedPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getAssignedPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getAssignedPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetAssignedPrintSelectsResponse
     */
