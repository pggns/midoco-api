...
class MigrateFiskalyTssResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary|null
     */
    protected ?\Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary $Migration_Summary = null;
    /**
     * The Migration_Log
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\Unprocessed_Units|null
     */
    protected ?\Pggns\MidocoApi\WorkflowSD\StructType\Unprocessed_Units $Unprocessed_Units = null;
    /**
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary $migration_Summary
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary|null
     */
    public function getMigration_Summary(): ?\Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary
    {
     ...
     */
    public function setMigration_Summary(?\Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Summary $migration_Summary = null): self
    {
    ...
    public static function validateMigration_LogForArrayConstraintFromSetMigration_Log(?array $values = []): string
    {
        ...
        foreach ($values as $migrateFiskalyTssResponseMigration_LogItem) {
            ...
            if (!$migrateFiskalyTssResponseMigration_LogItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Migration_Log property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log $item
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MigrateFiskalyTssResponse
     */
    public function addToMigration_Log(\Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log) {
            throw new InvalidArgumentException(sprintf('The Migration_Log property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\Tss_Migration_Log, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\Unprocessed_Units|null
     */
    public function getUnprocessed_Units(): ?\Pggns\MidocoApi\WorkflowSD\StructType\Unprocessed_Units
    {
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MigrateFiskalyTssResponse
     */
    public function setUnprocessed_Units(?\Pggns\MidocoApi\WorkflowSD\StructType\Unprocessed_Units $unprocessed_Units = null): self
    {
