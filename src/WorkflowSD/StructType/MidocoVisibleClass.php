...
class MidocoVisibleClass extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     ...
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute[]
     */
    ...
    public static function validateMidocoPropertyAttributeForArrayConstraintFromSetMidocoPropertyAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVisibleClassMidocoPropertyAttributeItem) {
            ...
            if (!$midocoVisibleClassMidocoPropertyAttributeItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute[] $midocoPropertyAttribute
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MidocoVisibleClass
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute $item
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MidocoVisibleClass
     */
    public function addToMidocoPropertyAttribute(\Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoPropertyAttribute property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\MidocoPropertyAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
