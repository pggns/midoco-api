...
class MidocoOrgUnitElementType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType[]
     */
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType[] $midocoOrgUnitElement
     */
     ...
     * Set parent value
     * @param string $parent
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType
     */
    ...
    public static function validateMidocoOrgUnitElementForArrayConstraintFromSetMidocoOrgUnitElement(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrgUnitElementTypeMidocoOrgUnitElementItem) {
            ...
            if (!$midocoOrgUnitElementTypeMidocoOrgUnitElementItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgUnitElement property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType $item
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType
     */
    public function addToMidocoOrgUnitElement(\Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgUnitElement property can only contain items of type \Pggns\MidocoApi\WorkflowSD\StructType\MidocoOrgUnitElementType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
