...
class De extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\OrderSD\ServiceType\De
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\DeAssignMidocoRuleRequest $paramDeAssignMidocoRuleRequest
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\DeAssignMidocoRuleResponse|bool
     */
    public function deAssignMidocoRuleSet(\Pggns\MidocoApi\Api\OrderSD\StructType\DeAssignMidocoRuleRequest $paramDeAssignMidocoRuleRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\DeAssignMidocoRuleResponse
     */
