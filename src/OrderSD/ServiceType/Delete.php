...
class Delete extends AbstractSoapClientBase
{
     ...
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \Pggns\MidocoApi\OrderSD\StructType\DeleteSupplierAgencyReservationRequest $paramDeleteSupplierAgencyReservationRequest
     * @return \Pggns\MidocoApi\OrderSD\StructType\DeleteSupplierAgencyReservationResponse|bool
     */
    public function deleteSupplierAgencyReservation(\Pggns\MidocoApi\OrderSD\StructType\DeleteSupplierAgencyReservationRequest $paramDeleteSupplierAgencyReservationRequest)
    {
        try {
