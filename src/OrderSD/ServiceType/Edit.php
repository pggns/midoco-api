...
class Edit extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\OrderSD\ServiceType\Edit
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\EditMidocoTextRemarkRequest $paramEditMidocoTextRemarkRequest
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\EditMidocoTextRemarkResponse|bool
     */
    public function editMidocoTextRemark(\Pggns\MidocoApi\Api\OrderSD\StructType\EditMidocoTextRemarkRequest $paramEditMidocoTextRemarkRequest)
    {
        try {
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\EditMidocoTextRemarkResponse
     */
