...
class MidocoQuestion extends QuestionDTO
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO[]
     */
    protected ?array $MidocoQmPrint = null;
    /**
     * Constructor method for MidocoQuestion
     * @uses MidocoQuestion::setMidocoQmPrint()
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO[] $midocoQmPrint
     */
    ...
    public static function validateMidocoQmPrintForArrayConstraintsFromSetMidocoQmPrint(?array $values = []): string
    {
        ...
        foreach ($values as $midocoQuestionMidocoQmPrintItem) {
            ...
            if (!$midocoQuestionMidocoQmPrintItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQmPrint property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQuestion
     */
    public function addToMidocoQmPrint(\Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoQmPrint property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\QmPrintDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
