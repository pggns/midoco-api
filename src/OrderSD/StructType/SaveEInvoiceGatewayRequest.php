...
class SaveEInvoiceGatewayRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoEInvoiceGatewayForArrayConstraintsFromSetMidocoEInvoiceGateway(?array $values = []): string
    {
        ...
        foreach ($values as $saveEInvoiceGatewayRequestMidocoEInvoiceGatewayItem) {
            ...
            if (!$saveEInvoiceGatewayRequestMidocoEInvoiceGatewayItem instanceof \Pggns\MidocoApi\OrderSD\StructType\EinvoiceGatewayDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\EinvoiceGatewayDTO[] $midocoEInvoiceGateway
     * @return \Pggns\MidocoApi\OrderSD\StructType\SaveEInvoiceGatewayRequest
     */
