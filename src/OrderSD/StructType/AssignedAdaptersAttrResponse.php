...
class AssignedAdaptersAttrResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO[] $midocoAdapterAttr
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO[]
     */
    ...
    public static function validateMidocoAdapterAttrForArrayConstraintFromSetMidocoAdapterAttr(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersAttrResponseMidocoAdapterAttrItem) {
            ...
            if (!$assignedAdaptersAttrResponseMidocoAdapterAttrItem instanceof \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdapterAttr property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO[] $midocoAdapterAttr
     * @return \Pggns\MidocoApi\OrderSD\StructType\AssignedAdaptersAttrResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\AssignedAdaptersAttrResponse
     */
    public function addToMidocoAdapterAttr(\Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAdapterAttr property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\AdapterAttrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
