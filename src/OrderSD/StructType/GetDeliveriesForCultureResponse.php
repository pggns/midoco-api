...
class GetDeliveriesForCultureResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO[] $midocoDeliveryTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO[]
     */
    ...
    public static function validateMidocoDeliveryTypeDescriptionForArrayConstraintsFromSetMidocoDeliveryTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getDeliveriesForCultureResponseMidocoDeliveryTypeDescriptionItem) {
            ...
            if (!$getDeliveriesForCultureResponseMidocoDeliveryTypeDescriptionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDeliveryTypeDescription property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO[] $midocoDeliveryTypeDescription
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetDeliveriesForCultureResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetDeliveriesForCultureResponse
     */
    public function addToMidocoDeliveryTypeDescription(\Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDeliveryTypeDescription property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\DeliveryTypeDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
