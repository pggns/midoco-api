...
class SaveUserQueryRequest extends AbstractStructBase
{
     ...
     * @param string $queryDescription
     * @return \Pggns\MidocoApi\OrderSD\StructType\SaveUserQueryRequest
     */
