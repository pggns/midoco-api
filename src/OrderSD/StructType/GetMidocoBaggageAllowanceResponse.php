...
class GetMidocoBaggageAllowanceResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance[]
     */
    ...
    public static function validateMidocoBaggageAllowanceForArrayConstraintsFromSetMidocoBaggageAllowance(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoBaggageAllowanceResponseMidocoBaggageAllowanceItem) {
            ...
            if (!$getMidocoBaggageAllowanceResponseMidocoBaggageAllowanceItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBaggageAllowance property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance[] $midocoBaggageAllowance
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetMidocoBaggageAllowanceResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetMidocoBaggageAllowanceResponse
     */
    public function addToMidocoBaggageAllowance(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance) {
            throw new InvalidArgumentException(sprintf('The MidocoBaggageAllowance property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoBaggageAllowance, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
