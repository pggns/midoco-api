...
class GetUserHistoryResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO[]
     */
    ...
    public static function validateMidocoUserHistoryForArrayConstraintsFromSetMidocoUserHistory(?array $values = []): string
    {
        ...
        foreach ($values as $getUserHistoryResponseMidocoUserHistoryItem) {
            ...
            if (!$getUserHistoryResponseMidocoUserHistoryItem instanceof \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserHistory property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO[] $midocoUserHistory
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetUserHistoryResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetUserHistoryResponse
     */
    public function addToMidocoUserHistory(\Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUserHistory property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\UserHistoryDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
