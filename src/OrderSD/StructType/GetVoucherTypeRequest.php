...
class GetVoucherTypeRequest extends AbstractStructBase
{
     ...
     * @param bool $validNow
     */
    public function __construct(?\Pggns\MidocoApi\Api\OrderSD\StructType\VoucherTypeDTO $midocoVoucherType = null, ?string $supplierId = null, ?bool $validNow = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\VoucherTypeDTO $midocoVoucherType
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetVoucherTypeRequest
     */
