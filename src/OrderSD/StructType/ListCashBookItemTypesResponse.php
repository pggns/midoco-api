...
class ListCashBookItemTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType[]
     */
    ...
    public static function validateMidocoCashBookItemTypeForArrayConstraintFromSetMidocoCashBookItemType(?array $values = []): string
    {
        ...
        foreach ($values as $listCashBookItemTypesResponseMidocoCashBookItemTypeItem) {
            ...
            if (!$listCashBookItemTypesResponseMidocoCashBookItemTypeItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCashBookItemType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType[] $midocoCashBookItemType
     * @return \Pggns\MidocoApi\OrderSD\StructType\ListCashBookItemTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\ListCashBookItemTypesResponse
     */
    public function addToMidocoCashBookItemType(\Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType) {
            throw new InvalidArgumentException(sprintf('The MidocoCashBookItemType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoCashBookItemType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
