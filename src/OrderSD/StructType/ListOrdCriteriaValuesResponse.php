...
class ListOrdCriteriaValuesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO[] $midocoOrdCriteriaValue
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO[]
     */
    ...
    public static function validateMidocoOrdCriteriaValueForArrayConstraintsFromSetMidocoOrdCriteriaValue(?array $values = []): string
    {
        ...
        foreach ($values as $listOrdCriteriaValuesResponseMidocoOrdCriteriaValueItem) {
            ...
            if (!$listOrdCriteriaValuesResponseMidocoOrdCriteriaValueItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaValue property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO[] $midocoOrdCriteriaValue
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListOrdCriteriaValuesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListOrdCriteriaValuesResponse
     */
    public function addToMidocoOrdCriteriaValue(\Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaValue property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
