...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\OrderSD\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetWSGroupsResponse
     */
