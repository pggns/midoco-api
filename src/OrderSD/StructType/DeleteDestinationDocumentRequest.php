...
class DeleteDestinationDocumentRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderSD\StructType\MidocoDestinationDocument $midocoDestinationDocument = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoDestinationDocument $midocoDestinationDocument
     * @return \Pggns\MidocoApi\OrderSD\StructType\DeleteDestinationDocumentRequest
     */
