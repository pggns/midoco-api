...
class GetAvailableSupplierNamesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName[] $midocoSupplierName
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName[]
     */
    ...
    public static function validateMidocoSupplierNameForArrayConstraintsFromSetMidocoSupplierName(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierNamesResponseMidocoSupplierNameItem) {
            ...
            if (!$getAvailableSupplierNamesResponseMidocoSupplierNameItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierName property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName[] $midocoSupplierName
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableSupplierNamesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableSupplierNamesResponse
     */
    public function addToMidocoSupplierName(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierName property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
