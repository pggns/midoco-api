...
class FeeMultiEditRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit[] $midocoFeeMultiEdit
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit[]
     */
    ...
    public static function validateMidocoFeeMultiEditForArrayConstraintsFromSetMidocoFeeMultiEdit(?array $values = []): string
    {
        ...
        foreach ($values as $feeMultiEditRequestMidocoFeeMultiEditItem) {
            ...
            if (!$feeMultiEditRequestMidocoFeeMultiEditItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeMultiEdit property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit[] $midocoFeeMultiEdit
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\FeeMultiEditRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\FeeMultiEditRequest
     */
    public function addToMidocoFeeMultiEdit(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeMultiEdit property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeMultiEdit, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoFeeGroupAssignForArrayConstraintsFromSetMidocoFeeGroupAssign(?array $values = []): string
    {
        ...
        foreach ($values as $feeMultiEditRequestMidocoFeeGroupAssignItem) {
            // validation for constraint: itemType
            if (!$feeMultiEditRequestMidocoFeeGroupAssignItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoFeeGroupAssign) {
