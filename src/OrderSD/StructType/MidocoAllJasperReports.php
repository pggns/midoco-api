...
class MidocoAllJasperReports extends AbstractStructBase
{
    ...
    public static function validateMidocoJasperReportForArrayConstraintsFromSetMidocoJasperReport(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAllJasperReportsMidocoJasperReportItem) {
            ...
            if (!$midocoAllJasperReportsMidocoJasperReportItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoJasperReport) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoJasperReport[] $midocoJasperReport
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoAllJasperReports
     */
