...
class MarketingKeyType extends MarketingKeyDTO
{
    ...
    public static function validateMidocoMarketingKeyDescriptionForArrayConstraintsFromSetMidocoMarketingKeyDescription(?array $values = []): string
    {
        ...
        foreach ($values as $marketingKeyTypeMidocoMarketingKeyDescriptionItem) {
            ...
            if (!$marketingKeyTypeMidocoMarketingKeyDescriptionItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDescriptionType) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDescriptionType[] $midocoMarketingKeyDescription
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyType
     */
