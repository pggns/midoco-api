...
class MarketingKeyType extends MarketingKeyDTO
{
    ...
    public static function validateMidocoMarketingKeyDescriptionForArrayConstraintFromSetMidocoMarketingKeyDescription(?array $values = []): string
    {
        ...
        foreach ($values as $marketingKeyTypeMidocoMarketingKeyDescriptionItem) {
            ...
            if (!$marketingKeyTypeMidocoMarketingKeyDescriptionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MarketingKeyDescriptionType) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MarketingKeyDescriptionType[] $midocoMarketingKeyDescription
     * @return \Pggns\MidocoApi\OrderSD\StructType\MarketingKeyType
     */
