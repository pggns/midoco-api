...
class GetAvailableOrderLockReasonsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonForArrayConstraintFromSetMidocoOrderLockReason(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableOrderLockReasonsResponseMidocoOrderLockReasonItem) {
            ...
            if (!$getAvailableOrderLockReasonsResponseMidocoOrderLockReasonItem instanceof \Pggns\MidocoApi\OrderSD\StructType\OrderLockReasonDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\OrderLockReasonDTO[] $midocoOrderLockReason
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetAvailableOrderLockReasonsResponse
     */
