...
class GetUserWithCrsExpedientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientResponseMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientResponseMidocoUserItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetUserWithCrsExpedientResponse
     */
