...
class ListSavedTemplatesQueriesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo[] $midocoUserQueryInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo[]
     */
    ...
    public static function validateMidocoUserQueryInfoForArrayConstraintsFromSetMidocoUserQueryInfo(?array $values = []): string
    {
        ...
        foreach ($values as $listSavedTemplatesQueriesResponseMidocoUserQueryInfoItem) {
            ...
            if (!$listSavedTemplatesQueriesResponseMidocoUserQueryInfoItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserQueryInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo[] $midocoUserQueryInfo
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListSavedTemplatesQueriesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListSavedTemplatesQueriesResponse
     */
    public function addToMidocoUserQueryInfo(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoUserQueryInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
