...
class MidocoQueryPage extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine[] $midocoQueryPageLine
     * @param int $pageNo
     */
    ...
    public static function validateMidocoQueryPageLineForArrayConstraintsFromSetMidocoQueryPageLine(?array $values = []): string
    {
        ...
        foreach ($values as $midocoQueryPageMidocoQueryPageLineItem) {
            ...
            if (!$midocoQueryPageMidocoQueryPageLineItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQueryPageLine property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine[] $midocoQueryPageLine
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPage
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPage
     */
    public function addToMidocoQueryPageLine(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine) {
            throw new InvalidArgumentException(sprintf('The MidocoQueryPageLine property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryPageLine, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
