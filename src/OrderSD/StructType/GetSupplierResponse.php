...
class GetSupplierResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier = null, ?\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierAddress $midocoSupplierAddress = null, ?array $midocoSupplierAccountAssign = null, ?array $midocoSupplierPaymentCondition = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetSupplierResponse
     */
    ...
    public static function validateMidocoSupplierAccountAssignForArrayConstraintsFromSetMidocoSupplierAccountAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierResponseMidocoSupplierAccountAssignItem) {
            ...
            if (!$getSupplierResponseMidocoSupplierAccountAssignItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierAccountAssign) {
    ...
    public static function validateMidocoSupplierPaymentConditionForArrayConstraintsFromSetMidocoSupplierPaymentCondition(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierResponseMidocoSupplierPaymentConditionItem) {
            // validation for constraint: itemType
            if (!$getSupplierResponseMidocoSupplierPaymentConditionItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierPaymentCondition) {
