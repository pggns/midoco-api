...
class DeleteMiscPaymentSettingRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoMiscPaymentSettingForArrayConstraintsFromSetMidocoMiscPaymentSetting(?array $values = []): string
    {
        ...
        foreach ($values as $deleteMiscPaymentSettingRequestMidocoMiscPaymentSettingItem) {
            ...
            if (!$deleteMiscPaymentSettingRequestMidocoMiscPaymentSettingItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\CashPaymentSettingDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\CashPaymentSettingDTO[] $midocoMiscPaymentSetting
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\DeleteMiscPaymentSettingRequest
     */
