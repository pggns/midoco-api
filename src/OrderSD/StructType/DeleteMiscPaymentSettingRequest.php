...
class DeleteMiscPaymentSettingRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoMiscPaymentSettingForArrayConstraintsFromSetMidocoMiscPaymentSetting(?array $values = []): string
    {
        ...
        foreach ($values as $deleteMiscPaymentSettingRequestMidocoMiscPaymentSettingItem) {
            ...
            if (!$deleteMiscPaymentSettingRequestMidocoMiscPaymentSettingItem instanceof \Pggns\MidocoApi\OrderSD\StructType\CashPaymentSettingDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\CashPaymentSettingDTO[] $midocoMiscPaymentSetting
     * @return \Pggns\MidocoApi\OrderSD\StructType\DeleteMiscPaymentSettingRequest
     */
