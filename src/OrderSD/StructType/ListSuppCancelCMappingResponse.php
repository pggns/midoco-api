...
class ListSuppCancelCMappingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSuppCancelCMappingForArrayConstraintsFromSetMidocoSuppCancelCMapping(?array $values = []): string
    {
        ...
        foreach ($values as $listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem) {
            ...
            if (!$listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSuppCancelCMapping) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSuppCancelCMapping[] $midocoSuppCancelCMapping
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListSuppCancelCMappingResponse
     */
