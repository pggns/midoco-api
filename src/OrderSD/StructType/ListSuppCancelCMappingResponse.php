...
class ListSuppCancelCMappingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSuppCancelCMappingForArrayConstraintsFromSetMidocoSuppCancelCMapping(?array $values = []): string
    {
        ...
        foreach ($values as $listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem) {
            ...
            if (!$listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoSuppCancelCMapping) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSuppCancelCMapping[] $midocoSuppCancelCMapping
     * @return \Pggns\MidocoApi\OrderSD\StructType\ListSuppCancelCMappingResponse
     */
