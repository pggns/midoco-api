...
class PrintRemarkDestinationList extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination[]
     */
    ...
    public static function validateMidocoPrintRemarkDestinationForArrayConstraintsFromSetMidocoPrintRemarkDestination(?array $values = []): string
    {
        ...
        foreach ($values as $printRemarkDestinationListMidocoPrintRemarkDestinationItem) {
            ...
            if (!$printRemarkDestinationListMidocoPrintRemarkDestinationItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintRemarkDestination property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination[] $midocoPrintRemarkDestination
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\PrintRemarkDestinationList
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\PrintRemarkDestinationList
     */
    public function addToMidocoPrintRemarkDestination(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintRemarkDestination property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoPrintRemarkDestination, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
