...
class GetProductTypesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType[]
     */
    ...
    public static function validateMidocoProductTypeForArrayConstraintsFromSetMidocoProductType(?array $values = []): string
    {
        ...
        foreach ($values as $getProductTypesResponseMidocoProductTypeItem) {
            ...
            if (!$getProductTypesResponseMidocoProductTypeItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoProductType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType[] $midocoProductType
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetProductTypesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetProductTypesResponse
     */
    public function addToMidocoProductType(\Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType) {
            throw new InvalidArgumentException(sprintf('The MidocoProductType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoProductTypeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
