...
class GetMidocoTextRemarksResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTextRemarkForArrayConstraintsFromSetMidocoTextRemark(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoTextRemarksResponseMidocoTextRemarkItem) {
            ...
            if (!$getMidocoTextRemarksResponseMidocoTextRemarkItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoTextRemark) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoTextRemark[] $midocoTextRemark
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMidocoTextRemarksResponse
     */
