...
class GetRemarkOrgunitsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit[]
     */
    ...
    public static function validateMidocoRemarkOrgunitForArrayConstraintsFromSetMidocoRemarkOrgunit(?array $values = []): string
    {
        ...
        foreach ($values as $getRemarkOrgunitsResponseMidocoRemarkOrgunitItem) {
            ...
            if (!$getRemarkOrgunitsResponseMidocoRemarkOrgunitItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRemarkOrgunit property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit[] $midocoRemarkOrgunit
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetRemarkOrgunitsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetRemarkOrgunitsResponse
     */
    public function addToMidocoRemarkOrgunit(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit) {
            throw new InvalidArgumentException(sprintf('The MidocoRemarkOrgunit property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkOrgunit, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
