...
class GetEMDSubgroupsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup[] $midocoEMDSubgroup
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup[]
     */
    ...
    public static function validateMidocoEMDSubgroupForArrayConstraintsFromSetMidocoEMDSubgroup(?array $values = []): string
    {
        ...
        foreach ($values as $getEMDSubgroupsResponseMidocoEMDSubgroupItem) {
            ...
            if (!$getEMDSubgroupsResponseMidocoEMDSubgroupItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoEMDSubgroup property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup[] $midocoEMDSubgroup
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetEMDSubgroupsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetEMDSubgroupsResponse
     */
    public function addToMidocoEMDSubgroup(\Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup) {
            throw new InvalidArgumentException(sprintf('The MidocoEMDSubgroup property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoEMDSubgroup, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
