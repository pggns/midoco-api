...
class ListMidocoFeeTypesLocalResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO[]
     */
    ...
    public static function validateMidocoFeeTypeLocalForArrayConstraintsFromSetMidocoFeeTypeLocal(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoFeeTypesLocalResponseMidocoFeeTypeLocalItem) {
            ...
            if (!$listMidocoFeeTypesLocalResponseMidocoFeeTypeLocalItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeTypeLocal property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO[] $midocoFeeTypeLocal
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListMidocoFeeTypesLocalResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListMidocoFeeTypesLocalResponse
     */
    public function addToMidocoFeeTypeLocal(\Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeTypeLocal property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\FeeTypeLocalDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
