...
class GetOrderLockReasonsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonForArrayConstraintsFromSetMidocoOrderLockReason(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderLockReasonsResponseMidocoOrderLockReasonItem) {
            ...
            if (!$getOrderLockReasonsResponseMidocoOrderLockReasonItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\OrderLockReasonDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrderLockReasonDTO[] $midocoOrderLockReason
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrderLockReasonsResponse
     */
