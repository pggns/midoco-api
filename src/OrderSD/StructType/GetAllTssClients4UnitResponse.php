...
class GetAllTssClients4UnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $getAllTssClients4UnitResponseMidocoTssClientItem) {
            ...
            if (!$getAllTssClients4UnitResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetAllTssClients4UnitResponse
     */
