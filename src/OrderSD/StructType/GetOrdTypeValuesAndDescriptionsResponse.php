...
class GetOrdTypeValuesAndDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType[] $midocoOrdCriteriaType
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory[] $midocoOrdCriteriaDescriptionCategory
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO[] $getOrdTypeValuesAndDescriptionsDTO
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeForArrayConstraintsFromSetMidocoOrdCriteriaType(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaTypeItem) {
            ...
            if (!$getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaTypeItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaType property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaType(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaType property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory[]
     */
    ...
    public static function validateMidocoOrdCriteriaDescriptionCategoryForArrayConstraintsFromSetMidocoOrdCriteriaDescriptionCategory(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaDescriptionCategoryItem) {
            // validation for constraint: itemType
            if (!$getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaDescriptionCategoryItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaDescriptionCategory property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaDescriptionCategory(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaDescriptionCategory property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaDescriptionCategory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO[]
     */
    ...
    public static function validateGetOrdTypeValuesAndDescriptionsDTOForArrayConstraintsFromSetGetOrdTypeValuesAndDescriptionsDTO(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdTypeValuesAndDescriptionsResponseGetOrdTypeValuesAndDescriptionsDTOItem) {
            // validation for constraint: itemType
            if (!$getOrdTypeValuesAndDescriptionsResponseGetOrdTypeValuesAndDescriptionsDTOItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The GetOrdTypeValuesAndDescriptionsDTO property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsResponse
     */
    public function addToGetOrdTypeValuesAndDescriptionsDTO(\Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO) {
            throw new InvalidArgumentException(sprintf('The GetOrdTypeValuesAndDescriptionsDTO property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdTypeValuesAndDescriptionsDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
