...
class GetMilesAndMorePromotionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO[]
     */
    ...
    public static function validateMidocoMilesAndMorePromotionForArrayConstraintFromSetMidocoMilesAndMorePromotion(?array $values = []): string
    {
        ...
        foreach ($values as $getMilesAndMorePromotionResponseMidocoMilesAndMorePromotionItem) {
            ...
            if (!$getMilesAndMorePromotionResponseMidocoMilesAndMorePromotionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMilesAndMorePromotion property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO[] $midocoMilesAndMorePromotion
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMilesAndMorePromotionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMilesAndMorePromotionResponse
     */
    public function addToMidocoMilesAndMorePromotion(\Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoMilesAndMorePromotion property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MilesAndMorePromotionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
