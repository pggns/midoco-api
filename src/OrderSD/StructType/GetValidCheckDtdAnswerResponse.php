...
class GetValidCheckDtdAnswerResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCheckDtdAnswerForArrayConstraintsFromSetMidocoCheckDtdAnswer(?array $values = []): string
    {
        ...
        foreach ($values as $getValidCheckDtdAnswerResponseMidocoCheckDtdAnswerItem) {
            ...
            if (!$getValidCheckDtdAnswerResponseMidocoCheckDtdAnswerItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoCheckDtdAnswer) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoCheckDtdAnswer[] $midocoCheckDtdAnswer
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetValidCheckDtdAnswerResponse
     */
