...
class GetOrdCriteriaTypeDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO[] $midocoOrdCriteriaTypeDescription
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeDescriptionForArrayConstraintsFromSetMidocoOrdCriteriaTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdCriteriaTypeDescriptionsResponseMidocoOrdCriteriaTypeDescriptionItem) {
            ...
            if (!$getOrdCriteriaTypeDescriptionsResponseMidocoOrdCriteriaTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO[] $midocoOrdCriteriaTypeDescription
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdCriteriaTypeDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetOrdCriteriaTypeDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaTypeDescription(\Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\OrdCriteriaDescriptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
