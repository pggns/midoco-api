...
class GetAvailableSupplierIdResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintsFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierIdResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierIdResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetAvailableSupplierIdResponse
     */
