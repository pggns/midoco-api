...
class GetAvailableSupplierIdResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintsFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierIdResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierIdResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableSupplierIdResponse
     */
