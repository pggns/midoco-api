...
class SaveMidocoAttributeLocalizationRequest extends AbstractStructBase
{
     ...
     * @param bool $isNew
     */
    public function __construct(?\Pggns\MidocoApi\Api\OrderSD\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization = null, ?bool $isNew = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\AttributeDefinitionLocalDTO $midocoSystemAttributeLocalization
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\SaveMidocoAttributeLocalizationRequest
     */
