...
class GetQueryFieldValuesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue[] $midocoQueryFieldValue
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue[]
     */
    ...
    public static function validateMidocoQueryFieldValueForArrayConstraintFromSetMidocoQueryFieldValue(?array $values = []): string
    {
        ...
        foreach ($values as $getQueryFieldValuesResponseMidocoQueryFieldValueItem) {
            ...
            if (!$getQueryFieldValuesResponseMidocoQueryFieldValueItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQueryFieldValue property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue[] $midocoQueryFieldValue
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetQueryFieldValuesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetQueryFieldValuesResponse
     */
    public function addToMidocoQueryFieldValue(\Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue) {
            throw new InvalidArgumentException(sprintf('The MidocoQueryFieldValue property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoQueryFieldValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
