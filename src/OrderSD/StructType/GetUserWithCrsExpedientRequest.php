...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetUserWithCrsExpedientRequest
     */
