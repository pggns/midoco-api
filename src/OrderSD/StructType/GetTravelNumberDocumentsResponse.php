...
class GetTravelNumberDocumentsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument[]
     */
    ...
    public static function validateMidocoTravelNumberDocumentForArrayConstraintsFromSetMidocoTravelNumberDocument(?array $values = []): string
    {
        ...
        foreach ($values as $getTravelNumberDocumentsResponseMidocoTravelNumberDocumentItem) {
            ...
            if (!$getTravelNumberDocumentsResponseMidocoTravelNumberDocumentItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNumberDocument property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument[] $midocoTravelNumberDocument
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetTravelNumberDocumentsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetTravelNumberDocumentsResponse
     */
    public function addToMidocoTravelNumberDocument(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNumberDocument property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTravelNumberDocument, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
