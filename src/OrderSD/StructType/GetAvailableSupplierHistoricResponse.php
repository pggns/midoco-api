...
class GetAvailableSupplierHistoricResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintsFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierHistoricResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierHistoricResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableSupplierHistoricResponse
     */
