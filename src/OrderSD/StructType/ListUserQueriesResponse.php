...
class ListUserQueriesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserQueryInfoForArrayConstraintsFromSetMidocoUserQueryInfo(?array $values = []): string
    {
        ...
        foreach ($values as $listUserQueriesResponseMidocoUserQueryInfoItem) {
            ...
            if (!$listUserQueriesResponseMidocoUserQueryInfoItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoUserQueryInfo[] $midocoUserQueryInfo
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListUserQueriesResponse
     */
