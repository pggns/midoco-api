...
class ListOrdCriteriaTypeCategoriesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo[] $midocoOrdCriteriaTypeCategoryInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeCategoryInfoForArrayConstraintsFromSetMidocoOrdCriteriaTypeCategoryInfo(?array $values = []): string
    {
        ...
        foreach ($values as $listOrdCriteriaTypeCategoriesResponseMidocoOrdCriteriaTypeCategoryInfoItem) {
            ...
            if (!$listOrdCriteriaTypeCategoriesResponseMidocoOrdCriteriaTypeCategoryInfoItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaTypeCategoryInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo[] $midocoOrdCriteriaTypeCategoryInfo
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListOrdCriteriaTypeCategoriesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListOrdCriteriaTypeCategoriesResponse
     */
    public function addToMidocoOrdCriteriaTypeCategoryInfo(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaTypeCategoryInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoOrdCriteriaTypeCategoryInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
