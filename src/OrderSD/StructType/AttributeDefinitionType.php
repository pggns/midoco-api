...
class AttributeDefinitionType extends AttributeDefinitionDTO
{
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $attributeDefinitionTypeMidocoAttributeChoiceValueItem) {
            ...
            if (!$attributeDefinitionTypeMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\OrderSD\StructType\AttributeChoiceValueDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\OrderSD\StructType\AttributeDefinitionType
     */
