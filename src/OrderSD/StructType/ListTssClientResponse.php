...
class ListTssClientResponse extends TssApiErrorConveyingResponse
{
    ...
    public static function validateMidocoTssClientForArrayConstraintsFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $listTssClientResponseMidocoTssClientItem) {
            ...
            if (!$listTssClientResponseMidocoTssClientItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListTssClientResponse
     */
