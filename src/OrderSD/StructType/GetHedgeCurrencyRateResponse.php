...
class GetHedgeCurrencyRateResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCurrencyRateHedgeForArrayConstraintsFromSetMidocoCurrencyRateHedge(?array $values = []): string
    {
        ...
        foreach ($values as $getHedgeCurrencyRateResponseMidocoCurrencyRateHedgeItem) {
            ...
            if (!$getHedgeCurrencyRateResponseMidocoCurrencyRateHedgeItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\CurrencyRateHedgeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\CurrencyRateHedgeDTO[] $midocoCurrencyRateHedge
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetHedgeCurrencyRateResponse
     */
