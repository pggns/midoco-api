...
class GetAreaCodesRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderSD\StructType\MidocoAreaCode $midocoAreaCode = null, ?string $cultureId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoAreaCode $midocoAreaCode
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetAreaCodesRequest
     */
