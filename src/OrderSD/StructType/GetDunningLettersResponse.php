...
class GetDunningLettersResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO[]
     */
    ...
    public static function validateMidocoDunningLetterForArrayConstraintsFromSetMidocoDunningLetter(?array $values = []): string
    {
        ...
        foreach ($values as $getDunningLettersResponseMidocoDunningLetterItem) {
            ...
            if (!$getDunningLettersResponseMidocoDunningLetterItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDunningLetter property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO[] $midocoDunningLetter
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetDunningLettersResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetDunningLettersResponse
     */
    public function addToMidocoDunningLetter(\Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDunningLetter property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\DunningLetterDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
