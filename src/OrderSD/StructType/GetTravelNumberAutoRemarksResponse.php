...
class GetTravelNumberAutoRemarksResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO[]
     */
    ...
    public static function validateMidocoTravelNumberAutoRemarkForArrayConstraintsFromSetMidocoTravelNumberAutoRemark(?array $values = []): string
    {
        ...
        foreach ($values as $getTravelNumberAutoRemarksResponseMidocoTravelNumberAutoRemarkItem) {
            ...
            if (!$getTravelNumberAutoRemarksResponseMidocoTravelNumberAutoRemarkItem instanceof \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNumberAutoRemark property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO[] $midocoTravelNumberAutoRemark
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTravelNumberAutoRemarksResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTravelNumberAutoRemarksResponse
     */
    public function addToMidocoTravelNumberAutoRemark(\Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNumberAutoRemark property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\TravelNumberAutoRemarkDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
