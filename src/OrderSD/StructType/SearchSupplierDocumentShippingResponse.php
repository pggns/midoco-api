...
class SearchSupplierDocumentShippingResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping[]
     */
    ...
    public static function validateMidocoSupplierDocumentShippingForArrayConstraintFromSetMidocoSupplierDocumentShipping(?array $values = []): string
    {
        ...
        foreach ($values as $searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem) {
            ...
            if (!$searchSupplierDocumentShippingResponseMidocoSupplierDocumentShippingItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping[] $midocoSupplierDocumentShipping
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchSupplierDocumentShippingResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchSupplierDocumentShippingResponse
     */
    public function addToMidocoSupplierDocumentShipping(\Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierDocumentShipping property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierDocumentShipping, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
