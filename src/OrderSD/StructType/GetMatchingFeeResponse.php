...
class GetMatchingFeeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign[] $midocoFeeTypeAssign
     */
    ...
    public static function validateMidocoFeeTypeAssignForArrayConstraintFromSetMidocoFeeTypeAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeResponseMidocoFeeTypeAssignItem) {
            ...
            if (!$getMatchingFeeResponseMidocoFeeTypeAssignItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeTypeAssign property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign[] $midocoFeeTypeAssign
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMatchingFeeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMatchingFeeResponse
     */
    public function addToMidocoFeeTypeAssign(\Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeTypeAssign property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoFeeTypeAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
