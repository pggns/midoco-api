...
class GetMarketingKeysForTypeResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO[]
     */
    ...
    public static function validateMidocoMarketingKeyForArrayConstraintsFromSetMidocoMarketingKey(?array $values = []): string
    {
        ...
        foreach ($values as $getMarketingKeysForTypeResponseMidocoMarketingKeyItem) {
            ...
            if (!$getMarketingKeysForTypeResponseMidocoMarketingKeyItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMarketingKey property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO[] $midocoMarketingKey
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetMarketingKeysForTypeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetMarketingKeysForTypeResponse
     */
    public function addToMidocoMarketingKey(\Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoMarketingKey property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MarketingKeyDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
