...
class GetTravelNumberVatSchemasResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO[]
     */
    ...
    public static function validateMidocoTravelNumberVatSchemaForArrayConstraintsFromSetMidocoTravelNumberVatSchema(?array $values = []): string
    {
        ...
        foreach ($values as $getTravelNumberVatSchemasResponseMidocoTravelNumberVatSchemaItem) {
            ...
            if (!$getTravelNumberVatSchemasResponseMidocoTravelNumberVatSchemaItem instanceof \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNumberVatSchema property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO[] $midocoTravelNumberVatSchema
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTravelNumberVatSchemasResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTravelNumberVatSchemasResponse
     */
    public function addToMidocoTravelNumberVatSchema(\Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNumberVatSchema property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\TravelNumberVatSchemaDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
