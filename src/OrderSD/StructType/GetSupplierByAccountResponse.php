...
class GetSupplierByAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierByAccountResponseMidocoSupplierItem) {
            ...
            if (!$getSupplierByAccountResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetSupplierByAccountResponse
     */
