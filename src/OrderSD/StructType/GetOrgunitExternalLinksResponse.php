...
class GetOrgunitExternalLinksResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO[]
     */
    ...
    public static function validateMidocoOrgunitExternalLinkForArrayConstraintFromSetMidocoOrgunitExternalLink(?array $values = []): string
    {
        ...
        foreach ($values as $getOrgunitExternalLinksResponseMidocoOrgunitExternalLinkItem) {
            ...
            if (!$getOrgunitExternalLinksResponseMidocoOrgunitExternalLinkItem instanceof \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgunitExternalLink property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO[] $midocoOrgunitExternalLink
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetOrgunitExternalLinksResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetOrgunitExternalLinksResponse
     */
    public function addToMidocoOrgunitExternalLink(\Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgunitExternalLink property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\OrgunitExternalLinkDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
