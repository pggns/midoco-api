...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\OrderSD\StructType\RefreshTssClientStateRequest
     */
