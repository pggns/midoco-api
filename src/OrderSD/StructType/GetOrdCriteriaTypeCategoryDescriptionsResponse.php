...
class GetOrdCriteriaTypeCategoryDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO[]
     */
    ...
    public static function validateMidocoOrdCriteriaTypeCategoryDescriptionForArrayConstraintsFromSetMidocoOrdCriteriaTypeCategoryDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdCriteriaTypeCategoryDescriptionsResponseMidocoOrdCriteriaTypeCategoryDescriptionItem) {
            ...
            if (!$getOrdCriteriaTypeCategoryDescriptionsResponseMidocoOrdCriteriaTypeCategoryDescriptionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaTypeCategoryDescription property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO[] $midocoOrdCriteriaTypeCategoryDescription
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetOrdCriteriaTypeCategoryDescriptionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetOrdCriteriaTypeCategoryDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaTypeCategoryDescription(\Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaTypeCategoryDescription property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\OrdCritTypeCatDescrDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
