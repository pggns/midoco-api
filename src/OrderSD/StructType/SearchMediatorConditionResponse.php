...
class SearchMediatorConditionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo[]
     */
    ...
    public static function validateMediatorConditionInfoForArrayConstraintFromSetMediatorConditionInfo(?array $values = []): string
    {
        ...
        foreach ($values as $searchMediatorConditionResponseMediatorConditionInfoItem) {
            ...
            if (!$searchMediatorConditionResponseMediatorConditionInfoItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MediatorConditionInfo property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo[] $mediatorConditionInfo
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchMediatorConditionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchMediatorConditionResponse
     */
    public function addToMediatorConditionInfo(\Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo) {
            throw new InvalidArgumentException(sprintf('The MediatorConditionInfo property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MediatorConditionInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
