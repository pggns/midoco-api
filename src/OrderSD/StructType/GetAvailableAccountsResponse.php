...
class GetAvailableAccountsResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoAccount
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount[]
     */
    ...
    public static function validateMidocoAccountForArrayConstraintsFromSetMidocoAccount(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableAccountsResponseMidocoAccountItem) {
            ...
            if (!$getAvailableAccountsResponseMidocoAccountItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAccount property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount[] $midocoAccount
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableAccountsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableAccountsResponse
     */
    public function addToMidocoAccount(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount) {
            throw new InvalidArgumentException(sprintf('The MidocoAccount property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
