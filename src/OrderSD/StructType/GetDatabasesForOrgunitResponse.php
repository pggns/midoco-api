...
class GetDatabasesForOrgunitResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType[] $midocoDatabaseType
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType[]
     */
    ...
    public static function validateMidocoDatabaseTypeForArrayConstraintFromSetMidocoDatabaseType(?array $values = []): string
    {
        ...
        foreach ($values as $getDatabasesForOrgunitResponseMidocoDatabaseTypeItem) {
            ...
            if (!$getDatabasesForOrgunitResponseMidocoDatabaseTypeItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDatabaseType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType[] $midocoDatabaseType
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetDatabasesForOrgunitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetDatabasesForOrgunitResponse
     */
    public function addToMidocoDatabaseType(\Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType) {
            throw new InvalidArgumentException(sprintf('The MidocoDatabaseType property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoDatabaseType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
