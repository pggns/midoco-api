...
class GetTempPrintjobInfosForUserIdResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo[]
     */
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintsFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetTempPrintjobInfosForUserIdResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetTempPrintjobInfosForUserIdResponse
     */
    public function addToMidocoTempPrintjobInfo(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoTempPrintjobInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
