...
class GetTempPrintjobInfosForUserIdResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo[]
     */
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintsFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTempPrintjobInfosForUserIdResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetTempPrintjobInfosForUserIdResponse
     */
    public function addToMidocoTempPrintjobInfo(\Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoTempPrintjobInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
