...
class GetSupplierCancelConditionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition[]
     */
    ...
    public static function validateMidocoSupplierCancelConditionForArrayConstraintsFromSetMidocoSupplierCancelCondition(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierCancelConditionResponseMidocoSupplierCancelConditionItem) {
            ...
            if (!$getSupplierCancelConditionResponseMidocoSupplierCancelConditionItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierCancelCondition property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition[] $midocoSupplierCancelCondition
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetSupplierCancelConditionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetSupplierCancelConditionResponse
     */
    public function addToMidocoSupplierCancelCondition(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierCancelCondition property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCancelCondition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
