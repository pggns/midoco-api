...
class SearchBankAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBankAccountForArrayConstraintFromSetMidocoBankAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchBankAccountResponseMidocoBankAccountItem) {
            ...
            if (!$searchBankAccountResponseMidocoBankAccountItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoBankAccount) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoBankAccount[] $midocoBankAccount
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchBankAccountResponse
     */
