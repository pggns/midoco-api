...
class GetPrintDescriptionListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintDescriptionListResponseMidocoPrintDescriptionItem) {
            ...
            if (!$getPrintDescriptionListResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetPrintDescriptionListResponse
     */
