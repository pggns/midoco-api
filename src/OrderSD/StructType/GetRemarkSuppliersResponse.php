...
class GetRemarkSuppliersResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier[]
     */
    ...
    public static function validateMidocoRemarkSupplierForArrayConstraintsFromSetMidocoRemarkSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getRemarkSuppliersResponseMidocoRemarkSupplierItem) {
            ...
            if (!$getRemarkSuppliersResponseMidocoRemarkSupplierItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRemarkSupplier property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier[] $midocoRemarkSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetRemarkSuppliersResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetRemarkSuppliersResponse
     */
    public function addToMidocoRemarkSupplier(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier) {
            throw new InvalidArgumentException(sprintf('The MidocoRemarkSupplier property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoRemarkSupplier, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
