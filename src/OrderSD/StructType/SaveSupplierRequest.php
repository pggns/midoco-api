...
class SaveSupplierRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier = null, ?bool $saveHistorical = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\SaveSupplierRequest
     */
