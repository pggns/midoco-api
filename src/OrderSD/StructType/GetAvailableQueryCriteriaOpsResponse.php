...
class GetAvailableQueryCriteriaOpsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp[] $midocoQueryCriteriaOp
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp[]
     */
    ...
    public static function validateMidocoQueryCriteriaOpForArrayConstraintsFromSetMidocoQueryCriteriaOp(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableQueryCriteriaOpsResponseMidocoQueryCriteriaOpItem) {
            ...
            if (!$getAvailableQueryCriteriaOpsResponseMidocoQueryCriteriaOpItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQueryCriteriaOp property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp[] $midocoQueryCriteriaOp
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableQueryCriteriaOpsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableQueryCriteriaOpsResponse
     */
    public function addToMidocoQueryCriteriaOp(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp) {
            throw new InvalidArgumentException(sprintf('The MidocoQueryCriteriaOp property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoQueryCriteriaOp, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
