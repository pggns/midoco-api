...
class GetMidocoCrsSystemResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoCrsSystem
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem[]
     */
    ...
    public static function validateMidocoCrsSystemForArrayConstraintsFromSetMidocoCrsSystem(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoCrsSystemResponseMidocoCrsSystemItem) {
            ...
            if (!$getMidocoCrsSystemResponseMidocoCrsSystemItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrsSystem property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem[] $midocoCrsSystem
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMidocoCrsSystemResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMidocoCrsSystemResponse
     */
    public function addToMidocoCrsSystem(\Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem) {
            throw new InvalidArgumentException(sprintf('The MidocoCrsSystem property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoCrsSystem, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
