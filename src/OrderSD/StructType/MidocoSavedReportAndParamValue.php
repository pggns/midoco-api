...
class MidocoSavedReportAndParamValue extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport|null
     */
    protected ?\Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport $MidocoSavedReport = null;
    /**
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport $midocoSavedReport
     */
    public function __construct(?array $midocoJasperReportParamValue = null, ?\Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport $midocoSavedReport = null)
    {
        $this
    ...
    public static function validateMidocoJasperReportParamValueForArrayConstraintFromSetMidocoJasperReportParamValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSavedReportAndParamValueMidocoJasperReportParamValueItem) {
            ...
            if (!$midocoSavedReportAndParamValueMidocoJasperReportParamValueItem instanceof \Pggns\MidocoApi\OrderSD\StructType\JasperReportParamValueDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\JasperReportParamValueDTO[] $midocoJasperReportParamValue
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReportAndParamValue
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport|null
     */
    public function getMidocoSavedReport(): ?\Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport
    {
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReportAndParamValue
     */
    public function setMidocoSavedReport(?\Pggns\MidocoApi\OrderSD\StructType\MidocoSavedReport $midocoSavedReport = null): self
    {
