...
class GetSupplierAgenciesResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO[]
     */
    ...
    public static function validateMidocoSupplierAgencyForArrayConstraintFromSetMidocoSupplierAgency(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierAgenciesResponseMidocoSupplierAgencyItem) {
            ...
            if (!$getSupplierAgenciesResponseMidocoSupplierAgencyItem instanceof \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierAgency property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO[] $midocoSupplierAgency
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetSupplierAgenciesResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetSupplierAgenciesResponse
     */
    public function addToMidocoSupplierAgency(\Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierAgency property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\SupplierAgencyDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
