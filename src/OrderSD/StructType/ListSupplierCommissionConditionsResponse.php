...
class ListSupplierCommissionConditionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition[]
     */
    ...
    public static function validateMidocoSupplierCommissionConditionForArrayConstraintsFromSetMidocoSupplierCommissionCondition(?array $values = []): string
    {
        ...
        foreach ($values as $listSupplierCommissionConditionsResponseMidocoSupplierCommissionConditionItem) {
            ...
            if (!$listSupplierCommissionConditionsResponseMidocoSupplierCommissionConditionItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierCommissionCondition property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition[] $midocoSupplierCommissionCondition
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListSupplierCommissionConditionsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition $item
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\ListSupplierCommissionConditionsResponse
     */
    public function addToMidocoSupplierCommissionCondition(\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierCommissionCondition property can only contain items of type \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierCommissionCondition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
