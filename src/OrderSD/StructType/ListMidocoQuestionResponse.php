...
class ListMidocoQuestionResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoQuestion
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion[]
     */
    ...
    public static function validateMidocoQuestionForArrayConstraintsFromSetMidocoQuestion(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoQuestionResponseMidocoQuestionItem) {
            ...
            if (!$listMidocoQuestionResponseMidocoQuestionItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQuestion property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion[] $midocoQuestion
     * @return \Pggns\MidocoApi\OrderSD\StructType\ListMidocoQuestionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\ListMidocoQuestionResponse
     */
    public function addToMidocoQuestion(\Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion) {
            throw new InvalidArgumentException(sprintf('The MidocoQuestion property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoQuestion, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
