...
class AvailableAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $availableAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$availableAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\OrderSD\StructType\AvailableAdaptersResponse
     */
