...
class GetAvailableSupplierHistoricRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType $midocoSupplier = null, ?string $creationDate = null, ?string $travelDate = null, ?string $accountId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoSupplierType $midocoSupplier
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetAvailableSupplierHistoricRequest
     */
