...
class GetAvailableSupplierHistoricRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier = null, ?string $creationDate = null, ?string $travelDate = null, ?string $accountId = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoSupplierType $midocoSupplier
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\GetAvailableSupplierHistoricRequest
     */
