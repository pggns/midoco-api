...
class SearchAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAccountForArrayConstraintFromSetMidocoAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchAccountResponseMidocoAccountItem) {
            ...
            if (!$searchAccountResponseMidocoAccountItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoAccount) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoAccount[] $midocoAccount
     * @return \Pggns\MidocoApi\OrderSD\StructType\SearchAccountResponse
     */
