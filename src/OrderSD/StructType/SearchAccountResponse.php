...
class SearchAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAccountForArrayConstraintsFromSetMidocoAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchAccountResponseMidocoAccountItem) {
            ...
            if (!$searchAccountResponseMidocoAccountItem instanceof \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount) {
     ...
     * @param \Pggns\MidocoApi\Api\OrderSD\StructType\MidocoAccount[] $midocoAccount
     * @return \Pggns\MidocoApi\Api\OrderSD\StructType\SearchAccountResponse
     */
