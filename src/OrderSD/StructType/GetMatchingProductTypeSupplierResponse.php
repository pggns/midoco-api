...
class GetMatchingProductTypeSupplierResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoProductTypeSupplierForArrayConstraintFromSetMidocoProductTypeSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingProductTypeSupplierResponseMidocoProductTypeSupplierItem) {
            ...
            if (!$getMatchingProductTypeSupplierResponseMidocoProductTypeSupplierItem instanceof \Pggns\MidocoApi\OrderSD\StructType\ProductTypeSupplierDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\ProductTypeSupplierDTO[] $midocoProductTypeSupplier
     * @return \Pggns\MidocoApi\OrderSD\StructType\GetMatchingProductTypeSupplierResponse
     */
