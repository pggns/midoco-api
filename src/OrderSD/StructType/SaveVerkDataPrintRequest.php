...
class SaveVerkDataPrintRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoVerkDataPrintForArrayConstraintsFromSetMidocoVerkDataPrint(?array $values = []): string
    {
        ...
        foreach ($values as $saveVerkDataPrintRequestMidocoVerkDataPrintItem) {
            ...
            if (!$saveVerkDataPrintRequestMidocoVerkDataPrintItem instanceof \Pggns\MidocoApi\OrderSD\StructType\VerkDataPrintDTO) {
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\VerkDataPrintDTO[] $midocoVerkDataPrint
     * @return \Pggns\MidocoApi\OrderSD\StructType\SaveVerkDataPrintRequest
     */
