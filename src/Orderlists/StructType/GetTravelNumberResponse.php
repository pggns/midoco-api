...
class GetTravelNumberResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber[]
     */
    ...
    public static function validateMidocoTravelNumberForArrayConstraintFromSetMidocoTravelNumber(?array $values = []): string
    {
        ...
        foreach ($values as $getTravelNumberResponseMidocoTravelNumberItem) {
            ...
            if (!$getTravelNumberResponseMidocoTravelNumberItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNumber property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber[] $midocoTravelNumber
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetTravelNumberResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetTravelNumberResponse
     */
    public function addToMidocoTravelNumber(\Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNumber property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNumber, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
