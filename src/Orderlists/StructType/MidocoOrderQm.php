...
class MidocoOrderQm extends OrderQmDTO
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO[] $midocoOrderQmAnswerDTO
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQuestion $midocoQuestion = null, ?array $midocoOrderQmAnswerDTO = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQuestion $midocoQuestion
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderQm
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO[]
     */
    ...
    public static function validateMidocoOrderQmAnswerDTOForArrayConstraintsFromSetMidocoOrderQmAnswerDTO(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderQmMidocoOrderQmAnswerDTOItem) {
            ...
            if (!$midocoOrderQmMidocoOrderQmAnswerDTOItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderQmAnswerDTO property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderQm
     */
    public function addToMidocoOrderQmAnswerDTO(\Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderQmAnswerDTO property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\OrderQmAnswerDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
