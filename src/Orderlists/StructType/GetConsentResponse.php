...
class GetConsentResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoConsentForArrayConstraintsFromSetMidocoConsent(?array $values = []): string
    {
        ...
        foreach ($values as $getConsentResponseMidocoConsentItem) {
            ...
            if (!$getConsentResponseMidocoConsentItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoConsent) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoConsent[] $midocoConsent
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetConsentResponse
     */
