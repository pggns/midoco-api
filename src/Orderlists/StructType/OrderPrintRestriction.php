...
class OrderPrintRestriction extends AbstractStructBase
{
    ...
    public static function validateSellItemPrintRestrictionForArrayConstraintFromSetSellItemPrintRestriction(?array $values = []): string
    {
        ...
        foreach ($values as $orderPrintRestrictionSellItemPrintRestrictionItem) {
            ...
            if (!$orderPrintRestrictionSellItemPrintRestrictionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SellItemPrintRestriction property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\OrderPrintRestriction
     */
    public function addToSellItemPrintRestriction(\Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction) {
            throw new InvalidArgumentException(sprintf('The SellItemPrintRestriction property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\SellItemPrintRestriction, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
