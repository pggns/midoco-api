...
class OrderPrintRestriction extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction[] $sellItemPrintRestriction
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction[]
     */
    ...
    public static function validateSellItemPrintRestrictionForArrayConstraintsFromSetSellItemPrintRestriction(?array $values = []): string
    {
        ...
        foreach ($values as $orderPrintRestrictionSellItemPrintRestrictionItem) {
            ...
            if (!$orderPrintRestrictionSellItemPrintRestrictionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SellItemPrintRestriction property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction[] $sellItemPrintRestriction
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\OrderPrintRestriction
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\OrderPrintRestriction
     */
    public function addToSellItemPrintRestriction(\Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction) {
            throw new InvalidArgumentException(sprintf('The SellItemPrintRestriction property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\SellItemPrintRestriction, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
