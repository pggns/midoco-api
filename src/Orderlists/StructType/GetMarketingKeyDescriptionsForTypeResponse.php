...
class GetMarketingKeyDescriptionsForTypeResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMarketingKeyDescriptionForArrayConstraintsFromSetMidocoMarketingKeyDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getMarketingKeyDescriptionsForTypeResponseMidocoMarketingKeyDescriptionItem) {
            ...
            if (!$getMarketingKeyDescriptionsForTypeResponseMidocoMarketingKeyDescriptionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MarketingKeyDescriptionType) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MarketingKeyDescriptionType[] $midocoMarketingKeyDescription
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetMarketingKeyDescriptionsForTypeResponse
     */
