...
class MidocoCrmCustomerPayment extends CrmCustomerPaymentDTO
{
     ...
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO $CustomerEInvoiceSetting = null;
    /**
     * The assignedDebitor
     * @var string|null
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO $customerEInvoiceSetting
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO|null
     */
    public function getCustomerEInvoiceSetting(): ?\Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO
    {
     ...
     */
    public function setCustomerEInvoiceSetting(?\Pggns\MidocoApi\Orderlists\StructType\CrmCustomerEinvoiceDTO $customerEInvoiceSetting = null): self
    {
    ...
    /**
     * Set vatType value
     * @uses \Pggns\MidocoApi\Orderlists\EnumType\MidocoCrmCustomerPaymentVatTypeType::valueIsValid()
     * @uses \Pggns\MidocoApi\Orderlists\EnumType\MidocoCrmCustomerPaymentVatTypeType::getValidValues()
    ...
    public function setVatType(?string $vatType = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Orderlists\EnumType\MidocoCrmCustomerPaymentVatTypeType::valueIsValid($vatType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Orderlists\EnumType\MidocoCrmCustomerPaymentVatTypeType', is_array($vatType) ? implode(', ', $vatType) : var_export($vatType, true), implode(', ', \Pggns\MidocoApi\Orderlists\EnumType\MidocoCrmCustomerPaymentVatTypeType::getValidValues())), __LINE__);
        }
