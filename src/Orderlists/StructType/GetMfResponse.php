...
class GetMfResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfResponseMidocoMfItem) {
            ...
            if (!$getMfResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetMfResponse
     */
