...
class SearchBankAccountResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoBankAccountForArrayConstraintsFromSetMidocoBankAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchBankAccountResponseMidocoBankAccountItem) {
            ...
            if (!$searchBankAccountResponseMidocoBankAccountItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoBankAccount) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoBankAccount[] $midocoBankAccount
     * @return \Pggns\MidocoApi\Orderlists\StructType\SearchBankAccountResponse
     */
