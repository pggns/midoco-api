...
class SearchDatastoresResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoDatastore
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO[]
     */
    ...
    public static function validateMidocoDatastoreForArrayConstraintsFromSetMidocoDatastore(?array $values = []): string
    {
        ...
        foreach ($values as $searchDatastoresResponseMidocoDatastoreItem) {
            ...
            if (!$searchDatastoresResponseMidocoDatastoreItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDatastore property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO[] $midocoDatastore
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SearchDatastoresResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SearchDatastoresResponse
     */
    public function addToMidocoDatastore(\Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDatastore property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\DatastoreDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
