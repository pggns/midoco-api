...
/**
 * This class stands for DepositListCsvExportResponse StructType
 * @subpackage Structs
 */
class DepositListCsvExportResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for DepositListCsvExportResponse
     * @uses DepositListCsvExportResponse::setZippedCsvContent()
     * @uses DepositListCsvExportResponse::setFileName()
     ...
     * @param string $zippedCsvContent
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\DepositListCsvExportResponse
     */
