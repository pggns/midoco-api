...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Orderlists\StructType\AssignedAdaptersResponse
     */
