...
class GetMidocoSettlementTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSettlementTypeForArrayConstraintsFromSetMidocoSettlementType(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoSettlementTypesResponseMidocoSettlementTypeItem) {
            ...
            if (!$getMidocoSettlementTypesResponseMidocoSettlementTypeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\SettlementTypeDTO) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\SettlementTypeDTO[] $midocoSettlementType
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetMidocoSettlementTypesResponse
     */
