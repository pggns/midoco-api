...
class GetTravelNumberVatDivTemplsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO[]
     */
    ...
    public static function validateMidocoTravelNumberVatDivTemplForArrayConstraintsFromSetMidocoTravelNumberVatDivTempl(?array $values = []): string
    {
        ...
        foreach ($values as $getTravelNumberVatDivTemplsResponseMidocoTravelNumberVatDivTemplItem) {
            ...
            if (!$getTravelNumberVatDivTemplsResponseMidocoTravelNumberVatDivTemplItem instanceof \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNumberVatDivTempl property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO[] $midocoTravelNumberVatDivTempl
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetTravelNumberVatDivTemplsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetTravelNumberVatDivTemplsResponse
     */
    public function addToMidocoTravelNumberVatDivTempl(\Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNumberVatDivTempl property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\TravelNumberVatDivTemplDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
