...
class CollectiveInvoicePrintOrderDetails extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - ref: MidocoOrder
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderType|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderType $MidocoOrder = null;
    /**
     * The MidocoInvoice
     * Meta information extracted from the WSDL
     * - ref: MidocoInvoice
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoice|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoInvoice $MidocoInvoice = null;
    /**
    ...
    public static function validateSellItemDetails4PrintingForArrayConstraintFromSetSellItemDetails4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $collectiveInvoicePrintOrderDetailsSellItemDetails4PrintingItem) {
            ...
            if (!$collectiveInvoicePrintOrderDetailsSellItemDetails4PrintingItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemInfo4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SellItemDetails4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemInfo4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CollectiveInvoicePrintOrderDetails
     */
    public function addToSellItemDetails4Printing(\Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemInfo4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemInfo4Printing) {
            throw new InvalidArgumentException(sprintf('The SellItemDetails4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemInfo4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderType|null
     */
    public function getMidocoOrder(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderType
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CollectiveInvoicePrintOrderDetails
     */
    public function setMidocoOrder(?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderType $midocoOrder = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoice|null
     */
    public function getMidocoInvoice(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoInvoice
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CollectiveInvoicePrintOrderDetails
     */
    public function setMidocoInvoice(?\Pggns\MidocoApi\Orderlists\StructType\MidocoInvoice $midocoInvoice = null): self
    {
