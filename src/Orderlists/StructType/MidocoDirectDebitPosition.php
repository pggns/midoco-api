...
class MidocoDirectDebitPosition extends MidocoOnlinePaymentTransactionPosition
{
     ...
     */
    public function __construct(?string $accountNo = null, ?string $accountBlz = null, ?string $accountName = null, ?string $accountOwner = null, ?string $accountCountry = null, ?string $transactionType = null, ?string $iban = null, ?string $swiftBicCode = null, ?int $mandateId = null, ?string $executionDate = null, ?string $mandateReference = null, ?bool $isRecurrent = null, ?string $mandateType = null, ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null, ?bool $bankTransferCollective = null, ?bool $isSepa = false, ?string $extReference = null, ?string $approvalCode = null)
    {
        $this
     ...
     * Set accountNo value
     * @param string $accountNo
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitPosition
     */
