...
/**
 * This class stands for MidocoSupplierAccountAssign StructType
 * @subpackage Structs
 */
class MidocoSupplierAccountAssign extends SupplierAccountAssignDTO
{
    /**
     * The isInheritance
     * @var bool|null
    ...
    /**
     * Constructor method for MidocoSupplierAccountAssign
     * @uses MidocoSupplierAccountAssign::setIsInheritance()
     * @uses MidocoSupplierAccountAssign::setOrgunit()
     * @uses MidocoSupplierAccountAssign::setIsHistorical()
     * @uses MidocoSupplierAccountAssign::setValidDate()
     * @uses MidocoSupplierAccountAssign::setValidCreationTravel()
