...
class GetAvailableSupplierResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintsFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAvailableSupplierResponse
     */
