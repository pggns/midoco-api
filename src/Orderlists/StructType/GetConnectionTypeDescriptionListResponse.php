...
class GetConnectionTypeDescriptionListResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO[]
     */
    ...
    public static function validateMidocoConnectionTypeDescriptionForArrayConstraintsFromSetMidocoConnectionTypeDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getConnectionTypeDescriptionListResponseMidocoConnectionTypeDescriptionItem) {
            ...
            if (!$getConnectionTypeDescriptionListResponseMidocoConnectionTypeDescriptionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoConnectionTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO[] $midocoConnectionTypeDescription
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetConnectionTypeDescriptionListResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetConnectionTypeDescriptionListResponse
     */
    public function addToMidocoConnectionTypeDescription(\Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoConnectionTypeDescription property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ConnectionTypeDescDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
