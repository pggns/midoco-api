...
class GetAvailableQueryCriteriaOpsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoQueryCriteriaOpForArrayConstraintFromSetMidocoQueryCriteriaOp(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableQueryCriteriaOpsResponseMidocoQueryCriteriaOpItem) {
            ...
            if (!$getAvailableQueryCriteriaOpsResponseMidocoQueryCriteriaOpItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQueryCriteriaOp property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAvailableQueryCriteriaOpsResponse
     */
    public function addToMidocoQueryCriteriaOp(\Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp) {
            throw new InvalidArgumentException(sprintf('The MidocoQueryCriteriaOp property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoQueryCriteriaOp, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
