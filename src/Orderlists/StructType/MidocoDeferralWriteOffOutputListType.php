...
class MidocoDeferralWriteOffOutputListType extends AbstractStructBase
{
     ...
     * @uses MidocoDeferralWriteOffOutputListType::setDebitor()
     * @uses MidocoDeferralWriteOffOutputListType::setCreditor()
     * @uses MidocoDeferralWriteOffOutputListType::setSupplierId()
     * @uses MidocoDeferralWriteOffOutputListType::setBookingId()
     * @uses MidocoDeferralWriteOffOutputListType::setCrsSystem()
     * @uses MidocoDeferralWriteOffOutputListType::setOrgUnit()
     * @uses MidocoDeferralWriteOffOutputListType::setStartTravel()
     * @uses MidocoDeferralWriteOffOutputListType::setEndTravel()
     * @uses MidocoDeferralWriteOffOutputListType::setReceiptDate()
     * @uses MidocoDeferralWriteOffOutputListType::setDebitAccount()
     * @uses MidocoDeferralWriteOffOutputListType::setCreditAccount()
     * @uses MidocoDeferralWriteOffOutputListType::setAmount()
     * @uses MidocoDeferralWriteOffOutputListType::setOriginalAmount()
     * @uses MidocoDeferralWriteOffOutputListType::setOriginalCurrency()
     * @uses MidocoDeferralWriteOffOutputListType::setOrderId()
     * @uses MidocoDeferralWriteOffOutputListType::setOrderNo()
     * @uses MidocoDeferralWriteOffOutputListType::setItemId()
     * @uses MidocoDeferralWriteOffOutputListType::setRevenueId()
     * @uses MidocoDeferralWriteOffOutputListType::setYear()
