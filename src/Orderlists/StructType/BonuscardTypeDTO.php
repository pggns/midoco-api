...
/**
 * This class stands for BonuscardTypeDTO StructType
 * @subpackage Structs
 */
class BonuscardTypeDTO extends AbstractStructBase
{
    /**
     * The cardType
     * @var string|null
    ...
    /**
     * Constructor method for BonuscardTypeDTO
     * @uses BonuscardTypeDTO::setCardType()
     ...
     * Set cardType value
     * @param string $cardType
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\BonuscardTypeDTO
     */
