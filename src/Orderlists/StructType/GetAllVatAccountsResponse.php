...
class GetAllVatAccountsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO[] $midocoVatAccount
     */
    ...
    public static function validateMidocoVatAccountForArrayConstraintsFromSetMidocoVatAccount(?array $values = []): string
    {
        ...
        foreach ($values as $getAllVatAccountsResponseMidocoVatAccountItem) {
            ...
            if (!$getAllVatAccountsResponseMidocoVatAccountItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVatAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO[] $midocoVatAccount
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAllVatAccountsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAllVatAccountsResponse
     */
    public function addToMidocoVatAccount(\Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoVatAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\VatAccountDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
