...
class ReceiptOnlinePaymentInfo extends OnlinePaymentInfoType
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $receiptOnlinePaymentInfoMidocoCcTokenItem) {
            ...
            if (!$receiptOnlinePaymentInfoMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo
     */
