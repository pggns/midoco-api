...
class GetRemarkCategoryResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory[]
     */
    ...
    public static function validateMidocoRemarkCategoryForArrayConstraintsFromSetMidocoRemarkCategory(?array $values = []): string
    {
        ...
        foreach ($values as $getRemarkCategoryResponseMidocoRemarkCategoryItem) {
            ...
            if (!$getRemarkCategoryResponseMidocoRemarkCategoryItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRemarkCategory property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory[] $midocoRemarkCategory
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetRemarkCategoryResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetRemarkCategoryResponse
     */
    public function addToMidocoRemarkCategory(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory) {
            throw new InvalidArgumentException(sprintf('The MidocoRemarkCategory property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
