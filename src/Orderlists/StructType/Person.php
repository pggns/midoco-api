...
class Person extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos $AdditionalFlightPassengerInfos = null;
    /**
     * The AdditionalRailPassengerInfos
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: AdditionalRailPassengerInfos
     * @var \Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos $AdditionalRailPassengerInfos = null;
    /**
     * The crs_salutation
     * Meta information extracted from the WSDL
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos
     * @param \Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos
     * @param string $crs_salutation
     * @param string $crs_name
     * @param string $nationality
     */
    public function __construct(int $position, ?string $salutation = null, ?string $title = null, ?string $forename = null, ?string $middleName = null, ?string $name = null, ?string $birthday = null, ?string $gender = null, ?int $age = null, ?float $person_price = null, ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null, ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null, ?string $crs_salutation = null, ?string $crs_name = null, ?string $nationality = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos|null
     */
    public function getAdditionalFlightPassengerInfos(): ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\Person
     */
    public function setAdditionalFlightPassengerInfos(?\Pggns\MidocoApi\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos|null
     */
    public function getAdditionalRailPassengerInfos(): ?\Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\Person
     */
    public function setAdditionalRailPassengerInfos(?\Pggns\MidocoApi\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null): self
    {
