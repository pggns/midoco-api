...
class Person extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos $AdditionalFlightPassengerInfos = null;
    /**
     * The AdditionalRailPassengerInfos
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: AdditionalRailPassengerInfos
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos $AdditionalRailPassengerInfos = null;
    /**
     * The crs_salutation
     * Meta information extracted from the WSDL
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos
     * @param string $crs_salutation
     * @param string $crs_name
     * @param string $nationality
     */
    public function __construct(int $position, ?string $salutation = null, ?string $title = null, ?string $forename = null, ?string $middleName = null, ?string $name = null, ?string $birthday = null, ?int $age = null, ?float $person_price = null, ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null, ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null, ?string $crs_salutation = null, ?string $crs_name = null, ?string $nationality = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos|null
     */
    public function getAdditionalFlightPassengerInfos(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\Person
     */
    public function setAdditionalFlightPassengerInfos(?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalFlightPassengerInfos $additionalFlightPassengerInfos = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos|null
     */
    public function getAdditionalRailPassengerInfos(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\Person
     */
    public function setAdditionalRailPassengerInfos(?\Pggns\MidocoApi\Api\Orderlists\StructType\AdditionalRailPassengerInfos $additionalRailPassengerInfos = null): self
    {
