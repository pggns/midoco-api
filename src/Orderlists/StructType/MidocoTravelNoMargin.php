...
class MidocoTravelNoMargin extends TravelNoMarginDTO
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem[]
     */
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem[]
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem[]
     */
    ...
    public static function validateMidocoTravelNoMarginBuyItemForArrayConstraintFromSetMidocoTravelNoMarginBuyItem(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTravelNoMarginMidocoTravelNoMarginBuyItemItem) {
            ...
            if (!$midocoTravelNoMarginMidocoTravelNoMarginBuyItemItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNoMarginBuyItem property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMargin
     */
    public function addToMidocoTravelNoMarginBuyItem(\Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNoMarginBuyItem property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginBuyItem, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem[]
     */
    ...
    public static function validateMidocoTravelNoMarginSaleItemForArrayConstraintFromSetMidocoTravelNoMarginSaleItem(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTravelNoMarginMidocoTravelNoMarginSaleItemItem) {
            // validation for constraint: itemType
            if (!$midocoTravelNoMarginMidocoTravelNoMarginSaleItemItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTravelNoMarginSaleItem property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMargin
     */
    public function addToMidocoTravelNoMarginSaleItem(\Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem) {
            throw new InvalidArgumentException(sprintf('The MidocoTravelNoMarginSaleItem property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoTravelNoMarginSaleItem, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
