...
class PrintDetailsForBonusEmployee extends AbstractStructBase
{
    ...
    public static function validateMidocoBonusAssignmentSellitemDetailsForArrayConstraintsFromSetMidocoBonusAssignmentSellitemDetails(?array $values = []): string
    {
        ...
        foreach ($values as $printDetailsForBonusEmployeeMidocoBonusAssignmentSellitemDetailsItem) {
            ...
            if (!$printDetailsForBonusEmployeeMidocoBonusAssignmentSellitemDetailsItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBonusAssignmentSellitemDetails property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\PrintDetailsForBonusEmployee
     */
    public function addToMidocoBonusAssignmentSellitemDetails(\Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails) {
            throw new InvalidArgumentException(sprintf('The MidocoBonusAssignmentSellitemDetails property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoBonusAssignmentSellitemDetails, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoBonusAdditionForArrayConstraintsFromSetMidocoBonusAddition(?array $values = []): string
    {
        ...
        foreach ($values as $printDetailsForBonusEmployeeMidocoBonusAdditionItem) {
            // validation for constraint: itemType
            if (!$printDetailsForBonusEmployeeMidocoBonusAdditionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBonusAddition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\PrintDetailsForBonusEmployee
     */
    public function addToMidocoBonusAddition(\Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoBonusAddition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\BonusAdditionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
