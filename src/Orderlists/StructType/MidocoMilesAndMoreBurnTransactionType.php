...
class MidocoMilesAndMoreBurnTransactionType extends MilesAndMoreBurnTransactionDTO
{
    ...
    public static function validateMidocoMilesAndMoreBurnTransactionDeltaForArrayConstraintFromSetMidocoMilesAndMoreBurnTransactionDelta(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMilesAndMoreBurnTransactionTypeMidocoMilesAndMoreBurnTransactionDeltaItem) {
            ...
            if (!$midocoMilesAndMoreBurnTransactionTypeMidocoMilesAndMoreBurnTransactionDeltaItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMilesAndMoreBurnTransactionDelta property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreBurnTransactionType
     */
    public function addToMidocoMilesAndMoreBurnTransactionDelta(\Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoMilesAndMoreBurnTransactionDelta property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MilesAndMoreBurnTransactionDeltaDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
