...
class SearchVirtualAccountResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO[]
     */
    ...
    public static function validateMidocoVirtualAccountForArrayConstraintsFromSetMidocoVirtualAccount(?array $values = []): string
    {
        ...
        foreach ($values as $searchVirtualAccountResponseMidocoVirtualAccountItem) {
            ...
            if (!$searchVirtualAccountResponseMidocoVirtualAccountItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVirtualAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO[] $midocoVirtualAccount
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SearchVirtualAccountResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SearchVirtualAccountResponse
     */
    public function addToMidocoVirtualAccount(\Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoVirtualAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\VirtualAccountDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
