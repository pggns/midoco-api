...
class GetValidCheckDtdAnswerResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCheckDtdAnswerForArrayConstraintsFromSetMidocoCheckDtdAnswer(?array $values = []): string
    {
        ...
        foreach ($values as $getValidCheckDtdAnswerResponseMidocoCheckDtdAnswerItem) {
            ...
            if (!$getValidCheckDtdAnswerResponseMidocoCheckDtdAnswerItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCheckDtdAnswer) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCheckDtdAnswer[] $midocoCheckDtdAnswer
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetValidCheckDtdAnswerResponse
     */
