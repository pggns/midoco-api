...
class RefreshTssClientStateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoTssClientForArrayConstraintFromSetMidocoTssClient(?array $values = []): string
    {
        ...
        foreach ($values as $refreshTssClientStateRequestMidocoTssClientItem) {
            ...
            if (!$refreshTssClientStateRequestMidocoTssClientItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTssClient) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTssClient[] $midocoTssClient
     * @return \Pggns\MidocoApi\Orderlists\StructType\RefreshTssClientStateRequest
     */
