...
class ValidateCompetitionRuleContentRequest extends AbstractStructBase
{
     ...
     * @param int $orderNo
     */
    public function __construct(?\Pggns\MidocoApi\Orderlists\StructType\RulesetDTO $midocoRuleSet = null, ?int $orderNo = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\RulesetDTO $midocoRuleSet
     * @return \Pggns\MidocoApi\Orderlists\StructType\ValidateCompetitionRuleContentRequest
     */
