...
class ValidateCompetitionRuleContentRequest extends AbstractStructBase
{
     ...
     * @param int $orderNo
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\RulesetDTO $midocoRuleSet = null, ?int $orderNo = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\RulesetDTO $midocoRuleSet
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ValidateCompetitionRuleContentRequest
     */
