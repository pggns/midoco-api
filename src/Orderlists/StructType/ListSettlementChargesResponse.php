...
class ListSettlementChargesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSettlementChargeForArrayConstraintsFromSetMidocoSettlementCharge(?array $values = []): string
    {
        ...
        foreach ($values as $listSettlementChargesResponseMidocoSettlementChargeItem) {
            ...
            if (!$listSettlementChargesResponseMidocoSettlementChargeItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\SettlementChargeDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\SettlementChargeDTO[] $midocoSettlementCharge
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListSettlementChargesResponse
     */
