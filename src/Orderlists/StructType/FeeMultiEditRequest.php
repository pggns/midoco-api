...
class FeeMultiEditRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoFeeMultiEditForArrayConstraintsFromSetMidocoFeeMultiEdit(?array $values = []): string
    {
        ...
        foreach ($values as $feeMultiEditRequestMidocoFeeMultiEditItem) {
            ...
            if (!$feeMultiEditRequestMidocoFeeMultiEditItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeMultiEdit property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\FeeMultiEditRequest
     */
    public function addToMidocoFeeMultiEdit(\Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeMultiEdit property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeMultiEdit, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoFeeGroupAssignForArrayConstraintsFromSetMidocoFeeGroupAssign(?array $values = []): string
    {
        ...
        foreach ($values as $feeMultiEditRequestMidocoFeeGroupAssignItem) {
            // validation for constraint: itemType
            if (!$feeMultiEditRequestMidocoFeeGroupAssignItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeGroupAssign property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\FeeMultiEditRequest
     */
    public function addToMidocoFeeGroupAssign(\Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeGroupAssign property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeGroupAssign, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
