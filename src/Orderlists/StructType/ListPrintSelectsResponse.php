...
class ListPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(?array $values = []): string
    {
        ...
        foreach ($values as $listPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$listPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListPrintSelectsResponse
     */
