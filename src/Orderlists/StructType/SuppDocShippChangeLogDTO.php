...
/**
 * This class stands for SuppDocShippChangeLogDTO StructType
 * @subpackage Structs
 */
class SuppDocShippChangeLogDTO extends AbstractStructBase
{
    /**
     * The changeId
     * @var int|null
    ...
    /**
     * Constructor method for SuppDocShippChangeLogDTO
     * @uses SuppDocShippChangeLogDTO::setChangeId()
     * @uses SuppDocShippChangeLogDTO::setSupplierId()
     * @uses SuppDocShippChangeLogDTO::setTimestamp()
     * @uses SuppDocShippChangeLogDTO::setTraveltype()
     * @uses SuppDocShippChangeLogDTO::setUserId()
     * @uses SuppDocShippChangeLogDTO::setValidFrom()
     * @param int $changeId
     ...
     * Set changeId value
     * @param int $changeId
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SuppDocShippChangeLogDTO
     */
