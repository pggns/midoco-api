...
class GetOrderLockReasonDescriptionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonDescriptionForArrayConstraintFromSetMidocoOrderLockReasonDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem) {
            ...
            if (!$getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\OrderLockReasonDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\OrderLockReasonDescriptionDTO[] $midocoOrderLockReasonDescription
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetOrderLockReasonDescriptionsResponse
     */
