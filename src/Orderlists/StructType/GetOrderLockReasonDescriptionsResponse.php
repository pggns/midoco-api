...
class GetOrderLockReasonDescriptionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrderLockReasonDescriptionForArrayConstraintsFromSetMidocoOrderLockReasonDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem) {
            ...
            if (!$getOrderLockReasonDescriptionsResponseMidocoOrderLockReasonDescriptionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\OrderLockReasonDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\OrderLockReasonDescriptionDTO[] $midocoOrderLockReasonDescription
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetOrderLockReasonDescriptionsResponse
     */
