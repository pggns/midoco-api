...
class GetUserWithCrsExpedientRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUserWithCrsExpedientRequestMidocoUserItem) {
            ...
            if (!$getUserWithCrsExpedientRequestMidocoUserItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetUserWithCrsExpedientRequest
     */
