...
class CustomerDumpVersionDTO extends AbstractStructBase
{
    ...
    /**
     * Constructor method for CustomerDumpVersionDTO
     * @uses CustomerDumpVersionDTO::setCustomerId()
     * @uses CustomerDumpVersionDTO::setExportTime()
     * @uses CustomerDumpVersionDTO::setInternalVersion()
     * @uses CustomerDumpVersionDTO::setUnitName()
     ...
     * @param int $customerId
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CustomerDumpVersionDTO
     */
