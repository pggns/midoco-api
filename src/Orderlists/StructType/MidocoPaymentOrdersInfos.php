...
class MidocoPaymentOrdersInfos extends AbstractStructBase
{
    ...
    public static function validateMidocoPaymentServiceInfosForArrayConstraintFromSetMidocoPaymentServiceInfos(?array $values = []): string
    {
        ...
        foreach ($values as $midocoPaymentOrdersInfosMidocoPaymentServiceInfosItem) {
            ...
            if (!$midocoPaymentOrdersInfosMidocoPaymentServiceInfosItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPaymentServiceInfos property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentOrdersInfos
     */
    public function addToMidocoPaymentServiceInfos(\Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos) {
            throw new InvalidArgumentException(sprintf('The MidocoPaymentServiceInfos property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentServiceInfos, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
