...
/**
 * This class stands for CrmLockDescriptionDTO StructType
 * @subpackage Structs
 */
class CrmLockDescriptionDTO extends AbstractStructBase
{
    /**
     * The cultureId
     * @var string|null
    ...
    /**
     * Constructor method for CrmLockDescriptionDTO
     * @uses CrmLockDescriptionDTO::setCultureId()
     * @uses CrmLockDescriptionDTO::setDescription()
     * @uses CrmLockDescriptionDTO::setReasonId()
     ...
     * Set cultureId value
     * @param string $cultureId
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CrmLockDescriptionDTO
     */
