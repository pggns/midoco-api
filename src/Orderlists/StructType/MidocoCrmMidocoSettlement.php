...
class MidocoCrmMidocoSettlement extends CrmMidocoSettlementDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO[] $midocoCrmMidocoSettlLevel
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO[] $midocoCrmMidocoSettlFee
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO[] $midocoAssignedMidocoSettlOUnit
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlLevelForArrayConstraintsFromSetMidocoCrmMidocoSettlLevel(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoCrmMidocoSettlLevelItem) {
            ...
            if (!$midocoCrmMidocoSettlementMidocoCrmMidocoSettlLevelItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlLevel property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO[] $midocoCrmMidocoSettlLevel
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmMidocoSettlement
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoCrmMidocoSettlLevel(\Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlLevel property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlLevelDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO[]
     */
    ...
    public static function validateMidocoCrmMidocoSettlFeeForArrayConstraintsFromSetMidocoCrmMidocoSettlFee(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoCrmMidocoSettlFeeItem) {
            // validation for constraint: itemType
            if (!$midocoCrmMidocoSettlementMidocoCrmMidocoSettlFeeItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmMidocoSettlFee property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoCrmMidocoSettlFee(\Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmMidocoSettlFee property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmMidocoSettlFeeDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO[]
     */
    ...
    public static function validateMidocoAssignedMidocoSettlOUnitForArrayConstraintsFromSetMidocoAssignedMidocoSettlOUnit(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmMidocoSettlementMidocoAssignedMidocoSettlOUnitItem) {
            // validation for constraint: itemType
            if (!$midocoCrmMidocoSettlementMidocoAssignedMidocoSettlOUnitItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAssignedMidocoSettlOUnit property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmMidocoSettlement
     */
    public function addToMidocoAssignedMidocoSettlOUnit(\Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAssignedMidocoSettlOUnit property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\AssignedMidocoSettlOUnitDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
