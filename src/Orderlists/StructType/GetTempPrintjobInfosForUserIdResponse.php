...
class GetTempPrintjobInfosForUserIdResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo[]
     */
    ...
    public static function validateMidocoTempPrintjobInfoForArrayConstraintsFromSetMidocoTempPrintjobInfo(?array $values = []): string
    {
        ...
        foreach ($values as $getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem) {
            ...
            if (!$getTempPrintjobInfosForUserIdResponseMidocoTempPrintjobInfoItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo[] $midocoTempPrintjobInfo
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetTempPrintjobInfosForUserIdResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetTempPrintjobInfosForUserIdResponse
     */
    public function addToMidocoTempPrintjobInfo(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoTempPrintjobInfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoTempPrintjobInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
