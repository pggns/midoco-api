...
class GetWSGroupsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoWsGroupForArrayConstraintsFromSetMidocoWsGroup(?array $values = []): string
    {
        ...
        foreach ($values as $getWSGroupsResponseMidocoWsGroupItem) {
            ...
            if (!$getWSGroupsResponseMidocoWsGroupItem instanceof \Pggns\MidocoApi\Orderlists\StructType\WsgroupDTO) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\WsgroupDTO[] $midocoWsGroup
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetWSGroupsResponse
     */
