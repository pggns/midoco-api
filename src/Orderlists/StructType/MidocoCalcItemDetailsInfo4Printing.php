...
class MidocoCalcItemDetailsInfo4Printing extends AbstractStructBase
{
    ...
    public static function validateMidocoSellItemVatDivisionForArrayConstraintsFromSetMidocoSellItemVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoSellItemVatDivisionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoSellItemVatDivisionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemVatDivision) {
    ...
    public static function validateMidocoInvoicePositionForArrayConstraintsFromSetMidocoInvoicePosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoInvoicePositionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoInvoicePositionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition) {
    ...
    public static function validateMidocoInvoiceVatPositionForArrayConstraintsFromSetMidocoInvoiceVatPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoInvoiceVatPositionItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoInvoiceVatPositionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition) {
    ...
    public static function validateFeeTypeLocalizationForArrayConstraintsFromSetFeeTypeLocalization(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingFeeTypeLocalizationItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingFeeTypeLocalizationItem instanceof \Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FeeTypeLocalization property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoCalcItemDetailsInfo4Printing
     */
    public function addToFeeTypeLocalization(\Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization) {
            throw new InvalidArgumentException(sprintf('The FeeTypeLocalization property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\FeeTypeLocalization, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoTouchedVatCodeForArrayConstraintsFromSetMidocoTouchedVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCalcItemDetailsInfo4PrintingMidocoTouchedVatCodeItem) {
            // validation for constraint: itemType
            if (!$midocoCalcItemDetailsInfo4PrintingMidocoTouchedVatCodeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType) {
