...
class VermiLinkAttributes extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderCustomer $midocoOrderCustomer
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\VermiLinkAttributes
     */
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $vermiLinkAttributesMidocoSellPassengerItem) {
            ...
            if (!$vermiLinkAttributesMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSellPassenger) {
