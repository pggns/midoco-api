...
/**
 * This class stands for MidocoSupplierDocumentShipping StructType
 * @subpackage Structs
 */
class MidocoSupplierDocumentShipping extends SupplierDocumentShippingDTO
{
    /**
     * The isInheritance
     * @var bool|null
    ...
    /**
     * Constructor method for MidocoSupplierDocumentShipping
     * @uses MidocoSupplierDocumentShipping::setIsInheritance()
     * @uses MidocoSupplierDocumentShipping::setOrgunit()
