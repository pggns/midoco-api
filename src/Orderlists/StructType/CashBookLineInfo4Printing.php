...
class CashBookLineInfo4Printing extends AbstractStructBase
{
    ...
    /**
     * The printingUser
     * @var \Pggns\MidocoApi\Orderlists\StructType\UserDTO|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $printingUser = null;
    /**
     * The creationUser
     * @var \Pggns\MidocoApi\Orderlists\StructType\UserDTO|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $creationUser = null;
    /**
     * The documentId
     * @var int|null
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\UserDTO $printingUser
     * @param \Pggns\MidocoApi\Orderlists\StructType\UserDTO $creationUser
     * @param int $documentId
     * @param float $paymentValue
     * @param string $signatureFailure
     */
    public function __construct(?string $documentNo = null, ?string $documentDate = null, ?float $totalPrice = null, ?string $customerName = null, ?string $customerId = null, ?string $description1stBillingPosition = null, ?string $debitorNo = null, ?string $paymentType = null, ?string $currency = null, ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $printingUser = null, ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $creationUser = null, ?int $documentId = null, ?float $paymentValue = null, ?string $signatureFailure = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\UserDTO|null
     */
    public function getPrintingUser(): ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing
     */
    public function setPrintingUser(?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $printingUser = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\UserDTO|null
     */
    public function getCreationUser(): ?\Pggns\MidocoApi\Orderlists\StructType\UserDTO
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing
     */
    public function setCreationUser(?\Pggns\MidocoApi\Orderlists\StructType\UserDTO $creationUser = null): self
    {
