...
class MidocoKaeraPackageExt extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\PackageitemDTO $midocoPackageInfo = null, ?bool $success = null, ?string $description = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PackageitemDTO $midocoPackageInfo
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoKaeraPackageExt
     */
