...
class MidocoKaeraPackageExt extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Orderlists\StructType\PackageitemDTO $midocoPackageInfo = null, ?bool $success = null, ?string $description = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\PackageitemDTO $midocoPackageInfo
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoKaeraPackageExt
     */
