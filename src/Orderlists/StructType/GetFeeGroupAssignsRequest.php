...
class GetFeeGroupAssignsRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeGroupAssign $midocoFeeGroupAssign = null, ?array $groupId = null, ?bool $onlyFromOwnDb = false)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeGroupAssign $midocoFeeGroupAssign
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetFeeGroupAssignsRequest
     */
