...
class DeleteMiscPaymentSettingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMiscPaymentSettingForArrayConstraintsFromSetMidocoMiscPaymentSetting(?array $values = []): string
    {
        ...
        foreach ($values as $deleteMiscPaymentSettingResponseMidocoMiscPaymentSettingItem) {
            ...
            if (!$deleteMiscPaymentSettingResponseMidocoMiscPaymentSettingItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CashPaymentSettingDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CashPaymentSettingDTO[] $midocoMiscPaymentSetting
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\DeleteMiscPaymentSettingResponse
     */
