...
class GetRemarks4OrgunitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoTextRemarkForArrayConstraintFromSetMidocoTextRemark(?array $values = []): string
    {
        ...
        foreach ($values as $getRemarks4OrgunitResponseMidocoTextRemarkItem) {
            ...
            if (!$getRemarks4OrgunitResponseMidocoTextRemarkItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoTextRemark) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoTextRemark[] $midocoTextRemark
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetRemarks4OrgunitResponse
     */
