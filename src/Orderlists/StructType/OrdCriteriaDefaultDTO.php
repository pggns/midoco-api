...
class OrdCriteriaDefaultDTO extends AbstractStructBase
{
    ...
    /**
     * Constructor method for OrdCriteriaDefaultDTO
     * @uses OrdCriteriaDefaultDTO::setCultureId()
     * @uses OrdCriteriaDefaultDTO::setDefaultValue()
     * @uses OrdCriteriaDefaultDTO::setTypeId()
     ...
     * Set cultureId value
     * @param string $cultureId
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\OrdCriteriaDefaultDTO
     */
