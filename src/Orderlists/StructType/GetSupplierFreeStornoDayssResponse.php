...
class GetSupplierFreeStornoDayssResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO[]
     */
    ...
    public static function validateMidocoSupplierFreeStornoDaysForArrayConstraintsFromSetMidocoSupplierFreeStornoDays(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierFreeStornoDayssResponseMidocoSupplierFreeStornoDaysItem) {
            ...
            if (!$getSupplierFreeStornoDayssResponseMidocoSupplierFreeStornoDaysItem instanceof \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierFreeStornoDays property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO[] $midocoSupplierFreeStornoDays
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetSupplierFreeStornoDayssResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetSupplierFreeStornoDayssResponse
     */
    public function addToMidocoSupplierFreeStornoDays(\Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierFreeStornoDays property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\SupplierFreeStornoDayDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
