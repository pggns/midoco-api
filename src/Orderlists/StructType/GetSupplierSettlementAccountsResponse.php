...
class GetSupplierSettlementAccountsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount[]
     */
    ...
    public static function validateMidocoSupplierSettlementAccountForArrayConstraintsFromSetMidocoSupplierSettlementAccount(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierSettlementAccountsResponseMidocoSupplierSettlementAccountItem) {
            ...
            if (!$getSupplierSettlementAccountsResponseMidocoSupplierSettlementAccountItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierSettlementAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount[] $midocoSupplierSettlementAccount
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetSupplierSettlementAccountsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetSupplierSettlementAccountsResponse
     */
    public function addToMidocoSupplierSettlementAccount(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierSettlementAccount property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierSettlementAccount, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
