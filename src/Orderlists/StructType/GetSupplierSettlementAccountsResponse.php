...
class GetSupplierSettlementAccountsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierSettlementAccountForArrayConstraintsFromSetMidocoSupplierSettlementAccount(?array $values = []): string
    {
        ...
        foreach ($values as $getSupplierSettlementAccountsResponseMidocoSupplierSettlementAccountItem) {
            ...
            if (!$getSupplierSettlementAccountsResponseMidocoSupplierSettlementAccountItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierSettlementAccount property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetSupplierSettlementAccountsResponse
     */
    public function addToMidocoSupplierSettlementAccount(\Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierSettlementAccount property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierSettlementAccount, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
