...
class MidocoOrderPaymentConfirmationInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo[] $paymentConfirmationInfo
     */
    ...
    public static function validatePaymentConfirmationInfoForArrayConstraintsFromSetPaymentConfirmationInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderPaymentConfirmationInfoPaymentConfirmationInfoItem) {
            ...
            if (!$midocoOrderPaymentConfirmationInfoPaymentConfirmationInfoItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PaymentConfirmationInfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo[] $paymentConfirmationInfo
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderPaymentConfirmationInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderPaymentConfirmationInfo
     */
    public function addToPaymentConfirmationInfo(\Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo) {
            throw new InvalidArgumentException(sprintf('The PaymentConfirmationInfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\PaymentConfirmationInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
