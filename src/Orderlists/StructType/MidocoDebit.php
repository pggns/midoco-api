...
class MidocoDebit extends MidocoOnlinePaymentTransactionPosition
{
     ...
     */
    public function __construct(?string $accountNo = null, ?string $accountBlz = null, ?string $accountName = null, ?string $accountOwner = null, ?string $accountCountry = null, ?string $transactionType = null, ?\Pggns\MidocoApi\Orderlists\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null)
    {
        $this
     ...
     * Set accountNo value
     * @param string $accountNo
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDebit
     */
