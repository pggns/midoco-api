...
class SaveEInvoiceGatewayResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoEInvoiceGatewayForArrayConstraintsFromSetMidocoEInvoiceGateway(?array $values = []): string
    {
        ...
        foreach ($values as $saveEInvoiceGatewayResponseMidocoEInvoiceGatewayItem) {
            ...
            if (!$saveEInvoiceGatewayResponseMidocoEInvoiceGatewayItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\EinvoiceGatewayDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\EinvoiceGatewayDTO[] $midocoEInvoiceGateway
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SaveEInvoiceGatewayResponse
     */
