...
class CreateCcProxySingleUseTokenRequest extends AbstractStructBase
{
    ...
    /**
     * The emailData
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO $emailData = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO $emailData
     */
    public function __construct(?string $token = null, ?string $tokenValue = null, ?string $sensitiveId = null, ?int $lifespanInSeconds = null, ?int $userId = null, ?string $orgUnit = null, ?\Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO $emailData = null)
    {
        $this
            ->setToken($token)
     ...
     * Set token value
     * @param string $token
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CreateCcProxySingleUseTokenRequest
     */
    ...
    /**
     * Get emailData value
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO|null
     */
    public function getEmailData(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CreateCcProxySingleUseTokenRequest
     */
    public function setEmailData(?\Pggns\MidocoApi\Api\Orderlists\StructType\CcProxyEmailDataDTO $emailData = null): self
    {
