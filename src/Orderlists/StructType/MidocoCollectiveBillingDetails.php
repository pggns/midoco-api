...
class MidocoCollectiveBillingDetails extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails[] $midocoBillingPositionsDetails
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails[]
     */
    ...
    public static function validateMidocoBillingPositionsDetailsForArrayConstraintsFromSetMidocoBillingPositionsDetails(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCollectiveBillingDetailsMidocoBillingPositionsDetailsItem) {
            ...
            if (!$midocoCollectiveBillingDetailsMidocoBillingPositionsDetailsItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBillingPositionsDetails property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails[] $midocoBillingPositionsDetails
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCollectiveBillingDetails
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCollectiveBillingDetails
     */
    public function addToMidocoBillingPositionsDetails(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails) {
            throw new InvalidArgumentException(sprintf('The MidocoBillingPositionsDetails property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoBillingPositionsDetails, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
