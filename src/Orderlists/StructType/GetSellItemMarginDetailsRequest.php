...
/**
 * This class stands for GetSellItemMarginDetailsRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetSellItemMarginDetailsRequest extends AbstractStructBase
{
    /**
     * The MidocoMargin
    ...
    /**
     * Constructor method for GetSellItemMarginDetailsRequest
     * @uses GetSellItemMarginDetailsRequest::setMidocoMargin()
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoMargin $midocoMargin
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetSellItemMarginDetailsRequest
     */
