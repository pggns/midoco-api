...
class CashBookPageInfo4Printing extends AbstractStructBase
{
    ...
    public static function validateCashBookLineInfo4PrintingForArrayConstraintFromSetCashBookLineInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $cashBookPageInfo4PrintingCashBookLineInfo4PrintingItem) {
            ...
            if (!$cashBookPageInfo4PrintingCashBookLineInfo4PrintingItem instanceof \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CashBookLineInfo4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\CashBookPageInfo4Printing
     */
    public function addToCashBookLineInfo4Printing(\Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing) {
            throw new InvalidArgumentException(sprintf('The CashBookLineInfo4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\CashBookLineInfo4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateCashBookReceiptPosition4PrintingForArrayConstraintFromSetCashBookReceiptPosition4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $cashBookPageInfo4PrintingCashBookReceiptPosition4PrintingItem) {
            // validation for constraint: itemType
            if (!$cashBookPageInfo4PrintingCashBookReceiptPosition4PrintingItem instanceof \Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CashBookReceiptPosition4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\CashBookPageInfo4Printing
     */
    public function addToCashBookReceiptPosition4Printing(\Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing) {
            throw new InvalidArgumentException(sprintf('The CashBookReceiptPosition4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\CashBookReceiptPosition4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
