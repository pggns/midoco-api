...
class MidocoOnlinePayment extends OnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoOnlinePayment
     */
