...
class MidocoOnlinePayment extends OnlinePaymentDTO
{
    ...
    public static function validateMidocoCcTokenForArrayConstraintsFromSetMidocoCcToken(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOnlinePaymentMidocoCcTokenItem) {
            ...
            if (!$midocoOnlinePaymentMidocoCcTokenItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcToken) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcToken[] $midocoCcToken
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOnlinePayment
     */
