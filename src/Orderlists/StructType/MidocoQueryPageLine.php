...
class MidocoQueryPageLine extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue[] $midocoQueryPageLineValue
     */
    ...
    public static function validateMidocoQueryPageLineValueForArrayConstraintsFromSetMidocoQueryPageLineValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoQueryPageLineMidocoQueryPageLineValueItem) {
            ...
            if (!$midocoQueryPageLineMidocoQueryPageLineValueItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQueryPageLineValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue[] $midocoQueryPageLineValue
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLine
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLine
     */
    public function addToMidocoQueryPageLineValue(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue) {
            throw new InvalidArgumentException(sprintf('The MidocoQueryPageLineValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoQueryPageLineValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
