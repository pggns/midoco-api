...
class MidocoCrmImportErrors extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors[] $midocoCrmDetailErrors
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors[]
     */
    ...
    public static function validateMidocoCrmDetailErrorsForArrayConstraintsFromSetMidocoCrmDetailErrors(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmImportErrorsMidocoCrmDetailErrorsItem) {
            ...
            if (!$midocoCrmImportErrorsMidocoCrmDetailErrorsItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmDetailErrors property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors[] $midocoCrmDetailErrors
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmImportErrors
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmImportErrors
     */
    public function addToMidocoCrmDetailErrors(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmDetailErrors property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmDetailErrors, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
