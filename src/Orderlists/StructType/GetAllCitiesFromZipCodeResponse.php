...
class GetAllCitiesFromZipCodeResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoCity
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO[]
     */
    ...
    public static function validateMidocoCityForArrayConstraintsFromSetMidocoCity(?array $values = []): string
    {
        ...
        foreach ($values as $getAllCitiesFromZipCodeResponseMidocoCityItem) {
            ...
            if (!$getAllCitiesFromZipCodeResponseMidocoCityItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCity property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO[] $midocoCity
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAllCitiesFromZipCodeResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAllCitiesFromZipCodeResponse
     */
    public function addToMidocoCity(\Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCity property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CityDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
