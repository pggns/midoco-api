...
class GetBookingTextsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO[]
     */
    ...
    public static function validateMidocoBookingTextForArrayConstraintsFromSetMidocoBookingText(?array $values = []): string
    {
        ...
        foreach ($values as $getBookingTextsResponseMidocoBookingTextItem) {
            ...
            if (!$getBookingTextsResponseMidocoBookingTextItem instanceof \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoBookingText property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO[] $midocoBookingText
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetBookingTextsResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetBookingTextsResponse
     */
    public function addToMidocoBookingText(\Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoBookingText property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\BookingTextDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
