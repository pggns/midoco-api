...
class SaveFeeTypeForOrgunitRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeTypeOrgUnit $midocoFeeTypeOrgUnit = null, ?string $lastOrgUnit = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeTypeOrgUnit $midocoFeeTypeOrgUnit
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\SaveFeeTypeForOrgunitRequest
     */
