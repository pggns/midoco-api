...
class ListSuppCancelCMappingResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSuppCancelCMappingForArrayConstraintsFromSetMidocoSuppCancelCMapping(?array $values = []): string
    {
        ...
        foreach ($values as $listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem) {
            ...
            if (!$listSuppCancelCMappingResponseMidocoSuppCancelCMappingItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSuppCancelCMapping) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSuppCancelCMapping[] $midocoSuppCancelCMapping
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListSuppCancelCMappingResponse
     */
