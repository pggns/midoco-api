...
class MidocoRemarkCategory extends RemarkCategoryDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO[] $midocoRemarkCategoryDesc
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO[]
     */
    ...
    public static function validateMidocoRemarkCategoryDescForArrayConstraintsFromSetMidocoRemarkCategoryDesc(?array $values = []): string
    {
        ...
        foreach ($values as $midocoRemarkCategoryMidocoRemarkCategoryDescItem) {
            ...
            if (!$midocoRemarkCategoryMidocoRemarkCategoryDescItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoRemarkCategoryDesc property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO[] $midocoRemarkCategoryDesc
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkCategory
     */
    public function addToMidocoRemarkCategoryDesc(\Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoRemarkCategoryDesc property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\RemarkCategoryDescDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
