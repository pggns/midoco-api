...
class MidocoCrmProfile extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: ExternalProfile
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes $ProfileAttributes = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile[] $externalProfile
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes $profileAttributes
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO[] $midocoCrmCustomerLink
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO[] $midocoFrequentFlyerNumber
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmProfile
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile[]
     */
    ...
    public static function validateExternalProfileForArrayConstraintsFromSetExternalProfile(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileExternalProfileItem) {
            ...
            if (!$midocoCrmProfileExternalProfileItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ExternalProfile property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmProfile
     */
    public function addToExternalProfile(\Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile) {
            throw new InvalidArgumentException(sprintf('The ExternalProfile property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ExternalProfile, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes|null
     */
    public function getProfileAttributes(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmProfile
     */
    public function setProfileAttributes(?\Pggns\MidocoApi\Api\Orderlists\StructType\ProfileAttributes $profileAttributes = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO[]
     */
    ...
    public static function validateMidocoCrmCustomerLinkForArrayConstraintsFromSetMidocoCrmCustomerLink(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoCrmCustomerLinkItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoCrmCustomerLinkItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCustomerLink property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmProfile
     */
    public function addToMidocoCrmCustomerLink(\Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCustomerLink property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\CrmCustomerLinkDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoFrequentFlyerNumberForArrayConstraintsFromSetMidocoFrequentFlyerNumber(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoFrequentFlyerNumberItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoFrequentFlyerNumberItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFrequentFlyerNumber property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmProfile
     */
    public function addToMidocoFrequentFlyerNumber(\Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoFrequentFlyerNumber property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\FrequentFlyerNumberDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoCrmAddressForArrayConstraintsFromSetMidocoCrmAddress(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoCrmAddressItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoCrmAddressItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCrmAddress) {
    ...
    public static function validateMidocoContactEntryForArrayConstraintsFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCrmProfileMidocoContactEntryItem) {
            // validation for constraint: itemType
            if (!$midocoCrmProfileMidocoContactEntryItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoContactEntryType) {
