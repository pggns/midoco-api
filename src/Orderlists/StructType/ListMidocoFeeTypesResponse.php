...
class ListMidocoFeeTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFeeTypeForArrayConstraintsFromSetMidocoFeeType(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoFeeTypesResponseMidocoFeeTypeItem) {
            ...
            if (!$listMidocoFeeTypesResponseMidocoFeeTypeItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeType) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeType[] $midocoFeeType
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListMidocoFeeTypesResponse
     */
