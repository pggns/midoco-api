...
class ListMidocoFeeTypesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoFeeTypeForArrayConstraintFromSetMidocoFeeType(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoFeeTypesResponseMidocoFeeTypeItem) {
            ...
            if (!$listMidocoFeeTypesResponseMidocoFeeTypeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeType) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoFeeType[] $midocoFeeType
     * @return \Pggns\MidocoApi\Orderlists\StructType\ListMidocoFeeTypesResponse
     */
