...
class AttributeDefinitionType extends AttributeDefinitionDTO
{
    ...
    public static function validateMidocoAttributeChoiceValueForArrayConstraintFromSetMidocoAttributeChoiceValue(?array $values = []): string
    {
        ...
        foreach ($values as $attributeDefinitionTypeMidocoAttributeChoiceValueItem) {
            ...
            if (!$attributeDefinitionTypeMidocoAttributeChoiceValueItem instanceof \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueDTO) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueDTO[] $midocoAttributeChoiceValue
     * @return \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionType
     */
