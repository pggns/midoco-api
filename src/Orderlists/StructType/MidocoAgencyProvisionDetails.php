...
class MidocoAgencyProvisionDetails extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1[] $attribute
     * @param int $orderNo
    ...
    /**
     * Get Attribute value
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1[]
     */
    ...
    public static function validateAttributeForArrayConstraintsFromSetAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAgencyProvisionDetailsAttributeItem) {
            ...
            if (!$midocoAgencyProvisionDetailsAttributeItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Attribute property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1[] $attribute
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAgencyProvisionDetails
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1 $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAgencyProvisionDetails
     */
    public function addToAttribute(\Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1) {
            throw new InvalidArgumentException(sprintf('The Attribute property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\Attribute_1, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->Attribute[] = $item;
