...
class GetAirportCodesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAirportCodeForArrayConstraintFromSetMidocoAirportCode(?array $values = []): string
    {
        ...
        foreach ($values as $getAirportCodesResponseMidocoAirportCodeItem) {
            ...
            if (!$getAirportCodesResponseMidocoAirportCodeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAirportCode property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAirportCodesResponse
     */
    public function addToMidocoAirportCode(\Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode) {
            throw new InvalidArgumentException(sprintf('The MidocoAirportCode property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAirportCode, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
