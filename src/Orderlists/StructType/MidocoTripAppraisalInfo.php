...
class MidocoTripAppraisalInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo[] $tripAppraisalInfo
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo[]
     */
    ...
    public static function validateTripAppraisalInfoForArrayConstraintsFromSetTripAppraisalInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoTripAppraisalInfoTripAppraisalInfoItem) {
            ...
            if (!$midocoTripAppraisalInfoTripAppraisalInfoItem instanceof \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TripAppraisalInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo[] $tripAppraisalInfo
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTripAppraisalInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoTripAppraisalInfo
     */
    public function addToTripAppraisalInfo(\Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo) {
            throw new InvalidArgumentException(sprintf('The TripAppraisalInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\TripAppraisalInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
