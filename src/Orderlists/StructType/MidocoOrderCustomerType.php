...
class MidocoOrderCustomerType extends OrderCustomerDTO
{
    ...
    public static function validateMidocoCommunicationForArrayConstraintsFromSetMidocoCommunication(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrderCustomerTypeMidocoCommunicationItem) {
            ...
            if (!$midocoOrderCustomerTypeMidocoCommunicationItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCommunication) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCommunication[] $midocoCommunication
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrderCustomerType
     */
