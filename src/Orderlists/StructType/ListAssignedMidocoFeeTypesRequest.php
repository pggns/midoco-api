...
class ListAssignedMidocoFeeTypesRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeType $midocoFeeType = null, ?string $referenceDate = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFeeType $midocoFeeType
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListAssignedMidocoFeeTypesRequest
     */
