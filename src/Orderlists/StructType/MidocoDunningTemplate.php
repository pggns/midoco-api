...
class MidocoDunningTemplate extends DunningTemplateDTO
{
    ...
    public static function validateMidocoDunningTemplateAssignForArrayConstraintsFromSetMidocoDunningTemplateAssign(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDunningTemplateMidocoDunningTemplateAssignItem) {
            ...
            if (!$midocoDunningTemplateMidocoDunningTemplateAssignItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\DunningTemplateAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\DunningTemplateAssignDTO[] $midocoDunningTemplateAssign
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDunningTemplate
     */
