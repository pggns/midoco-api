...
class MidocoDocumentitem4Printing extends DocumentitemDTO
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoPassengerInfo4Printing|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoPassengerInfo4Printing $MidocoPassengerInfo4Printing = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO[] $midocoDocumentTaxInfo4Printing
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoPassengerInfo4Printing|null
     */
    public function getMidocoPassengerInfo4Printing(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoPassengerInfo4Printing
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function setMidocoPassengerInfo4Printing(?\Pggns\MidocoApi\Orderlists\StructType\MidocoPassengerInfo4Printing $midocoPassengerInfo4Printing = null): self
    {
    ...
    public static function validateMidocoFlightDetailsInfo4PrintingForArrayConstraintFromSetMidocoFlightDetailsInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoFlightDetailsInfo4PrintingItem) {
            ...
            if (!$midocoDocumentitem4PrintingMidocoFlightDetailsInfo4PrintingItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoFlightDetailsInfo4Printing) {
    ...
    public static function validateMidocoRemarksForArrayConstraintFromSetMidocoRemarks(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoRemarksItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoRemarksItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoRemarkType) {
    ...
    public static function validateMidocoDocumentTaxInfo4PrintingForArrayConstraintFromSetMidocoDocumentTaxInfo4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoDocumentTaxInfo4PrintingItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoDocumentTaxInfo4PrintingItem instanceof \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDocumentTaxInfo4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoDocumentTaxInfo4Printing(\Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoDocumentTaxInfo4Printing property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\DocumentTaxCalculationDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoOrdersDbiInfoForArrayConstraintFromSetMidocoOrdersDbiInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoOrdersDbiInfoItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoOrdersDbiInfoItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdersDbiInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoOrdersDbiInfo(\Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdersDbiInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoOrdersDbiInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoInvoicePositionForArrayConstraintFromSetMidocoInvoicePosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoInvoicePositionItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoInvoicePositionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoInvoicePosition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoInvoicePosition(\Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition) {
            throw new InvalidArgumentException(sprintf('The MidocoInvoicePosition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoicePosition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoInvoiceVatPositionForArrayConstraintFromSetMidocoInvoiceVatPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoInvoiceVatPositionItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoInvoiceVatPositionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoInvoiceVatPosition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoInvoiceVatPosition(\Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition) {
            throw new InvalidArgumentException(sprintf('The MidocoInvoiceVatPosition property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoInvoiceVatPosition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellPassengerForArrayConstraintFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoSellPassengerItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellPassenger) {
    ...
    public static function validateMidocoTouchedVatCodeForArrayConstraintFromSetMidocoTouchedVatCode(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDocumentitem4PrintingMidocoTouchedVatCodeItem) {
            // validation for constraint: itemType
            if (!$midocoDocumentitem4PrintingMidocoTouchedVatCodeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoTouchedVatCode property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDocumentitem4Printing
     */
    public function addToMidocoTouchedVatCode(\Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\TouchedVatCodeType) {
