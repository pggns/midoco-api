...
class GetMatchingFeeRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute[]
     */
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute[] $midocoSellItemAttribute
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute[] $midocoOrderAttribute
     ...
     * @param string $supplierId
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetMatchingFeeRequest
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute[]
     */
    ...
    public static function validateMidocoSellItemAttributeForArrayConstraintFromSetMidocoSellItemAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoSellItemAttributeItem) {
            ...
            if (!$getMatchingFeeRequestMidocoSellItemAttributeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetMatchingFeeRequest
     */
    public function addToMidocoSellItemAttribute(\Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoSellItemAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoSellItemAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute[]
     */
    ...
    public static function validateMidocoOrderAttributeForArrayConstraintFromSetMidocoOrderAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoOrderAttributeItem) {
            // validation for constraint: itemType
            if (!$getMatchingFeeRequestMidocoOrderAttributeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrderAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetMatchingFeeRequest
     */
    public function addToMidocoOrderAttribute(\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute) {
            throw new InvalidArgumentException(sprintf('The MidocoOrderAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoVatDivisionForArrayConstraintFromSetMidocoVatDivision(?array $values = []): string
    {
        ...
        foreach ($values as $getMatchingFeeRequestMidocoVatDivisionItem) {
            // validation for constraint: itemType
            if (!$getMatchingFeeRequestMidocoVatDivisionItem instanceof \Pggns\MidocoApi\Orderlists\StructType\VatDivisionDTO) {
