...
class MidocoVerkDbiInfos extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue[] $midocoDbiDefValue
     */
     ...
     * Set orderId value
     * @param int $orderId
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoVerkDbiInfos
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue[]
     */
    ...
    public static function validateMidocoDbiDefValueForArrayConstraintsFromSetMidocoDbiDefValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVerkDbiInfosMidocoDbiDefValueItem) {
            ...
            if (!$midocoVerkDbiInfosMidocoDbiDefValueItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDbiDefValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoVerkDbiInfos
     */
    public function addToMidocoDbiDefValue(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue) {
            throw new InvalidArgumentException(sprintf('The MidocoDbiDefValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDbiDefValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
