...
class MidocoVerkDbiInfos extends AbstractStructBase
{
     ...
     * Set orderId value
     * @param int $orderId
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoVerkDbiInfos
     */
    ...
    public static function validateMidocoDbiDefValueForArrayConstraintFromSetMidocoDbiDefValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVerkDbiInfosMidocoDbiDefValueItem) {
            ...
            if (!$midocoVerkDbiInfosMidocoDbiDefValueItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDbiDefValue property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoVerkDbiInfos
     */
    public function addToMidocoDbiDefValue(\Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue) {
            throw new InvalidArgumentException(sprintf('The MidocoDbiDefValue property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDbiDefValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
