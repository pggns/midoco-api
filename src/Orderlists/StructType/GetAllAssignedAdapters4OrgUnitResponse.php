...
class GetAllAssignedAdapters4OrgUnitResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MidocoAdapter
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType[]
     */
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType[] $midocoAdapter
     * @param \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO[] $midocoAdapterAssign
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType[]
     */
    ...
    public static function validateMidocoAdapterForArrayConstraintFromSetMidocoAdapter(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem) {
            ...
            if (!$getAllAssignedAdapters4OrgUnitResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdapter property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
    public function addToMidocoAdapter(\Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType) {
            throw new InvalidArgumentException(sprintf('The MidocoAdapter property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAdapterType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO[]
     */
    ...
    public static function validateMidocoAdapterAssignForArrayConstraintFromSetMidocoAdapterAssign(?array $values = []): string
    {
        ...
        foreach ($values as $getAllAssignedAdapters4OrgUnitResponseMidocoAdapterAssignItem) {
            // validation for constraint: itemType
            if (!$getAllAssignedAdapters4OrgUnitResponseMidocoAdapterAssignItem instanceof \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdapterAssign property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAllAssignedAdapters4OrgUnitResponse
     */
    public function addToMidocoAdapterAssign(\Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoAdapterAssign property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AdapterAssignDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
