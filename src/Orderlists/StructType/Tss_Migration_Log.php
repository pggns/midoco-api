...
class Tss_Migration_Log extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse $CancelTssClientResponse = null;
    /**
     * The CreateTssClientResponse
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: CreateTssClientResponse
     * @var \Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse $CreateTssClientResponse = null;
    /**
     * The SendTssPukMailResponse
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: SendTssPukMailResponse
     * @var \Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse $SendTssPukMailResponse = null;
    /**
     * The Error
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse $cancelTssClientResponse
     * @param \Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse $createTssClientResponse
     * @param \Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse $sendTssPukMailResponse
     * @param string $error
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse|null
     */
    public function getCancelTssClientResponse(): ?\Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse
    {
     ...
     */
    public function setCancelTssClientResponse(?\Pggns\MidocoApi\Orderlists\StructType\CancelTssClientResponse $cancelTssClientResponse = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse|null
     */
    public function getCreateTssClientResponse(): ?\Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\Tss_Migration_Log
     */
    public function setCreateTssClientResponse(?\Pggns\MidocoApi\Orderlists\StructType\CreateTssClientResponse $createTssClientResponse = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse|null
     */
    public function getSendTssPukMailResponse(): ?\Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\Tss_Migration_Log
     */
    public function setSendTssPukMailResponse(?\Pggns\MidocoApi\Orderlists\StructType\SendTssPukMailResponse $sendTssPukMailResponse = null): self
    {
