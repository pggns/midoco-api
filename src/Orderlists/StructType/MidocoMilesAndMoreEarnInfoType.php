...
class MidocoMilesAndMoreEarnInfoType extends MilesAndMoreEarnInfoDTO
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction $MidocoMilesAndMoreEarnTransaction = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction $midocoMilesAndMoreEarnTransaction
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction|null
     */
    public function getMidocoMilesAndMoreEarnTransaction(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction
    {
     ...
     */
    public function setMidocoMilesAndMoreEarnTransaction(?\Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransaction $midocoMilesAndMoreEarnTransaction = null): self
    {
    ...
    public static function validateMidocoMilesAndMoreEarnTransactionReferenceForArrayConstraintFromSetMidocoMilesAndMoreEarnTransactionReference(?array $values = []): string
    {
        ...
        foreach ($values as $midocoMilesAndMoreEarnInfoTypeMidocoMilesAndMoreEarnTransactionReferenceItem) {
            ...
            if (!$midocoMilesAndMoreEarnInfoTypeMidocoMilesAndMoreEarnTransactionReferenceItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoMilesAndMoreEarnTransactionReference property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnInfoType
     */
    public function addToMidocoMilesAndMoreEarnTransactionReference(\Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference) {
            throw new InvalidArgumentException(sprintf('The MidocoMilesAndMoreEarnTransactionReference property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoMilesAndMoreEarnTransactionReference, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
