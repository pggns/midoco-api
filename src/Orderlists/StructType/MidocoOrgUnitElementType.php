...
class MidocoOrgUnitElementType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType[]
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType[] $midocoOrgUnitElement
     */
     ...
     * Set parent value
     * @param string $parent
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType
     */
    ...
    public static function validateMidocoOrgUnitElementForArrayConstraintsFromSetMidocoOrgUnitElement(?array $values = []): string
    {
        ...
        foreach ($values as $midocoOrgUnitElementTypeMidocoOrgUnitElementItem) {
            ...
            if (!$midocoOrgUnitElementTypeMidocoOrgUnitElementItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrgUnitElement property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType
     */
    public function addToMidocoOrgUnitElement(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType) {
            throw new InvalidArgumentException(sprintf('The MidocoOrgUnitElement property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoOrgUnitElementType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
