...
/**
 * This class stands for GetBillingStatsRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetBillingStatsRequest extends AbstractStructBase
{
    /**
     * The supplier
    ...
    /**
     * Constructor method for GetBillingStatsRequest
     * @uses GetBillingStatsRequest::setSupplier()
     * @uses GetBillingStatsRequest::setUnitName()
     * @uses GetBillingStatsRequest::setReceiptDateFrom()
     * @uses GetBillingStatsRequest::setReceiptDateTo()
     * @uses GetBillingStatsRequest::setDebitorNo()
     * @uses GetBillingStatsRequest::setStartTravelFrom()
     * @uses GetBillingStatsRequest::setStartTravelTo()
     * @uses GetBillingStatsRequest::setCustomerId()
     * @uses GetBillingStatsRequest::setOrderNo()
     * @uses GetBillingStatsRequest::setCreationUser()
     * @uses GetBillingStatsRequest::setAccrualNonZero()
    ...
    public static function validateSupplierForArrayConstraintFromSetSupplier(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $getBillingStatsRequestSupplierItem) {
            // validation for constraint: itemType
            if (!is_string($getBillingStatsRequestSupplierItem)) {
                $invalidValues[] = is_object($getBillingStatsRequestSupplierItem) ? get_class($getBillingStatsRequestSupplierItem) : sprintf('%s(%s)', gettype($getBillingStatsRequestSupplierItem), var_export($getBillingStatsRequestSupplierItem, true));
            }
        }
     ...
     * @param string[] $supplier
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetBillingStatsRequest
     */
    ...
    public static function validateUnitNameForArrayConstraintFromSetUnitName(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $getBillingStatsRequestUnitNameItem) {
            // validation for constraint: itemType
            if (!is_string($getBillingStatsRequestUnitNameItem)) {
                $invalidValues[] = is_object($getBillingStatsRequestUnitNameItem) ? get_class($getBillingStatsRequestUnitNameItem) : sprintf('%s(%s)', gettype($getBillingStatsRequestUnitNameItem), var_export($getBillingStatsRequestUnitNameItem, true));
            }
        }
        if (!empty($invalidValues)) {
