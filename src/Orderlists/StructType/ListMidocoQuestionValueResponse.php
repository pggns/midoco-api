...
class ListMidocoQuestionValueResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO[]
     */
    ...
    public static function validateMidocoQuestionValueForArrayConstraintsFromSetMidocoQuestionValue(?array $values = []): string
    {
        ...
        foreach ($values as $listMidocoQuestionValueResponseMidocoQuestionValueItem) {
            ...
            if (!$listMidocoQuestionValueResponseMidocoQuestionValueItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoQuestionValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO[] $midocoQuestionValue
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListMidocoQuestionValueResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListMidocoQuestionValueResponse
     */
    public function addToMidocoQuestionValue(\Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoQuestionValue property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\QuestionValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
