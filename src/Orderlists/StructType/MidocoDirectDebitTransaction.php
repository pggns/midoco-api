...
class MidocoDirectDebitTransaction extends DtausTransactionDTO
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoDtazvTransactionInfo|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoDtazvTransactionInfo $MidocoDtazvTransactionInfo = null;
    /**
    ...
    public static function validateMidocoDirectDebitTransactionPurposeForArrayConstraintFromSetMidocoDirectDebitTransactionPurpose(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDirectDebitTransactionMidocoDirectDebitTransactionPurposeItem) {
            ...
            if (!$midocoDirectDebitTransactionMidocoDirectDebitTransactionPurposeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDirectDebitTransactionPurpose property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransaction
     */
    public function addToMidocoDirectDebitTransactionPurpose(\Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose) {
            throw new InvalidArgumentException(sprintf('The MidocoDirectDebitTransactionPurpose property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransactionPurpose, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDtazvTransactionInfo|null
     */
    public function getMidocoDtazvTransactionInfo(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoDtazvTransactionInfo
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDirectDebitTransaction
     */
    public function setMidocoDtazvTransactionInfo(?\Pggns\MidocoApi\Orderlists\StructType\MidocoDtazvTransactionInfo $midocoDtazvTransactionInfo = null): self
    {
