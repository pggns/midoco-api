...
class MidocoDirectDebitTransaction extends DtausTransactionDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo $MidocoDtazvTransactionInfo = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose[] $midocoDirectDebitTransactionPurpose
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo $midocoDtazvTransactionInfo
     */
    public function __construct(?string $errorDescription = null, ?string $transactionType = null, ?array $midocoDirectDebitTransactionPurpose = null, ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo $midocoDtazvTransactionInfo = null)
    {
        $this
     ...
     * @param string $errorDescription
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransaction
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose[]
     */
    ...
    public static function validateMidocoDirectDebitTransactionPurposeForArrayConstraintsFromSetMidocoDirectDebitTransactionPurpose(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDirectDebitTransactionMidocoDirectDebitTransactionPurposeItem) {
            ...
            if (!$midocoDirectDebitTransactionMidocoDirectDebitTransactionPurposeItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDirectDebitTransactionPurpose property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransaction
     */
    public function addToMidocoDirectDebitTransactionPurpose(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose) {
            throw new InvalidArgumentException(sprintf('The MidocoDirectDebitTransactionPurpose property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransactionPurpose, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo|null
     */
    public function getMidocoDtazvTransactionInfo(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDirectDebitTransaction
     */
    public function setMidocoDtazvTransactionInfo(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoDtazvTransactionInfo $midocoDtazvTransactionInfo = null): self
    {
