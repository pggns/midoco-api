...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetUsersFromTopMostOrgUnitResponse
     */
