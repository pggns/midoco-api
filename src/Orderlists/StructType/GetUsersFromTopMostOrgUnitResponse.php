...
class GetUsersFromTopMostOrgUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(?array $values = []): string
    {
        ...
        foreach ($values as $getUsersFromTopMostOrgUnitResponseMidocoUserItem) {
            ...
            if (!$getUsersFromTopMostOrgUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetUsersFromTopMostOrgUnitResponse
     */
