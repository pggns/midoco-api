...
class MidocoFlightDetailsInfo4Printing extends FlightDetailDTO
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration $MidocoFlightDuration = null;
    /**
     * The MidocoRemarks
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing[] $midocoFlightSegmentDetails4Printing
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration $midocoFlightDuration
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing[]
     */
    ...
    public static function validateMidocoFlightSegmentDetails4PrintingForArrayConstraintsFromSetMidocoFlightSegmentDetails4Printing(?array $values = []): string
    {
        ...
        foreach ($values as $midocoFlightDetailsInfo4PrintingMidocoFlightSegmentDetails4PrintingItem) {
            ...
            if (!$midocoFlightDetailsInfo4PrintingMidocoFlightSegmentDetails4PrintingItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFlightSegmentDetails4Printing property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDetailsInfo4Printing
     */
    public function addToMidocoFlightSegmentDetails4Printing(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing) {
            throw new InvalidArgumentException(sprintf('The MidocoFlightSegmentDetails4Printing property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightSegmentDetails4Printing, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration|null
     */
    public function getMidocoFlightDuration(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDetailsInfo4Printing
     */
    public function setMidocoFlightDuration(?\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoFlightDuration $midocoFlightDuration = null): self
    {
    ...
    public static function validateMidocoRemarksForArrayConstraintsFromSetMidocoRemarks(?array $values = []): string
    {
        ...
        foreach ($values as $midocoFlightDetailsInfo4PrintingMidocoRemarksItem) {
            // validation for constraint: itemType
            if (!$midocoFlightDetailsInfo4PrintingMidocoRemarksItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoRemarkType) {
