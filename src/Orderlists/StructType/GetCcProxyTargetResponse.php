...
class GetCcProxyTargetResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget[]
     */
    ...
    public static function validateMidocoCcProxyTargetForArrayConstraintsFromSetMidocoCcProxyTarget(?array $values = []): string
    {
        ...
        foreach ($values as $getCcProxyTargetResponseMidocoCcProxyTargetItem) {
            ...
            if (!$getCcProxyTargetResponseMidocoCcProxyTargetItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCcProxyTarget property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget[] $midocoCcProxyTarget
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetCcProxyTargetResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetCcProxyTargetResponse
     */
    public function addToMidocoCcProxyTarget(\Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget) {
            throw new InvalidArgumentException(sprintf('The MidocoCcProxyTarget property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoCcProxyTarget, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
