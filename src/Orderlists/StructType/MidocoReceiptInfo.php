...
class MidocoReceiptInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo[]
     */
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo $ReceiptOnlinePaymentInfo = null;
    /**
     * The MidocoDebitInfoForReceipt
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MidocoDebitInfoForReceipt
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt $MidocoDebitInfoForReceipt = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo[] $receiptPositioninfo
     * @param \Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo $receiptOnlinePaymentInfo
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt $midocoDebitInfoForReceipt
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt[] $midocoAdditionalInfoForReceipt
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo[]
     */
    ...
    public static function validateReceiptPositioninfoForArrayConstraintFromSetReceiptPositioninfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptInfoReceiptPositioninfoItem) {
            ...
            if (!$midocoReceiptInfoReceiptPositioninfoItem instanceof \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ReceiptPositioninfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo[] $receiptPositioninfo
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoReceiptInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoReceiptInfo
     */
    public function addToReceiptPositioninfo(\Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo) {
            throw new InvalidArgumentException(sprintf('The ReceiptPositioninfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\ReceiptPositioninfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo|null
     */
    public function getReceiptOnlinePaymentInfo(): ?\Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoReceiptInfo
     */
    public function setReceiptOnlinePaymentInfo(?\Pggns\MidocoApi\Orderlists\StructType\ReceiptOnlinePaymentInfo $receiptOnlinePaymentInfo = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt|null
     */
    public function getMidocoDebitInfoForReceipt(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoReceiptInfo
     */
    public function setMidocoDebitInfoForReceipt(?\Pggns\MidocoApi\Orderlists\StructType\MidocoDebitInfoForReceipt $midocoDebitInfoForReceipt = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt[]
     */
    ...
    public static function validateMidocoAdditionalInfoForReceiptForArrayConstraintFromSetMidocoAdditionalInfoForReceipt(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptInfoMidocoAdditionalInfoForReceiptItem) {
            // validation for constraint: itemType
            if (!$midocoReceiptInfoMidocoAdditionalInfoForReceiptItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoAdditionalInfoForReceipt property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoReceiptInfo
     */
    public function addToMidocoAdditionalInfoForReceipt(\Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt) {
            throw new InvalidArgumentException(sprintf('The MidocoAdditionalInfoForReceipt property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoAdditionalInfoForReceipt, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
