...
class MidocoReceiptInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo[]
     */
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo|null
     */
    protected ?\Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo $ReceiptOnlinePaymentInfo = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo[] $receiptPositioninfo
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo $receiptOnlinePaymentInfo
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo[]
     */
    ...
    public static function validateReceiptPositioninfoForArrayConstraintsFromSetReceiptPositioninfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptInfoReceiptPositioninfoItem) {
            ...
            if (!$midocoReceiptInfoReceiptPositioninfoItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ReceiptPositioninfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo[] $receiptPositioninfo
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoReceiptInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoReceiptInfo
     */
    public function addToReceiptPositioninfo(\Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo) {
            throw new InvalidArgumentException(sprintf('The ReceiptPositioninfo property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptPositioninfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo|null
     */
    public function getReceiptOnlinePaymentInfo(): ?\Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo
    {
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoReceiptInfo
     */
    public function setReceiptOnlinePaymentInfo(?\Pggns\MidocoApi\Api\Orderlists\StructType\ReceiptOnlinePaymentInfo $receiptOnlinePaymentInfo = null): self
    {
    ...
    public static function validateMidocoAdditionalInfoForReceiptForArrayConstraintsFromSetMidocoAdditionalInfoForReceipt(?array $values = []): string
    {
        ...
        foreach ($values as $midocoReceiptInfoMidocoAdditionalInfoForReceiptItem) {
            // validation for constraint: itemType
            if (!$midocoReceiptInfoMidocoAdditionalInfoForReceiptItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAdditionalInfoForReceipt) {
