...
class MidocoDetailedBillingPositionInfo extends BillingPositionDTO
{
    ...
    public static function validateMidocoDetailedBillingPositionInfoForArrayConstraintsFromSetMidocoDetailedBillingPositionInfo(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDetailedBillingPositionInfoMidocoDetailedBillingPositionInfoItem) {
            ...
            if (!$midocoDetailedBillingPositionInfoMidocoDetailedBillingPositionInfoItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoDetailedBillingPositionInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo
     */
    public function addToMidocoDetailedBillingPositionInfo(\Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo) {
            throw new InvalidArgumentException(sprintf('The MidocoDetailedBillingPositionInfo property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\MidocoDetailedBillingPositionInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoDetailedBillingPositionInfoMidocoSellPassengerItem) {
            // validation for constraint: itemType
            if (!$midocoDetailedBillingPositionInfoMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellPassenger) {
