...
class MidocoAttributeValue extends AbstractStructBase
{
    ...
    public static function validateMidocoChoiceValuesForArrayConstraintsFromSetMidocoChoiceValues(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAttributeValueMidocoChoiceValuesItem) {
            ...
            if (!$midocoAttributeValueMidocoChoiceValuesItem instanceof \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoChoiceValues property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoAttributeValue
     */
    public function addToMidocoChoiceValues(\Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType) {
            throw new InvalidArgumentException(sprintf('The MidocoChoiceValues property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AttributeChoiceValueType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
