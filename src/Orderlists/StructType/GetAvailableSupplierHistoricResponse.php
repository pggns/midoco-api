...
class GetAvailableSupplierHistoricResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierHistoricResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierHistoricResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetAvailableSupplierHistoricResponse
     */
