...
class GetAvailableSupplierHistoricResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintsFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableSupplierHistoricResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableSupplierHistoricResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetAvailableSupplierHistoricResponse
     */
