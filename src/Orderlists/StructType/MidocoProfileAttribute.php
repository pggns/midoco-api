...
class MidocoProfileAttribute extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute[] $gdsProfileAttribute
     * @param int $id
     * @param string $type
     * @param string $value
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute[]
     */
    ...
    public static function validateGdsProfileAttributeForArrayConstraintsFromSetGdsProfileAttribute(?array $values = []): string
    {
        ...
        foreach ($values as $midocoProfileAttributeGdsProfileAttributeItem) {
            ...
            if (!$midocoProfileAttributeGdsProfileAttributeItem instanceof \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The GdsProfileAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoProfileAttribute
     */
    public function addToGdsProfileAttribute(\Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute) {
            throw new InvalidArgumentException(sprintf('The GdsProfileAttribute property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\GdsProfileAttribute, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
