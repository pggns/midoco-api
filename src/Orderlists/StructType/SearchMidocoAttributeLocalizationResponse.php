...
class SearchMidocoAttributeLocalizationResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO[]
     */
    ...
    public static function validateMidocoSystemAttributeLocalizationForArrayConstraintsFromSetMidocoSystemAttributeLocalization(?array $values = []): string
    {
        ...
        foreach ($values as $searchMidocoAttributeLocalizationResponseMidocoSystemAttributeLocalizationItem) {
            ...
            if (!$searchMidocoAttributeLocalizationResponseMidocoSystemAttributeLocalizationItem instanceof \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSystemAttributeLocalization property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO[] $midocoSystemAttributeLocalization
     * @return \Pggns\MidocoApi\Orderlists\StructType\SearchMidocoAttributeLocalizationResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\SearchMidocoAttributeLocalizationResponse
     */
    public function addToMidocoSystemAttributeLocalization(\Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSystemAttributeLocalization property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\AttributeDefinitionLocalDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
