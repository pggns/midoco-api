...
class GetMidocoPrintOptionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO[]
     */
    ...
    public static function validateMidocoPrintOptionForArrayConstraintsFromSetMidocoPrintOption(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoPrintOptionResponseMidocoPrintOptionItem) {
            ...
            if (!$getMidocoPrintOptionResponseMidocoPrintOptionItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoPrintOption property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO[] $midocoPrintOption
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetMidocoPrintOptionResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO $item
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetMidocoPrintOptionResponse
     */
    public function addToMidocoPrintOption(\Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoPrintOption property can only contain items of type \Pggns\MidocoApi\Api\Orderlists\StructType\PrintOptionDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
