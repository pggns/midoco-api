...
class Transfer_service_type extends AbstractStructBase
{
    ...
    public function setStart_time(?string $start_time = null): self
    {
        ...
        if (!is_null($start_time) && !preg_match('/[0-9]{2}:[0-9]{2}:[0-9]{2}/', $start_time)) {
    ...
    public function setEnd_time(?string $end_time = null): self
    {
        ...
        // validation for constraint: pattern([0-9]{2}:[0-9]{2}:[0-9]{2})
        if (!is_null($end_time) && !preg_match('/[0-9]{2}:[0-9]{2}:[0-9]{2}/', $end_time)) {
    ...
    /**
     * Set direction value
     * @uses \Pggns\MidocoApi\Api\Orderlists\EnumType\Direction::valueIsValid()
     * @uses \Pggns\MidocoApi\Api\Orderlists\EnumType\Direction::getValidValues()
    ...
    public function setDirection(?string $direction = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Api\Orderlists\EnumType\Direction::valueIsValid($direction)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Api\Orderlists\EnumType\Direction', is_array($direction) ? implode(', ', $direction) : var_export($direction, true), implode(', ', \Pggns\MidocoApi\Api\Orderlists\EnumType\Direction::getValidValues())), __LINE__);
        }
