...
class MidocoAdviceSettlementDetailInfo extends AdviceSettlemDetailDTO
{
    ...
    public static function validateMidocoAdviceDetailVatDivForArrayConstraintsFromSetMidocoAdviceDetailVatDiv(?array $values = []): string
    {
        ...
        foreach ($values as $midocoAdviceSettlementDetailInfoMidocoAdviceDetailVatDivItem) {
            ...
            if (!$midocoAdviceSettlementDetailInfoMidocoAdviceDetailVatDivItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAdviceDetailVatDiv) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAdviceDetailVatDiv[] $midocoAdviceDetailVatDiv
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoAdviceSettlementDetailInfo
     */
