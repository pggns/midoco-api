...
class MidocoSubBookingInfoType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderCustomer|null
     */
    protected ?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderCustomer $MidocoOrderCustomer = null;
    /**
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\MidocoOrderCustomer|null
     */
    public function getMidocoOrderCustomer(): ?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderCustomer
    {
     ...
     */
    public function setMidocoOrderCustomer(?\Pggns\MidocoApi\Orderlists\StructType\MidocoOrderCustomer $midocoOrderCustomer = null): self
    {
    ...
    public static function validateMidocoSellPassengerForArrayConstraintsFromSetMidocoSellPassenger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoSubBookingInfoTypeMidocoSellPassengerItem) {
            ...
            if (!$midocoSubBookingInfoTypeMidocoSellPassengerItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoSellPassenger) {
