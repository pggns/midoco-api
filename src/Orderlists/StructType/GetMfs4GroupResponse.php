...
class GetMfs4GroupResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfs4GroupResponseMidocoMfItem) {
            ...
            if (!$getMfs4GroupResponseMidocoMfItem instanceof \Pggns\MidocoApi\Orderlists\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Orderlists\StructType\GetMfs4GroupResponse
     */
