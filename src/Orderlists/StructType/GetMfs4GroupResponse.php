...
class GetMfs4GroupResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintsFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getMfs4GroupResponseMidocoMfItem) {
            ...
            if (!$getMfs4GroupResponseMidocoMfItem instanceof \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\GetMfs4GroupResponse
     */
