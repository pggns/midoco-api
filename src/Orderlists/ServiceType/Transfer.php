...
class Transfer extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Orderlists\ServiceType\Transfer
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\TransferListRequest $paramTransferListRequest
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\TransferListResponse|bool
     */
    public function transferList(\Pggns\MidocoApi\Api\Orderlists\StructType\TransferListRequest $paramTransferListRequest)
    {
        try {
