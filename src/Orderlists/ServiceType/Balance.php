...
class Balance extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Orderlists\ServiceType\Balance
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\BalanceListRequest $paramBalanceListRequest
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\BalanceListResponse|bool
     */
    public function balanceList(\Pggns\MidocoApi\Api\Orderlists\StructType\BalanceListRequest $paramBalanceListRequest)
    {
        try {
