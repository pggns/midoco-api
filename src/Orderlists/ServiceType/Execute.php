...
class Execute extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Orderlists\ServiceType\Execute
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\ExecuteMidocoSettlementRequest $paramExecuteMidocoSettlementRequest
     * @return \Pggns\MidocoApi\Orderlists\StructType\ExecuteMidocoSettlementResponse|bool
     */
    public function executeMidocoSettlement(\Pggns\MidocoApi\Orderlists\StructType\ExecuteMidocoSettlementRequest $paramExecuteMidocoSettlementRequest)
    {
        try {
