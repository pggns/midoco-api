...
class Vat extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Orderlists\ServiceType\Vat
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\VatReconciliationRequest $paramVatReconciliationRequest
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\VatReconciliationResponse|bool
     */
    public function vatReconciliation(\Pggns\MidocoApi\Api\Orderlists\StructType\VatReconciliationRequest $paramVatReconciliationRequest)
    {
        try {
