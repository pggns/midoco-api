...
class _List extends AbstractSoapClientBase
{
     ...
     * @param string $actor
     * @return \Pggns\MidocoApi\Api\Orderlists\ServiceType\_List
     */
     ...
     * @param \Pggns\MidocoApi\Api\Orderlists\StructType\ListFIBUInvRbBalanceRequest $paramListFIBUInvRbBalanceRequest
     * @return \Pggns\MidocoApi\Api\Orderlists\StructType\ListFIBUInvRbBalanceResponse|bool
     */
    public function listFIBUInvRbBalance(\Pggns\MidocoApi\Api\Orderlists\StructType\ListFIBUInvRbBalanceRequest $paramListFIBUInvRbBalanceRequest)
    {
        try {
